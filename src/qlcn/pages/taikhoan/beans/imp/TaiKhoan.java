...
//			this.sotien = formatter.format(rs.getDouble("SOTIEN"));
	...
	public boolean create() {
		try {
			...
			// Lưu log tài khoản
			query = "insert into TAIKHOAN_LOG(ID,TEN,DONVI_FK,TRANGTHAI,NGAYTAO,NGAYSUA,USERID,NGANHANG,ISTKNGANHANG,ISTKTINDUNG,HANMUC,NOTINDUNG,NGAY_LOG)"
					+ " select ID,TEN,DONVI_FK,TRANGTHAI,NGAYTAO,NGAYSUA,USERID,NGANHANG,ISTKNGANHANG,ISTKTINDUNG,HANMUC,NOTINDUNG,GETDATE()"
