...
public class Erp_DieuChuyenCPTTList extends Phan_Trang implements IErp_DieuChuyenCPTTList
{
	/**
	 * 
	 */
	...
	public void init(String sql)
	{
		String query = "";
			...
			{
				query="SELECT dc.pk_seq,dc.ngaychungtu,dc.Sochungtu,dc.trangthai,ts.diengiai as TAISAN FROM ERP_DIEUCHUYENCONGCUDUNGCU dc inner join ERP_CONGCUDUNGCU ts on dc.ccdc_fk=ts.pk_seq ";
