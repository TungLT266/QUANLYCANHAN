package geso.salesup.erp.beans.tieuhao.imp;

import geso.salesup.erp.db.sql.dbutils;
import geso.salesup.distributor.util.Utility;
...
@WebServlet("/ErpTieuHaoAjax")
public class ErpTieuHaoAjax extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	public ErpTieuHaoAjax()
	{
		super();
