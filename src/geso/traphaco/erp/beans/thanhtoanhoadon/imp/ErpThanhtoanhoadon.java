...
public class ErpThanhtoanhoadon implements IErpThanhtoanhoadon 
{
	...
	public ErpThanhtoanhoadon()
	{
		...
		this.isktt = "";
		this.nguoiNhanTien="";
		this.soChungTu_Chu = "PC"+this.ngayghinhan.substring(5,7)+ this.ngayghinhan.substring(0, 4);
		this.soChungTu_So = geso.traphaco.center.util.Utility.getSoChungTuMax(db, "ERP_THANHTOANHOADON", "100000");
	...
	public boolean createTTHD() 
	{
		...
		if (this.soChungTu_Chu.trim().length() > 0 || this.soChungTu_So.trim().length() > 0 )
		...
		try 
		{
			...
			if(nhomNCCCNId.length() > 0)
			{
				...
				" NGAYTAO, NGUOITAO, NGAYSUA, NGUOISUA, LOAITHANHTOAN, TIENTE_FK, TIGIA, THANHTOANTUTIENVAY, CTKEMTHEO, CONGTY_FK, PREFIX  " +
				...
				"'"+ ngaytao + "', '" + this.userId + "', '" + ngaytao + "', '" + this.userId + "','"+this.LoaiThanhToan+"', " + this.tienteId + ", " + this.tigia.replaceAll(",", "") + " , '"+ this.checkThanhtoantuTV +"', N'"+this.chungtukemtheo+"', "+this.ctyId+", 'DNPC'" +
				", '" + this.soChungTu + "', '" + this.soChungTu_So + "','"+this.soChungTu_Chu+"' ,"+this.nguoiNhanTien+", " + this.doiTuongKhacId + ", " + this.khachHang_NPP_FK + " "
				+ "\n)";
			...
			else
			{
				...
				" PHINGANHANG, PHINGANHANGNT, VAT, VATNT, CHENHLECHVND, " +
				" TRICHPHI, SOTAIKHOAN_TP, NGANHANG_TP_FK, CHINHANH_TP_FK, " +
				" NGAYTAO, NGUOITAO, NGAYSUA, NGUOISUA, LOAITHANHTOAN, TIENTE_FK, TIGIA , THANHTOANTUTIENVAY, KHACHHANG_FK, CTKEMTHEO, CONGTY_FK, PREFIX, isTICHLUY, isNPP " +
				", soChungTu, soChungTu_So,soChungTu_Chu, doiTuongKhac_FK, khachHang_NPP_FK) " +
				...
				"'"+ ngaytao + "', '" + this.userId + "', '" + ngaytao + "', '" + this.userId + "','"+this.LoaiThanhToan + "', " + this.tienteId + ", " + this.tigia.replaceAll(",", "") + ", '"+ this.checkThanhtoantuTV +"', " + (this.khachhangId.length()==0?null : this.khachhangId ) + ", N'"+this.chungtukemtheo+"', "+this.ctyId+", 'DNPC' , "+isTICHLUY+"" +
				", '" + this.isNpp + "', '" + this.soChungTu + "', '" + this.soChungTu_So + "', '"+this.soChungTu_Chu+"'," + this.doiTuongKhacId + ", " + this.khachHang_NPP_FK + " \n"
				+ ")";

				query = UtilityKeToan.refactorQuery(query);
				if(this.DoiTuongChiPhiKhac.equals("3"))
				{
					query = "Insert ERP_THANHTOANHOADON(NGAYGHINHAN, HTTT_FK, NGANHANG_FK, CHINHANH_FK\n" +
							", SOTAIKHOAN, NOIDUNGTT,  SOTIENTT, SOTIENTTNT\n" +
							", SOTIENHD, SOTIENHDNT, TRICHPHI, SOTAIKHOAN_TP\n" +
							", NGANHANG_TP_FK, CHINHANH_TP_FK, PHINGANHANG, PHINGANHANGNT\n" +
							", VAT, VATNT, NGAYTAO, NGUOITAO\n" +
							", NGAYSUA, NGUOISUA, LOAITHANHTOAN , TIENTE_FK\n" +
							", TIGIA, THANHTOANTUTIENVAY, CTKEMTHEO, CONGTY_FK\n" +
							", PREFIX, NGUOINHANTIEN, soChungTu, soChungTu_So,soChungTu_Chu, doiTuongKhac_FK, khachHang_NPP_FK)" +
							"values('" + this.ngayghinhan + "', '" + this.htttId + "', " + (this.nganhangId.length() == 0?null : this.nganhangId) + ", " + (this.chinhanhId.length() == 0?null : this.chinhanhId) + "\n" +
							", '" + this.sotaikhoan + "', N'" + this.noidungtt + "', " + ("" + this.sotientt).replaceAll(",", "") + "," + this.sotienttNT.replaceAll(",", "") + "\n" +
							"," + this.sotienHD.replaceAll(",", "") + "," + this.sotienHDNT.replaceAll(",", "") + " ," + this.trichphi + ", '" + this.sotaikhoan_tp + "'\n" +
							", " + (this.nganhang_tpId.length() == 0?null : this.nganhang_tpId) + ", " + (this.chinhanh_tpId.length() == 0?null : this.chinhanh_tpId) + ", " + this.pnganhang.replaceAll(",", "") + ", " + this.pnganhangNT.replaceAll(",", "") + "\n" +
							", " + this.thueVAT.replaceAll(",", "") + ", " + this.thueVATNT.replaceAll(",", "") + ", '"  + ngaytao + "', '" + this.userId + "'\n" +
							", '" + ngaytao + "', '" + this.userId + "','"+this.LoaiThanhToan+ "'," + this.tienteId + "\n" +
							", " + this.tigia.replaceAll(",", "") + " ,'"+ this.checkThanhtoantuTV +"', N'"+this.chungtukemtheo+"', "+this.ctyId+"\n" +
							", 'DNPC', N'"+this.nguoiNhanTien+"'" +
			...
			}else
			{
				for(int i = 0; i < this.hoadonList.size(); i++)
				{
					...
					if(thanhtoan.length() > 0)
					{
						...
						{
							if(this.tienteId.equals("100000")){
								query = "Insert ERP_THANHTOANHOADON_HOADON(THANHTOANHD_FK, HOADON_FK, SOTIENTT, SOTIENAVAT, SOTIENNT, CONLAI, LOAIHD, SOHOADON, TIGIA, TIENTE_FK, DIACHI ) " +
										"values('" + tthdCurrent + "', '" + hoadon.getId() + "', '" + thanhtoan.trim().replaceAll(",", "") + "', '" + avat.replaceAll(",", "") + "'," +
										" 0, '" + conlai.trim().replaceAll(",", "") + "', '"+ loaihd +"', '"+ sohoadon +"', "+tigiahd+", "+tientehd+", N'"+hoadon.getDiaChi()+"')";
								if(loaihd.equals("4"))
								{
									query = "Insert ERP_THANHTOANHOADON_HOADON(THANHTOANHD_FK, HOADON_FK, SOTIENTT, SOTIENAVAT, SOTIENNT, CONLAI, LOAIHD, LOAITHUE, SOHOADON, TIGIA, TIENTE_FK, DIACHI ) " +
									"values('" + tthdCurrent + "', '" + hoadon.getId() + "', '" + thanhtoan.trim().replaceAll(",", "") + "', '" + avat.replaceAll(",", "") + "'," +
											" 0, '" + conlai.trim().replaceAll(",", "") + "', '"+ loaihd +"', N'"+ hoadon.getKyhieu() +"', '"+ sohoadon +"', "+tigiahd+", "+tientehd+", N'"+hoadon.getDiaChi()+"')";
								}
							
							}else{
								query = "Insert ERP_THANHTOANHOADON_HOADON(THANHTOANHD_FK, HOADON_FK, SOTIENTT, SOTIENAVAT, SOTIENNT, CONLAI, LOAIHD, SOHOADON, TIGIA , TIENTE_FK, DIACHI ) " +
										"values('" + tthdCurrent + "', '" + hoadon.getId() + "', '" + thanhtoan.trim().replaceAll(",", "") + "', '" + avat.replaceAll(",", "") + "', " + sotienNT.replaceAll(",", "") + "," +
												" '" + conlai.trim().replaceAll(",", "") + "', '"+ loaihd +"', '"+ sohoadon +"', "+tigiahd+", "+tientehd+", N'"+hoadon.getDiaChi()+"')";																					
								if(loaihd.equals("4"))
								{
									query = "Insert ERP_THANHTOANHOADON_HOADON(THANHTOANHD_FK, HOADON_FK, SOTIENTT, SOTIENAVAT, SOTIENNT, CONLAI, LOAIHD, LOAITHUE, SOHOADON, TIGIA, TIENTE_FK, DIACHI ) " +
									"values('" + tthdCurrent + "', '" + hoadon.getId() + "', '" + thanhtoan.trim().replaceAll(",", "") + "', '" + avat.replaceAll(",", "") + "', " + sotienNT.replaceAll(",", "") + "," +
											" '" + conlai.trim().replaceAll(",", "") + "', '"+ loaihd +"', N'"+ hoadon.getKyhieu() +"', '"+ sohoadon +"', "+tigiahd+", "+tientehd+", N'"+hoadon.getDiaChi()+"')";																						
					...
					{						
						...
						if(Double.parseDouble(Tienhanghd[i].trim().replaceAll(",", "")) > 0)
						{
							...
							if(TaiKhoanIds[i]!="")
							{
								...
								}else if(loais[i].equals("7") ){ // NHÂN VIÊN
								...
								}else if(loais[i].equals("8") ){ // ĐỐI TƯỢNG KHÁC
	...
	public void taoMoiSoChungTu(){
		if(this.ngayghinhan.length() > 0 ){
			...
			this.soChungTu_So = geso.traphaco.center.util.Utility.generataSoChungTu(db, this.soChungTu_Chu,
					geso.traphaco.center.util.Utility.tblPC_UNC ,
					geso.traphaco.center.util.Utility.httt_TM, this.id, this.ngayghinhan);
			this.soChungTu = soChungTu_Chu + soChungTu_So;
		}
	}
		...
		try 
		{
			...
			if(this.DoiTuongChiPhiKhac.equals("5")) isTICHLUY = "1";
      	    ...
      	    query = "update ERP_THANHTOANHOADON " +
					...
					" NOIDUNGTT = N'" + this.noidungtt.replace("'", "&apos;") + "', " +
					...
					", NGUOINHANTIEN = N'"+this.nguoiNhanTien+"', soChungTu = '" + this.soChungTu + "' \n" +
					", soChungTu_Chu = '" + this.soChungTu_Chu + "'" +
					", soChungTu_So = '" + this.soChungTu_So + "'\n" +
					", isNPP = '" + this.isNpp + "', doiTuongKhac_FK = " + this.doiTuongKhacId + ", khachHang_NPP_FK = " + this.khachHang_NPP_FK + "-- \n" +
					" where PK_SEQ = '"  + this.id + "' and trangthai=0\n";
	
      	    	System.out.println("Cau lenh Update: \n" + query + "\n----------------------------------------------");
				...
				if(this.DoiTuongDinhKhoan.equals("3"))
				{
					query = "update ERP_THANHTOANHOADON " +
							...
							"NGAYSUA = '" + ngaysua + "', NGUOISUA = '" + this.userId + "', TIENTE_FK = " + this.tienteId + ", TIGIA = " + this.tigia.replaceAll(",", "") + " ," +
						 	...
						 	" NGUOINHANTIEN = N'"+this.nguoiNhanTien+"', soChungTu = '" + this.soChungTu + "' \n" +
						 	", soChungTu_Chu = '" + this.soChungTu_Chu + "'" +
						 	", soChungTu_So = '" + this.soChungTu_So + "', doiTuongKhac_FK = " + this.doiTuongKhacId + "\n" + 
							" where PK_SEQ = '"  + this.id + "' and trangthai=0";
				}
				...
				for(int i = 0; i < this.hoadonList.size(); i++)
				{
					...
					if(thanhtoan.length() > 0)
					{
						if(Float.parseFloat(thanhtoan) != 0)
						{
							...
							query = UtilityKeToan.refactorQuery(query);
							System.out.println("aaaaaaaaaaaa "+query);
							if(!db.update(query))
							{
								this.msg = "Khong the tao moi ERP_THANHTOANHOADON_HOADON: " + query;
								System.out.println(this.msg);
						...
						if(Double.parseDouble(Tienhanghd[i].trim().replaceAll(",", "")) > 0)
						{
							...
							if(TaiKhoanIds[i]!="")
							{
								...
								query = "SELECT DUNGCHOKHO, DUNGCHONCC, DUNGCHONGANHANG, DUNGCHOTAISAN, DUNGCHOKHACHHANG, COTTCHIPHI, DUNGCHONHANVIEN, " +
										"ISNULL(DUNGCHODOITUONGKHAC, 0) DUNGCHODOITUONGKHAC,  SOHIEUTAIKHOAN FROM ERP_TAIKHOANKT WHERE PK_SEQ = " + TkId[0] + "";
								System.out.println(query);
								ResultSet rs  = this.db.get(query);
								rs.next();
								...
								if(loais[i].equals("7") ){
									...
									if(loais[i].equals("8") ){ // DOI TUONG KHAC
										query="INSERT INTO ERP_THANHTOANHOADON_PHINGANHANG(THANHTOANHD_FK, MAUHOADON, KYHIEU, SOHOADON,NGAYHOADON, TENNCC, MST, TIENHANG, THUESUAT, TIENTHUE, DOITUONGKHAC_FK, TAIKHOAN_FK, PHONGBAN_FK, KBH_FK, TINHTHANH_FK, DIABAN_FK, VUVIEC_FK, BENHVIEN_FK , SP_FK, DIENGIAI, KHOANMUC_FK, DIACHI  ) VALUES " +
												" ('"+this.id+"', UPPER(N'" + Mauhd[i] +"'), UPPER(N'" + Kyhieuhd[i] + "'), '" + Sohd[i] + "'," +
												"'" + Ngayhd[i] + "', N'" + TenNCChd[i] + "', '" + MSThd[i] + "', " + Tienhanghd[i].replaceAll(",", "") + ", " + Thuesuathd[i].replaceAll(",", "") + ", " + Tienthuehd[i].replaceAll(",", "") + ", " +
												dcIds[i]+", "+TkId[0]+","+PhongBanIds[i]+","+KenhbhIds[i]+", "+TinhThanhIds[i]+", "+DiabanIds[i]+", "+MavvIds[i]+", "+ BenhvienIds[i] + ", " + SanPhamIds[i]+", N'"+Diengiaihd[i]+"', "+ttcpIds[i]+", N'"+diaChiHd[i]+"')";
...
//				rerult = (String[])resultSet.getArray("HOADON_FK").getArray();
	...
	public boolean chotTTHD(String userId)
	{
		try{
			...
			System.out.println(" ERP_CANTRUCONGNO :"+query);
		...
		try 
		{
			...
			String query="SELECT TRANGTHAI FROM ERP_THANHTOANHOADON WHERE PK_SEQ= '"  + this.id + "' ";
			...
			if (getIsCanTru() == 1)//Định khoản cho trường hợp PC tự động tạo ra từ DNTT, DNTT có cấn trừ
			{
				...
				else
				{
					...
					if(Double.parseDouble(this.checkThanhtoantuTV) <= 0 )	
					{
						...
						else
						{
							...
							else if(this.khachHang_NPP_FK.trim().length() > 0) //Chi nhánh
							{
								//Định khoản cho những hóa đơn không là DNTT
								result = dinhKhoanChiNhanh(util);
								if (result == false)
								{
									this.msg = "CTTHD1.14 " + this.msg;
									db.getConnection().rollback();
	...
	public boolean unchotTTHD(String userId)
	{
		...
		try 
		{
			...
			System.out.println("thamchieu: "+query);
			ResultSet rs=db.get(query);
			int dem=0;
			String dntt_fk="";
			while(rs.next()){
	...
	private boolean dinhKhoanChiNhanh(Utility util) {
	...
	private boolean dinhKhoanNhanVien(Utility util) 
	{
		String query =
	       ...
	       "        ( select pk_seq from erp_taiKhoanKT where SOHIEUTAIKHOAN = tknh.SOHIEUTAIKHOAN  AND CONGTY_FK = "+this.ctyId+") as taikhoanCO_NH , \n"+
	       ...
	       " inner join ERP_THANHTOANHOADON_HOADON HD on TTHD.PK_SEQ=HD.THANHTOANHD_FK AND HD.LOAIHD <>6  \n" +
	...
	{
		String query = 
		" SELECT  TTHD.NGANHANG_FK , NCC.TAIKHOAN_FK as taikhoan_NCC,  TTHD.NGAYGHINHAN , \n"+
		"        ( select TaiKhoan_fk from ERP_NGANHANG_CONGTY where  SoTaiKhoan = TTHD.SOTAIKHOAN AND CONGTY_FK = "+ this.ctyId + "  ) as taikhoan_NH , \n"+
		"        ( select pk_seq from ERP_TAIKHOANKT where SOHIEUTAIKHOAN = '11110000' AND CONGTY_FK = "+ this.ctyId + " ) as taikhoan_TIENVND, \n"+
		"        TTHD.TIENTE_FK , \n" +
		
		"		case when TTHD.TIENTE_FK = 100000 \n" +
		"		then TTHD_HD.SOTIENTT \n" +
		"		else isnull(TTHD_HD.SOTIENNT,0)* ISNULL(TTHD_HD.TIGIA,1) end AS TIENTHANHTOAN_HD_VND, \n"+
		
		"       TTHD.TIENTE_FK , \n" +
		
		"		case when TTHD.TIENTE_FK = 100000 \n" +
		"		then TTHD_HD.SOTIENTT \n" +
		"		else isnull(TTHD_HD.SOTIENNT,0) end AS TIENTHANHTOAN_HD_NT, \n"+
		
		"        ( case when TTHD.TIENTE_FK = 100000 \n" +
		"		   then TTHD_HD.SOTIENTT \n" +
		"		   else isnull(TTHD_HD.SOTIENNT,0)* ISNULL(TTHD.TIGIA,1) end ) \n"+
		
		"        - ( case when TTHD.TIENTE_FK = 100000 \n" +
		"			 then TTHD_HD.SOTIENTT \n" +
		"			 else isnull(TTHD_HD.SOTIENNT,0)* ISNULL(TTHD.TIGIA,1) end ) as TIENCHENHLECH , \n"+
		
		"        TTHD.NOIDUNGTT, ISNULL(TTHD.SOCHUNGTU, '') MACHUNGTU, \n" +
		"		 ISNULL(TTHD.ISNPP,0) ISNPP, TTHD_HD.TIGIA , \n"+
		...
		System.out.println("Cau query NCC " + query);
		try {
			ResultSet psktRs = db.get(query);
			
			if (psktRs == null)
			{
				this.msg = "DKNCC1.2 Không thể chốt phiếu chi" + msg;
				return false;
			}
			...
			while (psktRs.next()) 
			{
				...
				if (Double.parseDouble(this.checkThanhtoantuTV) <= 0) {
					if (TIENTHANHTOAN_HD_VND > 0) {
						...
						if (taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0) {
							this.msg = "DKNCC1.3 Lỗi xác định tài khoản kế toán. Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
							return false;
						}
					...
					if(TIENCHENHLECH > 0)
					{
						...
						if (taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0) {
							this.msg = "DKNCC1.5 Lỗi xác định tài khoản kế toán. Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
							return false;
						}
					...
					if(TIENCHENHLECH < 0)
					{
						...
						if (taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0) {
							this.msg = "3DKNCC1.7 Lỗi xác định tài khoản kế toán. Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
							return false;
						}
			...
			query = "select (select SOCHUNGTU from ERP_THUENHAPKHAU where PK_SEQ = (select top 1 THUENHAPKHAU_FK from ERP_THANHTOANHOADON_CHIPHIKHAC  where THANHTOANHD_FK= "+ this.id + " )) as sotokhai, \n"+
					...
					"       (select pk_seq from erp_taikhoankt where sohieutaikhoan= '11110000' AND CONGTY_FK = "	+ this.ctyId + ") as taikhoanCO_Tienmat, \n"+ 
				...
				while (ktRs.next()) {
					...
					if (Double.parseDouble(this.checkThanhtoantuTV) <= 0) {
						...
						if (stThueNK > 0) {
							...
							if (taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0) {
								this.msg = "DKNCC1.9 Lỗi xác định tài khoản kế toán (Thuế nhập khẩu). Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
								return false;
							}
						...
						if (stVATNK > 0) {
							...
							if (taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0) {
								this.msg = "DKNCC1.11 Lỗi xác định tài khoản kế toán (VAT nhập khẩu). Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
								return false;
							}
...
//					String khachhang_fk = RsRs.getString("KHACHHANG_FK") == null ? "":RsRs.getString("KHACHHANG_FK");
	...
	{
		String query = 
				"select  a.httt_fk, a.SOTIENHD, \n" +
				"    	 (select pk_seq from erp_taikhoankt where sohieutaikhoan= '11110000' AND CONGTY_FK = "+this.ctyId+") as taikhoanCO_tienhang, \n"+
...
//					", DIACHI AS DIACHIHD  "+						 
	...
	//					String DIACHIHD = ktRs.getString("DIACHIHD")== null ? "NULL": ktRs.getString("DIACHIHD"); 
					...
					if(Double.parseDouble(this.checkThanhtoantuTV) <= 0)
					{
						...
						if(tienhang > 0)
						{
							...
							if( taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0 )
							{
								this.msg = "DKTTK1.2 Lỗi xác định tài khoản kế toán. Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
								return false;
							}
							...
							if(this.msg.trim().length() > 0)
							{
								this.msg = "DKTTK1.3 Không thể chốt phiếu chi" + msg;
								ktRs.close();
								return false;
							}
						}
						...
						if(tienthue > 0)
						{
							...
							if( taikhoanCO.trim().length() <= 0 || taikhoanNO.trim().length() <= 0 )
							{
								this.msg = "DKTTK1.4 Lỗi xác định tài khoản kế toán. Vui lòng kiểm tra lại thông tin dữ liệu nền trước khi chốt.";
								db.getConnection().rollback();
								return false;
							}
...
//		String taiKhoanNO = "";
	...
	private boolean dinhKhoanCanTru() {
		String query = 
			...
			"\n" +
			", case when tt.HTTT_FK = 100000 then --Tiền mặt\n" +
			"				(select tk.PK_SEQ \n" +
			"				from ERP_TAIKHOANKT tk \n" +
			"				where tk.TRANGTHAI = 1 and tk.npp_fk = 1 and tk.SOHIEUTAIKHOAN = '11110000')\n" +
			...
			", case when tt.HTTT_FK = 100000 then N''\n" +
			"end as doiTuongCo \n" +
	...
	public void init_display(){
		...
		String query = " select distinct hd.prefix,  isnull(hd.LoaiThanhToan,'1') as LoaiThanhToan,hd.nhanvien_fk,hd.pk_seq \n" +
				...
				" 		hd.khachhang_fk, kh.ma as makh, kh.ten as tenkh, isnull(hd.nguoinhantien, '') as nguoinhantien, \n" +
				...
				"		, isNull(hd.soChungTu, '') soChungTu, KHOANMUC_FK, ISNULL(PNH.DIACHI, '') DIACHI , isnull(hd.isNPP,'0') isNPP \n" +
			...
			try 
			{
				while(rs.next())
				{
							...
							&& (this.khachHang_NPP_FK == null || this.khachHang_NPP_FK.trim().length() == 0)) // tra Khac
					{
						...
						this.nguoiNhanTien = rs.getString("NGUOINHANTIEN");
				...
				try 
				{
					...
					{				
						...
						if(rs.getString("SANPHAM_FK") != null){
						 ...
						 ttcpIds[i] =  rs.getString("KHOANMUC_FK") == null?"":rs.getString("KHOANMUC_FK");	
						 diaChiHd[i] =  rs.getString("DIACHI") == null?"":rs.getString("DIACHI");	
						...
						this.Mauhd[i] = rs.getString("MAUHOADON")== null?"":rs.getString("MAUHOADON");
		...
		if(rs != null)
		{
			try 
			{
				while(rs.next())
				{
					...
					System.out.println("khachHang_NPP_FK: " + khachHang_NPP_FK);
	...
	public void createDoiTuongDinhKhoan()
	{
		...
		{
			query = "select cast(PK_SEQ as varchar) + ' -- ' + MA+ ',' + TEN  as maten from ERP_NHACUNGCAP where PK_SEQ = "+ this.doituongdinhkhoanId +" AND CONGTY_FK ="+this.ctyId ;
		}
	...
	public void initDisplay()
	{
		...
		String query = " select hd.prefix,  isnull(hd.LoaiThanhToan,'1') as LoaiThanhToan,hd.nhanvien_fk,hd.pk_seq \n"+
				   ...
				   "   , case when hd.DNTT_FK > 0 then '1' else '0' end as isDNTT\n"+
				   " from ERP_THANHTOANHOADON hd  \n"+
				   " left join ERP_THANHTOANHOADON_PHINGANHANG PNH on PNH.THANHTOANHD_FK = hd.PK_SEQ \n"+ 
				   " left join erp_nhacungcap ncc on ncc.pk_Seq=hd.ncc_fk \n"+
				   " left join erp_nhanvien nv on nv.pk_Seq=hd.nhanvien_fk  \n"+
		...
		this.tienteRs = db.get("select pk_seq, ma + ', ' + ten as TEN from ERP_TIENTE where ma = 'VND'");
		...
		this.khachhangRs = db.get("select pk_seq, ma + ', ' + ten as TEN from KhachHang where trangthai = '1' and CONGTY_FK = "+this.ctyId+"");
		
		if(this.DoiTuongChiPhiKhac.equals("0")) // NẾU LOẠI THANH TOÁN CHO NHÂN VIÊN THÌ HIỆN 2 HÌNH THỨC THANH TOÁN
			this.htttRs = db.get("select pk_seq, ma, ten from ERP_HINHTHUCTHANHTOAN where trangthai = '1' and pk_seq IN ( '100000', '100003' )");
		else
			this.htttRs = db.get("select pk_seq, ma, ten from ERP_HINHTHUCTHANHTOAN where trangthai = '1' and pk_seq IN ( '100000' )");
		...
		{			
			if(  this.htttId.length() > 0 && this.hoadonList.size() <= 0)
			{
				...
				// LOAIHD: 6 - DENGHITHANHTOAN							 
					...
					query += "SELECT 10 AS LOAIHD, BTTH.PK_SEQ, TT.SOHOADON AS SOHOADON,  N'Bút toán tổng hợp'  AS KYHIEU , BTTH.NGAYBUTTOAN AS NGAYHOADON ,  \r\n" + 
							...
							"CASE WHEN TTHD.TIENTE_FK= '100000' THEN TT.SOTIENAVAT ELSE TT.SOTIENNT END AS SOTIENAVAT,      \r\n" + 
							"TT.SOTIENTT , '' AS POID ,BTTH.TIENTE_FK AS TTID, BTTH.TIGIA AS TIGIA, NGAYBUTTOAN, '' SOHOPDONG , '' SOHOPDONGNGOAI, TTHD.DIACHI      \r\n" + 
				...
				if(this.NhanvienId.trim().length() > 0)
				{
					...
					if(this.id.length() >0)
					{
							...
							query="  \n" +
							" select 1 AS LOAIHD, B.HOADON_FK AS PK_SEQ, cast(B.HOADON_FK as nvarchar(50)) AS SOHOADON , N'TẠM ỨNG ' as   KYHIEU ,a.ngaytamung as ngayhoadon, SOTIENTAMUNG as sotiengoc    \n" +
							"       ,a.sotientamung -( SELECT ISNULL(SUM(CT.SOTIENTT),0) \n" +
							"                          FROM ERP_THANHTOANHOADON_HOADON CT INNER JOIN ERP_THANHTOANHOADON A ON A.PK_SEQ=CT.THANHTOANHD_FK \n" +
							"                          WHERE  CT.LOAIHD = 1 AND A.TRANGTHAI<>'2'  AND CT.HOADON_FK=B.HOADON_FK and a.pk_seq <>"+this.id+" )  AS sotienAVAT , \n" +
							"  sotientt, '' as POID,  a.TIENTE_FK as TTID ,"+this.tigia.replace(",", "")+" AS TIGIA ,isnull(a.ngaydenhantt,'') as ngaydenhantt, '' SOHOPDONG, '' SOHOPDONGNGOAI \n" +
				...
				// LOAIHD: 6 - DENGHITHANHTOAN
				   ...
				   // LOAD NHỮNG PHIẾU CHI (ĐỀ NGHỊ TT ĐÃ CHỐT)
						...
						query += " select 8 as LOAIHD, tt.HOADON_FK as PK_SEQ, cast(tt.HOADON_FK as nvarchar(50)) as sohoadon,  N'Chi đề nghị thanh toán'  AS KYHIEU , \n"+
								...
								"       ISNULL((select SUM(a.SOTIENTT) as SOTIENTT  from ERP_THANHTOANHOADON_HOADON a inner join ERP_THANHTOANHOADON b on a.THANHTOANHD_FK = b.PK_SEQ where  b.NHANVIEN_FK = '" + this.NhanvienId + "' and a.LOAIHD = 6),0)*(-1) as sotiengoc, \n"+
								"       ( CASE WHEN tthd.TIENTE_FK= '100000' THEN tt.SOTIENAVAT ELSE tt.SOTIENNT END) as SOTIENAVAT, \n"+
			...
			/*	// LOAD NHỮNG PHIẾU CHI (ĐỀ NGHỊ TẠM ỨNG ĐÃ CHỐT)
					...
					query += " select 9 as LOAIHD, tt.HOADON_FK as PK_SEQ, cast(tt.HOADON_FK as nvarchar(50)) as sohoadon,  N'Chi đề nghị tạm ứng'  AS KYHIEU , \n"+
							"       (select a.NGAYGHINHAN from ERP_THANHTOANHOADON a where a.PK_SEQ = tt.HOADON_FK ) as ngayhoadon , \n" +
							"       ISNULL((select SUM(a.SOTIENTT) as SOTIENTT  from ERP_THANHTOANHOADON_HOADON a inner join ERP_THANHTOANHOADON b on a.THANHTOANHD_FK = b.PK_SEQ where a.LOAIHD = 1 and  b.NHANVIEN_FK = '" + this.NhanvienId + "'),0)*(-1) as sotiengoc, \n"+
							"       ( CASE WHEN tthd.TIENTE_FK= '100000' THEN tt.SOTIENAVAT ELSE tt.SOTIENNT END) as SOTIENAVAT, \n"+
							"		 tt.SOTIENTT as SOTIENTT , '' as POID , tthd.TIENTE_FK as ttId,  (select a.TIGIA from ERP_THANHTOANHOADON a where a.PK_SEQ = tt.HOADON_FK ) as TIGIA,  '' ngaydenhantt  \n"+
							" from  ERP_THANHTOANHOADON_HOADON tt  \n"+
				...
				if(this.khachhangId.trim().length() > 0)
				{
					...
					if(this.id.trim().length() > 0)
					{
					    ...
					    query = "select 7 as LOAIHD, tt.PK_SEQ, cast(tt.PK_SEQ as nvarchar(50)) as SOHOADON, N'Khách hàng trả trước' as KYHIEU, tt.NGAYCHUNGTU AS NGAYHOADON  , \n" +
...
//							}
							...
							String sotienNT = ("" + rsHoadon.getDouble("sotienAVAT")/rsHoadon.getDouble("TIGIA")).replaceAll(",", "");							
	...
	{		
		...
		System.out.println("SELECT PK_SEQ ,MA+','+TEN AS TEN FROM ERP_NHANVIEN WHERE TRANGTHAI=1 and CONGTY_FK = "+this.ctyId+"");
		this.NhanvienRs = db.get("SELECT PK_SEQ ,MA+','+TEN AS TEN FROM ERP_NHANVIEN WHERE TRANGTHAI=1 and CONGTY_FK = "+this.ctyId+"");
		this.nhomNCCRs = db.get("SELECT PK_SEQ, DIENGIAI AS TEN FROM NHOMNHACUNGCAPCN where TRANGTHAI = 1 and CONGTY_FK = "+this.ctyId+"" ) ;
		
		//Vì Khách hàng trong DNTT là NHAPHANPHOI nên tạm thời lấy KhachHangRs trong bảng NHAPHANPHOI
		this.khachhangRs = db.get("select pk_seq, MAFAST + ', ' + ten as TEN from NHAPHANPHOI where trangthai = '1' and iskhachhang = 1");
				...
				if (this.nccId.trim().length() > 0) {
					...
					if (this.id.length() > 0) {
						query +=" SELECT distinct 0 as LOAIHD,'' AS LOAITHUE, b.pk_seq, isnull(b.sohoadon, '') as sohoadon,  isnull(b.kyhieu, '') as kyhieu, b.ngayhoadon, \n" +
								...
								"     group by hoadon_fk) thanh_toan on a.hoadon_fk = thanh_toan.hoadon_fk \n" +
								"WHERE c.ncc_fk ='"+this.nccId+"' and a.thanhtoanhd_fk = '" + this.id + "' and c.TIENTE_FK = " + this.tienteId + " and b.CONGTY_FK = "+this.ctyId+" \n" +
					...
					query +="(SELECT distinct 0 as LOAIHD,'' AS LOAITHUE, hoadon.pk_seq, isnull(hoadon.sohoadon, '') as sohoadon, isnull(hoadon.kyhieu, '') as kyhieu, hoadon.ngayhoadon, \n" +
							...
							" FROM ( \n" +
							"       SELECT a.pk_seq, a.kyhieu, a.sohoadon, a.ngayhoadon, a.sotienAVAT, b.TIENTE_FK as ttId, b.TIGIA, a.sotienavat_vnd, isnull(a.ngaydenhantt,'') as  ngaydenhantt, '' SOHOPDONG, '' SOHOPDONGNGOAI \n"+
						...
						query += " ) hoadon \n" +
						   ...
						   +
							...
							"where hoadon.ngayhoadon >'2017-01-01' and hoadon.sotienAVAT - isnull(dathanhtoan.DATHANHTOAN, '0') - isnull(dathanhtoanNCC.DATHANHTOAN, '0')  > 0 and hoadon.ttId = " + this.tienteId + " ) \n" ;
					...
					if (this.tienteId.equals("100000")) {
						...
						query += " select distinct  4 as LOAIHD,'' AS LOAITHUE, tnk.pk_seq, tnk.SOCHUNGTU as sohoadon, N'Thuế nhập khẩu' as kyhieu ,  tnk.NGAYCHUNGTU as ngayhoadon, tnk.THUENK as sotiengoc \n"+
								 ...
								 " where tnk.TIENTE_FK = " + this.tienteId + " and tnk.NGAYCHUNGTU>='2017-01-01' and tnk.NCC_FK = '" + this.nccId+ "' and ( tt.CONLAI is null or (tt.CONLAI > 0 \n"+
								 "					 and tt.HOADON_FK not in \n"+
								 "						(select distinct tt.HOADON_FK \n"+
								 "						from ERP_THUENHAPKHAU tnk \n"+
								 "						left join ERP_THANHTOANHOADON_HOADON tt on tt.HOADON_FK = tnk.PK_SEQ AND TT.LOAIHD = 4 \n"+
						...
						query += " UNION ALL \n"+
								 ...
								 "       group by HOADON_FK \n"+
								 "       ) dathanhtoanNCC  on tnk.PK_SEQ  = dathanhtoanNCC.hoadon_fk \n"+
								 "where tnk.TIENTE_FK = " + this.tienteId + "  and tnk.NGAYCHUNGTU>='2017-01-01' and tnk.CONGTY_FK = " + this.ctyId + " AND tnk.NCC_FK = '" + this.nccId +
								 "' and ( tt.CONLAI is null or (tt.CONLAI > 0 \n"+
								 "					 and tt.HOADON_FK not in \n"+
								 "						(select distinct tt.HOADON_FK \n"+
								 "						from ERP_THUENHAPKHAU tnk \n"+
					...
					query += "select distinct 5 as LOAIHD,'' AS LOAITHUE, cp.pk_seq , cast(cp.PK_SEQ as nvarchar(50)) as sohoadon, cp.DIENGIAI as kyhieu,  cp.NGAY as ngayhoadon, (cpct.TONGTIENCHUATHUE + cpct.THUE ) as sotiengoc \n"+
							 ...
							 "       select TTHD.HOADON_FK , sum(TTHD.SOTIENTT) as DATHANHTOAN  \n"+
							 "       from ERP_THANHTOANHOADONNCC_HOADON TTHD inner join ERP_THANHTOANHOADONNCC TT on TTHD.THANHTOANHD_FK = TT.PK_SEQ \n"+
							 "       where TTHD.LOAIHD = 5 AND TT.TRANGTHAI != 2 and TT.CONGTY_FK = " + this.ctyId + "  \n" + 
							 "       group by HOADON_FK \n"+
					...
					if (this.id.length() > 0) {
						query += " and cp.pk_seq not in (select HOADON_FK from ERP_THANHTOANHOADON_HOADON where THANHTOANHD_FK = "	+ this.id + " AND LOAIHD = 5 ) \n";
					}
					...
					query += 
							...
							"WHERE BTTH.TIENTE_FK =  " + this.tienteId + " and (NGAYBUTTOAN>='2017-01-01' or btth.diengiai like '%DK%') AND CONGTY_FK =  " + this.ctyId + "   \r\n" + 
					...
					if (this.id.length() > 0) {
						query += " and BTTH.pk_seq not in " +
								 ...
								 "  AND (SELECT NCC_FK FROM ERP_THANHTOANHOADON WHERE PK_SEQ = "	+ this.id + ") = " + this.nccId + " " +
								") \n";
					}
					query += 
							"AND (" +
					...
					query += "select distinct 11 as LOAIHD,'' AS LOAITHUE, hdk.pk_seq , hdk.sohoadon as sohoadon, hdk.mauhoadon as kyhieu,  HDK.ngayhoadon as ngayhoadon, hdk.TONGTIENAVAT_VND as sotiengoc \n"+
							 ...
							 "	SELECT TTHD.HOADONNCC_FK,TT.NCC_FK, sum(TTHD.TienThanhToan) as tongthanhtoan \n " +
							 "  FROM ERP_XOANONCC_HOADONNCC TTHD inner join ERP_XOANONCC TT on TTHD.XOANONCC_FK = TT.PK_SEQ \n " +
							 "  WHERE TT.trangthai != '2' and TT.NCC_FK = '" + this.nccId + "'  \n " +
							 " 	and TTHD.LOAICT = 11 \n" + "     GROUP BY TTHD.HOADONNCC_FK,TT.NCC_FK \n " +
					...
					query += " select distinct 6 as LOAIHD,'' AS LOAITHUE, mh.PK_SEQ, cast(mh.SOPO as nvarchar(50)) as sohoadon,  N'Đề nghị thanh toán'  AS KYHIEU , mh.NGAYMUA as ngayhoadon, " +
							 ...
							 "       select TTHD.HOADON_FK , sum(TTHD.SOTIENTT) as DATHANHTOAN  \n"+
							 "       from ERP_THANHTOANHOADON_HOADON TTHD inner join ERP_THANHTOANHOADON TT on TTHD.THANHTOANHD_FK = TT.PK_SEQ \n"+
							 "       where TTHD.LOAIHD = 6 AND TT.TRANGTHAI = 0 AND tt.CONGTY_FK = " + this.ctyId + " " +
...
*/							 "and  mh.quanlycongno='1' and mh.TYPE ='1' and mh.trangthai not in (2,3) \n";
				...
				if (this.NhanvienId.trim().length() > 0) {
					...
					if (this.id.length() > 0) {
						...
						query += " SELECT distinct 1 AS LOAIHD,'' AS LOAITHUE, TU.PK_SEQ , cast(TU.PK_SEQ as nvarchar(50)) as sohoadon ,N'TẠM ỨNG'  AS KYHIEU," +
								...
								+ this.tigia.replace(",", "") +
								 ...
								 " ) " +
								 "   and TU.TRANGTHAI = 1 and TU.NGAYTAMUNG>='2017-01-01' \n" + 
					...
					query += "select distinct 5 as LOAIHD,'' AS LOAITHUE, cp.pk_seq , cast(cp.PK_SEQ as nvarchar(50)) as sohoadon, cp.DIENGIAI as kyhieu,  cp.NGAY as ngayhoadon , (cpct.TONGTIENCHUATHUE + cpct.THUE ) as sotiengoc \n"
							...
							+ this.NhanvienId + " \n"
							+ "	         group by a.cttt_fk) xoatamung  on xoatamung.cttt_fk = cp.PK_SEQ \n"
							+ "where cp.CONGTY_FK = " + this.ctyId + "  and  cp.NGAY>='2017-01-01' and  cp.DOITUONG = '" + this.NhanvienId
							+ "' and cp.TIENTE_FK= " + this.tienteId + " and ( tt.CONLAI is null or (tt.CONLAI > 0 \n"
							+ "					 and tt.HOADON_FK not in \n"
							+ "						(select distinct tt.HOADON_FK \n"
							+ "						from ERP_CHIPHIKHAC_CHITIET cpct \n"
					...
					query += 
							...
							"CASE WHEN BTTH.TIENTE_FK= '100000' THEN \n " +
							"CO - ISNULL(DATHANHTOAN.TIENTHANHTOAN, 0)  \r\n" +
							"ELSE " +
					...
					query += " select distinct 6 as LOAIHD,'' AS LOAITHUE,  mh.PK_SEQ, cast(mh.SOPO as nvarchar(50)) as sohoadon,  N'Đề nghị thanh toán'  AS KYHIEU , mh.NGAYMUA as ngayhoadon,  mh.TONGTIENAVAT as sotiengoc \n"
							...
							+ "				    left join ERP_NHANVIEN nv on nv.PK_SEQ = mh.NHANVIEN_FK \n"
							+ "				where mh.CONGTY_FK = " + this.ctyId
							+ " and  mh.TRANGTHAI = 1 and mh.NGAYMUA>='2017-01-01' and mh.LOAIHANGHOA_FK = '2' and TYPE = '1'  and mh.TIENTE_FK = "
				...
				if (this.khachhangId.trim().length() > 0) {
					...
					query += " select distinct 6 as LOAIHD,'' AS LOAITHUE, mh.PK_SEQ, cast(mh.SOPO as nvarchar(50)) as sohoadon,  N'Đề nghị thanh toán'  AS KYHIEU , mh.NGAYMUA as ngayhoadon, mh.TONGTIENAVAT as sotiengoc \n"
							...
							+ " 		LEFT JOIN ERP_THANHTOANHOADON_HOADON tt on  tt.HOADON_FK = mh.PK_SEQ AND TT.LOAIHD = 6 \n"
							+ " 		LEFT JOIN ERP_THANHTOANHOADON t on  t.pk_seq = tt.thanhtoanhd_fk  \n"							
							+ " where mh.ngaymua >'2016-09-30' and mh.CONGTY_FK = " + this.ctyId 
					...
					query += " UNION ALL \n"+
					 ...
					 if (this.id.trim().length() > 0) {
							query += "       and hd.PK_SEQ not in (select HOADON_FK from ERP_THANHTOANHOADON_HOADON where  THANHTOANHD_FK = '"+ this.id + "' AND LOAIHD = 8) ";
					  }  
				...
				System.out.println("Query khoi tao hoa don 111112: \n" + query + "\n------------------------------------------------------------");
					...
					query += " select p.ncc_fk , b.pk_seq, b.kyhieu, b.sohoadon, b.ngayhoadon, b.sotienAVAT - isnull(thanh_toan.tongthanhtoan, '0') as sotienAVAT, SOTIENTT, " +
								" ISNULL( (  " +
										...
										"Where PO1.hoadonncc_fk = b.pk_seq " +
											...
											"From ERP_HOADONNCC_PHIEUNHAP PO  " +
											"where PO.hoadonncc_fk = b.pk_seq " +
										"), '' )   as POID, ISNULL(DIACHI, '') AS DIACHI  \n"+
							"from ERP_THANHTOANHOADON_HOADON a " +
				...
				if(rsHoadon != null)
				{
					try 
					{
						...
						while(rsHoadon.next())
						{
							...
							hd = new Hoadon(ncc_fk, id, kyhieu, sohoadon, ngayhd, avat, "0", dathanhtoan, "" , "", diaChi);
							hd.setSoPO(rsHoadon.getString("POID"));
							hdList.add(hd);
						}
						rsHoadon.close();
				...
				if (this.nccId.trim().length() > 0) {
					...
					if (this.id.length() > 0) {
						query +=" SELECT distinct 0 as LOAIHD,'' AS LOAITHUE, b.pk_seq, isnull(b.sohoadon, '') as sohoadon,  isnull(b.kyhieu, '') as kyhieu, b.ngayhoadon, \n" +
								...
								"   ( select TTHD.hoadon_fk, sum(TTHD.SOTIENTT) as tongthanhtoan \n" +
								"     from ERP_THANHTOANHOADON_HOADON TTHD inner join ERP_THANHTOANHOADON TT on TTHD.THANHTOANHD_FK = TT.PK_SEQ \n" +
								"     where TT.CONGTY_FK = "+this.ctyId+"  and TTHD.LOAIHD = 0 AND TT.trangthai !=2 and TTHD.thanhtoanhd_fk != '" + this.id + "' \n" +  //sua trang thai !=2 thanh =1
								"           and TTHD.hoadon_fk in ( select hoadon_fk \n" +
						        "									from ERP_THANHTOANHOADON_HOADON \n" +
								"									where thanhtoanhd_fk = '" + this.id + "' and loaihd = 0 ) \n" +
								"     group by hoadon_fk) thanh_toan on a.hoadon_fk = thanh_toan.hoadon_fk \n" +
					...
					if (this.tienteId.equals("100000")) {
						...
						if (this.id.length() > 0) {
							...
							query += "select distinct 4 as LOAIHD,'' AS LOAITHUE, tnk.pk_seq , tnk.SOCHUNGTU as sohoadon, N'Thuế nhập khẩu' as kyhieu , tnk.NGAYCHUNGTU as ngayhoadon, tnk.THUENK as sotiengoc \n"+
									 ...
									 "select distinct  4 as LOAIHD,'' AS LOAITHUE, tnk.pk_seq , tnk.SOCHUNGTU as sohoadon, N'VAT nhập khẩu' as kyhieu , tnk.NGAYCHUNGTU as ngayhoadon, tnk.VAT as sotiengoc \n"+
									 " 		,tt.sotienavat as sotienavat, tt.SOTIENTT as sotientt  , '' as POID \n"+
									 " 		,'100000' as ttId, '1' as TIGIA,  tnk.ngaydenhantt, '' SOHOPDONG, '' SOHOPDONGNGOAI , ISNULL(tt.DIACHI, '') AS DIACHI \n"+
									 "from ERP_THUENHAPKHAU tnk \n"+
									 "		left join ERP_THANHTOANHOADON_HOADON tt on tt.HOADON_FK = tnk.PK_SEQ AND TT.LOAIHD = 4 \n"+
									 "		left join ERP_THANHTOANHOADON t on t.PK_SEQ = tt.THANHTOANHD_FK  \n"+
									 " where tnk.NCC_FK= '" + this.nccId + "' and tt.THANHTOANHD_FK = '" + this.id +"' and tt.LOAITHUE = N'VAT nhập khẩu' \n";
...
//						diaChiGoc = rs.next() ? rs.getString("DIACHI") : "";
					...
					if (this.id.trim().length() > 0) {
						...
						query = "select distinct 7 as LOAIHD,'' AS LOAITHUE, tt.PK_SEQ, cast(tt.PK_SEQ as nvarchar(50)) as SOHOADON, N'Khách hàng trả trước' as KYHIEU, tt.NGAYCHUNGTU AS NGAYHOADON  , \n"
								...
								+ "		from ERP_THUTIEN a where TRANGTHAI = '1' and NOIDUNGTT_FK = '100001' and KHACHHANG_FK = '"+ this.khachhangId + "' and a.PK_SEQ = tt.PK_SEQ ) AS SOTIENGOC,  \n"
								+ "       CASE WHEN tt.TIENTE_FK <> '100000' THEN ttct.SOTIENNT ELSE ttct.SOTIENAVAT END AS SOTIENAVAT , \n"
								+ "       ttct.SOTIENTT, '' AS POID, tt.TIENTE_FK AS TTID, ISNULL(tt.TIGIA,1) as TIGIA, '' as NGAYDENHANTT, '' SOHOPDONG, '' SOHOPDONGNGOAI, ISNULL(ttct.DIACHI, '') AS DIACHI  \n"
								+ "from ERP_THUTIEN tt  inner join ERP_THANHTOANHOADON_HOADON ttct on ttct.HOADON_FK = tt.PK_SEQ AND ttct.LOAIHD = 7 \n"
								+ "where tt.KHACHHANG_FK = '" + this.khachhangId + "' and ttct.THANHTOANHD_FK = "
								+ this.id + "  \n" + loaiphieuthu;
						query += " UNION ALL \n";
				...
				if (this.bophanId.trim().length() > 0) {
					...
					if (this.id.length() > 0) {
						query += "SELECT 10 AS LOAIHD,'' AS LOAITHUE, BTTH.PK_SEQ, TT.SOHOADON AS SOHOADON,  N'Bút toán tổng hợp'  AS KYHIEU , BTTH.NGAYBUTTOAN AS NGAYHOADON ,  \r\n" + 
								"CASE WHEN TTHD.TIENTE_FK= '100000' THEN BTTHCT.CO ELSE BTTHCT.GIATRINT END AS SOTIENGOC,       \r\n" + 
								"CASE WHEN TTHD.TIENTE_FK= '100000' THEN TT.SOTIENAVAT ELSE TT.SOTIENNT END AS SOTIENAVAT,      \r\n" + 
								"TT.SOTIENTT , '' AS POID ,BTTH.TIENTE_FK AS TTID, BTTH.TIGIA AS TIGIA, NGAYBUTTOAN AS NGAYDENHANTT, '' SOHOPDONG , '' SOHOPDONGNGOAI, ISNULL(TT.DIACHI, '') AS DIACHI       \r\n" + 
								"FROM ERP_BUTTOANTONGHOP BTTH         \r\n" + 
								"INNER JOIN ERP_BUTTOANTONGHOP_CHITIET BTTHCT ON BTTH.PK_SEQ = BTTHCT.BUTTOANTONGHOP_FK      \r\n" + 
...
//							String sotienNT = ("" + rsHoadon.getDouble("sotienAVAT")).replaceAll(",", "");
	...
	public static void main(String[] args) 
	{
		...
		UtilityKeToan util = new UtilityKeToan();
		ErpThanhtoanhoadon ucn = new ErpThanhtoanhoadon();
		ucn.db = db;
		try
		{
		db.getConnection().setAutoCommit(false);
		String query="select pk_seq,ngayghinhan,nguoisua from ERP_THANHTOANHOADON where pk_seq = 100947  ";
		String msg="";
		ResultSet rs= db.get(query);
		while (rs.next())
		{
			...
			util.setNam(nam);
			util.setThang(thang);
			msg=util.HuyUpdate_TaiKhoan(db, rs.getString("pk_seq"), "Thanh toán hóa đơn");
			if(msg.length()>0)
			{
				db.getConnection().rollback();
	...
	public ResultSet getDoituongRs(String taikhoanId) 
	{
		...
		if(this.dungchos.trim().length() > 0)
		{
			...
			for(int i= 0; i < mang.length; i++)
			{
				...
				if(mang[i].equals("2")){
					 if(command.trim().length() > 0)  command += " UNION ALL ";
					 command += "SELECT CONVERT(VARCHAR, PK_SEQ) AS PK_SEQ, MA, TEN, 2 AS LOAI FROM ERP_NHACUNGCAP WHERE  TRANGTHAI=1 and duyet = '1' AND CONGTY_FK ="+this.ctyId;
				}
				if(mang[i].equals("3")){
					 if(command.trim().length() > 0)  command += " UNION ALL ";
	...
	/*@Override
	public String getPhongBanChoKhoanMuc(String khoanMuc) {
		
		sString query = 	"SELECT PK_SEQ,MA,TEN FROM ERP_TRUNGTAMCHIPHI " +
						"WHERE TRANGTHAI = 1 AND CONGTY_FK = " + this.congtyId + " " +
						"AND 1 = (SELECT ISNULL(COTTCHIPHI, 0) FROM ERP_TAIKHOANKT WHERE PK_SEQ = " + tknoId + " AND CONGTY_FK = " + this.congtyId + ") ";

		String phongBanId = "";
		if(khoanMuc != null || khoanMuc.trim().length() >= 0){
		
		String query = 	
			"SELECT DVTH.PK_SEQ,\r\n" + 
			"	ISNULL(DVTH.TEN, '') AS DVTHTEN\r\n" + 
			"FROM\r\n" + 
			"	ERP_NHOMCHIPHI NHOMCHIPHI\r\n" + 
			...
			"WHERE\r\n" + 
			"	NHOMCHIPHI.PK_SEQ = '"+khoanMuc+"'";
		try {
			ResultSet rs = db.get(query);
			phongBanId = (rs.next()) ? rs.getString("DVTHTEN") : "";
			rs.close();
		} catch (SQLException e) {
			e.printStackTrace();
		}
		System.out.println("PHONG BAN CUA KHOAN MUC:\n" + phongBanId + "\n---------------------------------------------------------------");
		}
		return phongBanId;
	}*/
	...
	{
		this.soChungTu_Chu = "PC"+this.ngayghinhan.substring(5,7)+ this.ngayghinhan.substring(0, 4);
		this.soChungTu_So = geso.traphaco.center.util.Utility.getSoChungTuMax(db, "ERP_THANHTOANHOADON", "100000", this.ngayghinhan);
		this.soChungTu = soChungTu_Chu + soChungTu_So;
	}
