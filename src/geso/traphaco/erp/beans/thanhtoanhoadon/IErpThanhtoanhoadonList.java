package geso.traphaco.erp.beans.thanhtoanhoadon;
...
public interface IErpThanhtoanhoadonList extends Serializable, IPhan_Trang
{
	...
	String getDoiTuongChiPhiKhac();
	void setDoiTuongChiPhiKhac(String doiTuongChiPhiKhac);
	String getNccTen();
	void setNccTen(String nccTen);
