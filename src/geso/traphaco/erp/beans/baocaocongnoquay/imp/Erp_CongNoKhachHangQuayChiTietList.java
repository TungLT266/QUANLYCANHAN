...
public class Erp_CongNoKhachHangQuayChiTietList  extends Phan_Trang implements IErp_BaoCaoCongNoChiTietList
{
	/**
	 * 
	 */
	...
	public Erp_CongNoKhachHangQuayChiTietList()
	{
		this.congTyId = "";
		this.msg= ""; 
...
//		String [] param = {"x...."};
		...
		if (this.dieuKienLoc.getSoHieuTaiKhoanNo().trim().length() > 0 
				...
				&& this.dieuKienLoc.getDoiTuongNoId().trim().length() > 0)
		{
