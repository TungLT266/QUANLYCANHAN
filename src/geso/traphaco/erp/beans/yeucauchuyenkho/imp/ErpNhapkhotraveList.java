...
public class ErpNhapkhotraveList extends Phan_Trang implements IErpNhapkhotraveList
{
	...
	public void init(String search)
	{
		...
		{
			query = "  select a.PK_SEQ, a.trangthai, a.ngaytra, a.lydo, NV.TEN as nguoitao, a.NGAYSUA, a.NGAYTAO, isnull(NV2.TEN, '') as nguoisua, a.ghichu, isnull( sohoadon, '' ) as sohoadon, " + 
					"  			b.Ten as doituong, isnull(ngaynhapkho, '9999-99-99') as ngaynhapkho    " + 
		...
		this.nhapkhoRs = createSplittingData(50, 10, " trangthai asc,ngaynhapkho desc, PK_SEQ desc ", query);
	...
	{
		try{
			if(this.khonhanRs!=null) this.khonhanRs.close();
		}catch(Exception e){
