...
public class ErpDieuchinhtonkhoList extends Phan_Trang implements IErpDieuchinhtonkhoList
{
	...
	public void init(String search)
	{
		...
		{
			query = 	" SELECT A.PK_SEQ, A.TRANGTHAI, A.ngaydieuchinh, KHOTT.TEN as khochuyen, isnull( BIN.MA + ' - ' + BIN.TEN, '' ) as vitrichuyen, " +
			...
			if(this.tungayTao.length() > 0)
				query += "\n and a.ngaydieuchinh >= '" + tungayTao + "'";
			
			if(this.denngayTao.length() > 0)
				query += "\n and a.ngaydieuchinh  <= '" + denngayTao + "'";
