...
public interface IErpHoaDonTaiChinh extends Serializable, IPhan_Trang 
{	
	...
	public void Setcheckctu(String checkctu);// KIỂM TRA LÀ ĐƠN HÀNG HAY PHIẾU XUẤT KHO
	public String getchecktu();
	
	public String gethinhthucxhd(); //HÌNH THỨC XUẤT HÓA ĐƠN
	...
	public void SetSotienavat(String sotienavat);// SỐ HÓA ĐƠN KÈM THEO
	public String getSotienavat();
	
	//ĐỊA CHỈ GIAO HÀNG TÌM KIẾM
