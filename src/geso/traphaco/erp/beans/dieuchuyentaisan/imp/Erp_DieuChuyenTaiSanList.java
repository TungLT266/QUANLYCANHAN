...
public class Erp_DieuChuyenTaiSanList extends Phan_Trang implements IErp_DieuChuyenTaiSanList
{
	/**
	 * 
	 */
	...
	public Erp_DieuChuyenTaiSanList( )
	{
		this.sochungtu="";
		this.sodieuchuyen="";
		this.tungay="";
	...
	public void init(String sql)
	{
		String query = "";
			...
			{
				query="SELECT dc.pk_seq,dc.ngaychungtu,dc.Sochungtu,dc.trangthai,ts.diengiai as TAISAN FROM ERP_DIEUCHUYENTAISAN dc inner join erp_taisancodinh ts on dc.taisan_fk=ts.pk_seq ";
