...
public class Erp_DanhGiaLaiTaiSanList extends Phan_Trang implements IErp_DanhGiaLaiTaiSanList
{
	/**
	 * 
	 */
	...
	public Erp_DanhGiaLaiTaiSanList( )
	{
		this.sochungtu="";
		this.sodieuchuyen="";
		this.tungay="";
	...
	public void init(String sql)
	{
		String query = "";
			...
			{
				query="SELECT dc.pk_seq,dc.ngaychungtu,dc.Sochungtu,dc.trangthai,ts.diengiai as TAISAN FROM ERP_DANHGIALAITAISAN dc inner join erp_taisancodinh ts on dc.taisan_fk=ts.pk_seq ";
