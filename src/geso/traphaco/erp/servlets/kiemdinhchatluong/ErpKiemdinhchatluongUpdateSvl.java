...
import geso.traphaco.erp.beans.kiemdinhchatluong.IErpKiemdinhchatluong;
import geso.traphaco.erp.beans.kiemdinhchatluong.IErpKiemdinhchatluongList;
import geso.traphaco.erp.beans.kiemdinhchatluong.imp.ErpKiemdinhchatluong;
import geso.traphaco.erp.beans.kiemdinhchatluong.imp.ErpKiemdinhchatluongList;
...
public class ErpKiemdinhchatluongUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Erp/ErpKiemDinhChatLuongUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        {
        	nextJSP = "/TraphacoHYERP/pages/Erp/ErpKiemDinhChatLuongDisplay.jsp";
        }
