...
/**
 * Servlet implementation class ErpLoaiMauKiemNghiemSvl
 */
@WebServlet("/ErpLoaiMauKiemNghiemSvl")
public class ErpLoaiMauKiemNghiemSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ErpLoaiMauKiemNghiemSvl() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(action.equals("new")) {
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpLoaimaukiemnghiemNew.jsp");
