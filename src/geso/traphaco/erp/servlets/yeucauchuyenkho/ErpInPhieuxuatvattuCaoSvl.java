...
public class ErpInPhieuxuatvattuCaoSvl extends HttpServlet {
	List<IYeucau> danhsach_sp;
	public ErpInPhieuxuatvattuCaoSvl() {
        super(); 
    }
	...
	private void Create_PO_PDF(HttpServletResponse response,
		...
		response.setHeader("Content-Disposition",
				" inline; filename=Traphaco_InPhieuxuatvattuCao.pdf");
...
//lay kho xuat
		...
		//	float[] TABLE_HEADER_WIDTHS = new float[] {9.25f * CONVERT ,11.25f * CONVERT };
			...
			String[] spTitles = { "TT","Mã VT","Tên hàng", "Đơn vị ", "Số lượng", "Số PKN", "Hàm ẩm","Hàm lượng","Mẻ","Thùng", "Số lô NSX","Vị trí" };
			//in tieu de
	       		...
	       		while (j< danhsach_sp.size()) { 
	       			...
	       			while( keys.hasMoreElements() )
                	{
                		...
                		if(key.startsWith(sanpham.getMa()))
                		{
                			...
                			String[] spTitles2={sott+" ",Masp,Tensp,Donvi,soluongXUAT,pkn,hamam,hamluong,me,thung,solo,vitri};
