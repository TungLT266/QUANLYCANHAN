...
public class ErpInPhieuxuatvattuBaobi2Svl extends HttpServlet {
	private static final long serialVersionUID = 1L;

	List<IYeucau> danhsach_sp;
	public ErpInPhieuxuatvattuBaobi2Svl() {
        super(); 
    }
	...
	private void Create_PO_PDF(HttpServletResponse response,
		...
		response.setHeader("Content-Disposition",
				" inline; filename=Traphaco_InPhieuxuatvattuBaobi2.pdf");
	...
	private void CreatePO_Training(Document document,
		...
		System.out.println("id phieu chuyen kho:" + id);
...
//lay kho xuat
		...
		//	float[] TABLE_HEADER_WIDTHS = new float[] {9.25f * CONVERT ,11.25f * CONVERT };
			...
			String[] spTitles = { "TT","Mã VT","Tên hàng", "Đơn vị ", "Số lượng", "Số PKN", "Maquette","Số đăng ký", "Số lô NSX","Vị trí" };
			//in tieu de
	       		...
	       		while (j< danhsach_sp.size()) { 
	       			...
	       			while( keys.hasMoreElements() )
                	{
                		...
                		if(key.startsWith(sanpham.getMa()))
                		{
                			...
                			String[] spTitles2={sott+" ",Masp,Tensp,Donvi,soluongXUAT,pkn,marquete,phieudangki,solo,vitri};
