...
public class ErpHuyChuyenKhoSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpHuyChuyenKhoSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpHuyChuyenKhoList obj;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {
	    	IErpHuyChuyenKho hctmhBean = new ErpHuyChuyenKho();
	    ...
	    else
	    {
	    	if(action.equals("view") || action.equals("next") || action.equals("prev"))
	    	{
		    	...
		    	session.setAttribute("obj", obj);
		    	response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpHuyChuyenKho.jsp");	
		    }
	    	else
	    	{
		    	obj = new ErpHuyChuyenKhoList();
	...
	private String getSearchQuery(HttpServletRequest request, IErpHuyChuyenKhoList obj)
	{
	 
		/*String query =  " select  CASE A.LOAICHUNGTU WHEN 'YCCK' THEN  N'YÊU CẦU CHUYỂN KHO' WHEN 'CK' THEN N'CHUYỂN KHO' WHEN 'DQC' THEN N'ĐỔI QUY CÁCH' WHEN 'DCTK' THEN N'ĐIỀU CHỈNH TỒN KHO' END AS LOAICHUNGTU,  " +
						" a.PK_SEQ as SOPHIEU, a.PHIEUYEUCAU_FK AS  SOCHUNGTU, isnull(a.SOCHUNGTUPHATSINH, '') as SOCHUNGTUPHATSINH, a.TRANGTHAI, a.NGAYTAO, a.NGAYSUA, b.TEN as NGUOITAO, c.TEN as NGUOISUA " +
		...
		String query =  " select   CASE A.LOAICHUNGTU WHEN 'PDT_EO' THEN  N'PHIẾU KIỂM ĐỊNH EO/ĐỊNH TÍNH' WHEN 'CVT' THEN N'CHUYỂN VỊ TRÍ'END AS LOAICHUNGTU,  " +
				" a.PK_SEQ as SOPHIEU, a.PHIEUYEUCAU_FK AS  SOCHUNGTU, isnull(a.SOCHUNGTUPHATSINH, '') as SOCHUNGTUPHATSINH, a.TRANGTHAI, a.NGAYTAO, a.NGAYSUA, b.TEN as NGUOITAO, c.TEN as NGUOISUA " +
				" from ERP_HUYCHUYENKHO a inner join NHANVIEN b on a.nguoitao = b.pk_seq inner join NHANVIEN c on a.nguoisua = c.pk_seq " +
				" where a.congty_fk = '" +  obj.getCongtyId() + "' ";
		...
		if(sochungtu.length() > 0)
			query += " and a.PHIEUYEUCAU_FK like '%" + sochungtu + "%'";
