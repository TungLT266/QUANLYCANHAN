...
public class Erp_YeucaumuaNLSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	PrintWriter out;
	private static final String UPLOAD_DIRECTORY = "C:\\upload\\excel\\";
    public Erp_YeucaumuaNLSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(task == null){
		    ...
		    IErp_YeucaumuaNL ycNL = new Erp_YeucaumuaNL();
		    ycNL.setCtyId(ctyId);
		    ycNL.setUserId(userId);

		    String action = util.getAction(querystring);
		    String id = util.getId(querystring);
		    
		    ycNL.init();
			session.setAttribute("ycNL", ycNL);
		    
		    String nextJSP = "/TraphacoHYERP/pages/Erp/Erp_YeucaumuaNL.jsp";
	...
	private void FillData(Workbook workbook, IStockintransit obj, String sheet, String khoId) {
		...
		// ĐƯA DỮ LIỆU VÀO SHEET CÁC KHO VÙNG			
			query = "SELECT  SP.MA, SP.PK_SEQ AS SPID, SP.TEN, DVDL.DONVI, \n " + //CL.TEN AS CHUNGLOAI, 
...
//							"INNER JOIN CHUNGLOAI CL ON CL.PK_SEQ = SP.CHUNGLOAI_FK \n " +
							...
							"WHERE KHOTT_SP.KHOTT_FK IN (100014, 100016, 100017, 100018, 100019, 100020, 100049) " +
							"AND SP.TRANGTHAI = 1 AND SP.LOAISANPHAM_FK IN (100000, 100008, 100013) \n " +
							"GROUP BY SP.MA , SP.PK_SEQ, SP.TEN, DVDL.DONVI \n " + //CL.PK_SEQ, CL.TEN, 
	...
	private void getSearchQuery(HttpServletRequest request, IErp_YeucaumuaNL obj) 
	{
		Utility util = new Utility();
