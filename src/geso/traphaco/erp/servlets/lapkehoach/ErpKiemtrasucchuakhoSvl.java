...
public class ErpKiemtrasucchuakhoSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	PrintWriter out;
	private static final String UPLOAD_DIRECTORY = "C:\\upload\\excel\\";
    public ErpKiemtrasucchuakhoSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    IErpKiemtrasucchuakhoList ktrakhoList = new ErpKiemtrasucchuakhoList();
	    ktrakhoList.setCtyId(ctyId);
	    ktrakhoList.setUserId(userId);

	    String action = util.getAction(querystring);
	    String id = util.getId(querystring);
		    
	    ktrakhoList.init();
		session.setAttribute("ktrakhoList", ktrakhoList);
		    
	    String nextJSP = "/TraphacoHYERP/pages/Erp/ErpKiemtrasucchuakho.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		IErpKiemtrasucchuakhoList ktrakhoList;
		ktrakhoList = new ErpKiemtrasucchuakhoList();
		ktrakhoList.setCtyId(ctyId);
		ktrakhoList.setUserId(userId);
	    
		getSearchQuery(request, ktrakhoList);
		...
		try{
			...
			ktrakhoList.setUserId(userId);
			ktrakhoList.setMsg(msg);
			ktrakhoList.init();
			
			session.setAttribute("ktrakhoList", ktrakhoList);  	
			session.setAttribute("userId", userId);
		
			response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpKiemtrasucchuakho.jsp");
		}catch (Exception e) 
		{
	...
	private void getSearchQuery(HttpServletRequest request, IErpKiemtrasucchuakhoList obj) 
	{
		Utility util = new Utility();
