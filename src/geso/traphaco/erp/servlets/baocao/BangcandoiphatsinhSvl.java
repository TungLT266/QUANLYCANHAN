...
public class BangcandoiphatsinhSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	public BangcandoiphatsinhSvl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = "/TraphacoHYERP/pages/Erp/Bangcandoiphatsinh.jsp";
		...
		if(!cutil.check(userId, userTen, sum)){
			...
			if (action.equals("tao")) {
				try {
					...
					response.setHeader("Content-Disposition", "attachment; filename=BangCanDoiPhatSinh.xls");
	...
	private void CreateReport(OutputStream out, IBangcandoiphatsinh obj)throws Exception {
		...
		try{
			String file = getServletContext().getInitParameter("path") + "\\BangCanDoiSoPhatSinh.xlsm";
