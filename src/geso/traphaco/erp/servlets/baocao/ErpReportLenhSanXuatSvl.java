...
public class ErpReportLenhSanXuatSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpReportLenhSanXuatSvl() {
        super();
    } 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Erp/ErpReportLenhsanxuat.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
	    ...
	    else
	    {
			...
			response.setHeader("Content-Disposition", "Attachment; filename=ReportLSX(NPP).xlsm");
	...
	private void CreatePivotTable(OutputStream out, HttpServletResponse response, HttpServletRequest request,  IBaocao obj) throws Exception
	{
		try
		{
			...
			Worksheets worksheets = workbook.getWorksheets();
	  		...
	  		worksheet_2.setName("REPORT_LENHSANXUAT");
	  		 Cells cells = worksheet_2.getCells();
				...
				param[2]=obj.getLoaibaocao();
			  
				ResultSet	rs = db.getRsByPro("GET_REPORT_LENHSANXUAT", param);
		  		worksheets = workbook.getWorksheets();
		  		 
		  		this.TaoBaoCao(db,rs,worksheet_2, obj,"REPORT_LENHSANXUAT",style1);
