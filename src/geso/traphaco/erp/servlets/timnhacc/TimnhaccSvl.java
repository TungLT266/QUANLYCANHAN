...
public class TimnhaccSvl extends HttpServlet 
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    else 
	    {
		    ...
		    else if(action.equals("chot"))
	    	{
				...
				if(db.updateReturnInt(" update ERP_TIMNCC set trangthai = '1' where pk_seq = '" + timnccId + "' and TRANGTHAI=0")!=1)
				{
					obj.setMsg("Chốt không thành công ! Vui lòng thử lại !");
				}
				 if(msg.length() > 0) obj.setMsg(msg);
		    ...
		    else if(action.equals("unchot"))
		    {
				...
				geso.traphaco.center.util.GiuDieuKienLoc.setParamsToOject(obj, searchQuery);
		    	dbutils db = new dbutils();
				if(db.updateReturnInt(" update ERP_TIMNCC set trangthai = '0' where pk_seq = '" + timnccId + "' and trangthai<>0")!=1)
				{
					obj.setMsg("Bỏ chốt không thành công , Vui lòng thử lại");
				}
    ...
    private void GET_DATA_TO_CLIENT(HttpServletRequest request, HttpServletResponse response, String action)  throws ServletException, IOException 
	{
    	try
    	{
		    ...
		    String query =  "select top 1 a.PK_SEQ from erp_danhgiancc a where a.NCC_FK = '"+nccId+"' "+//and a.SP_FK = '"+spId+"' "+
		    				"order by a.pk_seq desc";
		    System.out.println("danhgiancc "+query);
			String dgid = "0";
		    ...
		    String myDATA =
		    "<div align=\"center\" style=\"width: 550px; float: none; clear: left\">"+
			"<fieldset>"+
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    else
	    {
	    	if(action.equals("view") || action.equals("next") || action.equals("prev"))
	    	{
		    	...
		    	session.setAttribute("obj", obj);
		    	response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpTimNcc.jsp");	
		    }
	    	else
	    	{
		    	obj = new TimnhaccList();
    ...
    private void getSearchQuery(HttpServletRequest request, ITimnhaccList obj)
	{
		Utility util = new Utility();
...
//		
//		String query = "select a.pk_seq as id, a.trangthai, a.ngaytao, b.ten as nguoitao, a.ngaysua, c.ten as nguoisua, isnull(a.diengiai, 'na') as diengiai, d.sodenghi "
...
//		return query;
	...
	private String Delete(String timnccId,String userId)
	{
		...
		try 
		{
			...
			query = " DELETE ERP_TIMNCC WHERE PK_SEQ = '" + timnccId + "' and TRANGTHAI=0";
