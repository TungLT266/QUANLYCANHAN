...
public class StockSvl extends HttpServlet {
    ...
    {    //khoi tao de viet pivottable
		//buoc 1
	     ...
	     //Buoc2 tao khung
	    //ham tao khu du lieu
	     CreateStaticHeader(workbook, this.userTen);
	     //Buoc3 
	     // day du lieu vao
	...
	private void CreateStaticHeader(Workbook workbook, String UserName) 
	{
	    ...
	    cell.setValue("Inventory Report");   	
	    ...
	    cell.setValue("Report Date: " + this.getDateTime());
	    ...
	    cell = cells.getCell("EE1"); cell.setValue("Brand");
	    cell = cells.getCell("EF1"); cell.setValue("Category");
	    cell = cells.getCell("EG1"); cell.setValue("SKU");
	    cell = cells.getCell("EH1"); cell.setValue("Channel");
	    cell = cells.getCell("EI1"); cell.setValue("Warehouse");	    
	    cell = cells.getCell("EJ1"); cell.setValue("Piece");
	   
	   
	    worksheet.setName("Inventory Report");
	}
	private void CreateStaticData(Workbook workbook) 
	{
	    ...
	    dbutils db = new dbutils();
	   String sql  = "select isnull(d.ten, 'Chua xac dinh') as Channel, f.ten as Region, h.ten as Area, e.ten as Distributor, e.sitecode as Distcode,";
		   sql = sql + "  b.ma + '_' + b.ten as SKU, b.ma as SKUcode,  c.ten as Warehouse, g.ten as Province,";
		   sql = sql + " i.donvikinhdoanh as BusinessUnit, k.ten as Brand, j.ten as Category, a.soluong as Piece";
		 sql = sql + " from nhapp_kho a inner join sanpham b on a.sanpham_fk = b.pk_seq inner join kho c on a.kho_fk = c.pk_seq";
		 ...
		 {
			try 
			{// set do rong cho cac cot se dung
				...
				{ 				
					...
					cell = cells.getCell("EE" + Integer.toString(i)); cell.setValue(Brand);
					cell = cells.getCell("EF" + Integer.toString(i)); cell.setValue(Category);					
					cell = cells.getCell("EG" + Integer.toString(i)); cell.setValue(Sku);
					cell = cells.getCell("EH" + Integer.toString(i)); cell.setValue(Channel);					
					cell = cells.getCell("EI" + Integer.toString(i)); cell.setValue(Warehouse);
					cell = cells.getCell("EJ" + Integer.toString(i)); cell.setValue(Integer.parseInt(Piece));
	    ...
	    int index = pivotTables.add("=EA1:EJ" + pos,"A8","PivotTableDemo");
