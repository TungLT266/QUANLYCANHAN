...
public class Ppromotionreportnpp extends HttpServlet {	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/PromotionReportnpp.jsp";
    ...
    {  
		FileInputStream fstream = new FileInputStream(getServletContext().getInitParameter("path") + "\\XuatKhuyenMai.xlsm");

	//	FileInputStream fstream = new FileInputStream("D:\\Best Stable\\SalesUp\\WebContent\\pages\\Templates\\XuatKhuyenMai.xlsm");
