...
import geso.traphaco.center.beans.theodoithieuhang.ITheodoithieuhang;
import geso.traphaco.center.beans.theodoithieuhang.imp.Theodoithieuhang;
	   ...
	   String[] recipient;
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		    ...
		    if(action.equals("id")){
				...
				String nextJSP = "/TraphacoHYERP/pages/Center/ThieuhangUpdate.jsp";
		    	...
		    	String nextJSP = "/TraphacoHYERP/pages/Center/Theodoithieuhang.jsp";
		    	response.sendRedirect(nextJSP);
		    }
