...
public class KPInpp extends HttpServlet {
	...
	//	PrintWriter out = response.getWriter();
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/KPInpp.jsp";
    ...
    {    
		...
		//buoc 1
	FileInputStream fstream = new FileInputStream(getServletContext().getInitParameter("path") + "\\KPINPP.xlsm");
//			FileInputStream fstream = new FileInputStream("D:\\Best Stable\\SalesUp\\WebContent\\pages\\Templates\\KPINPP.xlsm");	
...
//					cell.setStyle(style);
					...
					cell = cells.getCell("AH" + Integer.toString(i)); cell.setValue(Float.parseFloat(SKU));				//7
//					style = cell.getStyle();
//					style.setNumber(2);
//					cell.setStyle(style);
					
					cell = cells.getCell("AI" + Integer.toString(i)); cell.setValue(Double.parseDouble(Volume));		//8
//					style = cell.getStyle();
//					style.setNumber(2);
//					cell.setStyle(style);
...
//					cell.setStyle(style);
			...
			/*		setAn(workbook,49);
					...
					int index = pivotTables.add("=AA1:AJ" + pos,"A10","KPINPP");
			...
			//	    pivotTable.getRowFields().get(0).setNumber(0);
			
				    pivotTable.addFieldToArea(PivotFieldType.ROW, 1);	
				    pivotTable.getRowFields().get(1).setAutoSubtotals(true);	
			//	    pivotTable.getRowFields().get(1).setNumber(1);
