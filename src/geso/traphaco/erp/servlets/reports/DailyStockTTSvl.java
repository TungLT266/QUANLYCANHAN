...
public class DailyStockTTSvl extends HttpServlet 
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/rp_DailyStock_center.jsp";
    ...
    {    
		FileInputStream fstream = new FileInputStream(getServletContext().getInitParameter("path") + "\\TonKhoHangNgayTT.xlsm");
	//	FileInputStream fstream = new FileInputStream("D:\\Best Stable\\SalesUp\\WebContent\\pages\\Templates\\TonKhoHangNgayTT.xlsm");	
...
/*			PivotTables pivotTables = worksheet.getPivotTables();
		    ...
		    int index = pivotTables.add("=EA1:EN" + pos,"A9","PivotTableDemo");
		    ...
		    pivotTable.addFieldToArea(PivotFieldType.ROW, 8); pivotTable.getRowFields().get(3).setAutoSubtotals(false);  
		    pivotTable.addFieldToArea(PivotFieldType.ROW, 9); pivotTable.getRowFields().get(4).setAutoSubtotals(false);  
