...
public class ErpTinhgiatonBTPSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
    
    public ErpTinhgiatonBTPSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpTinhgiatonBTP obj;
		...
		String nextJSP = "/TraphacoHYERP/pages/Erp/ErpTinhGiaTonBTP.jsp";
