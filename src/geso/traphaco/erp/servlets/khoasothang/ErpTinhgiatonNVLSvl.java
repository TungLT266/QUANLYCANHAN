...
public class ErpTinhgiatonNVLSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
    
    public ErpTinhgiatonNVLSvl() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpTinhgiatonNVL obj;
		...
		String nextJSP = "/TraphacoHYERP/pages/Erp/ErpTinhGiaTonNVL.jsp";
