...
public class ErpParkHoadonnhapkhauSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ErpParkHoadonnhapkhauSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    else
	    {
	    	if(action.equals("chot"))
	    	{
    			...
    			{
    				obj.setMsg("Không chốt được vui lòng kiểm tra lại");
    			}
	    	    obj.init("");    
	    		session.setAttribute("obj", obj);
	    		String nextJSP = "/TraphacoHYERP/pages/Erp/ErpParkHoaDonNhapKhau.jsp";
	    	...
	    	else if(action.equals("convert"))
	    	{
			    ...
			    pBean.setLoaidonmh("0"); // MẶC ĐỊNH LÀ LOẠI HD NHẬP KHẨU
	...
	private void CreateNhanHangNew(String userId, HttpSession session, String hoaDonid){
		...
		nhBean.setNgaynhanhang("");
		nhBean.setIsTudong("0");
		nhBean.setKhoNhanId("");
		nhBean.setKhachhangId("");
		
		nhBean.setNdnId("100000");
    	nhBean.setLdnId("100046");
    	nhBean.GetInfoNhanHangNgamDinh( hoaDonid);
    	
    	// gán mặc định
    	String loaihd = "0";
    	nhBean.init_convert( nhBean.getHdNccId(), "0");
    	nhBean.createRs();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.equals("Tao moi"))
	    {
	    	...
	    	pBean.setUserId(userId);
	    	pBean.setnppdangnhap(util.getIdNhapp(userId));
	    	// gán hóa đơn mặc định là Nhập khẩu
	    	pBean.setKyHieuHoaDon("NK");
	...
	/*	String query = "select a.PK_SEQ , a.NGAYGHINHAN, ncc.TEN as TENNHACUNGCAP, " +
...
//					 "  where c.PK_SEQ = N'"+sonhanhang+"' and a.CONGTY_FK = "+obj.getCongtyId()+" ) ";			
//		}
//		
//		if(donMuaHang.length() >0){
//			query += " and HDNCC_DMH.muahang_fk in( select PK_SEQ from ERP_MUAHANG where sopo='%"+donMuaHang.trim()+"%') ";
//		}
//
//		return query;
	}
