...
public class ErpNhanhangtrongnuocUpdateSvl extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	
	PrintWriter out;
	
	public ErpNhanhangtrongnuocUpdateSvl()
	{
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			...
			IErpNhanhang nhBean = new ErpNhanhang(id);
			...
			{
				nextJSP = "/TraphacoHYERP/pages/Erp/ErpNhanHangDisplay.jsp";
			}
			...
			{
				nextJSP = "/TraphacoHYERP/pages/Erp/ErpNhanHangUpdate.jsp";	
			}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			...
			if (id == null)
			{
				nhBean = new ErpNhanhang("");
			}
			else
			{
				nhBean = new ErpNhanhang(id);
			}
			...
			if (action.equals("save"))
			{
				if (id == null) // tao moi
				{
					...
					else
					{
						...
						IErpNhanhangList obj = new ErpNhanhangList();
				...
				else
				{
					if (!nhBean.updateNhanHang())
					{
						...
						session.setAttribute("nhBean", nhBean);
						String nextJSP = "/TraphacoHYERP/pages/Erp/ErpNhanHangUpdate.jsp";
						response.sendRedirect(nextJSP);
					}
					else
					{
			...
			else
			{
				if ( action.equals("changePO") || action.equals("changeLHH") )
				{
					...
					if (id == null)
					{
						nextJSP = "/TraphacoHYERP/pages/Erp/ErpNhanHangNew.jsp";
					}
					else
					{
						nextJSP = "/TraphacoHYERP/pages/Erp/ErpNhanHangUpdate.jsp";
