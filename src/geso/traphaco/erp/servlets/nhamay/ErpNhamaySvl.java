...
import geso.traphaco.erp.beans.nhamay.*;
import geso.traphaco.erp.beans.nhamay.imp.*;
...
public class ErpNhamaySvl extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(action.equals("new"))
	    {
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpNhaMayNew.jsp");
	    }
	    else
	    {
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Erp/ErpNhaMay.jsp");	
	    }
	}
	...
	private String getSearchQuery(HttpServletRequest request, IErpNhamayList obj) 
	{
		...
		String  sql = "select a.pk_seq, a.manhamay, a.tennhamay, a.diachi, a.trangthai, b.ten as nguoitao, a.ngaytao, c.ten as nguoisua, a.ngaysua    " +
					  "from Erp_NhaMay a inner join NhanVien b on a.nguoitao = b.pk_seq    " +
