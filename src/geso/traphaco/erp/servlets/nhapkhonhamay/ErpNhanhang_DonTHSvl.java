...
import geso.traphaco.erp.beans.nhanhang.IErpNhanhangList_DonTH;
import geso.traphaco.erp.beans.nhanhang.IErpNhanhang_DonTH;
import geso.traphaco.erp.beans.nhanhang.imp.ErpNhanhangList_DonTH;
import geso.traphaco.erp.beans.nhanhang.imp.ErpNhanhang_DonTH;
...
public class ErpNhanhang_DonTHSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpNhanhang_DonTHSvl() {
        super();
    }
	...
	private String chotNhanHang_SanPham(String nhId, String userId, String ctyId, dbutils db)
	{
		...
		/******************* END TIEU HAO ******************************/		
				...
				queryTK = 	" select a.TAIKHOAN_FK as TAIKHOANKTCO,"
					      ...
					      + "        as TAIKHOANKTNO, b.NCC_FK_FK KHACHHANG_FK "
						  + " from   ERP_NHANHANG b INNER JOIN ERP_KHACHHANG a KH ON b.NCC_FK_FK = a.PK_SEQ " +
							" where  b.pk_seq = '" + nhId + "' ";
