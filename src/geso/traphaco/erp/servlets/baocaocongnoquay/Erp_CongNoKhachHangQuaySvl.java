package geso.traphaco.erp.servlets.baocaocongnoquay;
...
import geso.traphaco.erp.beans.baocaocongnoquay.imp.Erp_CongNoKhachHangQuayList;
...
public class Erp_CongNoKhachHangQuaySvl extends HttpServlet 
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	   ...
	   public Erp_CongNoKhachHangQuaySvl() {
			super();
		}   
	   ...
	   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	   {
		    ...
		    Erp_CongNoKhachHangQuayList obj = new Erp_CongNoKhachHangQuayList();
			...
			response.sendRedirect("/TraphacoHYERP/pages/Erp/Erp_CongNoKhachHangQuay.jsp");
		}  	
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
		{
			...
			HttpSession session = request.getSession();
			IErp_CongNoKhachHangQuayList obj = new Erp_CongNoKhachHangQuayList();
		    ...
		    String quayId = request.getParameter("quayId");
		    if (quayId == null)
		    	quayId = "";
		    obj.getDieuKienLoc().setQuay_fk(quayId);
