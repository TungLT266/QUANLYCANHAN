...
import geso.traphaco.erp.beans.lapngansach.imp.LapngansachTSList;
...
public class LapngansachTSSvl extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public LapngansachTSSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ILapngansachTSList nsList = (ILapngansachTSList) new LapngansachTSList();
		...
		URL="../TraphacoHYERP/pages/Erp/Erp_LapngansachTS.jsp";			
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("new")){
			...
			session.setAttribute("nsList", nsList);
			URL="../TraphacoHYERP/pages/Erp/Erp_LapngansachTSNew.jsp";			
