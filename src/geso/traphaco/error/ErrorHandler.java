		...
		// Analyze the servlet exception       
	      ...
	      else if (statusCode != null)
	      {
	    	 ...
	    	 /* String table = "<table width='99%' border='0' cellspacing='0' cellpadding='0' style='padding-left:2px;' >" +
	    	  					...
	    	  					"</tr>" +
	    	  					"<tr>" +
	    	  						"<td style='vertical-align:top;' width='410px'><img src='/TraphacoHYERP/pages/images/Loi1.png' /><br />" +
	    	  						 									"<img src='/TraphacoHYERP/pages/images/Loi2.png' /></td>" +
	    	  						 "<td style='vertical-align:top;' ><img src='/TraphacoHYERP/pages/images/404.jpg' /></td>" +
	    	  					"</tr>";*/
	    	 ...
	    	 /* out.println("<b style='font-size: 2.0em'>ERROR...</b><hr>" +
	    	  				...
	    	  				"Cảm ơn bạn.<br></p>");*/
	    	  out.println(table);
	    	  //response.sendRedirect("/TraphacoHYERP/error_page.jsp");
	      }
	      else
	      {
