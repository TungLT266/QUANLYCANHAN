...
public class SendMail
{
	  ...
	  public void postMail_Phatsinhkettoan_FIT( String[] recipients,String cc, String subject, String message ) throws MessagingException
	  {
		  boolean debug = false;
	      SMTP_HOST_NAME = "mail.geso.us";
	      SMTP_AUTH_USER = "hr@geso.us";
	      SMTP_AUTH_PWD = "Nhansu@123";
	      emailFromAddress = "hr@geso.us";
	  ...
	  {
		  SMTP_HOST_NAME = "mail.phanam.com.vn";
		  SMTP_AUTH_USER = "dms@phanam.com.vn";
		  SMTP_AUTH_PWD = "phanam@123";
		  emailFromAddress = "dms@phanam.com.vn";
		  ...
		  try 
		  {
			  ...
			  //LÚC NÀO CŨNG BCC WEBMASTER
			  message.setRecipients(Message.RecipientType.BCC, InternetAddress.parse("webmaster@merapgroup.com.vn"));
	  ...
	  public String postMailWARNING( String To, String Cc, String subject, String mesg ) throws MessagingException
	  {
		  SMTP_HOST_NAME = "mail.geso.us";
	      SMTP_AUTH_USER = "luonghv@geso.us";
	      SMTP_AUTH_PWD = "cuibap@123";
		  ...
		  try 
		  {
			  ...
			  System.out.println("Gui MAIL WARNING thanh cong toi: " + To);
			  return "";
	...
	public static void main(String[] arg)
	{
		...
		try 
		{
			String msg = sendMAIL.postMailHTML("hienttd@geso.us", "luonghv@geso.us", "TEST", "ABC 123");
