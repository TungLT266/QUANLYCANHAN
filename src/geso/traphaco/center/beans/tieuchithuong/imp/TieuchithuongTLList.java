...
public class TieuchithuongTLList implements ITieuchithuongTLList 
{
	String userId;
	...
	public void init(String query)
	{
		...
		else
		{
			sql = "select a.scheme, a.pk_seq, a.thang, a.nam, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
					"from TIEUCHITHUONGTL a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq inner join NHANVIEN c on a.NGUOISUA = c.pk_seq"
					+ " where a.phanloai = '" + this.phanloai + "' " +
