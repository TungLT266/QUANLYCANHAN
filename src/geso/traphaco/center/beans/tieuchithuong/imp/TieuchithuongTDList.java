...
public class TieuchithuongTDList implements ITieuchithuongTDList 
{
	String userId;
	...
	public void init(String query)
	{
		...
		{
			sql = "select a.scheme, a.pk_seq, a.tungay, a.denngay, a.ghichu, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
					"from CHINHSACHBANHANG a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq inner join NHANVIEN c on a.NGUOISUA = c.pk_seq " +
	...
	public void initReport(String query) 
	{
		...
		sql = "select pk_seq as schemeId, scheme as schemeTen from TieuchithuongTD where trangthai = '1' ";
