...
public class TieuchithuongSKUList implements ITieuchithuongSKUList 
{
	String userId;
	...
	public void init(String query)
	{
		...
		else
		{
			sql = "select a.scheme, a.pk_seq, a.thang, a.nam, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
					"from TIEUCHITHUONGSKU a inner join NHANVIEN b on a.NGUOITAO = b.pk_seq inner join NHANVIEN c on a.NGUOISUA = c.pk_seq " +
