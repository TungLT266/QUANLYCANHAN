...
public class ThongtinsanphamList extends Phan_Trang implements IThongtinsanphamList
{
	...
	public void init()
	{	
		this.loaisplist = db.get(" select PK_SEQ, MA + ' - ' + TEN TENLOAI from ERP_LOAISANPHAM ");
        ...
        query ="select ROW_NUMBER() OVER(ORDER BY a.ma DESC) AS 'stt', a.pk_seq, a.ma, a.ten, a.trongluong, a.thetich, b.donvikinhdoanh as dvkd,b.pk_seq as dvkdId, c.ten as chungloai, e.pk_seq as nhId, d.donvi, e.ten as nhanhang, d.pk_seq as clId, a.trangthai, isnull(f.giabanlechuan,'0') as giablc, a.ma_fast, isnull(k.stt,9) sapxep ";
		...
		this.splist = super.createSplittingDataNew(this.db, soItems, super.getSplittings(), " sapxep asc, trangthai desc, pk_seq desc  ", query);
