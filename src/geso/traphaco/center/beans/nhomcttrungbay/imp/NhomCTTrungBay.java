package geso.traphaco.center.beans.nhomcttrungbay.imp;

import geso.traphaco.center.beans.nhomcttrungbay.INhomCTTrungBay;
...
public class NhomCTTrungBay implements  INhomCTTrungBay
{
	public NhomCTTrungBay(String id)
	{
		super();
		this.id = id;
		this.nppId = "";
	...
	public NhomCTTrungBay(String id, String nppId, String userId, String vungId, String kvId, String ma, String ten, String kenhId, String loainhom, String nhomId, String msg, String tinhId, String quanhuyenId, ResultSet nppRs, ResultSet vungRs,
	...
	public NhomCTTrungBay(String id, String nppId, String userId, String vungId, String kvId, String ma, String ten, ResultSet nppRs, ResultSet vungRs, ResultSet kvRs)
	{
	...
	public NhomCTTrungBay(String id, String nppId, String userId, String vungId, String kvId, String ma, String ten)
	{
		this.id = id;
		this.nppId = nppId;
		this.userId = userId;
	...
	public boolean save()
	{
		String query="insert into NHOMCTTRUNGBAY(Ma,Ten,NguoiTao,NgayTao,NguoiSua,NgaySua)" +
				"values (N'"+this.ma+"',N'"+this.ten+"','"+this.userId+"','"+getDateTime()+"','"+this.userId+"','"+getDateTime()+"')  ";
		try
		{
			ResultSet rsCheck = db.get("select COUNT(PK_SEQ) as sodong from NHOMCTTRUNGBAY where  upper(ma) = upper('" + this.ma + "')");
			boolean chk = true;
			if(rsCheck != null)
			{
				if(rsCheck.next())
	...
	public boolean edit()
	{
		...
		String query="update NHOMCTTRUNGBAY  set Ma=N'"+this.ma+"', Ten=N'"+this.ten+"',NguoiSua='"+this.userId+"',NgaySua='"+getDateTime()+"' where pk_Seq='"+this.id+"'" ;
		try
		{
			ResultSet rsCheck = db.get("select COUNT(PK_SEQ) as sodong from NHOMCTTRUNGBAY where pk_seq != '" + this.id + "' and upper(ma) = upper('" + this.ma + "')");
			boolean chk = true;
			if(rsCheck != null)
			{
				if(rsCheck.next())
	...
	public void init()
	{
		String query="select ma,ten from NHOMCTTRUNGBAY where pk_seq='"+this.id+"'";
