...
public class Khaosat implements IKhaosat
{
	...
	{	
		try 
		{
			...
			String query = "insert KHAOSAT(tieude, diengiai, bophan, socauhoi, trangthai, ngaytao, nguoitao, ngaysua, nguoisua) " +
							"values(N'" + this.tieude + "', N'" + this.diengiai + "', N'" + this.bophan + "', '" + this.socauhoi + "', '0', '" + this.getDateTime() + "', '" + this.userId + "', '" + this.getDateTime() + "', '" + this.userId + "')";
	...
	public boolean updateKhaosat() 
	{
		try 
		{
			...
			String query = "Update KHAOSAT set tieude = N'" + this.tieude + "', diengiai = N'" + this.diengiai + "', bophan = N'" + this.bophan + "', " +
