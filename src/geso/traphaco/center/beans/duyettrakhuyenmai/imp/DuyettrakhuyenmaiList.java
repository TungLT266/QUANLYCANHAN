...
import geso.traphaco.center.beans.duyettrakhuyenmai.IDuyettrakhuyenmaiList;
import geso.traphaco.center.db.sql.dbutils;

public class DuyettrakhuyenmaiList implements IDuyettrakhuyenmaiList 
{
	String userId;
	...
	public void init(String query)
	{
		...
		{
			sql = "select d.scheme, a.pk_seq, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua  " +
