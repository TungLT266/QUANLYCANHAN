package geso.traphaco.center.beans.dieukienkhuyenmai.imp;
...
public class Dieukienkhuyenmai implements IDieukienkhuyenmai
{
		...
		if(!this.type.equals("3"))
		{
			try 
			{
				...
				String query = "Insert into Dieukienkhuyenmai(diengiai, tongluong, tongtien, loai, trongso, isThung, ngaytao, nguoitao, ngaysua, nguoisua) " +
								"values(N'" + this.diengiai + "', " + this.tongluong + ", " + this.tongtien + ", '" + this.type + "', '" + this.trongso + "', '" + this.isThung + "', '" + this.ngaytao + "', '" + this.nguoitao + "', '" + this.ngaytao + "', '" + this.nguoitao + "')";
				...
				for(int i = 0; i < this.spList.size(); i++)
				{
					...
					else
					{
						...
						if(soluong.trim().length() <= 0)
						{
							...
							this.msg = "Vui lòng nhập số lượng của sản phẩm: " + sp.getMasanpham();
							return false;
					...
					query = "Insert into dieukienkm_sanpham(dieukienkhuyenmai_fk, sanpham_fk, soluong, batbuoc) " +
							...
							"from ERP_SANPHAM where ma = '" + sp.getMasanpham() + "'";
			...
			catch(Exception e) 
			{
				...
				this.msg = "3.Exception: " + e.getMessage();
				return false;
			}
		}
		else
		...
		{		
			try 
			{
				...
				String query = "Update Dieukienkhuyenmai set diengiai = N'" + this.diengiai + "', tongluong = " + this.tongluong + ", " +
								"tongtien = " + this.tongtien + ", loai = '" + this.type + "', trongso = '" + this.trongso + "', IsThung = '" + this.isThung + "', " +
				...
				{
					db.update("rollback");
					this.msg = "Khong the cap nhat 'dieukienkm_sanpham', " + query;
					return false; 
				}
	...
	private void createSpList()
	{
		String query =  "select b.pk_seq, b.MA, b.TEN from NHOMSANPHAM_SANPHAM a " +
						"inner join ERP_SANPHAM b on a.SP_FK = b.PK_SEQ " +
	...
	{		
		String query = "select a.soluong, b.pk_seq, b.MA, b.TEN, isnull(a.batbuoc, 0) as batbuoc " +
						"from dieukienkm_sanpham a inner join ERP_SANPHAM b on a.SanPham_FK = b.PK_SEQ " +
