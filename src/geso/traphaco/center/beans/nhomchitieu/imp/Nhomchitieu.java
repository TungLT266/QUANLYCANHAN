package geso.traphaco.center.beans.nhomchitieu.imp;
import geso.traphaco.center.beans.nhomchitieu.INhomchitieu;
import geso.traphaco.center.beans.nhomchitieu.imp.Nhomchitieu;
...
public class Nhomchitieu implements INhomchitieu, Serializable
{
	...
	public boolean saveNewNkm()
	{
		...
		command = "insert into nhomsanpham(diengiai, nsp_parent_fk, loaithanhvien, ngaytao, ngaysua, nguoitao, nguoisua, trangthai, ten, type, loainhom,TuNgay,DenNgay,TinhThuong) " +
				"values(N'" + this.diengiai + "', '0', '2', '" + this.ngaytao + "', '" + this.ngaysua +"', " +
				"	'" + this.nguoitao + "', '" + this.nguoisua + "', '0', N'" + this.ten + "','0','3','"+this.TuNgay+"','"+this.DenNgay+"',"+this.tinhthuong+")";
