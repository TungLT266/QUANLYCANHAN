...
public class ErpNhapkhoList extends Phan_Trang implements IErpNhapkhoList
{
	...
	public void init(String search)
	{
		...
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngaynhap, a.lydo, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua   " +
					"from ERP_NHAPKHO a inner join ERP_KHOTT b on a.khonhap_fk = b.pk_seq  " +
					"inner join NHANVIEN nv on a.NGUOITAO = nv.PK_SEQ   " +
					"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.pk_seq > 0  AND A.KHONHAP_FK IN  "+util.quyen_khoTT(userId)+"  ";
		} 
