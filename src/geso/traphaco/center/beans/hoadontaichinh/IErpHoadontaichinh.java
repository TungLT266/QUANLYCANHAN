package geso.traphaco.center.beans.hoadontaichinh;
...
public interface IErpHoadontaichinh
{
	...
	public boolean chot(String lsxId, String userId );
	...
	public ResultSet getSoloTheoSpDisplay(String spIds, String donvi, String tongluong);
