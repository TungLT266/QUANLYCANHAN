package geso.traphaco.center.beans.nhomthuong.imp;
...
public class Nhomthuong implements INhomthuong, Serializable
{
	...
	public boolean saveNewNkm()
	{
		...
		command = "insert into nhomsanpham values(N'" + this.diengiai + "', '0', '2', '" + this.ngaytao + "', '" + this.ngaysua +"', " +
				"	'" + this.nguoitao + "', '" + this.nguoisua + "', '0', N'" + this.ten + "','" + this.type + "','0')";
	...
	//	command ="update nhomsanpham set ten ='"+ this.ten +"', diengiai = '"+ this.diengiai +"', trangthai ='" + this.trangthai + "' where pk_seq = '" + this.id + "'";
		command ="update nhomsanpham set ten =N'"+ this.ten +"', diengiai = N'"+ this.diengiai +"',ngaysua ='"+ this.ngaysua +"'" +
