...
public class ErpXuatkhoList extends Phan_Trang implements IErpXuatkhoList
{
	...
	public void init(String search)
	{
		...
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngayyeucau, c.ten as nppTEN, b.ten as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua,  " +
					...
					"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.pk_seq > 0 and a.trangthai >= '1' ";  //AND A.NPP_FK IN  "+util.quyen_npp(userId) +" AND A.KHO_FK IN "+util.quyen_khoTT(userId)+"   ";
		} 
