...
import geso.traphaco.center.beans.khuvuc.IKhuvucList;
...
public class KhuvucList implements IKhuvucList 
{
	...
	public void init(String search) 
	{
		...
		if (search.length() == 0)
		{
			query = "select a.pk_seq as id, a.ten as kvTen, a.trangthai as trangthai, b.pk_seq as vmId, b.ten as vmTen, c.ten as nguoitao, a.ngaytao as ngaytao, d.ten as nguoisua, a.ngaysua as ngaysua, a.diengiai ";
