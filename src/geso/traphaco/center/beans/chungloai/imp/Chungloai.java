package geso.traphaco.center.beans.chungloai.imp;
...
public class Chungloai implements IChungloai
{
	...
	public boolean UpdateChungloai(){
		...
		String query = "update chungloai set ten=N'" + this.chungloai + "',  ngaysua = '" + this.ngaysua + "',  nguoisua = '" + this.nguoisua + "', trangthai = '" + this.trangthai + "' where pk_seq = '" + this.id + "'" ;
