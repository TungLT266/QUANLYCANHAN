...
public class ErpDuyetddhList extends Phan_Trang implements IErpDuyetddhList
{
	...
	public void init(String search)
	{
		...
		{
			query = "select a.PK_SEQ, a.trangthai, a.ngaydonhang, c.ten as nppTEN, a.loaidonhang, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua, isnull(a.NOTE, '') as NOTE, isnull(SOTIENTHU, 0) as SOTIENTHU, a.hopdong_fk   " +
					"from ERP_Dondathang a inner join ERP_KHOTT b on a.kho_fk = b.pk_seq inner join NHAPHANPHOI c on a.NPP_FK = c.pk_seq  " +
					"inner join NHANVIEN nv on a.NGUOITAO = nv.PK_SEQ   " +
					"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.pk_seq > 0 and a.trangthai in ('1') ";//  AND A.NPP_FK IN  "+util.quyen_npp(userId) +"  ";
		} 
