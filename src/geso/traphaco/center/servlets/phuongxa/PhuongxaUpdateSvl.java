...
public class PhuongxaUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/PhuongXaUpdate.jsp";
		...
		kvBean.setNguoisua(nguoisua);
 		...
 		String action = request.getParameter("action");
	    	...
	    	if(action.equals("save"))
	    	{
	    		...
	    		String nextJSP;
	    		if (id == null){			
	    			nextJSP = "/TraphacoHYERP/pages/Center/PhuongXaNew.jsp";
	    		}else{
	    			nextJSP = "/TraphacoHYERP/pages/Center/PhuongXaUpdate.jsp";   						
	    		}
	    		response.sendRedirect(nextJSP);
