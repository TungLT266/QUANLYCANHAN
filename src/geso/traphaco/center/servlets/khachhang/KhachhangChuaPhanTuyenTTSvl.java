...
import geso.traphaco.center.beans.khachhang.*;
import geso.traphaco.center.beans.khachhang.imp.*;
...
public class KhachhangChuaPhanTuyenTTSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/KhachHangChuaPhanTuyen.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    {	    
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Center/KhachHangChuaPhanTuyen.jsp");	    		    	
	    } else
