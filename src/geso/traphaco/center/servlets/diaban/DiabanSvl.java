package geso.traphaco.center.servlets.diaban;

import geso.traphaco.center.beans.diaban.*;
import geso.traphaco.center.beans.diaban.imp.*;
...
public class DiabanSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/Diaban.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if (action.equals("new")){
    		...
    		String nextJSP = "/TraphacoHYERP/pages/Center/DiabanUpdate.jsp";
    		response.sendRedirect(nextJSP);
	    ...
	    if (action.equals("search")){
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Center/Diaban.jsp");	    	
