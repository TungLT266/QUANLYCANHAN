 ...
 public class BanggiamuanppUpdateSvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/BangGiaMuaNppUpdate.jsp";
        String copy = request.getParameter("copy");
        if(copy != null)
		{			
        	bgBean.setTungay("");
        	bgBean.setDenngay("");
			nextJSP = "/TraphacoHYERP/pages/Center/BangGiaMuaNppNew.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action.equals("save") & !error)
		{
			...
			if (id.length()==0){			
				...
				nextJSP = "/TraphacoHYERP/pages/Center/BangGiaMuaNppUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
