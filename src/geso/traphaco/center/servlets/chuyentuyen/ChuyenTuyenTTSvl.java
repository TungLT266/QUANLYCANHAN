...
package geso.traphaco.center.servlets.chuyentuyen;

import geso.traphaco.center.db.sql.dbutils;
import geso.traphaco.center.util.Utility;
import geso.traphaco.center.beans.chuyentuyen.IChuyenTuyen;
import geso.traphaco.center.beans.chuyentuyen.imp.ChuyenTuyen;
...
public class ChuyenTuyenTTSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(type.equals("sohoadon"))
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/SoHoaDon.jsp";
		...
		{/*
			...
			else
			{
				...
				obj.createRs();
				session.setAttribute("ctuyenBean", obj);
				String nextJSP = "/TraphacoDMS/pages/Distributor/ChuyenTuyen.jsp";
				response.sendRedirect(nextJSP);
			}
		*/}
	}
		...
		else
		{
			...
			if(action.equals("saveSOHOADON"))
			{
				...
				*/
				...
				String nextJSP;
				nextJSP = "/TraphacoHYERP/pages/Center/SoHoaDon.jsp";
				response.sendRedirect(nextJSP);
			}
			//else
			{/*
				...
				if (action.equals("save") && !error)
				{
					...
					session.setAttribute("ctuyenBean", ctuyenBean);
					String nextJSP;
					nextJSP = "/TraphacoDMS/pages/Distributor/ChuyenTuyen.jsp";
					response.sendRedirect(nextJSP);
				} 
				else
				{
