package geso.traphaco.center.servlets.upromoAllcation;
...
public class UpromoAllcation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public UpromoAllcation() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     {    //khoi tao de viet pivottable
 		//buoc 1
 	     ...
 	     //Buoc2 tao khung
 	    //ham tao khu du lieu
 	     CreateStaticHeader(workbook, "12-11-2011", "30-10-2011",this.userTen);
 	     //Buoc3 
 	     // day du lieu vao
...
sql = sql + " from nhaphanphoi a inner join phanbokhuyenmai b on b.npp_fk = a.pk_seq inner join ctkhuyenmai c on b.ctkm_fk = c.pk_seq ";
	...
	sql = sql + " inner join nhapp_kbh f on f.npp_fk = a.pk_seq inner join kenhbanhang g on f.kbh_fk = g.pk_seq ";
