package geso.traphaco.center.servlets.hoadon;
...
import geso.traphaco.center.beans.hoadon.IHoaDon_CTKM;
import geso.traphaco.center.beans.hoadon.IHoaDon_SanPham;
import geso.traphaco.center.beans.hoadon.imp.HoaDon;
import geso.traphaco.center.beans.hoadon.imp.HoaDon_CTKM;
import geso.traphaco.center.beans.hoadon.imp.HoaDon_SanPham;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String action = request.getParameter("action");		
 		...
 		if(tenform.equals("newform")){
 			nextJSP = "/TraphacoHYERP/pages/Center/HoaDonKhuyenMaiNew.jsp";
 		}else{
 		nextJSP = "/TraphacoHYERP/pages/Center/HoaDonKhuyenMaiUpdate.jsp";
 		}
