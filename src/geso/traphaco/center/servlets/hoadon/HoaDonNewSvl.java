	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String action = request.getParameter("action");		
 		...
 		if(tenform.equals("newform")){
 			nextJSP = "/TraphacoHYERP/pages/Center/HoaDonNew.jsp";
 		}else{
 			nextJSP = "/TraphacoHYERP/pages/Center/HoaDonUpdate.jsp";
 		}
    ...
    //	System.out.println(sql_infonpp);
		...
		if(action.equals("save"))
		{
			...
			if(dhBean.EditHoaDon()){
				...
				session.setAttribute("obj", dhBean);
				 nextJSP = "/TraphacoHYERP/pages/Center/DonMuaHangTTXuLy.jsp";
					response.sendRedirect(nextJSP);
			}
		}
