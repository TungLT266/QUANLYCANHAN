package geso.traphaco.center.servlets.phieuchuyenkhott;

import geso.traphaco.center.beans.phieuchuyenkhott.IPhieuChuyenKhoTT;
import geso.traphaco.center.beans.phieuchuyenkhott.IPhieuChuyenKhoTT_SanPham;
import geso.traphaco.center.beans.phieuchuyenkhott.imp.PhieuChuyenKhoTT;
import geso.traphaco.center.beans.phieuchuyenkhott.imp.PhieuChuyenKhoTT_SanPham;
import geso.traphaco.center.beans.phieunhapkhott.imp.PhieuNhapKhoTT;
import geso.traphaco.center.beans.phieunhapkhott.imp.PhieuNhapKhoTT_SanPham;
		 ...
		 request.setCharacterEncoding("UTF-8");
		    ...
		    if(action.equals("update")){
		    	...
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTTUpdate.jsp";
		    	...
		    	obj = new PhieuChuyenKhoTT(id);	
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTTDisplay.jsp";
		    	
		    }else if(action.equals("chot")){
		    	obj = new PhieuChuyenKhoTT(id);	
		    	session.setAttribute("obj", obj);		   
		    	 nextJSP = "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTTChot.jsp";	
		    }
		...
		String[] soluongchuyen = request.getParameterValues("soluongchuyen");
		 ...
		 //lay thong tin ve ngaynhapkho
			...
			if(tenform.equals("newform")){
				nextJSP= "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTTNew.jsp";
			}else{
				nextJSP= "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTTUpdate.jsp";
			}
			...
			ctbean.setListSanPham(spList);
			  ...
			  //sau khi luu xong thi thuc hien quay lai form PhieuNhapKhoTT.jsp
				...
				nextJSP= "/TraphacoHYERP/pages/Center/PhieuChuyenKhoTT.jsp";
			  }
