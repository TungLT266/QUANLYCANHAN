package geso.traphaco.center.servlets.upload;
...
public class UploadTonKhoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/UploadTonKhoUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		if(flag && action.equals("save"))
 		{
    		...
    		{ //Create New Upload
    			...
    			else 
    			{
    				...
    				String nextJSP = "/TraphacoHYERP/pages/Center/UploadTonKho.jsp";
    				response.sendRedirect(nextJSP);
    			}		
    		} 
    		else 
		...
		else
		{
			...
			if(spnppList.trim().length() == 0) {
 			...
 			session.setAttribute("userId", userId);
			session.setAttribute("uploadBean", bean);
			String nextJSP = id == null ?  "/TraphacoHYERP/pages/Center/UploadTonKhoNew.jsp" : "/TraphacoHYERP/pages/Center/UploadTonKhoUpdate.jsp";   						
			response.sendRedirect(nextJSP);
		}	
	}
