...
import geso.traphaco.distributor.beans.gioihancongno.IGioihancongno;
...
public class GioiHanCongNoTTSvl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (action.equals("new"))
	    {
    		...
    		String nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTTNew.jsp";
    		response.sendRedirect(nextJSP);
	    ...
	    if (action.equals("search"))
	    {
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Center/GioiHanCongNoTT.jsp");	    		    	
	    }
	}
