package geso.traphaco.center.servlets.gioihancongnott;

import geso.traphaco.center.beans.gioihancongnott.IGioiHanCongNoTT;
import geso.traphaco.center.beans.gioihancongnott.IGioiHangCongNoTT_Npp;
import geso.traphaco.center.beans.gioihancongnott.imp.GioiHanCongNoTT;
import geso.traphaco.center.beans.gioihancongnott.imp.GioiHangCongNo_Npp;
import geso.traphaco.distributor.beans.gioihancongno.IGioihancongnoList;
import geso.traphaco.distributor.beans.gioihancongno.imp.Gioihancongno;
import geso.traphaco.distributor.beans.gioihancongno.imp.GioihancongnoList;
...
public class GioiHanCongNoTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  //truyen qua rskhuvuc
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTTUpdate.jsp";                                    
		response.sendRedirect(nextJSP);
	    	...
	    	obj.DeleteGioiHanCongNoTT();
	 		...
	 		String nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTT.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(formname.equals("newform")){
			nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTTNew.jsp";
		}else{
			nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTTUpdate.jsp";
		}
		...
		{		if(error ==false){
				if ((ghcnBean.SaveGioiHanCongNoTT())){	
					...
					session.setAttribute("obj", ghcnBean);
					 nextJSP = "/TraphacoHYERP/pages/Center/GioiHanCongNoTT.jsp";
				}
				}
