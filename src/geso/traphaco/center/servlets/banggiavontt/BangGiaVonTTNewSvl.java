package geso.traphaco.center.servlets.banggiavontt;

import geso.traphaco.center.beans.banggiavontt.IBangGiaVonTT;
import geso.traphaco.center.beans.banggiavontt.IBangGiaVonTT_SanPham;
import geso.traphaco.center.beans.banggiavontt.imp.BangGiaVonTT;
import geso.traphaco.center.beans.banggiavontt.imp.BangGiaVonTT_SanPham;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql_dvkd="select pk_seq,donvikinhdoanh as ten from donvikinhdoanh where trangthai!='0'";
     	...
     	if(action.equals("update")){
        	...
        	String nextJSP = "/TraphacoHYERP/pages/Center/BangGiaVonTTUpdate.jsp";
        	...
        	String nextJSP = "/TraphacoHYERP/pages/Center/BangGiaVonTTDisplay.jsp";
        	response.sendRedirect(nextJSP);
     	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {//truong hop co file dinh kem
		  ...
		  if(tenform.equals("newform")){
			  nextJSP= "/TraphacoHYERP/pages/Center/BangGiaVonTTNew.jsp";
		  }else{
			  nextJSP= "/TraphacoHYERP/pages/Center/BangGiaVonTTUpdate.jsp";
		  }		  
      	...
      	ctbean.setListBangGia_SanPham(spList);//add cac chi tiet san pham  vao don hang
			  ...
			  if(ctbean.SaveBangGiaVonTT()){
				  ...
				  nextJSP= "/TraphacoHYERP/pages/Center/BangGiaVonTT.jsp";
			  }
