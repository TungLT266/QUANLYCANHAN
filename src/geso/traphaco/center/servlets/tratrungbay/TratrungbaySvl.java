...
public class TratrungbaySvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/TraTrungBay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    String search = getSearchQuery(request,userId);
	...
	private String getSearchQuery(HttpServletRequest request,String userId)
	{	
	...
	private void Delete(String tratbId) 
	{
    	...
    	String str1 = "delete from tratrungbay_sanpham where trakhuyenmai_fk='" + tratbId + "'";
		if(!db.update(str1))
		{
			db.update("rollback");
		}
