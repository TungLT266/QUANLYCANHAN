package geso.traphaco.center.servlets.bandott;

import geso.traphaco.center.util.Utility;
import geso.traphaco.center.beans.bandott.IBandott;
import geso.traphaco.center.beans.bandott.imp.Bandott;
...
public class BandoTTSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(view.equals("khachhangTB"))
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/KhachHangTrungBay.jsp";
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/KhachHangToaDo.jsp";
			response.sendRedirect(nextJSP);
		}
		else if(view.equals("lotrinhOnline"))
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/BanDoLoTrinhOnline.jsp";
			response.sendRedirect(nextJSP);
		}
		else if(view.equals("lotrinhOnlineNPP"))
		{
			...
			session.setAttribute("obj", obj);
			System.out.println("Ban do TT");
			String nextJSP = "/TraphacoHYERP/pages/Distributor/BanDoLoTrinhOnline.jsp";
			response.sendRedirect(nextJSP);
		}
		else
		{
			...
			session.setAttribute("obj", obj);
			System.out.println("Ban do TT");
			String nextJSP = "/TraphacoHYERP/pages/Center/BanDoTT.jsp";
			response.sendRedirect(nextJSP);
		}
