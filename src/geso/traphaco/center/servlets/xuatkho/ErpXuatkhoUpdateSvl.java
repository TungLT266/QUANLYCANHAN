...
import geso.traphaco.center.beans.xuatkho.IErpXuatkho;
import geso.traphaco.center.beans.xuatkho.IErpXuatkhoList;
import geso.traphaco.center.beans.xuatkho.imp.ErpXuatkho;
import geso.traphaco.center.beans.xuatkho.imp.ErpXuatkhoList;
...
public class ErpXuatkhoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Center/ErpXuatKhoUpdate.jsp";	
    		}
    		else
    		{
    			nextJSP = "/TraphacoHYERP/pages/Center/ErpXuatKhoDisplay.jsp";
    		}
			...
			{	
				if(id == null)
				{
					if(!lsxBean.create())
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Center/ErpXuatKhoNew.jsp";
					...
					else
					{
			    		...
			    		String nextJSP = "/TraphacoHYERP/pages/Center/ErpXuatKho.jsp";
			    		response.sendRedirect(nextJSP);
					}
				}
				else
				{
					if(!lsxBean.update())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Center/ErpXuatKhoUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
