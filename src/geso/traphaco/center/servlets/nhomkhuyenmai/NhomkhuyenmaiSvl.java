	    ...
	    if (userId.length()==0)
		  ...
		  //  List<INhomkhuyenmai> nkmlist = new ArrayList<INhomkhuyenmai>(); 
		   ...
		   // getNkmBeanList(nkmlist);
			...
			System.out.println("Nhom san pham  khuyen mai "+sql);		
			System.out.println("Nhom san pham  khuyen mai "+sql);
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
          ...
          System.out.println(query);
			...
			if (action.equals("new")){
		    	...
		    	String nextJSP = "/TraphacoHYERP/pages/Center/NhomKhuyenMaiNew.jsp";
		    	response.sendRedirect(nextJSP);
			    ...
			    response.sendRedirect("/TraphacoHYERP/pages/Center/NhomKhuyenMai.jsp");
			}
