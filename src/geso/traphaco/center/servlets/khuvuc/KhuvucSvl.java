...
import geso.traphaco.center.beans.vung.IVungmienList;
import geso.traphaco.center.beans.vung.imp.VungmienList;
...
public class KhuvucSvl extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if (action.equals("search")){
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Center/KhuVuc.jsp");	    	
