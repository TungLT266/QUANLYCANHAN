...
public class NhomthuongSvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		ResultSet Dsnkm = db.get("select a.pk_seq, a.ten, a.diengiai, a.trangthai, a.type, a.ngaytao, a.ngaysua, b.ten as nguoitao," + " c.ten as nguoisua from nhomsanpham a, nhanvien b, nhanvien c"
				+ " where a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and (a.type='4' or a.type = '6') ");
		obj.setDsnkm(Dsnkm);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String query = "select a.pk_seq, a.ten, a.type, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua from nhomsanpham a, nhanvien b, nhanvien c where a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and a.type = '4' ";
		...
		// query = query
		// +" and a.pk_seq in (select nsp_fk from NHOMSANPHAM_SANPHAM where sp_fk in "+
		...
		} else if (action.equals("search"))
		{
			...
			response.sendRedirect("/TraphacoHYERP/pages/Center/NhomThuong.jsp");
		...
		} else
		{
			...
			ResultSet Dsnkm = db
					.get("select a.pk_seq, a.type, a.ten, a.diengiai, a.trangthai, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua from nhomsanpham a, nhanvien b, nhanvien c where a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and a.type='1' and a.pk_seq in (select nsp_fk from NHOMSANPHAM_SANPHAM where sp_fk in "
							+ Ult.quyen_sanpham(userId) + ")");
			obj.setDsnkm(Dsnkm);
			session.setAttribute("obj", obj);
