package geso.traphaco.center.servlets.nhomthuong;

import geso.traphaco.center.beans.nhomthuong.INhomthuong;
import geso.traphaco.center.beans.nhomthuong.INhomthuongList;
import geso.traphaco.center.beans.nhomthuong.imp.Nhomthuong;
import geso.traphaco.center.beans.nhomthuong.imp.NhomthuongList;
...
public class NhomthuongUpdateSvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   ...
   private PrintWriter out;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = 	"select a.pk_seq, a.ten, a.diengiai, a.trangthai, a.type, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua " +
						"from nhomsanpham a, nhanvien b, nhanvien c where (a.type='4' or a.type='6') and a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and a.pk_seq='" + id + "'";
    	...
    	String nextJSP = "/TraphacoHYERP/pages/Center/NhomThuongUpdate.jsp";
    	
    	if(querystring.indexOf("display") >= 0)
    		nextJSP = "/TraphacoHYERP/pages/Center/NhomThuongDisplay.jsp";
    	else if(querystring.indexOf("copy") >= 0)
    	{
    		nextJSP = "/TraphacoHYERP/pages/Center/NhomThuongNew.jsp";
    	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("xuatexel"))
		{
    		...
    		session.setAttribute("userId", userId);
    		if(id.length()>0){
    			response.sendRedirect("/TraphacoHYERP/pages/Center/NhomThuongUpdate.jsp");
    		}else{
    			response.sendRedirect("/TraphacoHYERP/pages/Center/NhomThuongNew.jsp");
    		}
			...
			if(id.length()>0){
				if (!nkmBean.updateNkm()){
					...
					dbutils db = new dbutils();
				      ...
				      String sql="select a.pk_seq, a.ten, a.diengiai, a.trangthai, a.type, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua from nhomsanpham a, nhanvien b, nhanvien c where a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and (a.type='4' or a.type='6') and a.pk_seq in (select nsp_fk from NHOMSANPHAM_SANPHAM where sp_fk in "+ Ult.quyen_sanpham(userId) +")";
					...
					String nextJSP = "/TraphacoHYERP/pages/Center/NhomThuong.jsp";
					response.sendRedirect(nextJSP);
				...
				if (!nkmBean.saveNewNkm()){			
					session.setAttribute("nkmBean", nkmBean);
		    		session.setAttribute("userId", userId);
					String nextJSP = "/TraphacoHYERP/pages/Center/NhomThuongNew.jsp";
		    		response.sendRedirect(nextJSP);
				}
				else{
					INhomthuongList obj = new NhomthuongList();
					dbutils db = new dbutils();
				    ResultSet Dsnkm = db.get("select a.pk_seq, a.ten, a.diengiai, a.trangthai, a.type, a.ngaytao, a.ngaysua, b.ten as nguoitao, c.ten as nguoisua from nhomsanpham a, nhanvien b, nhanvien c where a.nguoitao = b.PK_SEQ and a.nguoisua = c.PK_SEQ and (a.type='4' or a.type='6') and a.pk_seq in (select nsp_fk from NHOMSANPHAM_SANPHAM where sp_fk in "+ Ult.quyen_sanpham(userId) +")");
				    obj.setDsnkm(Dsnkm);
				    session.setAttribute("obj", obj);
				    session.setAttribute("userId", userId);
