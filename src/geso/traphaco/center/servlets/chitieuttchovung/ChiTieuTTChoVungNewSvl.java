package geso.traphaco.center.servlets.chitieuttchovung;
...
import geso.traphaco.center.beans.khuvuc.imp.KhuvucList;
...
public class ChiTieuTTChoVungNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuTTChoVungUpdate.jsp";//default
			...
			*/
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuTTChoVungDisplay.jsp";//default
			response.sendRedirect(nextJSP);
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] sosku=request.getParameterValues("sosku");
		  ...
		  if(tenform.equals("update")){
			  nextJSP= "/TraphacoHYERP/pages/Center/ChiTieuTTChoVungUpdate.jsp";
		  }else{
			  nextJSP= "/TraphacoHYERP/pages/Center/ChiTieuTTChoVungNew.jsp";
		  }
		  ...
		  if(action.equals("new")){ // mode them moi
			  if(loaichitieu.equals("0")){
				  if(ctbean.SaveChiTieu()){//truong hop nay them duoc,quay tro  lai trang main
				    ...
				    nextJSP= "/TraphacoHYERP/pages/Center/ChiTieuTTChoVung.jsp"; 	 
			 }
			  }else{
