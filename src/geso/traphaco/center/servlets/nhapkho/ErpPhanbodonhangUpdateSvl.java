...
import geso.traphaco.center.beans.nhapkho.IErpPhanbodonhangList;
import geso.traphaco.center.beans.nhapkho.imp.ErpPhanbodonhang;
import geso.traphaco.center.beans.nhapkho.imp.ErpPhanbodonhangList;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			{	
				if(id == null)
				{
					...
					else
					{
			    		...
			    		response.sendRedirect("/TraphacoHYERP/pages/Center/ErpPhanBoDonHang.jsp");
					}
				}
				else
				{
			...
			else
			{
				...
				nextJSP = "/TraphacoHYERP/pages/Center/ErpPhanBoDonHangNew.jsp";
				if(id != null)
					nextJSP = "/TraphacoHYERP/pages/Center/ErpPhanBoDonHangUpdate.jsp";
