package geso.traphaco.center.servlets.nhomsptrungbay;

import geso.traphaco.center.beans.nhomsptrungbay.*;
import geso.traphaco.center.beans.nhomsptrungbay.imp.*;
...
public class NhomsptrungbayUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/NhomSpTrungBayUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		if(action.equals("save"))
 		{
    		if (id == null )
    		{
    			if (!nsptbBean.CreateNsptb(masp, soluong)){
    				...
    				String nextJSP = "/TraphacoHYERP/pages/Center/NhomSpTrungBayNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else{
    				...
    				response.sendRedirect("/TraphacoHYERP/pages/Center/NhomSpTrungBay.jsp");	    	
    			}		
    		}else{
		...
		else
		{
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/TraphacoHYERP/pages/Center/NhomSpTrungBayNew.jsp";
			}
			else{
				nextJSP = "/TraphacoHYERP/pages/Center/NhomSpTrungBayUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}	
	}
