...
import geso.traphaco.center.beans.hoadontaichinh.imp.Soathoadon;
...
public class SoathoadonTTSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{
			//obj.init();
			nextJSP = "/TraphacoHYERP/pages/Center/SoatHoaDon.jsp";
		}
		else
		{
			//obj.initETC();
			nextJSP = "/TraphacoHYERP/pages/Center/DoiSoHoaDon.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    if(loaihoadon == null)
	    	loaihoadon = "0";
	    obj.setLoaidonhang(loaihoadon);
	    String loaihd = request.getParameter("loaihd");
	    if(loaihd == null)
	    	loaihd = "";
	    ...
	    if (action.equals("excel"))
	    {
    		...
    		if(loaihoadon.equals("0"))
				...
				nextJSP = "/TraphacoHYERP/pages/Distributor/SoatHoaDonETC.jsp"; 	
    		response.sendRedirect(nextJSP); 
	    }
	    else
	    {
