package geso.traphaco.center.servlets.hoadongtgt;
...
import geso.traphaco.center.beans.hoadongtgt.IHoaDonGTGT;
import geso.traphaco.center.beans.hoadongtgt.IHoaDonGTGT_SP;
import geso.traphaco.center.beans.hoadongtgt.imp.HoaDonGTGT;
...
import geso.traphaco.center.beans.phieuxuatkhott.IPhieuXuatKhoTT_SP;
import geso.traphaco.center.beans.phieuxuatkhott.imp.PhieuXuatKhoTT;
import geso.traphaco.center.util.Utility;
import geso.traphaco.distributor.beans.khachhang.imp.Khachhang;
...
public class HoaDonGTGTpdfSvl extends HttpServlet {
	...
	private void CreatePxk(Document document, ServletOutputStream outstream, List<IHoaDonGTGT_SP> spList) throws IOException
	{
		...
		//lay doi tuong khach hang
			...
			Image hinhanh=Image.getInstance("C:/Tomcat 5.5/webapps/TraphacoHYERP/pages/images/logo.gif");	
			//Image hinhanh =Image.getInstance("D:/DMS/TraphacoHYERP/WebContent/pages/images/logo.bmp");
