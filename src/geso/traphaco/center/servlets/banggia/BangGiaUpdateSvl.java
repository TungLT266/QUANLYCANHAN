...
import geso.traphaco.center.beans.banggia.imp.BangGia_Sp;
...
public class BangGiaUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/BangGiaUpdate.jsp";
		if (querystring.indexOf("display") >= 0)
		{
			nextJSP = "/TraphacoHYERP/pages/Center/BangGiaDisplay.jsp";
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (action.equals("save"))
		{
			if (id == null)
			{
				if (!(csxBean.createBanggia()))
				{
					...
					String nextJSP = "/TraphacoHYERP/pages/Center/BangGiaNew.jsp";
					response.sendRedirect(nextJSP);
				} else
				{
		...
		} else
		{
			...
			if (id != null)
			{
				nextJSP = "/TraphacoHYERP/pages/Center/BangGiaUpdate.jsp";
			}
			response.sendRedirect(nextJSP);
		}
	}
