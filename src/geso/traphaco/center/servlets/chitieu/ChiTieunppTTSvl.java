...
public class ChiTieunppTTSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieunpp.jsp";//default
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(quy!=null)
	    chitieu.setQuy(Integer.parseInt(quy));
	    ...
	    {String  sql_getdata="";
		  ...
		  sql_getdata="SELECT   C.PK_SEQ,c.trangthai,kenh_fk, C.Quy,C.Thang, C.NAM,  C.CHITIEU,C.DIENGIAI, C.NGAYKETTHUC,C.DVKD_FK,D.donvikinhdoanh,C.SONGAYLAMVIEC, C.NGAYTAO, C.NGAYSUA,NT.TEN AS NGUOITAO, "+ 
	    ...
	    else if(action.equals("new"))
	    {
	    	...
	    	String	nextJSP= "/TraphacoHYERP/pages/Center/ChiTieunppNew.jsp";
	    	response.sendRedirect(nextJSP);
