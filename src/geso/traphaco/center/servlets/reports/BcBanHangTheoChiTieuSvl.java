...
import geso.traphaco.center.beans.report.IBcBanHangTheoChiTieuList;
import geso.traphaco.center.beans.report.imp.BcBanHangTheoChiTieuList;
...
public class BcBanHangTheoChiTieuSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		nextJSP = "/TraphacoHYERP/pages/Center/BcBanHangTheoChiTieu.jsp";
    ...
    if (action.equals("excel")  )
    {
    	...
    	String 	nextJSP = "/TraphacoHYERP/pages/Center/BcBanHangTheoChiTieu.jsp";
    	response.sendRedirect(nextJSP);
    }
    else
    {
