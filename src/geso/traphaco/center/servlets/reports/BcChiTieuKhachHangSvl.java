...
public class BcChiTieuKhachHangSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(!view.equals("TT"))
		{
			nextJSP = "/TraphacoHYERP/pages/Distributor/BcChiTieuKhachHang.jsp";
			response.sendRedirect(nextJSP);
		}
		else
		{
			 nextJSP = "/TraphacoHYERP/pages/Center/BcChiTieuKhachHang.jsp";
			response.sendRedirect(nextJSP);
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(!view.equals("TT"))
		{
			String	nextJSP = "/TraphacoHYERP/pages/Distributor/BcChiTieuKhachHang.jsp";
			response.sendRedirect(nextJSP);
		}
		else
		{
			String	 nextJSP = "/TraphacoHYERP/pages/Center/BcChiTieuKhachHang.jsp";
			response.sendRedirect(nextJSP);
		}
	}
