...
{	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/PromotionDayToDayTT.jsp";
    ...
    " DDKD.MANHANVIEN AS SALEREPID, isnull(DDKD.TEN, 'Chưa khai báo') AS SALESREP,   CAST(KH.PK_SEQ as nvarchar(8)) as khId,KH.ten +'__' +isnull(kh.diachi,'') +'__' + isnull(kh.dienthoai,'') AS CUSTOMER, DH.NGAYNHAP "+ 
