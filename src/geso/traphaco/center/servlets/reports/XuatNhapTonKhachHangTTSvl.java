...
public class XuatNhapTonKhachHangTTSvl extends HttpServlet 
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/XuatNhapTonKhachHang_center.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		{	
			...
			{
				response.sendRedirect("/TraphacoHYERP/pages/Center/XuatNhapTonKhachHang_center.jsp");
			}
	    }
	    catch (Exception ex)
	    {
