...
public class BCTheoDoiKSN extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/TheoDoiKhoaSo.jsp";
		...
		if(!view.equals("TT"))
		{
			nextJSP = "/TraphacoHYERP/pages/Distributor/TheoDoiKhoaSo.jsp";
			response.sendRedirect(nextJSP);
		}
		else
		{
			 nextJSP = "/TraphacoHYERP/pages/Center/TheoDoiKhoaSo.jsp";
			response.sendRedirect(nextJSP);
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!view.equals("TT"))
		{
			String	nextJSP = "/TraphacoHYERP/pages/Distributor/TheoDoiKhoaSo.jsp";
			response.sendRedirect(nextJSP);
		}
		else
		{
