package geso.traphaco.center.servlets.phieunhapkhott;
...
public class PhieuNhapKhoTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			...
			String nextJSP = "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTUpDate.jsp";//default
			response.sendRedirect(nextJSP);
		}
		else if(action.equals("display")){
			String nextJSP = "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTDisplay.jsp";//default
			response.sendRedirect(nextJSP);
		}
		else if(action.equals("chot")){
			String nextJSP = "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTChot.jsp";//default
			response.sendRedirect(nextJSP);
		}
	}
	/**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {//truong hop co file dinh kem
		  ...
		  if(tenform.equals("newform")){
			  nextJSP= "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTNew.jsp";
		  }else{
			  nextJSP= "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTUpDate.jsp";
		  }
			  ...
			  if(ctbean.SavePhieuNhapKhoTT()){
				  ...
				  nextJSP= "/TraphacoHYERP/pages/Center/PhieuNhapKhoTT.jsp";
			  }
				 ...
				 if(ctbean.ChotPhieuNhapKhoTT()){
					 ...
					 nextJSP= "/TraphacoHYERP/pages/Center/PhieuNhapKhoTTChot.jsp";
				 }
			 }
