package geso.traphaco.center.servlets.mucchietkhautt;

import geso.traphaco.center.beans.mucchietkhautt.IMucChietKhauTT;
import geso.traphaco.center.beans.mucchietkhautt.IMucChietKhauTT_NhaPP;
import geso.traphaco.center.beans.mucchietkhautt.imp.MucChietKhauTT;
import geso.traphaco.center.beans.mucchietkhautt.imp.MucChietKhauTT_NhaPP;
...
public class MucChietKhauTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if (action.equals("update")){	   		  	    	
	    	...
	    	String nextJSP = "/TraphacoHYERP/pages/Center/MucChietKhauTTUpdate.jsp";                                    
	    	response.sendRedirect(nextJSP);
	    }else if(action.equals("delete")){
	    	obj.DeleteMucChietKhauTT();
	    	 obj.setListMucChietKhau("");
	 		session.setAttribute("obj", obj);	 				
	 		String nextJSP = "/TraphacoHYERP/pages/Center/MucChietKhauTT.jsp";	 		                                     
	 		response.sendRedirect(nextJSP);
	    }
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(formname.equals("newform")){
			nextJSP = "/TraphacoHYERP/pages/Center/MucChietKhauTTNew.jsp";
		}else{
			nextJSP = "/TraphacoHYERP/pages/Center/MucChietKhauTTUpdate.jsp";
		}
		...
		{		if(error ==false){
				if ((ghcnBean.SaveMucChietKhauTT())){	
					...
					session.setAttribute("obj", ghcnBean);
					 nextJSP = "/TraphacoHYERP/pages/Center/MucChietKhauTT.jsp";
				}
				}
