...
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongDP;
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongDPList;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuchithuongDP;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuchithuongDPList;
...
public class TieuchithuongDPUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDPUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDPDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		{    
    		if (id == null )
    		{
    			if (!tctskuBean.createTctSKU())
    			{
    				...
    				String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDPNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
				    ...
				    String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDP.jsp";
					response.sendRedirect(nextJSP);
    			}	
    		}
    		else
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDPNew.jsp";
			}
			else{
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongDPUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}
	}
