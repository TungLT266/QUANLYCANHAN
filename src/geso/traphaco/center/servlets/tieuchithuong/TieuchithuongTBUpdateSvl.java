...
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongTB;
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongTBList;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuchithuongTB;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuchithuongTBList;
...
public class TieuchithuongTBUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTBUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTBDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
 		...
 		{    
    		if (id == null )
    		{
    			if (!tctskuBean.createTctSKU())
    			{
    				...
    				String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTBNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
				    ...
				    String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTB.jsp";
					response.sendRedirect(nextJSP);
    			}	
    		}
    		else
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTBNew.jsp";
			}
			else{
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongTBUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}
	}
