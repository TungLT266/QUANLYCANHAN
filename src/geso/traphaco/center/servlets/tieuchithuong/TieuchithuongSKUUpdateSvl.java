...
import geso.traphaco.center.beans.tieuchithuong.INhomsp;
import geso.traphaco.center.beans.tieuchithuong.INhomspDetail;
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongSKU;
import geso.traphaco.center.beans.tieuchithuong.ITieuchithuongSKUList;
import geso.traphaco.center.beans.tieuchithuong.imp.Nhomsp;
import geso.traphaco.center.beans.tieuchithuong.imp.NhomspDetail;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuChiThuongSKU;
import geso.traphaco.center.beans.tieuchithuong.imp.TieuchithuongSKUList;
...
public class TieuchithuongSKUUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongSKUUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongSKUDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
			...
			{	
				...
				if (filename.length() > 0)
				{
					if(!readExcel(filename,userId,tctskuBean))
					{
						...
						{
							    nextJSP =  "/TraphacoHYERP/pages/Center/TieuChiThuongSKUUpdate.jsp";
						}
						else nextJSP =  "/TraphacoHYERP/pages/Center/TieuChiThuongSKUNew.jsp";
				...
				{
					String nextJSP =  "/TraphacoHYERP/pages/Center/TieuChiThuongSKUNew.jsp";
 		...
 		{    
    		...
    		if (id == null )
    		{
    			...
    			else
    			{
				    ...
				    String nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongSKU.jsp";
					response.sendRedirect(nextJSP);
    			}	
    		}
    		else
		...
		{		
			...
			String nextJSP;
			if (id == null){
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongSKUNew.jsp";
			}
			else{
				nextJSP = "/TraphacoHYERP/pages/Center/TieuChiThuongSKUUpdate.jsp";   						
			}
