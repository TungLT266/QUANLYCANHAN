...
public class PhieuThanhToanTTSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTT.jsp";
	    ...
	    if(action.equals("new"))
	     {
	    	...
	    	obj.setUserId(userId);
	        session.setAttribute("obj",obj);
	        String nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTTNew.jsp";
	        response.sendRedirect(nextJSP);
	     }
	    else {
	    	obj.setUserId(userId);
    		...
    		response.sendRedirect("/TraphacoHYERP/pages/Center/PhieuThanhToanTT.jsp");	
	    }
	}
