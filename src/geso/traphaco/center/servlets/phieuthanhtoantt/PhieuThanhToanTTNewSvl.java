package geso.traphaco.center.servlets.phieuthanhtoantt;

import geso.traphaco.center.beans.phieuthanhtoantt.IPhieuThanhToanTT;
import geso.traphaco.center.beans.phieuthanhtoantt.IPhieuThanhToanTT_DH;
import geso.traphaco.center.beans.phieuthanhtoantt.imp.PhieuThanhToanTT;
import geso.traphaco.center.beans.phieuthanhtoantt.imp.PhieuThanhToanTT_DH;
...
public class PhieuThanhToanTTNewSvl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("update")){
			String nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTTUpdate.jsp";
			response.sendRedirect(nextJSP);
		}else if(action.equals("display")){
			String nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTTDiplay.jsp";
			response.sendRedirect(nextJSP);
		}
    	...
    	if(action.equals("new") || action.equals("update")){
        	...
        	//System.out.println("tong so chuoi2:"+thanhtoan.length);
     		...
     		if(formname.equals("newform")){
     			nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTTNew.jsp";
     		}else{
     			nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTTUpdate.jsp";
     		}
				  ...
				  response.sendRedirect(nextJSP);
    				...
    				if(!obj.saveThanhToan())
    				{
		    			...
		    			session.setAttribute("obj", dh);		    					
		    			 nextJSP = "/TraphacoHYERP/pages/Center/PhieuThanhToanTT.jsp";
		    			response.sendRedirect(nextJSP);
    				}
