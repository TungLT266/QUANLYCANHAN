...
import geso.traphaco.center.beans.erp_dontrahang.IERP_dontrahang;
import geso.traphaco.center.beans.erp_dontrahang.imp.Erp_dontrahang;
        ...
        else if(action.equals("display"))
        {
        	...
        	{        		
        		IERP_DonDatHang dhBean=new ERP_DonDatHang(ddhId);
   		 	  	...
   		 	  	{   		 	  		
   		 	  		nextJSP = "/TraphacoHYERP/pages/Center/Erp_DonMuaHangKmDisplayDuyet.jsp";
   		 	  	}
   		 	  	else
   		 	  	{
   		 		nextJSP = "/TraphacoHYERP/pages/Center/Erp_DonDatHangDisplayDuyet.jsp";
   		 	  	}
        	...
        	else
        	{
        		...
        		String  nextJSP = "/TraphacoHYERP/pages/Center/Erp_DonTraHangDisplayDuyet.jsp";
        		session.setAttribute("obj", dhBean);
        		response.sendRedirect(nextJSP);     	
        	}
        	return;
		        ...
		        String nextJSP = "/TraphacoHYERP/pages/Center/Erp_KTDuyetDonHang.jsp";
		        response.sendRedirect(nextJSP);
