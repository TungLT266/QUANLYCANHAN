...
import geso.traphaco.center.beans.donmuahang.IDonmuahang;
import geso.traphaco.center.beans.donmuahang.IDonmuahangList;
import geso.traphaco.center.beans.donmuahang.imp.Donmuahang;
...
//		out.print("tongtienavat =" + tongtienavat);
		...
		if(action.equals("chot")){
			if (!(dmhBean.ChotDdhnpp(request))){			
				...
				String nextJSP = "/TraphacoHYERP/pages/Center/DonMuaHangUpdate.jsp";
//				response.sendRedirect(nextJSP);
			}else{
