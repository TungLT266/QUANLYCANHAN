...
public class Sanpham implements ISanpham, Comparable<Object>
{
	...
	public Sanpham(String masp, String tensp, float soluongcan, float dongia, float slAvaiable, boolean comprareTongluong)
	{
		this.masp = masp;
		this.tensp = tensp;
	...
	public int compareTo(Object obj) 
	{
		...
		float soluong = ((Sanpham)obj).getSoluongcan();
