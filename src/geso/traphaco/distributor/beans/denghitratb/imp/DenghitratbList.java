package geso.traphaco.distributor.beans.denghitratb.imp;

import java.io.Serializable;
import java.sql.ResultSet;

import geso.traphaco.center.util.Phan_Trang;
import geso.traphaco.distributor.beans.denghitratb.*;
...
public class DenghitratbList extends Phan_Trang implements IDenghitratbList, Serializable
{
	...
	public void init(String search) 
	{
		...
		this.rsDenghi=   createSplittingDataNew(this.db, 50, 10, "ngaydenghi desc, dnttbId desc", query);	
	}
