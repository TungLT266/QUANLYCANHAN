package geso.traphaco.distributor.beans.dondathangotc.imp;
...
public class ErpDonhangNppOTC implements IErpDonhangNppOTC
{
	String userId;
	String id;
	...
	public ErpDonhangNppOTC(String id)
	{
		this.id = id;
		this.ma = "";
		this.tungay = "";
