...
import geso.traphaco.distributor.beans.chuyenkho.IErpChuyenKhoList;
	...
	public void init(String search)
	{
		...
		else
		{
			query = 
					...
					"inner join NHANVIEN nv2 on a.NGUOISUA = nv2.PK_SEQ where a.tructhuoc_fk = '" + this.nppId + "' and a.loaichuyenkho = '0' ";
			} 
