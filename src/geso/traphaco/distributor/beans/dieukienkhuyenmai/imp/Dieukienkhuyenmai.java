package geso.traphaco.distributor.beans.dieukienkhuyenmai.imp;
...
public class Dieukienkhuyenmai implements IDieukienkhuyenmai, Comparable<Object> , Serializable
{
	...
	private int type;
	private float soxuatKM;
	private String IsThung;
	private float trongso;  //Chi OneOne moi xai trong so
	
	private Hashtable<String, Float> sanpham_soluong; //ma --> soluong(tuong ung voi id)
	...
	public Dieukienkhuyenmai()
	{
		...
		this.ttTraTheoDK = 0;
		this.IsThung = "0";
		this.sanpham_soluong = new Hashtable<String, Float>();
			...
			try 
			{
				while(spList.next())
				{
					...
					if(spList.getString("soluong") != null)
						soluong = Float.parseFloat(spList.getString("soluong"));
	...
	public Hashtable<String, Float> getSanpham_Soluong()
	{
		return this.sanpham_soluong;
	}
	public void setSanpham_Soluong(Hashtable<String, Float> sanpham)
	{
