...
import geso.traphaco.distributor.beans.duyetdonhangss.IErpDuyetdonhangss;
...
public class ErpDuyetdonhangss implements IErpDuyetdonhangss
{
	String userId;
	String id;
	...
	public ErpDuyetdonhangss(String id)
	{
		this.id = id;
		this.ma = "";
		this.tungay = "";
