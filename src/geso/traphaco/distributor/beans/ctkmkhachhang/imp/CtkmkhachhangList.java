package geso.traphaco.distributor.beans.ctkmkhachhang.imp;
...
public class CtkmkhachhangList extends Phan_Trang implements ICtkmkhachhangList, Serializable{
	...
	System.out.println("load:"+ query);
		this.Dskm = createSplittingDataNew(this.db, 50, 10, "ctkm desc", query);// createSplittingData(request, "ctkm desc", query);//db.get(query);
