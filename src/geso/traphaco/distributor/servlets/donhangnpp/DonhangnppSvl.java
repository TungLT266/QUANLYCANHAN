...
import geso.traphaco.center.beans.nhacungcap.imp.Nhacungcap;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   String nextJSP="";
		if(action.equals("display") )
		{
			...
			nextJSP = "/TraphacoHYERP/pages/Distributor/DonHangNhaPPDisplay.jsp";
		...
		else if(action.equals("update"))//Truong hop xu ly sua lai donhangnpp
		{
			...
			obj.SetDonHangNPP("");
			session.setAttribute("obj", obj);			
			nextJSP = "/TraphacoHYERP/pages/Distributor/DonHangNhaPP.jsp";
		    response.sendRedirect(nextJSP);
		}
