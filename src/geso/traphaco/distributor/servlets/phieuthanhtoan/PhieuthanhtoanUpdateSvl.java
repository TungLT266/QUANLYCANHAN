package geso.traphaco.distributor.servlets.phieuthanhtoan;

import geso.traphaco.distributor.beans.phieuthanhtoan.IPhieuthanhtoan;
import geso.traphaco.distributor.beans.phieuthanhtoan.IPhieuthanhtoanList;
import geso.traphaco.distributor.beans.phieuthanhtoan.imp.Phieuthanhtoan;
import geso.traphaco.distributor.beans.phieuthanhtoan.imp.PhieuthanhtoanList;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        if(action.equals("chotphieu"))
        {
        	...
        	IPhieuthanhtoanList obj = new PhieuthanhtoanList();
     		...
     		String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToan.jsp";
        ...
        {
        	session.setAttribute("obj", obj);
 	        String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToanDisplay.jsp";
 	        response.sendRedirect(nextJSP);
        }
        else
        {
	        session.setAttribute("obj", obj);
	        String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToanUpdate.jsp";
	        response.sendRedirect(nextJSP);
        }
	}
   ...
   {db = new dbutils();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		*/
    	...
    	else
    	{
   		 ...
   		 {
   			  session.setAttribute("obj", obj);	
		    	  String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToanNew.jsp";
				  response.sendRedirect(nextJSP);
   		 }
   		 else 
   		 {
    ...
    /*	String ngayhoadon = request.getParameter("ngayhoadon");
		...
		else
		{
			...
			String nextJSP;
			if (id == null){			
				nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToanNew.jsp";
			}else{
				nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThanhToanUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);		
		}
		*/
