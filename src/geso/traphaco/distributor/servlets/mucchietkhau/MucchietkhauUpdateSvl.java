...
import geso.traphaco.distributor.beans.mucchietkhau.*;
import geso.traphaco.distributor.beans.mucchietkhau.imp.*;
...
public class MucchietkhauUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(!cutil.check(userId, userTen, sum)){
	        ...
	        String nextJSP = "/TraphacoHYERP/pages/Distributor/MucChietKhauUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
	    ...
	    if (!error){
	    	if(action.equals("save"))
	    	{
	    		...
	    		String nextJSP;
	    		if (id == null){			
	    			nextJSP = "/TraphacoHYERP/pages/Distributor/MucChietKhauNew.jsp";
	    		}else{
	    			nextJSP = "/TraphacoHYERP/pages/Distributor/MucChietKhauUpdate.jsp";   						
	    		}
	    		response.sendRedirect(nextJSP);	    	
	    	}
	    }
