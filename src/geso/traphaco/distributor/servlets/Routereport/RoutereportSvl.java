package geso.traphaco.distributor.servlets.Routereport;

import geso.traphaco.distributor.beans.Router.IDRouter;
import geso.traphaco.distributor.beans.Router.imp.Router;
...
public class RoutereportSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		} else
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Distributor/RouteReport.jsp";
