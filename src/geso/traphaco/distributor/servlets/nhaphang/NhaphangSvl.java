...
public class NhaphangSvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet
{
	...
	private String getSearchQuery(HttpServletRequest request, INhaphangList obj)
	{
		...
		String query =  	
			"	select  a.ngaychungtu,  "+ 
				...
				"		'HD_' + (     "+
				"			select top(1) SOHOADON from ERP_HOADONNPP_DDH aa      "+
 ...
 "		) when a.CHUYENKHONPP_FK IS NOT NULL THEN 'XCNB_' +(SELECT TOP(1) SoChungTu from ERP_CHUYENKHONPP where CHUYENKHONPP_FK=A.CHUYENKHONPP_FK)  "
				+
				"	end as dathang_fk ,  "+
				"		a.ngaynhan, a.pk_seq as chungtu, isnull(e.donvikinhdoanh, '') as donvikinhdoanh, f.diengiai as kbh ,  0 as sotienavat, b.ten as nguoitao,  "+
				...
				"	left join  NHOMKENH f  on f.pk_seq = a.nhomkenh_fk  "+   
