...
public class BanggiabandoitacUpdateSvl extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet 
{
   static final long serialVersionUID = 1L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaBanDoiTacUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		{	
			...
			{			
				...
				bgBean.createRS();
				session.setAttribute("bgBean", bgBean);
				nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaBanDoiTacNew.jsp";
			}
			else
			{
				bgBean.setUserId(userId);
				...
				nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaBanDoiTacUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);
		}
	}
