...
public class ErpDondathangDoitacUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacDisplay.jsp";	
    		}
    		else if(querystring.contains("duyet"))
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacDuyetDisplay.jsp";
    		}
    		else
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacUpdate.jsp";
    		}
			...
			{	
				...
				else
				{
					...
					if(!kq)
					{
						...
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
				...
				else
				{
					if(action.equals("duyet"))
					{
						...
						if(!lsxBean.duyetDH( session.getAttribute("congtyId").toString() ))
						{
							...
							lsxBean.init();
							session.setAttribute("lsxBean", lsxBean);
		    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacDuyetDisplay.jsp";
		    				response.sendRedirect(nextJSP);
						}
						else
						{
					...
					else
					{
						...
						nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacNew.jsp";
						if(id != null)
						{
							nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangDoiTacUpdate.jsp";
						}
