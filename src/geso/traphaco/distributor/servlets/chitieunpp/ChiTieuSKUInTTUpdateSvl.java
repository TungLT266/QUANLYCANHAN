...
public class ChiTieuSKUInTTUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUInUpdate.jsp";
        if(querystring.indexOf("display") >= 0)
        	nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUInDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
 		...
 		if(action.equals("save"))
 		{
    		if (id == null )
    		{
    			if (!ctskuBean.createChiTieuThang())
    			{
    				...
    				String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUInNew.jsp";
    				response.sendRedirect(nextJSP);
    			}
    			else
    			{
    			    ...
    			    String nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUIn.jsp";
    				response.sendRedirect(nextJSP);	
    			}		
    		}
    		else{
		...
		{		
			...
			else
			{
				...
				if (id == null){
					nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUInNew.jsp";
				}
				else{
					nextJSP = "/TraphacoHYERP/pages/Center/ChiTieuSKUInUpdate.jsp";					
				}
				response.sendRedirect(nextJSP);
			}
		}		
