...
import geso.traphaco.distributor.beans.bcchietkhauconlai.IBcChietKhauConLai;
import geso.traphaco.distributor.beans.bcchietkhauconlai.imp.BcChietKhauConLai;
...
public class BcChietKhauConLaiSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		nextJSP = "/TraphacoHYERP/pages/Distributor/BcChietKhauConLai.jsp";
    ...
    if (action.equals("excel")  )
    {
    	...
    	session.setAttribute("obj", obj);
    	response.sendRedirect("/TraphacoHYERP/pages/Distributor/BcChietKhauConLai.jsp");
    }
