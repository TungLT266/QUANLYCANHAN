...
import geso.traphaco.distributor.beans.reports.imp.BcDoanhSoNhomHangNpp;
...
public class BcDoanhSoNhomHangNppSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		nextJSP = "/TraphacoHYERP/pages/Distributor/BcDoanhSoNhomHang.jsp";
    ...
    if (action.equals("excel")  )
    {
    	...
    	session.setAttribute("obj", obj);
    	response.sendRedirect("/TraphacoHYERP/pages/Distributor/BcDoanhSoNhomHang.jsp");
    }
	...
	private void CreateStaticHeader(Workbook workbook, IBcDoanhSoNhomHangNpp obj)
  {
			...
			Cells cells = worksheet.getCells();
			 ...
			 Style style;
			    ...
			    cell = cells.getCell("E7");	cell.setValue("Trình dược viên");
			    ReportAPI.setCellBackground_Font(cell,  Color.GREEN, BorderLineType.THIN, true, 0,Color.WHITE);
