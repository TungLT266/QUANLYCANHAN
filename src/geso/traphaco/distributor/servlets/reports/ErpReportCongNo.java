...
public class ErpReportCongNo extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	
	public ErpReportCongNo()
	{
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpReportCongno.jsp";
	...
	private void CreatePivotTable(OutputStream out, HttpServletResponse response, HttpServletRequest request, String[] fieldsHien, IStockintransit obj) throws Exception
	{
		try
		{
			...
			String strfstream = getServletContext().getInitParameter("path") + "\\ReportCongNo.xlsm";
			...
			db.update(query);
				...
				ResultSet	rs = db.getRsByPro("GET_CHITIET_CONGNO_HOADON", param);
			 
				   
		  		worksheets = workbook.getWorksheets();
		  		Worksheet worksheet_REPORT_HOADON = worksheets.getSheet("sheet1");
		  		worksheet_REPORT_HOADON.setName("Report_Chitiet_Congno");
		  		this.TaoBaoCao(db,rs,worksheet_REPORT_HOADON, obj,"CHI TIẾT CÔNG NỢ",style1);
