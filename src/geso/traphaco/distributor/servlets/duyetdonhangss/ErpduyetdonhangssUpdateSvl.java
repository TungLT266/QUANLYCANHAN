package geso.traphaco.distributor.servlets.duyetdonhangss;
...
import geso.traphaco.distributor.beans.duyetdonhangss.imp.ErpDuyetdonhangss;
import geso.traphaco.distributor.beans.duyetdonhangss.imp.ErpDuyetdonhangssList;
...
public class ErpduyetdonhangssUpdateSvl extends HttpServlet {
private static final long serialVersionUID = 1L;
	
	PrintWriter out;
    public ErpduyetdonhangssUpdateSvl() 
    {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
		    ...
		    IErpDuyetdonhangss lsxBean = new ErpDuyetdonhangss(id);
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDuyetDonHangSSDisplay.jsp";
    		}    		
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			IErpDuyetdonhangss lsxBean;
			
			Utility util = new Utility();	
			String id = util.antiSQLInspection(request.getParameter("id"));
		    if(id == null)
		    {  	
		    	lsxBean = new ErpDuyetdonhangss("");
		    }
		    else
		    {
		    	lsxBean = new ErpDuyetdonhangss(id);
		    }
			...
			{	
				...
				if(id == null)
				{
					...
					else
					{
						...
						IErpDuyetdonhangssList obj = new ErpDuyetdonhangssList();
			...
			else if (action.equals("duyet"))
			{
				...
				if(!lsxBean.duyetETC())
				{
					...
					lsxBean.setSanpham_Soluong(sanpham_soluong);
					session.setAttribute("lsxBean", lsxBean);
    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDuyetDonHangSSDisplay.jsp";
    				response.sendRedirect(nextJSP);
				}
				else
				{
