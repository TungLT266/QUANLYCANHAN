...
public class ErpDuyetdonhangssSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public ErpDuyetdonhangssSvl() {
		super();
	}
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpDuyetdonhangssList obj = null;
		...
		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDuyetDonHangSS.jsp";
	...
	private String getSearchQuery(HttpServletRequest request, IErpDuyetdonhangssList obj)
	{
		Utility util = new Utility();
