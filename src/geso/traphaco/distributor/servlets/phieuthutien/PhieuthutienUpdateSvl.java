package geso.traphaco.distributor.servlets.phieuthutien;

import geso.traphaco.distributor.beans.phieuthutien.IPhieuthutien;
import geso.traphaco.distributor.beans.phieuthutien.IPhieuthutienList;
import geso.traphaco.distributor.beans.phieuthutien.imp.Phieuthutien;
import geso.traphaco.distributor.beans.phieuthutien.imp.PhieuthutienList;
...
public class PhieuthutienUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienUpdate_2.jsp";
        
        if(querystring.indexOf("display") >= 0 ) 
        	nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienDisplay.jsp";
    	...
    	if(action.equals("save"))
		{
			if ( id == null){
				if (!(pttBean.CreatePtt(request))){	
					pttBean.initNew();
					session.setAttribute("pttBean", pttBean);			
					String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienNew_2.jsp";
					response.sendRedirect(nextJSP);
				}else{
					...
					String nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTien.jsp";
					response.sendRedirect(nextJSP);			    			    									
				}
				...
				if(action.equals("claim")){
					...
					if(khIds != null){
						if (id == null){
							nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienNew_2.jsp";
							pttBean.initNew();
						}else{
							nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienUpdate_2.jsp";
							pttBean.initUpdate();						
						}
					}else{
						if (id == null){
							nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienNew_1.jsp";
							pttBean.initNew();
					...
					if(action.equals("noclaim")){
						...
						if (id == null){
							...
							nextJSP = "/TraphacoHYERP/pages/Distributor/PhieuThuTienUpdate_1.jsp";
							pttBean.initUpdate();						
						}					
					}else{
						pttBean.setClaim(false);
