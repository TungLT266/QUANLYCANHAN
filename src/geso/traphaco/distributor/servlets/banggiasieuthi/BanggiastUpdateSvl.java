package geso.traphaco.distributor.servlets.banggiasieuthi;


import geso.traphaco.distributor.beans.banggiasieuthi.*;
import geso.traphaco.distributor.beans.banggiasieuthi.imp.*;
...
public class BanggiastUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaSieuThiUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action.equals("save"))
		{
			if ( id == null){
				if (!(bgstBean.CreateBgst(spId, spGiasieuthi))){	
					...
					session.setAttribute("bgstBean", bgstBean);			
					String nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaSieuThiNew.jsp";
					response.sendRedirect(nextJSP);
				}else{
					...
					String nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaSieuThi.jsp";
					response.sendRedirect(nextJSP);			    			    									
				}
		...
		}else
		{
			...
			String nextJSP;
			if (id == null){			
				nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaSieuThiNew.jsp";
			}else{
				nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaSieuThiUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);		
		}
		}
