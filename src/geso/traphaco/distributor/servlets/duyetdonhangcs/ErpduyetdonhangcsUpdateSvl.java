...
import geso.traphaco.distributor.beans.duyetdonhangcs.imp.ErpDuyetdonhangcs;
...
public class ErpduyetdonhangcsUpdateSvl extends HttpServlet {
private static final long serialVersionUID = 1L;
	
	PrintWriter out;
    public ErpduyetdonhangcsUpdateSvl() 
    {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
		    ...
		    IErpDuyetdonhangcs lsxBean = new ErpDuyetdonhangcs(id);
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDuyetDonHangCSDisplay.jsp";
    		}    		
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			IErpDuyetdonhangcs lsxBean;
			
			Utility util = new Utility();	
			String id = util.antiSQLInspection(request.getParameter("id"));
		    if(id == null)
		    {  	
		    	lsxBean = new ErpDuyetdonhangcs("");
		    }
		    else
		    {
		    	lsxBean = new ErpDuyetdonhangcs(id);
		    }
			...
			else if (action.equals("duyet"))
			{
				...
				if(!lsxBean.duyetETC())
				{
					...
					lsxBean.setSanpham_Soluong(sanpham_soluong);
					session.setAttribute("lsxBean", lsxBean);
    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDuyetDonHangCSDisplay.jsp";
    				response.sendRedirect(nextJSP);
				}
				else
				{
