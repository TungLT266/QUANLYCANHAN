package geso.traphaco.distributor.servlets.gioihancongno;
...
public class GioihancongnoUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        String nextJSP = "/TraphacoHYERP/pages/Distributor/GioiHanCongNoUpdate.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(action.equals("save"))
		{
			if ( id == null)
			{
				if (!(ghcnBean.CreateGhcn(khIds))){	
					ghcnBean.createRS();
					session.setAttribute("ghcnBean", ghcnBean);			
					String nextJSP = "/TraphacoHYERP/pages/Distributor/GioiHanCongNoNew.jsp";
					response.sendRedirect(nextJSP);
				}else{
					...
					String nextJSP = "/TraphacoHYERP/pages/Distributor/GioiHanCongNo.jsp";
					response.sendRedirect(nextJSP);			    			    									
				}
		...
		}else
		{
			...
			String nextJSP;
			if (id == null){			
				nextJSP = "/TraphacoHYERP/pages/Distributor/GioiHanCongNoNew.jsp";
			}else{
				nextJSP = "/TraphacoHYERP/pages/Distributor/GioiHanCongNoUpdate.jsp";   						
			}
			response.sendRedirect(nextJSP);		
		}}
	}
