...
import geso.traphaco.distributor.beans.doihang.IErpDenghidoihangNpp;
import geso.traphaco.distributor.beans.doihang.IErpDenghidoihangNppList;
import geso.traphaco.distributor.beans.doihang.imp.ErpDenghidoihangNpp;
import geso.traphaco.distributor.beans.doihang.imp.ErpDenghidoihangNppList;
...
public class ErpDenghidoihangNppUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppUpdate.jsp";
    		}
    		else
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppDisplay.jsp";
    		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			{	
				if(id == null)
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppNew.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			    		...
			    		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNpp.jsp";
			    		response.sendRedirect(nextJSP);
					}
				}
				else
				{
					...
					if(!kq)
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			...
			else
			{
				...
				nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppNew.jsp";
				if(id != null)
				{
					nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDeNghiDoiHangNppUpdate.jsp";
				}
