...
public class ErpTinhtrangdonhangSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
       
    public ErpTinhtrangdonhangSvl() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
	    ...
	    obj.initTHEODOIDONHANG("");
	    
		session.setAttribute("obj", obj);
			
		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpTinhTrangDonHang.jsp";
	...
	private String getSearchQuery(HttpServletRequest request, IErpDonhangNppETCList obj)
	{
		...
		String query =  "select distinct a.PK_SEQ, isnull(a.machungtu, '') as machungtu, a.trangthai, isnull(a.hopdong_fk, -1) as hopdong_fk, a.Created_Date as ngaydonhang, a.ngaydenghi, a.tooltip, a.tooltip_scheme, \n" + 
						...
						"	a.CS_DUYET, a.SS_DUYET, a.thoigianxuly, a.mohoadon, a.donhangmuon,  " + 
		...
		if(trangthai.length() > 0)
		{
			if( trangthai.equals("0") )
				...
				query += " AND	ISNULL ( ( select COUNT(sxh_dh.hoadon_fk) from ERP_SOXUATHANGNPP sxh inner join ERP_SOXUATHANGNPP_DDH sxh_dh on sxh.PK_SEQ = sxh_dh.soxuathang_fk " + 
						" 				   where sxh.TRANGTHAI != 0 and sxh_dh.hoadon_fk in ( select hd.PK_SEQ from ERP_HOADONNPP hd inner join ERP_HOADONNPP_DDH hd_dh on hd.PK_SEQ = hd_dh.HOADONNPP_FK where hd.TRANGTHAI not in ( 3, 5 ) and hd_dh.DDH_FK = a.pk_seq )  ), 0 ) = 1 ";
		}
