...
public class KhachhangChuaPhanTuyenSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		} else
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Distributor/KhachHangChuaPhanTuyen.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		} else
		{
			...
			if (action.equals("search"))
			{
				...
				response.sendRedirect("/TraphacoHYERP/pages/Distributor/KhachHangChuaPhanTuyen.jsp");
