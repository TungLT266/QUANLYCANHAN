package geso.traphaco.distributor.servlets.trakhuyenmai;
...
import geso.traphaco.distributor.beans.quanlykhuyenmai.ITrakhuyenmaiNpp;
import geso.traphaco.distributor.beans.quanlykhuyenmai.ITrakhuyenmaiNppList;
import geso.traphaco.distributor.beans.quanlykhuyenmai.imp.TrakhuyenmaiNpp;
import geso.traphaco.distributor.beans.quanlykhuyenmai.imp.TrakhuyenmaiNppList;
...
public class TrakhuyenmaiNppUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String nextJSP = "/TraphacoHYERP/pages/Distributor/TraKhuyenMaiNppSanPham.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		if(action.equals("save"))
		{
			...
			else
			{
				...
				String nextJSP = "/TraphacoHYERP/pages/Distributor/TraKhuyenMai.jsp";
				response.sendRedirect(nextJSP);
			}
		}
		else
