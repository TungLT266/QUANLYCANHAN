package geso.traphaco.distributor.servlets.banggiablnpp;

import geso.traphaco.distributor.beans.banggiablnpp.*;
import geso.traphaco.distributor.beans.banggiablnpp.imp.*;
...
public class BanggiablUpdateSvl extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		else
		{
			...
			String nextJSP = "/TraphacoHYERP/pages/Distributor/BgBanLeNppUpdate.jsp";
		...
		} else
		{
			...
			if (!error)
			{
				if (action.equals("save"))
				{
					if (id == null)
					{
						if (!(bgblBean.CreateBgbl(spId, spGiablc, spGiabanleNpp)))
						{
							...
							session.setAttribute("bgblBean", bgblBean);
							String nextJSP = "/TraphacoHYERP/pages/Distributor/BgBanLeNppNew.jsp";
							response.sendRedirect(nextJSP);
						} else
						{
							...
							String nextJSP = "/TraphacoHYERP/pages/Distributor/BangGiaBanLeNpp.jsp";
							response.sendRedirect(nextJSP);
						}
				...
				} else
				{
					...
					if (id == null)
					{
						nextJSP = "/TraphacoHYERP/pages/Distributor/BgBanLeNppNew.jsp";
					} else
					{
						nextJSP = "/TraphacoHYERP/pages/Distributor/BgBanLeNppUpdate.jsp";
					}
					response.sendRedirect(nextJSP);
				}
			} else
