...
public class ErpYeucauxuatkhoNppUpdateSvl extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpYeuCauXuatKhoNppUpdate.jsp";	
    		}
    		else
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpYeuCauXuatKhoNppDisplay.jsp";
    		}
			...
			{	
				if(id == null)
				{
					if(!lsxBean.create())
					{
						lsxBean.createRs();
	    		    	session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpYeuCauXuatKhoNppNew.jsp";
					...
					else
					{
			    		...
			    		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpYeuCauXuatKhoNpp.jsp";
			    		response.sendRedirect(nextJSP);
					}
				}
				else
				{
					if(!lsxBean.update())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpYeuCauXuatKhoNppUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
