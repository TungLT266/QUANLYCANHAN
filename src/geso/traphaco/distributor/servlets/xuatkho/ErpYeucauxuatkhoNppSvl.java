...
public class ErpYeucauxuatkhoNppSvl extends HttpServlet 
{
	...
	private String getSearchQuery(HttpServletRequest request, IErpYeucauxuatkhoNppList obj)
	{
		Utility util = new Utility();
		String query =
				"select a.PK_SEQ, a.machungtu, a.trangthai, a.ngayyeucau, isnull(c.ten, d.ten) as nppTEN, b.ten as khoTEN, NV.TEN as nguoitao, b.ten as khonhan, a.NGAYSUA, a.NGAYTAO, NV2.TEN as nguoisua, " +
