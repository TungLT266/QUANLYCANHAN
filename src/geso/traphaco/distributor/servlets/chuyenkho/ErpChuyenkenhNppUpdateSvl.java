	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
    		...
    		if(!querystring.contains("display"))
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNppUpdate.jsp";
    		else
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNppDisplay.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
					...
					if(soLUONGXUAT != null)
					{
						for(int j = 0; j < soLUONGXUAT.length; j++ )
						{
							if(soLUONGXUAT[j] != null && soLUONGXUAT[j].trim().length() > 0)
							{
								...
								sp_hansudung.put(spMa[i] + "__" + spSOLO[j] + "__" + spNgayHetHan[j]  , spNgayHetHan[j] );
							}
						}
					}
				}
			...
			{	
				if(id == null)
				{
					...
					else
					{
			    		...
			    		response.sendRedirect("/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNpp.jsp");
					}
				}
				else
				{
					if(!lsxBean.updateNK())
					{
						lsxBean.createRs();
						session.setAttribute("lsxBean", lsxBean);
	    				String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNppUpdate.jsp";
	    				response.sendRedirect(nextJSP);
					}
					else
					{
			...
			else
			{
				...
				nextJSP = "/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNppNew.jsp";
				if(id != null)
					nextJSP = "/TraphacoHYERP/pages/Distributor/ErpChuyenKenhNppUpdate.jsp";
