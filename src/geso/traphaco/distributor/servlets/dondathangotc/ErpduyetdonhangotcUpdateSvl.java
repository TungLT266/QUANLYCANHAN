package geso.traphaco.distributor.servlets.dondathangotc;
...
import geso.traphaco.distributor.beans.dondathangotc.IErpDonhangNppOTCList;
import geso.traphaco.distributor.beans.dondathangotc.imp.ErpDonhangNppOTC;
import geso.traphaco.distributor.beans.dondathangotc.imp.ErpDonhangNppOTCList;
...
public class ErpduyetdonhangotcUpdateSvl extends HttpServlet {
private static final long serialVersionUID = 1L;
	
	PrintWriter out;
    public ErpduyetdonhangotcUpdateSvl() 
    {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
		    ...
		    IErpDonhangNppOTC lsxBean = new ErpDonhangNppOTC(id);
    		...
    		{
    			nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonHangNppOTCDuyetDisplay .jsp";
    		}    		
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else
		{
			...
			IErpDonhangNppOTC lsxBean;
			
			Utility util = new Utility();	
			String id = util.antiSQLInspection(request.getParameter("id"));
		    if(id == null)
		    {  	
		    	lsxBean = new ErpDonhangNppOTC("");
		    }
		    else
		    {
		    	lsxBean = new ErpDonhangNppOTC(id);
		    }
			...
			{	
				...
				if(id == null)
				{
					...
					else
					{
						...
						IErpDonhangNppOTCList obj = new ErpDonhangNppOTCList();
