...
import geso.traphaco.distributor.beans.dondathangotc.imp.ErpDuyetddhNppListOtc;
...
public class ErpDuyetddhNppOtcSvl extends HttpServlet 
{
	private static final long serialVersionUID = 1L;
	
	public ErpDuyetddhNppOtcSvl() {
		super();
	}
	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		IErpDuyetddhNppListOtc obj = null;
		...
		String nextJSP = "/TraphacoHYERP/pages/Distributor/ErpDonDatHangNppDuyetOTC.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		IErpDuyetddhNppListOtc obj = new ErpDuyetddhNppListOtc();
	...
	private String getSearchQuery(HttpServletRequest request, IErpDuyetddhNppListOtc obj)
	{
		Utility util = new Utility();
