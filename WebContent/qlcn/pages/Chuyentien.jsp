...
<%@page import="qlcn.pages.chuyentien.beans.IChuyenTienList"%>
...
IChuyenTienList obj = (IChuyenTienList) session.getAttribute("obj");
ResultSet ChuyentienRs = obj.getChuyentienRs();
			...
			<tr>
				<td colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
							<td align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý tài khoản > Chuyển tiền</td>
					...
					<table width="100%" cellpadding="0" cellspacing="1">
								...
								<fieldset>
									...
									<table width="100%" cellpadding="6" cellspacing="0">
										...
										<tr>
											...
											<td class="plainlabel">
												<select name="taikhoanchuyenId" class="select2" style="width: 200px" onchange="search();">
													<option value=""></option>
													<%if(TaikhoanRs != null){ %>
											...
											<td class="plainlabel">
												<select name="taikhoannhanId" class="select2" style="width: 200px" onchange="search();">
													<option value=""></option>
											...
											<td class="plainlabel">
												<select name="trangthai" class="select2" style="width: 200px;" onchange="search();">
													...
													<%} else if(obj.getTrangthai().equals("1")){ %>
														...
														<option value="1" selected="selected">Đã chuyển tiền</option>
														<option value="2">Đã xóa</option>
						...
						<tr>
							<td width="100%">
								<fieldset>
									<legend class="legendtitle">&nbsp;Chuyển tiền &nbsp;&nbsp;
										...
										<tr>
											<td width="98%">
												<table width="100%" border="0" cellspacing="1" cellpadding="4">
			                                    	...
			                                    	%>
			                                    	<%if(ChuyentienRs != null){ %>
				                                    	<%while(ChuyentienRs.next()){ %>
				                                    		<%String tt = ChuyentienRs.getString("trangthai").trim(); %>
															...
															<td align="center"><%=ChuyentienRs.getString("id") %></td>
															...
															<%} else if(tt.equals("1")) { %>
																<td align="center">Đã chuyển tiền</td>
															<%} else { %>
																<td align="center" style="color: red;">Đã xóa</td>
															<%} %>
															
															<td align="center"><%=ChuyentienRs.getString("NGAYTAO") %></td>
