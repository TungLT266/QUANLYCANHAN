									...
									<table border="0" width="100%" cellpadding="6" cellspacing="0">
											...
											<td class="plainlabel">
												<select id="loai" name="loai">
													<%if(obj.getLoai().equals("1")) { %>
														...
														<option value="2" disabled="disabled">Thẻ thanh toán</option>
													<%} else { %>
														<option value="1" disabled="disabled">Tiền mặt</option>
										...
										<tr id="loaitienmat1" <%=obj.getLoai().equals("1") ? "" : "style=\"display: none;\"" %>>
											...
											<td class="plainlabel" colspan="3">
												<input type="text" name="ten" id="ten" style="width: 300px;" value="<%=obj.getTen() %>" readonly="readonly">
											</td>
										</tr>
										...
										<tr id="loaittt2" <%=obj.getLoai().equals("2") ? "" : "style=\"display: none;\"" %>>
