...
<script language="javascript" type="text/javascript">
	function save() {
		...
		document.forms["MainForm"].action.value = "save";
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
							<%if (obj.getID().length() > 0) {%>
								<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Loại tài khoản > Cập nhật</td>
							<%} else { %>
								<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Loại tài khoản > Tạo mới</td>
							<%} %>
