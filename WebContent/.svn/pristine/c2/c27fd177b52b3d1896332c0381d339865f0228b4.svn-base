...
<%@page import="qlcn.pages.donvi.beans.IDonViList"%>
...
IDonViList obj = (IDonViList) session.getAttribute("obj");
			...
			<tr>
				<td colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr height="22">
							<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Đơn vị</td>
								...
								<fieldset>
									...
									<table width="100%" cellpadding="6" cellspacing="0">
										...
										<tr>
											...
											<td class="plainlabel">
												<input type="text" name="diengiai" value="<%=obj.getDiengiai() %>" onchange="search();">
											</td>
										...
										<tr>
											<td width="98%">
												<table width="100%" border="0" cellspacing="1" cellpadding="4">
			                                    	...
			                                    	<%if(DonviRs != null){ %>
				                                    	<%while(DonviRs.next()){ %>
				                                    		<%String tt = DonviRs.getString("trangthai").trim(); %>
															...
															<td align="center"><%=DonviRs.getString("id") %></td>
															<td><%=DonviRs.getString("TEN") %></td>
															<td><%=DonviRs.getString("diengiai") %></td>
															...
															<td align="center"><%=DonviRs.getString("NGAYTAO") %></td>
															<td align="center"><%=DonviRs.getString("NGAYSUA") %></td>
															<td align="center">
																<% if(tt.equals("1") || tt.equals("0")){ %>
																		<a href="/QUANLYCANHAN/DonViUpdateSvl?userId=<%=userId %>&update=<%=DonviRs.getString("ID") %>">
																			<img title="Cập nhật" src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border=0>
																		</a>
																		<a href="/QUANLYCANHAN/DonViUpdateSvl?userId=<%=userId%>&display=<%=DonviRs.getString("ID") %>">
																			<img title="Hiển thị" src="../images/Display20.png" alt="Hien thi" title="Hien thi" border=0>
																		</a>
																		<a href="/QUANLYCANHAN/DonViSvl?userId=<%=userId%>&delete=<%=DonviRs.getString("ID") %>" onclick="if(!confirm('Bạn thật sự muốn xóa?')) return false;">
