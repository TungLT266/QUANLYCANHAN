...
<form name="passForm" method="post" action="/TraphacoHYERP/LoginSvl">
<input type="hidden" name="login" value = "2"></input>
<table width="100%"	height="35%" border="0" cellpadding="0" cellspacing="0">
  	<tr bgcolor="#FFFFFF">
    	<td width="14%" height="52"  align="right" valign="middle" colspan=2><img src="pages/images/logo.gif" height="40" align="right" /></td>
