					   ...
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						   <tr height="22">
 							   <TD align="left" colspan="2" class="tbnavigation">
 							   		&nbsp;Dữ liệu nền &gt;Sản phẩm &gt; Bảng giá bán &gt; Tạo mới </TD>
								...
								if (!(sanpham == null))
								{
									...
									{ 
										...
										<%}%>
												...
												<TD align="center"><%= sanpham.getString("donvi") %></TD>
												<%-- <TD align="center"><%= sanpham.getString("giabanlechuan") %></TD> --%>
												
												
												<TD align="center">		
												<input type='text' name='giablc' onkeyup="Dinhdang(this)" value="<%= sanpham.getString("giabanlechuan") %>" style="text-align: right"/>										
													 <%-- <input type='text' name='<%= sanpham.getString("id") %>' onkeyup="Dinhdang(this)" value="" style="text-align: right"/> --%>
													<input type='hidden' name='quycach_<%= sanpham.getString("id") %>' onkeyup="Dinhdang(this)" value="<%=sanpham.getString("quycach") %>" style="text-align: right"/>
													<input type='hidden' name='<%= sanpham.getString("id") %>' onkeyup="Dinhdang(this)" value="<%=sanpham.getString("id") %>" style="text-align: right"/>
