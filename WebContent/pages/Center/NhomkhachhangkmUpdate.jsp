<%@page import="geso.traphaco.center.beans.nhomkhachhangkm.INhomkhachhangkm"%>
	...
	<TR>
				...
				<TR>
					<TD align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mãi &gt; Khai báo &gt; Nhóm khách hàng khuyến mại &gt; Cập nhật</TD>
		...
		<TABLE width = 100% cellpadding = "4" cellspacing = "0" border = "0">
			...
			<TR>
            	...
            	<h1 style="font-size:0.8em"><a href="#">Chi nhánh / Đối tác</a></h1>
                ...
                <tr class="plainlabel" style="padding: 5px">
  				...
  				<h1 style="font-size:0.8em"><a href="#">DDKD</a></h1>
                    ...
                    <TR class="tbheader">
                        ...
                        <TH align="left" width="35%"> Chi nhánh / Đối tác </TH>
