...
<% IBanggiablcNppList obj = (IBanggiablcNppList)session.getAttribute("obj"); %>
...
<form name="bgmuanppForm" method="post" action="../../BanggiablcNppSvl">
			...
			<TR>
				<TD align="left" class="tbnavigation">
				  <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR height="22">
					  	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm > Áp bảng giá cho KH </TD>
						...
						<% 
							...
							while(bglist.next()){
							  ...
							  <%}%>
										...
										<TD align="center"><%= bglist.getString("ngaybatdau") %></TD>					
									...
									<%} %>
										...
										<TD align="center">
											...
											<A href = "../../BanggiablcNppUpdateSvl?userId=<%=userId%>&update=<%= bglist.getString("id") %>"><img src="../images/Edit.png" alt="Hiển thị" width="20" height="20" longdesc="Hiển thị" border = 0></A>
											<A href = "../../BanggiablcNppUpdateSvl?userId=<%=userId%>&copy=<%= bglist.getString("id") %>"><img src="../images/copy20.png" alt="Copy" width="20" height="20" longdesc="Copy" border = 0></A>
