...
<%@ page  import = "geso.traphaco.center.beans.congtacvien.ICongtacvienList" %>
		...
		<table  width="100%" cellpadding="0" cellspacing="1">
				...
				<tr>
				  <td align="left"><table  width="100%" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <tr height="20">
						   <td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Nền kinh doanh &gt; Cộng tác viên </td>
