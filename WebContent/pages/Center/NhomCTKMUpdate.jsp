...
<%@ page  import = "geso.traphaco.center.beans.nhomctkhuyenmai.INhomctkhuyenmai" %>
<%@ page  import = "geso.traphaco.center.beans.nhomctkhuyenmai.imp.Nhomctkhuyenmai" %>
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1"><%= nctkmBean.getMessage() %></textarea>
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">							
							<tr class="tbheader">
								...
								<th width="60%" align="left"> Diễn giải</th>
