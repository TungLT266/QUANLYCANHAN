...
<%	
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("TieuchithuongTDSvl","",userId);
%>
...
<form name="tcsku" method="post" action="../../TieuchithuongTDSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Chính sách bán hàng </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Chính sách bán hàng &nbsp;&nbsp;	   
                              <%if(quyen[0]!=0){ %>                      
                                ...
                                <% 
                                    ...
                                    while ( tieuchiSKU.next()){
                                        ...
                                        <%} else {%>
                                            <TR class= <%= darkrow%> >
                                        <%}%>
                                        		<TD><%= tieuchiSKU.getString("PK_SEQ")%></TD>
                                                <TD align="left"><%= tieuchiSKU.getString("TUNGAY") %></TD>                                   
                                                <TD><%= tieuchiSKU.getString("DENNGAY")%></TD>
												<TD><%= tieuchiSKU.getString("ghichu")%></TD>
