				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm > Bảng giá mua > Cập nhật</TD> 
				                  			...
				                  			<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
												...
												<% for(int i = 0; i < spList.size(); i++ ) { 
													...
													<TR>
														...
														<TD>
															<input type="text" style="width: 100%; text-align: right;" name="giaban" value="<%= sanpham.getGiaban() %>"  onkeyup="Dinhdang(this);" >
														</TD>
