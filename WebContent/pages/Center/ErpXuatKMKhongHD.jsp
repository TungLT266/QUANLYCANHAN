...
<%	
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("ErpXuatkmkhonghdSvl","",userId);
...
<form name="khtt" method="post" action="../../ErpXuatkmkhonghdSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation"> Quản lý bán hàng > Chức năng > Xuất khuyến mại không hóa đơn </TD>  
                        ...
                        <TR>
                            ...
                            <TABLE  width="100%" cellpadding="6" cellspacing="0">							 
                             ...
                             <TR>
                              ...
                              <TR>
                             	<TD width="20%" class="plainlabel" >Đối tác / ETC </TD>
								<TD class="plainlabel">
                        ...
                        <TR>
                            ...
                            <TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
                                <TR class="tbheader">
                                    ...
                                    <TH width="20%" align="center">Đối tác / ETC</TH>
                                    ...
                                    <TH width="20%" align="center">Người sửa</TH>
                         		...
                         		{ 
                         			while(csxRs.next())
                         			{
        		                        ...
        		                        <%} %>
                                                ...
                                                <TD align="center"><%= csxRs.getString("ngayghinhan")%></TD>                            
                                                ...
                                                <% if( tt.equals("0") ) { %>
                                                  <% if(quyen[2] == 1) { %>
							                   		<A href = "../../ErpXuatkmkhonghdUpdateSvl?userId=<%=userId%>&update=<%= csxRs.getString("pk_seq") %>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" longdesc="Cập nhật" border = 0></A> &nbsp;
							                   		<%} %>
							                   		<% if(quyen[4] == 1) { %>
							                   		<A href = "../../ErpXuatkmkhonghdSvl?userId=<%=userId%>&chot=<%= csxRs.getString("pk_seq") %>"><img src="../images/Chot.png" alt="Duyệt" width="20" height="20" longdesc="Duyệt" border=0 onclick="if(!confirm('Bạn Muốn Duyệt Hóa Đơn Này?')) return false;"></A>&nbsp;
							                   		<%} %>
							                   		<% if(quyen[1] == 1) { %>
													<A href = "../../ErpXuatkmkhonghdSvl?userId=<%=userId%>&delete=<%=csxRs.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xóa" width="20" height="20" longdesc="Xóa" border=0 onclick="if(!confirm('Bạn Muốn Xóa Hóa Đơn Này?')) return false;"></A>
													<%} %>
													
												<% } else { %>
												
													<A href = "../../ErpXuatkmkhonghdUpdateSvl?userId=<%=userId%>&display=<%= csxRs.getString("pk_seq") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
												
												
												<% System.out.println(" trang thai :"+ tt);
												if(!tt.equals("2")  ){%>
													<A href = "../../ErpInPhieuGiaoHangPdfSvl?userId=<%=userId%>&id=<%= csxRs.getString("pk_seq") %>"><IMG src="../images/Printer20.png" alt="In phiếu giao hàng" title="In phiếu giao hàng" border=0></A>&nbsp;
