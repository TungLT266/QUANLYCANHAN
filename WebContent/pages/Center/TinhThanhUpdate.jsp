...
<%@ page  import = "geso.traphaco.center.beans.tinhthanh.ITinhThanh" %>
...
<% ITinhThanh kvBean = (ITinhThanh)session.getAttribute("kvBean"); 
ResultSet qg = (ResultSet)kvBean.getQuocgia();%>
...
<form name='kvForm' method="post" action="../../TinhThanhUpdateSvl">
					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		Dữ liệu nền > Kinh doanh > Tỉnh thành > Cập nhật </TD>
						   ...
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
								  ...
								  <TD class="plainlabel"><SELECT name="quocgia">
									<%  try{
								  		while(qg.next()){								  			
								  			if (qg.getString("pk_seq").equals(kvBean.getMaQuocGia())){ %>								  			
									...
									<%-- <TR>
								    <TD width="20%" class="plainlabel">Tỉnh thành<FONT class="erroralert"> *</FONT></TD>
									...
									<%-- <TR>
										<TD width="20%" class="plainlabel">Quận huyện<FONT class="erroralert"> *</FONT></TD>
