...
<%@ page  import = "geso.traphaco.center.beans.nhomsptrungbay.*" %>
<%@ page  import = "geso.traphaco.center.beans.nhomsptrungbay.imp.*" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý trưng bày > Khai báo >Điều kiện trưng bày > Tạo mới
        </div>
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold" readonly="readonly" rows="1"><%= nsptbBean.getMessage() %></textarea>
           ...
           <TABLE width="100%" border="0" cellpadding="1" cellspacing="1" >
            ...
            <br>
               <a class="button" href="javascript:clearform()">
                   <img style="top: -4px;" src="../images/button.png" alt="">Nhap lai san pham </a>             
        </div>      
     </fieldset>	
    </div>
</div>
