...
<%@ page  import = "geso.traphaco.center.beans.dieukienkhuyenmai.imp.*" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý khuyến mại > Khai báo > Điều kiện khuyến mãi > Tạo mới
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> Điều kiện khuyến mại</legend>
          ...
          <%if(!dkkmBean.getType().equals("3")){ %>   
                ...
                <TR>
                    <TD class="plainlabel">Số lượng tính theo thùng</TD>
                    <TD class="plainlabel">
                    	<%if(dkkmBean.getIsThung().equals("1")){ %>
                        <input type="checkbox" name="isThung" id="isThung"  checked="checked" value="1"/>
                        <%}else { %>
                        <input type="checkbox" name="isThung" id="isThung"  value="1"/>
                        <%} %>
                     </TD> 
                </TR>  
            </TABLE>
           ...
           <%} else {%>
            <TR>
	                <TD class="plainlabel">Tổng tiền </TD>
	                    <% if(dkkmBean.getType().equals("1")){ %>
	                    	<TD class="plainlabel"><input type="text" name="tongtien" id="tongtien" value="<%= dkkmBean.getTongtien() %>"   readonly> VND</TD> 
	                    <%}else{ %>
	                    	<TD class="plainlabel"><input type="text" name="tongtien" id="tongtien" value="<%= dkkmBean.getTongtien() %>"   onkeypress="return keypress(event);"> VND</TD> 
	                    <%} %>
	                </TR> 
           <%} %>       
        </div>      
