...
<%@ page  import = "geso.traphaco.center.beans.thaydoikhuyenmai.*" %>
<%@ page  import = "geso.traphaco.center.beans.thaydoikhuyenmai.imp.*" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý khuyến mại > Thêm sản phẩm CTKM > Tạo mới
        </div>
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold" rows="1" style="width: 100%" readonly="readonly" readonly="readonly"><%= tdkmBean.getMsg() %></textarea>
		         <% tdkmBean.setMsg(""); %>
    	</fieldset>
  	</div>
