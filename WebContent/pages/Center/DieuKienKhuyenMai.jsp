...
<%@ page  import = "geso.traphaco.center.beans.dieukienkhuyenmai.*" %>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý khuyến mãi &#62; Khai báo &gt; Điều kiện khuyến mãi
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                 
                    <TR>
                        <TD class="plainlabel" valign="middle" width="10%">Diễn giải </TD>
                        <TD class="plainlabel" valign="middle" width="25%">
                            <input type="text" name="diengiai" value="<%= obj.getDiengiai() %>">
                        </TD>
                        <TD class="plainlabel" valign="middle" width="10%">Mã điều kiện </TD>
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Điều kiện khuyến mãi </span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                    ...
		                    <%if((m%2)== 0) {%>
		                         ...
		                         <%} %>
				                    ...
				                    <TD align="center"> 
		                                ...
		                                <A href = "../../DkkhuyenmaiUpdateSvl?userId=<%=userId%>&update=<%= dkkmList.getString("dkkmId") %>"><IMG src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" border=0></A>&nbsp;
		                               	<%} %>
		                               	<%if(quyen[Utility.XOA]!=0){ %>
		                                <A href = "../../DieukienkhuyenmaiSvl?userId=<%=userId%>&delete=<%= dkkmList.getString("dkkmId") %>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa điều kiện khuyến mại này?')) return false;"></A>									
				                    	<%} %>
				                    </TD>
				                </TR>
		                     <% m++; }} %>														
