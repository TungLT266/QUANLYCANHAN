			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">		
					...
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   ...
						   Báo cáo quản trị > Theo dõi thành tích > Yếu tố nền tảng Trình dược viên</TD>
				...
				<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1">
	    					<%=loi%>
	    				</textarea>
						</FIELDSET>
				   </TD>
