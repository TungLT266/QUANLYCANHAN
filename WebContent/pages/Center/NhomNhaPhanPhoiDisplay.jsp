...
<%@ page  import = "geso.traphaco.center.beans.nhomnhaphanphoi.imp.NhomNhaPhanPhoi" %>
<%@ page  import = "geso.traphaco.center.beans.nhomnhaphanphoi.INhomNhaPhanPhoi" %>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu &gt; Dữ liệu nền kinh doanh  &gt; Nhóm Chi nhánh / Đối tác > Hiển thị</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1"><%=nnppBean.getMsg()%></textarea>
						<% nnppBean.getMsg(); %>
						</FIELDSET>
				   </TD>
				</tr>			
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Thông tin nhóm Chi nhánh / Đối tác </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR  style="display:none;">
                              ...
                              <% if (nnppBean.getLoainhom().equals("1")){ %>                                
                                	<OPTION value="1" selected >Nhóm Chi nhánh / Đối tác</OPTION>
                                	<OPTION value="2" >Chi nhánh / Đối tác </OPTION>
                              <%}else{ %>
                                	<OPTION value="1" >Nhóm Chi nhánh / Đối tác</OPTION>
                                	<OPTION value="2" selected>Chi nhánh / Đối tác</OPTION>
							  <%} %>                              
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4" >							
								...
								<%}else{ %>
									...
									<TH width="10%">Mã Chi nhánh / Đối tác</TH>
