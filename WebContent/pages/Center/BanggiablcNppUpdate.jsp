				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt; Dữ liệu nền sản phẩm > Áp bảng giá cho KH > Cập nhật</TD> 
			...
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
						    ...
						    <TD width="30" align="left" >
						    	<A href="javascript:excelform()" ><IMG src="../images/excel.gif" title="Xuat file Excel" alt="Xuat file Excel" border = "1"  style="border-style:outset"></A>
						    </TD>
							<TD >&nbsp; </TD>						
						</TR>
					</TABLE>
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                   ...
		                   <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="chietkhau" value="<%=obj.getCk() %>"  maxlength="10" onchange="thaydoichietkhau(this);" > 
		                        </TD>
										...
										<div>
				                  			...
				                  			<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
												...
												<% if(sanphamRs != null) { 
													...
													{ %>
														<tr <%if(Float.parseFloat(spChietkhau.get(sanphamRs.getString("pk_seq"))) != 0) {%>class="tbdarkrow"<%}else{ %>class="tblightrow"<%} %> >
															<td>
															...
															<td style="text-align: right;"><%= formatter.format(sanphamRs.getDouble("gblc")) %></td>
															<td>
