...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý trưng bày > Khai báo > Chương trình trưng bày > Cập nhật
        </div>
                 ...
                 <TR>
                    ...
                    <TR>
                        ...
                        <% if(cttbBean.getType().equals("2")){ %>
                            <input type="checkbox" value="2" name="type" id ="ckType" checked>Từ ngày kết thúc tính doanh số đến ngày kết thúc trưng bày
                        <%}else{ %>
                        	<input type="checkbox" value="2" name="type" id ="ckType">Từ ngày kết thúc tính doanh số đến ngày kết thúc trưng bày
                        <%} %> 
                        </TD>
                    </TR>
                        ...
                        <TD class="plainlabel" colspan=3>
                        	<% System.out.println("Gia tri dang ky them la: " + cttbBean.isDangkythem());  
                          	if(cttbBean.isDangkythem().equals("1")){ %>
                          		<input type="checkbox" name="isDkthem" checked="checked"><i> Cho phép đăng ký thêm.</i>
                          	<%} else{ %>
                          		<input type="checkbox" name="isDkthem"><i> Cho phép đăng ký thêm.</i>
                          	<%} %>
                          	
                          	&nbsp;&nbsp;&nbsp;
                          	
                        	<% if(cttbBean.isTinhdoanhso().equals("1")){ %>
                        		<input type="checkbox" name = "isTinhds" value="1" checked="checked"><i> Đăng ký khi phát sinh doanh số </i> 
                        	<% } else { %>
                        		<input type="checkbox" name = "isTinhds" value="0"><i> Đăng ký khi phát sinh doanh số </i> 
                         	<% } %>
                        </TD>
                    </TR>	
                    <tr>
