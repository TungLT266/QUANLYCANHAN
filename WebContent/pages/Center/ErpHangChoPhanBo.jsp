						...
						<table cellpadding="0px" cellspacing="1px" width="100%">
							...
							<tr>
								...
								<td align="center">
									...
									<DIV id="subcontent_<%=count%>" style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 350px; max-height: 300px; overflow: auto; padding: 4px;">
											...
											<table width="95%" align="center">
												<%
						                        	...
						                        	if(rsLO != null)
						                        	{
						                        		...
						                        		while( rsLO.next()  )
						                        		{
						                        			String key = spMa[i] + "__" + rsLO.getString("solo");
												...
												<tr>
													<td width="100px" >
														<input type="hidden" style="width: 100%; text-align: right;" name="dong<%=count%>_spSOLUONG" value="0" onkeyup="Dinhdang(this);">
													...
													<td width="100px" style="text-align: center;" >
														<input type="checkbox"  name="<%= spMa[i] %>_spCHON" value="<%= rsLO.getString("solo") %>" <%= selected %> >
													</td>
												</tr>
