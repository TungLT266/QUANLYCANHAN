					...
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <% if(obj.getPhanloai().equals("0")) { %>
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích lũy > Cập nhật</TD> 
						 <% } else if(obj.getPhanloai().equals("1")) { %>
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích điểm > Cập nhật</TD> 
						 <% } else { %>
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý trưng bày > Khai báo > Chương trình trưng bày > Cập nhật</TD> 
						 <% } %>
