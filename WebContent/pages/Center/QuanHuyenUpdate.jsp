...
<%@ page  import = "geso.traphaco.center.beans.quanhuyen.IQuanHuyen" %>
...
<% IQuanHuyen kvBean = (IQuanHuyen)session.getAttribute("kvBean"); %>
...
<form name='kvForm' method="post" action="../../QuanHuyenUpdateSvl">
					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		Dữ liệu nền > Kinh doanh > Quận huyện > Cập nhật </TD>
