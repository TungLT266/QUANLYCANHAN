	...
	<form name="frm" method="post"
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Chỉ số thành tích</legend>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
									...
									if(obj.gettype().equals("1")){ %>
										<input type="radio" id="xemtheo" name="xemtheo" onchange="LayTheoNgay();" value="0" />Ngày &nbsp;&nbsp;&nbsp;
									...
									<%} else { %> 
										<input type="radio" id="xemtheo" name="xemtheo" onchange="LayTheoNgay();" value="0" checked="checked"  />Ngày &nbsp;&nbsp;&nbsp;
										<!-- <input type="radio" id="xemtheo" name="xemtheo" onchange="LayTheoTuan();" value="2" />Tuần &nbsp;&nbsp;&nbsp;
										<input type="radio" id="xemtheo" name="xemtheo" onchange="LayTheoThang();" value="1"  />Tháng -->
									<%} %>
									</TD>
