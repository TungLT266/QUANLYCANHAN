				...
				<TR>
					<TD width="100%" align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&#160; Quản lý kho chi nhánh &#62; Báo cáo &#62; Tồn kho hiện tại </TD>
					...
					<TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
						<TR>
							...
							<TABLE  width="100%" cellpadding="6px" cellspacing="0px">
								...
								<TD class="plainlabel">Date </TD>
										<TD class="plainlabel" >
											<select name="date" style="width:250px">
												<option value="0" >All</option>
												<option value="1" >Cận Date</option>
												<option value="2" >Hết Date</option>
											</select>
										</TD>
