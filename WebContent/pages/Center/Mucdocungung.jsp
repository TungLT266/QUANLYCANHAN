...
<%@ page  import = "geso.traphaco.center.beans.baocao.IMucdocungunghang" %>
<%@ page  import = "geso.traphaco.center.beans.baocao.imp.Mucdocungunghang" %>
									...
									<TD width="98%">
										<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
											<TR class="tbheader">
												...
												<TH width="12%">Chi nhánh / Đối tác</TH>
												<TH width="12%">Loại</TH>
											</TR>
								<% 
									int m = 0;
