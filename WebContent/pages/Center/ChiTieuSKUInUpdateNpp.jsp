...
<%@page import="geso.bibica.distributor.beans.chitieunpp.*"%>
<%@page import="geso.bibica.distributor.beans.chitieunpp.imp.*"%>
<%@page import="java.util.Calendar"%>
<%@page import="java.util.Date"%>
<%@page import="javax.xml.crypto.Data"%>
<%@ page  import = "java.util.Iterator" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.bibica.center.util.*" %>
								...
								<TD class="plainlabel">
									...
									<%
  										int k=1;
  																for(k=1; k <= 12; k++ )
  																{
  																	System.out.println(obj.getQuy());
  																  if(obj.getQuy().equals(String.valueOf(k)) ) {
  									%>
