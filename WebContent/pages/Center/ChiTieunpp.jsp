            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    ...
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp; Quản lý chỉ tiêu &gt; Chỉ tiêu nhân viên OTC</TD>  
                    ...
                    <TABLE border="0" width="100%" cellpadding="0" cellspacing="0">
                        <TR>
                            ...
                            <TABLE  width="100%" cellpadding="6" cellspacing="0">
                             <TR>
                             <TD width="15%" class="plainlabel" >Quý &nbsp;&nbsp;  <FONT class="erroralert"> </FONT></TD>
								<TD class="plainlabel">
                                ...
                                <% 
                                    ...
                                    while (m < size){
                                        ...
                                        <%} else {%>
                                            <TR class= <%= darkrow%> >
                                        <%}%>
                                                <TD align="left"><div align="left"><%=ct.getQuy()%></div></TD>                                   
                                                ...
                                                <TD align="center">
                                                    ...
                                                    <TR>
                                              		   <TD>
                                              		   <%if(quyen[3]!=0){ %>
                                                        <A href = "../../ChiTieuNewnppSvl?userId=<%=userId%>&display=<%=ct.getID()%>&loaict=<%=loaichitieu%>"><img src="../images/Display20.png" alt="Hien thi" title="Hiển thị" width="20" height="20" title="Hiển thị" border = 0></A>
                                                     	<%} %>
                                                     </TD>
                                                    <%
                                                    ...
                                                    <TD>
                                                    <%if(quyen[2]!=0){ %>
                                                        <A href = "../../ChiTieuNewnppSvl?userId=<%=userId%>&update=<%=ct.getID()%>&loaict=<%=loaichitieu%>"><img src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" width="20" height="20" title="Cập nhật" border = 0></A>
                                                    <%} %>
                                                    </TD>
                                                   
                                                    <TD>
                                                    <%if(quyen[1]!=0){ %>
                                                        <A href = "../../ChiTieunppTTSvl?userId=<%=userId%>&delete=<%=ct.getID()%>&loaict=<%=loaichitieu%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" title="Xóa" border=0 onclick="if(!confirm('Bạn chắc chắn muốn xóa chỉ tiêu này?')) return false;"></A></TD>
                                                     <%} %>
                                                     <TD>
                                                     <%if(quyen[4]!=0){ %>
                                                        <A href = "../../ChiTieunppTTSvl?userId=<%=userId%>&chot=<%=ct.getID()%>&loaict=<%=loaichitieu%>"><img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt chỉ tiêu" border = 0></A>
                                                    <%} %>
                                                     </TD>
                                                     <%}else{ %>
                                                     ...
                                                     <TD>
                                                     <%if(quyen[4]!=0){ %>
                                                        <A href = "../../ChiTieunppTTSvl?userId=<%=userId%>&unchot=<%=ct.getID()%>&loaict=<%=loaichitieu%>"><img src="../images/unChot.png" alt="Hien thi" width="20" height="20" title="Tháo chốt" border = 0></A>
                                                     <%} %>
                                                     </TD>
                                                    <%}%>
