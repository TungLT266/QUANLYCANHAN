...
<%	
	...
	IUploadLuongCoBan obj=(UploadLuongCoBan)session.getAttribute("obj");	
...
<form name="bgstForm" method="post" action="../../UploadLuongCoBanSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    ...
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;  Upload Lương Cơ Bản </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Upload Lương Cơ bản &nbsp;&nbsp;	   
                            <%if(quyen[0]!=0) {%>                        
                                        ...
                                        <%}%>
                                                ...
                                                <TD align="center">
                                                    ...
                                                    <TR>
                                              		   <TD>
                                              		   <%if(quyen[3]!=0){ %>
                                                        <A href = "../../UploadLuongCoBanNewSvl?userId=<%=userId%>&display=<%=luongkhacRs.getString("PK_SEQ")%>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%
                                                    ...
                                                    <TD>
                                                    	<%if(quyen[2]!=0) {%>
                                                        <A href = "../../UploadLuongCoBanNewSvl?userId=<%=userId%>&update=<%=luongkhacRs.getString("PK_SEQ")%>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" title="Cập nhật" border = 0></A>
                                                    	<%} %>
                                                    </TD>
                                                    <TD>
                                                   		<%if(quyen[1]!=0) {%>
                                                        <A href = "../../UploadLuongCoBanSvl?userId=<%=userId%>&delete=<%=luongkhacRs.getString("PK_SEQ")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" title="Xóa" border=0 onclick="if(!confirm('Bạn chắc chắn muốn xóa chỉ tiêu này?')) return false;"></A></TD>
                                                     	<%} %>
                                                     <TD>
                                                     	<%if(quyen[4]!=0) {%>
                                                        <A href = "../../UploadLuongCoBanSvl?userId=<%=userId%>&chot=<%=luongkhacRs.getString("PK_SEQ")%>"><img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt chỉ tiêu" border = 0></A>
                                                     	<%} %>
                                                     </TD>
                                                     <%}else{ %>
                                                     ...
                                                     <TD>
                                                     	<%if(quyen[4]!=0) {%>
                                                        <A href = "../../UploadLuongCoBanSvl?userId=<%=userId%>&unchot=<%=luongkhacRs.getString("PK_SEQ")%>"><img src="../images/unChot.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%}%>
                                                    </TR></TABLE>
