            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm > Bảng giá mua  </TD>  
										...
										<TD align="center">
											...
											<TD>
												...
												<A href = "../../BangGiaSvl?userId=<%=userId%>&copy=<%= bglist.getString("pk_seq") %>"><img src="../images/copy20.png" alt="Cap nhat" title="Copy bảng giá" width="20" height="20" longdesc="Copy bảng giá" border = 0></A>
													<A href = "../../BangGiaUpdateSvl?userId=<%=userId%>&edit=<%= bglist.getString("pk_seq") %>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A>
												<%}
