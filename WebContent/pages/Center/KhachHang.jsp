...
<%@ page  import = "geso.traphaco.center.beans.khachhang.*" %>
                                    ...
                                    <%} else {%>
                                    	...
                                    	<%}%>
											...
											<TABLE border = 0 cellpadding="0" cellspacing="0">
												...
												<TD>
												<%-- <%if(quyen[Utility.THEM]!=0){ %> --%>
													<A href = "../../KhachhangUpdateTTSvl?userId=<%=userId%>&update=<%=khlist.getString("khId") %>"><img src="../images/Display20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>
												<%-- <%} %> --%>
												</TD>
												<TD>&nbsp;</TD>
												<TD>
