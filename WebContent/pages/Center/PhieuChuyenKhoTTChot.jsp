<%@page import="geso.traphaco.center.beans.phieuchuyenkhott.imp.PhieuChuyenKhoTT_SanPham"%>
<%@page import="geso.traphaco.center.beans.phieuchuyenkhott.IPhieuChuyenKhoTT_SanPham"%>
<%@page import="geso.traphaco.center.beans.phieuchuyenkhott.IPhieuChuyenKhoTT"%>
<%@page import="geso.traphaco.center.beans.phieunhapkhott.imp.PhieuNhapKhoTT_SanPham"%>
<%@page import="geso.traphaco.center.beans.phieunhapkhott.imp.PhieuNhapKhoTT"%>
					...
					<TR height="22">
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%"  rows="2"   title="" ><%=  dhBean.getMessage()%> </textarea>
									</FIELDSET>
							   </TD>
								</tr>
								<TR>
