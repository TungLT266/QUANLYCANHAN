...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Chức năng > Xuất hóa đơn > Tạo mới
        </div>
			                            	...
			                            	<%
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			while(spRs.next())
				                        			{
				                        				...
				                        				String temID = spId[i] + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN")+ "__" + spRs.getString("VITRI");
				                        			%>
				                        			...
				                        			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="<%= spMa[i] %>_spVITRI" value="<%= spRs.getString("VITRI") %>" readonly="readonly">
				                        				</td>
				                        				<td>
