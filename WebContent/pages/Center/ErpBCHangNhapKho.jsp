...
<%@ page  import = "geso.traphaco.center.beans.baocao.*" %>
...
String url="";
url = util.getUrl("ErpBCHangnhapSvl",""); %>
...
<div id="main" style="width:100%; padding-left:2px">
    ...
    <div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror" style="background-color: white; width: 100%;color: red" readonly="readonly" rows="1" readonly="readonly"><%= obj.getMsg() %></textarea>
		         <% obj.setMsg(""); %>
    	</fieldset>
  	</div>
