...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BCBanHangTDV">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý chỉ tiêu > Báo cáo > Thực hiện chỉ tiêu của Trình dược viên</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle"> Thực hiện chỉ tiêu của Trình dược viên</legend>
