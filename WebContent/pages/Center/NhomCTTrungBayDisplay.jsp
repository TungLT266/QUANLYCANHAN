...
<%@ page  import = "geso.traphaco.center.beans.nhomcttrungbay.INhomCTTrungBay" %>
<%@ page  import = "geso.traphaco.center.beans.nhomcttrungbay.imp.NhomCTTrungBay" %>
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1"><%= ncttbBean.getMsg()%></textarea>
							<% ncttbBean.setMsg(""); %>
						</FIELDSET>
				   </TD>
				</tr>			
