...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > <%= lsxBean.getLoaidonhang().equals("2") ? "Đơn hàng bán" : "Bán nguyên vật liệu" %> > Hiển thị
        </div>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<td> 
									<input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 70%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" onchange="submitform();" > 
								...
								<td>
								 <input type="text" name="spvat" value="<%= spVat[i] %>" style="width: 50%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" readonly="readonly" <%= readonly ? "readonly" : "" %> > 
					...
					<% for(int i = count; i < 0; i++) { %>
						...
						<tr>
							...
							<td>
							 <input type="text" name="spvat" value="" style="width: 50%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" readonly="readonly" > 
							  <input type="checkbox" name="is_khongthue1"  id = "is_khongthue_<%=i %>" value="" style="width: 20%" disabled>
