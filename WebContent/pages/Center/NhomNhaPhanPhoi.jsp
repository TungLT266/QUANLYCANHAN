...
<%@ page import="geso.traphaco.center.beans.nhomnhaphanphoi.INhomNhaPhanPhoiList"%>
...
<% obj.setNextSplittings(); 
	int[] quyen = new  int[6];
	quyen = util.Getquyen("NhomNhaPhanPhoiSvl","",userId);
						...
						<TR>
							<TD align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt; Dữ liệu nền kinh doanh &gt;Nhóm Chi nhánh / Đối tác</TD>
 ...
 %>
																		...
																		<TD>
																			...
																			%> <A href="../../NhomNhaPhanPhoiSvl?userId=<%=userId%>&delete=<%=npplist.getString("id")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0
																				onclick="if(!confirm('Bạn muốn xóa nhóm Chi nhánh / Đối tác này?')) return false;"></A>
																				<%
																			}
																		%>
																		</TD>
