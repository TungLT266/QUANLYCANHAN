...
<%@ page  import = "geso.traphaco.center.beans.trakhuyenmai.imp.*" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý khuyến mại > Khai báo > Trả khuyến mại > Tạo mới
        </div>
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold" rows="1" style="width: 100%" readonly="readonly" readonly="readonly"><%= trakmBean.getMessage() %></textarea>
                ...
                <TABLE width="100%" cellpadding="6" cellspacing="0">								
                    ...
                    <% if(trakmBean.getType().equals("1")){ %>
	                    <TR>
	                        ...
	                        <TD class="plainlabel"><input type="text" name="tongtien" id="tongtien" value="<%= trakmBean.getTongtien() %>" style="text-align:right" style="width:95%" onkeypress="return keypress(event);"> VND</TD> 
	                    </TR>
                    <%}else{ if(trakmBean.getType().equals("2")){ %>
	                   	<TR>
...
<%
 if(trakmBean!=null)trakmBean.DBClose();
%>