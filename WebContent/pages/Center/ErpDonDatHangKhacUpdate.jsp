...
<script language="javascript" type="text/javascript">
	...
	function changescheme()
	{
	 ...
	 function TinhTien()
	 {
		...
		tongtienCK = 0;
		var a = DinhDangTien(tongtienBVAT);
		document.getElementById("txtBVAT").value = DinhDangTien(tongtienBVAT);
		var b = document.getElementById("txtBVAT").value;
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<% for(int i = count; i < 50; i++) { %>
						...
						<tr>
							...
							<td > <input type="text" name="dongia" value="0" style="width: 100%; text-align: right;"  >  </td>
							...
							<td > <input type="text" name="spvat" value="0" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);"  > </td>
							<td > <input type="text" name="thanhtien" value="0" style="width: 100%; text-align: right;" readonly="readonly" > </td>
