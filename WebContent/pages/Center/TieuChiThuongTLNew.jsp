					...
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <% if(obj.getPhanloai().equals("0")) { %>
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích lũy > Tạo mới</TD> 
						 ...
						 <% } else { %>
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý trưng bày > Khai báo > Chương trình trưng bày > Tạo mới</TD> 
						 <% } %>
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						  ...
						  <TR>
								<TD width="120px" class="plainlabel" >Ngày trưng bày <br />&nbsp;&nbsp;&nbsp;&nbsp; Từ ngày<FONT class="erroralert"> *</FONT></TD>
								<TD width="250px" class="plainlabel" >
									<input type="text" name="ngaytb_tungay" class="days" value="<%= obj.getNgayTB_Tungay() %>" readonly="readonly" >
								</TD>
						  	  	<TD width="120px" class="plainlabel" >Đến ngày<FONT class="erroralert"> *</FONT></TD>
								<TD class="plainlabel" >
									<input type="text" name="ngaytb_denngay" class="days" value="<%= obj.getNgayTB_Denngay() %>" readonly="readonly" >
								</TD>
						  </TR>
						  <% } %>
						  <TR>
		                        <TD class="plainlabel" >Giờ bắt đầu </TD>
		                        <TD class="plainlabel">
		                            <input type="text" name="giobatdau" value="<%= obj.getGiobatdau() %>" style="text-align: right;" />
		                        </TD>
		                   
		                        <TD class="plainlabel" >Giờ kết thúc </TD>
		                        <TD class="plainlabel" colspan="3" >
		                            <input type="text" name="gioketthuc" value="<%= obj.getGioketthuc() %>" style="text-align: right;" />
		                        </TD>
		                  </TR>
						  <TR>
						  	  	...
						  	  	<TD class="plainlabel">Ngân sách phân bổ </TD>
						  	  	<TD class="plainlabel" >
						  	  		<select name="httt" >
						  	  			<% if(obj.getHTTT().equals("0")) { %>
						  	  				<option value="0" selected="selected" >Theo từng mức</option>
						  	  			<% } else { %>
						  	  				<option value="0"  >Theo từng mức</option>
						  	  			<% } %>
						  	  			<% if(obj.getHTTT().equals("1")) { %>
						  	  				<option value="1" selected="selected" >Không giới hạn ngân sách</option>
						  	  			<% } else { %>
						  	  				<option value="1"  >Không giới hạn ngân sách</option>
						  	  			<% } %>
						  	  		</select>
						  	  	</TD>
						  </TR>
...
<%-- 						  	  		<% } %> --%>
						  ...
						  <tr>
									...
									<TD class="plainlabel">Ghi chú</TD>
							  	  	<TD class="plainlabel" colspan="2">
							  	  		...
							  	  		<% if(obj.getChiavaodongia().equals("1")) { %>
							  	  			<input name="chiavaodongia" type="checkbox" value="1" checked="checked" > Chia vào đơn giá
							  	  		<% } else { %>
							  	  			<input name="chiavaodongia" type="checkbox" value="1" > Chia vào đơn giá
							  	  		<% } %> --%>
		                    ...
		                    <tr>
		                        ...
		                        <TD class="plainlabel" colspan="2" >
		                        	<% if(obj.getPhaidangky().equals("1")) { %>
						  	  			<input name="phaidangky" type="checkbox" value="1" checked="checked" > Bắt buộc đăng ký
						  	  		<% } else { %>
						  	  			<input name="phaidangky" type="checkbox" value="1" > Bắt buộc đăng ký
						  	  		<% } %>
						  	  		
						  	  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  	  		<% if(obj.getKhongcanduyettraTL().equals("1")) { %>
						  	  			<input name="khongcanduyettra" type="checkbox" value="1" checked="checked" > Không cần duyệt trả TL
						  	  		<% } else { %>
						  	  			<input name="khongcanduyettra" type="checkbox" value="1" > Không cần duyệt trả TL
						  	  		<% } %>
		                        </TD>
		                    </tr>
						...
						<% } else if(obj.getPhanloai().equals("1")) { %>
							<li <%=obj.getActiveTab().equals("0") ? "class='current'" : "" %>><a href="#tab1">Điểm tính thưởng</a></li>
						<% } else {  %>
							<li <%=obj.getActiveTab().equals("0") ? "class='current'" : "" %>><a href="#tab1">Tiêu chí trưng bày</a></li>
						<% } %>
						
						<% if(obj.getPhanloai().equals("0") ) { %>
							<li <%=obj.getActiveTab().equals("1") ? "class='current'" : "" %>><a href="#tab2">Sản phẩm mua</a></li>
						<% } else if(obj.getPhanloai().equals("1") ) { %>
							<li <%=obj.getActiveTab().equals("1") ? "class='current'" : "" %>><a href="#tab2">Công thức tích điểm</a></li>
						<% } else { %>
							<li <%=obj.getActiveTab().equals("1") ? "class='current'" : "" %>><a href="#tab2">Sản phẩm trưng bày</a></li>
						<% } %>			
									
							<li <%=obj.getActiveTab().equals("2") ? "class='current'" : "" %>><a href="#tab3">Phân bổ</a></li>
							<li <%=obj.getActiveTab().equals("3") ? "class='current'" : "" %>><a href="#tab4">KH đăng ký</a></li>
						</ul>
						...
						<div class="panes">
							...
							<div id="tab1" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    <TR class="tbheader">
				                        <% if(!obj.getPhanloai().equals("2")) { %>
				                        	<TH align="center" width="25%" rowspan="2" >Mức tích lũy</TH>
				                        <% } else { %>
				                        	<TH align="center" width="25%" rowspan="2" >Mức trưng bày</TH>
				                        <% } %>
				                         <TH align="center" width="5%" rowspan="2" >Ngân sách phân bổ</TH>
				                        <% if(obj.getPhanloai().equals("0")) { %>
				                        <TH align="center" width="10%" rowspan="2" >Tiến độ</TH>
				                        <% } %>
				                        
				                        <% if( obj.getPhanloai().equals("0")) { %>
				                        <TH align="center" width="20%" colspan="2" >Doanh số phát sinh</TH>
				                        <% } else if( obj.getPhanloai().equals("1")) { %>
				                        <TH align="center" width="20%" colspan="2" >Điểm tính thưởng</TH>
				                        <% } else { %>
				                        <TH align="center" width="20%" colspan="1" >Doanh số phát sinh</TH>
				                        <% } %>
				                        
				                        <% if(!obj.getPhanloai().equals("2")) { %>
				                        	<td align="center" width="15%" rowspan="2" >Trả tích lũy</td>
				                        <% } else { %>
				                        	<td align="center" width="15%" rowspan="2" >Trả trưng bày</td>
				                        <% } %>
				                    ...
				                    <%
				                    	...
				                    	if( diengiaiMuc != null ) 
				                    	{
				                    		for(int i = 0; i < diengiaiMuc.length; i++)
				                    		{
												...
												<tr>
													<td>
														<input type="text" name="diengiaiMuc" value="<%= diengiaiMuc[i] %>" readonly="readonly"  >
													</td>
														<TD>
												  	  		<select name="httt1" >
												  	  			<% 
													...
													<td align="center" >
														<a class="muc<%= i %>" href="#">
						                        			<img style="top: -4px;" src="../images/vitriluu.png" title="Tiến độ cần thực hiện"></a>
										                  <div style='display:none'>
									                        <div id='muc<%= i %>' style='padding:0px 5px; background:#fff;'>
									                                	...
									                                	<td colspan="2">
									                                		<table align="left" cellpadding="0" cellspacing="1">
										                                		<tr class="tbheader">
										                                			...
										                                			<td width="100px" align="center" ><span style="font-size: 0.9em">Từ ngày</span></td>       			
										                                			<td width="100px" align="center" ><span style="font-size: 0.9em">Đến ngày</span></td>
										                                			<td width="100px" align="center" ><span style="font-size: 0.9em">Phải đạt ( % )</span></td>
										                                		</tr>
										                                		<%
										                                			int count2 = 0;
										                                			...
										                                			{ 
										                                				...
										                                				%>
										                                					...
										                                					<tr>
													                                			<td>
													                                				<input type="text" value="Tiến độ <%= count2 + 1 %>" name="muc<%= i %>.tiendo" style="width: 100%;" readonly="readonly"  >
													                                			</td>
													                                			<td>
													                                				<input type="text" value="<%= info[k].split("_")[0] %>" name="muc<%= i %>.tiendoTUNGAY" style="width: 100%;" class="days" readonly="readonly" >
													                                			</td>
													                                			<td>
													                                				<input type="text" value="<%= info[k].split("_")[1] %>" name="muc<%= i %>.tiendoDENNGAY" style="width: 100%;" class="days" readonly="readonly" >
													                                			</td>
													                                			<td>
													                                				<input type="text" value="<%= info[k].split("_")[2] %>" name="muc<%= i %>.tiendoPHAIDAT" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" >
													                                			</td>
													                                		</tr>
										                                		...
										                                		<tr>
										                                			<td>
										                                				<input type="text" value="Tiến độ <%= j + 1 %>" name="muc<%= i %>.tiendo" style="width: 100%;" readonly="readonly"  >
										                                			</td>
										                                			<td>
										                                				<input type="text" value="" name="muc<%= i %>.tiendoTUNGAY" style="width: 100%;" class="days" readonly="readonly" >
										                                			</td>
										                                			<td>
										                                				<input type="text" value="" name="muc<%= i %>.tiendoDENNGAY" style="width: 100%;" class="days" readonly="readonly" >
										                                			</td>
										                                			<td>
										                                				<input type="text" value="" name="muc<%= i %>.tiendoPHAIDAT" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" >
										                                			</td>
										                                		</tr>
										                                		<% } %>
										                                	</table>
													...
													<% } else { %>
														<td>
															<input type="text" name="tumuc" value="<%= tumuc[i] %>" style="text-align: right;" onkeyup="FormatNumber(this);" onkeypress="return keypress(event);" >
															<input type="hidden" name="denmuc" value="99999999999" style="text-align: right;" onkeyup="FormatNumber(this);" onkeypress="return keypress(event);" >
														</td>
													<% } %>
														...
														<a class="sanphamTRA<%= i %>" href="#">
											                ...
											                <div style='display:none; '>
										                        <div id='sanphamTRA<%= i %>' style='padding:0px 5px; background:#fff;'>
																	...
																	<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
										                            <tr>
									                                	<td width="150px" valign="top" align="left"><span style="font-size: 12px">Hình thức</span></td>
									                                    <td valign="top" align="left">
										                                    <select name="sanphamTRA<%= i %>.hinhthuc" id="hinhthuctra" style="width: 200px;" >
										                                				...
										                                				%>
										                                					...
										                                					<tr>
													                                			<td width="100px" align="center">
													                                				<input type="text" value="<%= info2[0] %>" style="width: 100px" name="sanphamTRA<%= i %>.masanpham" 
													                                						onkeyup="ajax_showOptions(this,'abc',event)" AUTOCOMPLETE="off">
													                                			</td>
													                                			<td width="300px" align="left">
													                                				<input type="text" value="<%= info2[1] %>" name="sanphamTRA<%= i %>.tensanpham" style="width: 300px" readonly="readonly">
													                                			</td>                   			
													                                			<td width="100px" align="left">
													                                				<input type="text" value="<%= info2[2].trim() %>" name="sanphamTRA<%= i %>.soluong" style="width: 100px; text-align: right;" onkeypress="return keypress(event);" >
													                                			</td>
													                                		</tr>
				                    	...
				                    	if(Mucphanbo == null)
				                    		Mucphanbo = new String[]{"0","0","0","0","0"};
			                    		...
			                    		{                 			
			                    			...
			                    			<tr>
												<td>
													<input type="text" name="diengiaiMuc" value="Mức <%= ( i + 1 ) %>" readonly="readonly"  >
												</td>
												<TD>
												  	  		<select name="httt1" >
												  	  			<% if(Mucphanbo[i].equals("0")) { %>
							...
							<div id="tab2" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
									...
									<tr>
				                		<td style="font-size: 12px; padding: 8px; " colspan="6" >Nhóm sản phẩm &nbsp;&nbsp;   
				                    		...
				                    		while(nppRs.next())
				                    		{
				                    			...
				                    			if(obj.getMucNPP().equals("0"))
				                    			{
				                    				...
				                    				if(obj.getMucNPP().equals("1"))
				                    				{
				                    					...
				                    					System.out.println("Muc "+obj.getMucNPP());
				                    					System.out.println("So luong phan bo "+soluongPHANBO);
				                    					System.out.println("Page slphanbo "+phanbo2.get(nppRs.getString("pk_seq")));
				                    			%>
				                    			...
				                    			<tr>
				                    				...
				                    				<td>
				                    					...
				                    					<input type="hidden" name="mucnpp1" value="<%= obj.getMucNPP() %>"  >
				                    				...
				                    				<td align="center">
				                    				<input type="hidden" name="nppIds1" value="<%=obj.getNppIds1()%>"  >
				                    				<input type="hidden" name="nppIds2" value="<%=obj.getNppIds2()%>"  >
				                    				<input type="hidden" name="nppIds3" value="<%=obj.getNppIds3()%>"  >
				                    				<input type="hidden" name="nppIds4" value="<%=obj.getNppIds4()%>"  >
				                    				<input type="hidden" name="nppIds5" value="<%=obj.getNppIds5()%>"  >
				                    					<% if(obj.getMucNPP().equals("0"))
							...
							<div id="tab4" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    <TR class="tbheader">
				                        <td align="center" width="25%">Nhà phân phối</td>
				                    	<td align="center" width="15%">Mã khách hàng</td>
				                    	<td align="center" width="40%">Tên khách hàng</td>
				                    	<td align="center" width="10%">Đăng ký</td>
				                    	<td align="center" width="10%">Duyệt <input type="checkbox" name="checkAll" id="checkAll" onchange="SelectALL();" > </td>
				                    </TR>
				                </TABLE>
							</div>
