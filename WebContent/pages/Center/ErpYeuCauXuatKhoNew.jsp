							...
							<td align="center" >
								<a href="" id="scheme_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" rel="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>">
	           	 		 		...
	           	 		 		<DIV id="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 650px; max-height:300px; overflow:auto; padding: 4px;">
		                            	...
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("VITRI") + "__" + spRs.getString("MATHUNG") + "__" + spRs.getString("MAME") + "__" + spRs.getString("MAPHIEU");
			                        			%>
