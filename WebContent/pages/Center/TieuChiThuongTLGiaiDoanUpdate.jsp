				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khai báo > Tích lũy theo giai đoạn > Cập nhật</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						  ...
						  <TR>
						  	  	...
						  	  	<TD class="plainlabel" >Số xuất tối đa</TD>
								<TD class="plainlabel" >
									<input type="text" name="soxuattoida"  value="<%= obj.getSoxuattoida() %>" style="text-align: right;"  >
								</TD>
		                        ...
		                        <TD class="plainlabel" >
		                            <select name="kbhId" id="kenhId" multiple="multiple"   >
				                        ...
				                        <% if(kbhRS != null) {
				                         while(kbhRS.next()) 
				                         {
				                           if(obj.getKbhIds().indexOf(kbhRS.getString("pk_seq")) >= 0 ){ %>
		                        ...
		                        <TD class="plainlabel" >
		                            <select name="loaikhId" id="loaikhId" multiple="multiple"  >
				                        ...
				                        <% if(loaikhRS != null) {
				                         while(loaikhRS.next()) 
				                         {
				                           if(obj.getLoaikhIds().indexOf(loaikhRS.getString("loaiId")) >= 0 ){ %>
							...
							<div id="tab1" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    <TR class="tbheader">
				                        ...
				                        <TH align="center" width="15%" rowspan="2" >Giai đoạn</TH>
				                        <TH align="center" width="15%" rowspan="2" >Số xuất tối đa</TH>
				                        
				                        <TH align="center" width="20%" colspan="2" >Hiệu lực</TH>
				                    ...
				                    <%
				                    	...
				                    	if( diengiaiMuc != null ) 
				                    	{
				                    		for(int i = 0; i < diengiaiMuc.length; i++)
				                    		{
												...
												<tr>
													...
													<TD>
												  	  	<input type="text" name="soluongtoidaMuc" value="<%= thuongASM[i] %>" style="text-align: right;"  >	
					  	 						 	</TD>
													<TD>
											  	  		<input type="text" name="tungayMuc" value="<%= thuongSS[i] %>" readonly="readonly" class="days" >
					  	 						 	</TD>
					  	 						 	<TD>
											  	  		<input type="text" name="denngayMuc" value="<%= thuongTDSS[i] %>" readonly="readonly" class="days" >
					  	 						 	</TD>
													<td>
			                    		...
			                    		{                 			
			                    			...
			                    			<tr>
												<td>
													<input type="text" name="diengiaiMuc" value="Giai đoạn <%= ( i + 1 ) %>" readonly="readonly"  >
												</td>
												<TD>
											  	  	<input type="text" name="soluongtoidaMuc" value="" style="text-align: right;"  >	
				  	 						 	</TD>
												<TD>
										  	  		<input type="text" name="tungayMuc" value="" readonly="readonly" class="days" >
				  	 						 	</TD>
				  	 						 	<TD>
										  	  		<input type="text" name="denngayMuc" value="" readonly="readonly" class="days" >
				  	 						 	</TD>
												<td>
							...
							<div id="tab3" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                	...
				                	<b>Khu vực </b>
				                		...
				                		<tr align="center">
				                		<td style="font-size: 12px; padding: 8px; " colspan="2" ><b >Giai đoạn</b>
