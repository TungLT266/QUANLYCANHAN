...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng> Chức năng > Soát hóa đơn 
        </div>
                    ...
                    <TR>
                     ...
                     <TR>
                        ...
                        <TD class="plainlabel" >
  							...
  							<select name = "loaihd" class="select2" style="width: 200px" >
	                    		<option value="" <%if(obj.getLoaihd().equals("")){ %> selected="selected" <%} %>>  ALL </option>
	                    		<option value="1" <%if(obj.getLoaihd().equals("1")){ %> selected="selected" <%} %> > Hóa đơn đối tác </option>
	                    		<option value="2" <%if(obj.getLoaihd().equals("2")){ %> selected="selected" <%} %>> Hóa đơn đối khác</option>
	                    		<option value="3" <%if(obj.getLoaihd().equals("3")){ %> selected="selected" <%} %>> Hóa đơn khuyến mãi</option>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 1% ; display: none" >Trạng thái</TH> 
	                    <TH align="center" style="width: 10%" >Mã <br > khách hàng</TH>
	                    <TH align="center" style="width: 20%" >Họ tên</TH>
	                   <!--   <TH align="center" style="width: 10%" >Tài khoản</TH> -->
					...
					<% if(hdRs != null) {
						...
						while(hdRs.next())
						{
							...
							<TR>
								...
								<%-- <Td><input type="text" name="taikhoan" style="width: 100%" readonly="readonly" value="<%= hdRs.getString("taikhoan") %>" disabled="disabled" > </Td>
								 --%>
