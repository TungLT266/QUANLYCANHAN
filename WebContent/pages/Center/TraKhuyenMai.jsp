...
<%@ page  import = "geso.traphaco.center.beans.trakhuyenmai.*" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
        ...
        Quản lý khuyến mãi &gt; Khai báo &gt; Trả khuyến mãi
        </div>
            ...
            <legend class="legendtitle"> Tiêu chí tìm kiếm </legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px">								                 
                    <TR>
                        ...
                        <TD class="plainlabel" valign="middle" width="10%">Mã trả KM </TD>
				                    ...
				                    <TD align="center">
				                        <TABLE cellpadding="1" cellspacing="0">
				                            ...
				                            <%if(quyen[Utility.SUA]!=0){ %>
				                                <A href = "../../TrakhuyenmaiUpdateSvl?userId=<%=userId%>&update=<%= dkkmList.getString("trakmId")%>"><IMG src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" border="0"></A>
				                            <%} %>
				                            </TD><TD>
				                            <%if(quyen[Utility.XOA]!=0){ %>
				                                <A href = "../../TrakhuyenmaiSvl?userId=<%=userId%>&delete=<%= dkkmList.getString("trakmId") %>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa trả khuyến mãi  <% dkkmList.getString("trakmId") ; %>?')) return false;"></A>
				                            <%} %>
				                            </TD></TR>
				                        </TABLE>									
				                    </TD>
