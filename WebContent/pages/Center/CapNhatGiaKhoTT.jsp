<%@page import="geso.traphaco.center.beans.khott.ICapNhatGiaKhoTT"%>
<%@page import="geso.traphaco.center.beans.khott.imp.TonKhoTT"%>
<%@page import="geso.traphaco.center.beans.khott.ITonKhoTT"%>
		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			...
			<tr>
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%"  rows="2"   ><%=obj.getMessage() %> </textarea>
									</FIELDSET>
							   </TD>
								</tr>
				<TR>
