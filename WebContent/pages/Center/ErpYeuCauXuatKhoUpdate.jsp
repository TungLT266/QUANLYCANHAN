		                            	...
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("VITRI") + "__" + spRs.getString("MATHUNG") + "__" + spRs.getString("MAME") + "__" +
			                        				spRs.getString("MAPHIEU") + "__" + spRs.getString("MARQ") + "__" + spRs.getString("NSX") + "__" + spRs.getString("NGAYNHAPKHO");
			                        			%>
