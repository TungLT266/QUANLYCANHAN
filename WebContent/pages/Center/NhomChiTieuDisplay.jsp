...
<%@ page  import = "geso.traphaco.center.beans.nhomchitieu.INhomchitieu" %>
<%@ page  import = "geso.traphaco.center.beans.nhomchitieu.imp.Nhomchitieu" %>
...
<%  if(nkmBean!=null)nkmBean.DBClose();
