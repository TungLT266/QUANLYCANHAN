...
<%	
	...
	int[] quyen = new  int[5];
	quyen = util.Getquyen("ThuongdauthungSvl","&loai=1",userId);
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    ...
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý chỉ tiêu &gt; Chỉ tiêu nhân viên &gt; <%=obj.getLoai().equals("0")?"Thưởng đầu cái":"Thưởng sản phẩm mới" %></TD>  
                                ...
                                <% 
                                    ...
                                    while (luongkhacRs.next()){
                                        ...
                                        <%} else {%>
                                            <TR class= <%= darkrow%> >
                                        <%}%>
                                                <TD align="left"><div align="left"><%=luongkhacRs.getString("thang")%></div></TD>                                   
                                                <TD><div align="center"><%=luongkhacRs.getString("nam")%></div></TD>
                                                ...
                                                <% if(luongkhacRs.getString("TRANGTHAI").trim().equals("0")){%>
                                                 ...
                                                 <%}else if(luongkhacRs.getString("TRANGTHAI").trim().equals("1")) { %>
                                                ...
                                                <TD align="center">
                                                    ...
                                                    <TR>
                                              		   <TD>
                                              		   <%if(quyen[3]!=0){ %>
                                                        <A href = "../../ThuongdauthungNewSvl?userId=<%=userId%>&display=<%=luongkhacRs.getString("PK_SEQ")%>&loai=<%=luongkhacRs.getInt("loai")%>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%
                                                    ...
                                                    <TD>
                                                    	<%if(quyen[2]!=0) {%>
                                                        <A href = "../../ThuongdauthungNewSvl?userId=<%=userId%>&update=<%=luongkhacRs.getString("PK_SEQ")%>&loai=<%=luongkhacRs.getInt("loai")%>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" title="Cập nhật" border = 0></A>
                                                    	<%} %>
                                                    </TD>
                                                    <TD>
                                                   		<%if(quyen[1]!=0) {%>
                                                        <A href = "../../ThuongdauthungSvl?userId=<%=userId%>&delete=<%=luongkhacRs.getString("PK_SEQ")%>&loai=<%=luongkhacRs.getInt("loai")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" title="Xóa" border=0 onclick="if(!confirm('Bạn chắc chắn muốn xóa thưởng  này?')) return false;"></A></TD>
                                                     	<%} %>
                                                     <TD>
                                                     	<%if(quyen[4]!=0) {%>
                                                        <A href = "../../ThuongdauthungSvl?userId=<%=userId%>&chot=<%=luongkhacRs.getString("PK_SEQ")%>&loai=<%=luongkhacRs.getInt("loai")%>"><img src="../images/Chot.png" alt="Chốt" width="20" height="20" title="Chốt chỉ tiêu" border = 0 onclick="if(!confirm('Bạn chắc chắn muốn chốt thưởng này?')) return false;"></A>
                                                     	<%} %>
                                                     </TD>
                                                     <%}else{ %>
                                                     ...
                                                     <TD>
                                                     	<%if(quyen[4]!=0) {%>
                                                        <A href = "../../ThuongdauthungSvl?userId=<%=userId%>&unchot=<%=luongkhacRs.getString("PK_SEQ")%>&loai=<%=luongkhacRs.getInt("loai")%>"><img src="../images/unChot.png" alt="Hien thi" width="20" height="20" title="Hiển thị" border = 0 onclick="if(!confirm('Bạn chắc chắn muốn  mở chốt thưởng này?')) return false;"></A>
                                                    	<%} %>
                                                     </TD>
                                                    <%}%>
                                                    </TR></TABLE>
