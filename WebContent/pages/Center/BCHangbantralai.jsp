...
<%@ page  import = "geso.traphaco.center.beans.bchangtralai.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<% IBCHangtralai obj = (IBCHangtralai)session.getAttribute("obj"); %>
...
<% 
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[5];
		quyen = util.Getquyen("BCHangbantralaiSvl","22",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../BCHangbantralaiSvl">
