			...
			<TABLE width = 100% cellpadding = "3" cellspacing = "0" border = "0">
				  	<tr>
							<TD align="left" colspan="4" class="legendtitle">
			    				...
			    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width: 100%" readonly="readonly" rows="1" ><%=obj.getMsg()%></textarea>
					...
					<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle">Thông tin Chi nhánh / Đối tác ERP 
								</LEGEND>
								...
								<TR>
									...
									<TR>
									  <TD class="plainlabel" >Tên Chi nhánh / Đối tác ERP<FONT class="erroralert"> *</FONT></TD>
									  <TD class="plainlabel" ><INPUT  name="TenNCC_long" style="width:300px" value ='<%=obj.getten()%>'    type="text"></TD>
								  </TR>
								  <TR>
									  <TD class="plainlabel" >Địa chỉ Chi nhánh / Đối tác ERP<FONT class="erroralert"> *</FONT></TD>
									...
									<TR>
									  <TD class="plainlabel" >Chọn Chi nhánh / Đối tác DMS<FONT class="erroralert">*</FONT></TD>
									  <TD class="plainlabel" >
									     <SELECT name="npptn"  >
								   <option value=""> </option>
								  ...
								  <td colspan="2">
								  	<a class="button2" href="javascript:taomoinpp()">
										<img style="top: -4px;" src="../images/button.png" alt="">Tạo Chi nhánh / Đối tác mới </a>&nbsp;&nbsp;&nbsp;&nbsp;	
								  </td>
