...
<%@ page import="geso.traphaco.center.beans.banggia.imp.*" %>
<%@ page import="geso.traphaco.center.beans.banggia.*" %>
...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function DinhDangTien(num) 
	{
		...
		var numtemp = num.toString().replace(/\$|\,/g,'');
		var sole = '';
		if(num.indexOf(".") >= 0)
		{
			...
			if(sole.length > 1)
			{
				numtemp = (Math.round( numtemp * 10000 ) / 10000).toString();
				sole = numtemp.substring(numtemp.indexOf('.'));
			}
		}
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm > Bảng giá mua > Tạo mới</TD> 
		                  ...
		                  <TR>
		                  		<td colspan="4">
		                  			...
		                  			<ul class="tabs">
			                  			...
			                  			<li><a href="#">Chi nhánh / Đối tác</a></li>
		                  			...
		                  			<div class="panes">
										<div>
											...
											<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
												<TR class="tbheader">
													<TH width="15%">Mã Chi nhánh / Đối tác </TH>
				                  			...
				                  			<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
												...
												<% for(int i = 0; i < spList.size(); i++ ) { 
													...
													<TR>
														...
														<TD>
															<input type="text" style="width: 100%; text-align: right;"   onkeyup="Dinhdang(this)"  name="giaban" value="<%= sanpham.getGiaban() %>" onkeyup="Dinhdang(this);" > 
