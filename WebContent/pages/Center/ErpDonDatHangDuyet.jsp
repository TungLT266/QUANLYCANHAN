...
<% obj.setNextSplittings();
	...
	String url="";
	url = util.getUrl("ErpDuyetddhSvl","");
                        ...
                        <TD class="plainlabel" valign="middle">
                           <select name="trangthai" onchange="submitform();"  >
								<% if (obj.getTrangthai().equals("0")){%>
								  	<option value="1" >Đơn hàng ETC</option>
								  	<option value="0" selected>Đơn hàng đối tác</option>
								  	<option value="2" >Đơn hàng khuyến mại</option>
								  	<option value="" ></option>
								<%}else if(obj.getTrangthai().equals("1")) {%>
								 	<option value="1" selected>Đơn hàng ETC</option>
								  	<option value="0" >Đơn hàng đối tác</option>
								  	<option value="2" >Đơn hàng khuyến mại</option>
								  	<option value="" ></option>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center">
		                    	<%
		                    		...
		                    		if(nhapkhoRs.getString("hopdong_fk") != null )
		                    			hopdong_fk = nhapkhoRs.getString("loaidonhang");
		                    		
		                    		if(ldh.equals("0") && hopdong_fk.trim().length() > 0 ) //NPP TAO
		                    			loaidonhang = "Đơn hàng ETC";
		                    		else if(ldh.equals("0") && hopdong_fk.trim().length() <= 0 )
	                    			{
	                    			...
	                    			{
	                    				loaidonhang = "Đơn hàng NVL";
                    				}
	                    			else if(ldh.equals("4"))
	                    			{
	                    				loaidonhang = "Đơn hàng KM";
                    				}
	                    			else if(ldh.equals("5"))
	                    			{
		                    ...
		                    <TD align="center"> 
		                   			...
		                   			<% if(nhapkhoRs.getString("trangthai").equals("4")){
		                     			 %>
                              		<A href = "../../ErpDuyetddhUpdateSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>&hopdongId=<%= hopdong_fk %>"><IMG src="../images/Display20.png" alt="Duyệt đơn đặt hàng" title="Duyệt đơn đặt hàng" border=0></A>
                            		<%} else { %>
                            		<A href = "../../ErpDuyetddhUpdateSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>&hopdongId=<%= hopdong_fk %>"><IMG src="../images/Chot.png" alt="Duyệt đơn đặt hàng" title="Duyệt đơn đặt hàng" border=0></A>
		                    		<% }}  %>
		                    </TD>
		                </TR>
                     <% m++; } nhapkhoRs.close(); } %>
