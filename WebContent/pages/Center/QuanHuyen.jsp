...
<%@ page  import = "geso.traphaco.center.beans.quanhuyen.*" %>
...
<%	String userId = (String) session.getAttribute("userId");  
	...
	if(!util.check(userId, userTen, sum)){
		...
		quyen = util.Getquyen("QuanHuyenSvl","14",userId);
...
<% IQuanHuyenList obj = (IQuanHuyenList)session.getAttribute("obj"); 
...
<form name="kvForm" method="post" action="../../QuanHuyenSvl">
		...
		<TABLE width="100%" cellpadding="0" cellspacing="1">
				...
				<TR>
					<TD align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Quận huyện </TD>
			...
			<TABLE width="100%" cellpadding="0" cellspacing="0">			
				<TR>
					<TD width="100%">
						<FIELDSET>
							<LEGEND class="legendtitle">&nbsp;Quận huyện &nbsp;&nbsp;
							<%if(quyen[0]!=0){ %>
								...
								if(qhRs != null)
								{
									...
									while (qhRs.next()){
										...
										<%}%>
											    ...
											    <TD align="center"><div align="center"><%= qhRs.getString("TENTT") %></div></TD>
											    <%-- <TD align="center"><div align="center"><%= qhRs.getString("TENQH") %></div></TD> --%>
											                             
												<% if (qhRs.getString("TRANGTHAI").equals("1")){ %>
													<TD align="center">Hoạt động </TD>
												<%}else{%>
													<TD align="center">Ngưng hoạt động</TD>
												<%}%>
												<TD align="center"><%= qhRs.getString("NGAYTAO") %></TD>
												<TD align="center"><%= qhRs.getString("NGUOITAO") %></TD>
												<TD align="center"><%= qhRs.getString("NGAYSUA") %></TD>
												<TD align="center"><%= qhRs.getString("NGUOISUA") %></TD>
										 	
												<TD align="center">
												<TABLE border = 0 cellpadding="0" cellspacing="0">
													<TR><TD>
													<%if(quyen[2]!=0){ %>
														<A href = "../../QuanHuyenUpdateSvl?userId=<%=userId%>&update=<%=qhRs.getString("PK_SEQ")%>"><img src="../images/Edit20.png" alt="Cap nhat" title="Cập nhật" width="20" height="20" longdesc="Cap nhat" border = 0></A>
													<%} %>
													</TD>
													<TD>&nbsp;</TD>
													<TD>
													<%if(quyen[1]!=0){ %>
														<A href = "../../QuanHuyenSvl?userId=<%=userId%>&delete=<%=qhRs.getString("PK_SEQ")%>"><img src="../images/Delete20.png" alt="Xoa" title="Xóa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa thông tin quận huyện  này ?')) return false;"></A>
														<%} %>
														</TD>
													</TR></TABLE>
												</TD>
