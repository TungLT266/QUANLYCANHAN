				...
				<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
		                        	...
		                        	<textarea name="dataerror"  style="width: 100% ; font-weight:bold" cols="104%" rows="1" style="width: 100%" readonly="readonly"><%= ghcnBean.getMessage() %></textarea>
		                        	<% ghcnBean.setMessage(""); %>
                        		</FIELDSET>
						   </TD>
					</tr>
        ...
        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
				<TR>
					<TD colspan = "6" width='100%'>
						<FIELDSET><LEGEND class="legendtitle">Chi nhánh / Đối tác được hưởng tín dụng</LEGEND>
						  	<div class="title" align="left" style="height:30px;background-color:#C5E8CD;padding-top:5px " >  Chi nhánh / Đối tác thuộc Khu Vực: &nbsp;&nbsp;&nbsp;&nbsp;
					...
					<TABLE  border="0" cellspacing="1" cellpadding="6" width='100%'>
								...
								<TH width="18%">Tên Khu Vực </TH>
								  <TH align="center" width="17%">Mã Chi nhánh / Đối tác</TH>
									<TH width="25%">Tên Chi nhánh / Đối tác </TH>
