...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Chức năng > Phân bổ hàng
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Phân bổ hàng </span>&nbsp;&nbsp;
                 		...
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <%} else{ %>
		                    	...
		                    	<%if(quyen[Utility.HUYCHOT]!=0) {%>
                              	<A href = "../../ErpPhanbodonhangSvl?userId=<%=userId%>&mochot=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/unChot.png" alt="Mở chốt" title="Mở chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn mở chốt phân bổ này?')) return false;"></A>
                              	<%} %>
