				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Chính sách bán hàng > Hiển thị </TD> 
						  ...
						  <TR>
								...
								<TD class="plainlabel" >
						  	  		...
						  	  		<% if(obj.getApdungchohopdong().equals("1")) { %>
						  	  			<input type="checkbox" name="apdungchohopdong" checked="checked" value="1" > <i>Áp dụng cho hợp đồng</i>
						  	  		<% } else { %>
						  	  			<input type="checkbox" name="apdungchohopdong" value="1" > <i>Áp dụng cho hợp đồng</i>
						  	  		<% } %>
