...
<%@ page  import = "geso.traphaco.center.beans.duyettrasanpham.*" %>
<%@ page  import = "geso.traphaco.distributor.beans.donhangtrave.ISanpham" %>
						...
						<TD align="left" >
							...
							<TABLE border="0" width="100%" cellpadding = "0" cellspacing = "0">
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%" readonly="readonly" rows="1"><%= dtspBean.getMessage() %></textarea>
									</FIELDSET>
							   </TD>
								</tr>
								<TR>
									<TD  align="left">						
										...
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>
                                          ...
                                          <TR >
												<TD width="22%" class="plainlabel">Chi nhánh / Đối tác  </TD>
