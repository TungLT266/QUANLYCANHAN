...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý kho trung tâm > Kiểm kê > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpNhapkhoSvl?userId=<%= userId %>" >
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td > <input type="text" name="donvi" value="<%= spDonvi[i] %>" style="width: 100%; " readonly="readonly"> </td>
				                        	...
				                        	if(ct != null)
				                        	{
				                        		...
				                        		for(int j = 0; j <  ctARR.length; j++ )
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= count %>_spSOLO" value="<%= _ct[1] %>"  >
				                        				</td>
				                        				<td>
		                            	...
		                            	<%
		                            		for(int j = stt; j < 120; j++ ) { %>
		                            			...
		                            			<tr>
			                        				...
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= count %>_spSOLO" value=""  >
			                        				</td>
			                        				<td>
			                            	...
			                            	<%
			                            		for(int j = 0; j < 120; j++ ) { %>
			                            			...
			                            			<tr>
				                        				...
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= i %>_spSOLO" value=""  >
				                        				</td>
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center;" name="dong<%= i %>_spNGAYSANXUAT" value="<%= lsxBean.getDateTime() %>" readonly="readonly" class="days">
				                        				</td>
				                        				<td>
