<%@page import="geso.traphaco.center.beans.hoadon.IHoaDon_CTKM"%>
...
function TinhTien()
{
	...
	function saveform()
	 {	 
		...
		if(nhapp==""){
			document.forms['dhForm'].dataerror.value="Vui lòng chọn Chi nhánh / Đối tác để xuất hàng ";
			return;
		}
		var khott= document.forms['dhForm'].khottid.value;
		if(khott==""){
			document.forms['dhForm'].dataerror.value="Chọn Chi nhánh / Đối tác để lấy kho ";
			return;
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
								<tr>
								 ...
								 <TD align="left" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%;margin:0px " readonly="readonly" rows="1"><%=hdBean.getMessage() %></textarea>
							  	</fieldset>
							  	 </TD>
								</tr>
							   ...
							   <td style="text-align: center">
								   Chi tiết đơn hàng khuyến mãi (Vui lòng chọn Chi nhánh / Đối tác,đơn vị kinh doanh,kênh bán hàng  trước khi sản phẩm cho đơn đặt hàng)
							   </td>
							   </tr>
							   <TR>
							   		<TD>
