...
<%@ page import="geso.traphaco.center.beans.nhomhang.INhomHangList"%>
						...
						<TR>
							<TD align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản phẩm > Nhóm hàng</TD>
																	...
																	<TR>
																		<TD>
																			<%if(quyen[Utility.SUA]!=0) {%>
																			 <A href="../../NhomHangUpdateSvl?userId=<%=userId%>&update=<%=npplist.getString("id")%>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border=0></A> <%
 	}
 %>
																		</TD>
																		<TD>
																			...
																			if(quyen[Utility.XOA]!=0)
																							{
																			%> <A href="../../NhomHangSvl?userId=<%=userId%>&delete=<%=npplist.getString("id")%>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0
																		...
																		{%>
																			 <A href="../../NhomHangUpdateSvl?userId=<%=userId%>&display=<%=npplist.getString("id")%>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border=0></A>
																		<%}%>
																		</TD>
