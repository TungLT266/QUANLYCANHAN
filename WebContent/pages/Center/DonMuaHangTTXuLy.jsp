	...
	function addRow(name)
		...
		function KiemTraGioiHangCongNo(){
			...
			if((parseFloat(conno)+ parseFloat(phaitra) > parseFloat(gioihancongno))){
				document.forms['dhForm'].dataerror.value	="Chi nhánh / Đối tác NÀY ĐÃ VƯỢI MỨC GIỚ HẠN CÔNG NỢ ";
			}else{
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
								<tr>
								 ...
								 <TD align="left" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%;margin:0px ;color: red"  rows="1"  ><%=hdBean.getMessage() %></textarea>
							  	</fieldset>
							  	 </TD>
								</tr>
