...
<%@ page  import = "geso.traphaco.center.beans.mucchietkhau.*" %>
	...
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  rows="1" readonly="readonly" style ="width:100%%"><%= ckBean.getMessage() %></textarea>
		         <% ckBean.setMessage(""); %>
    	</fieldset>
  	</div>
