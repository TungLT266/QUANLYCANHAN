...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > <%= lsxBean.getETC().equals("0") ? "Bán hàng cho đối tác" : "Bán hàng ETC" %> > Tạo mới
        </div>
    	...
    	<legend class="legendtitle"><%= lsxBean.getETC().equals("0") ? "Bán hàng cho đối tác" : "Bán hàng ETC" %></legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
                ...
                <TR>
                    ...
                    <%-- <TD class="plainlabel" <%= lsxBean.getETC().equals("1") ? " colspan='3' " : "  " %> > --%>
                    <TD class="plainlabel" colspan='3'  >
