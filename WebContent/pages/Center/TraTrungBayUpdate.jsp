...
<%@ page  import = "geso.traphaco.center.beans.tratrungbay.imp.*" %>
<%@ page  import = "geso.traphaco.center.beans.nhomsptrungbay.ISanpham" %>
<%@ page  import = "geso.traphaco.center.beans.nhomsptrungbay.imp.Sanpham" %>
...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý trưng bày > Khai báo > Trả trưng bày > Cập nhật
        </div>
  	...
  	<div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold" rows="1" style="width: 100%" readonly="readonly" readonly="readonly"><%= tratbBean.getMessage() %></textarea>
