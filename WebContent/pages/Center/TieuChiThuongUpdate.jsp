								...
								<TD>
									...
									<TABLE class="first" border="0" width="100%" cellpadding="3" cellspacing="0">
						  	  					...
						  	  					<SELECT name= "ctyId" >
						  	  						<%if(rsCty!=null){ 
							  	  						...
							  	  						while (rsCty.next()){
							  	  							...
							  	  							if(rsCty.getString("pk_seq").equals(tctBean.GetCongty().trim())){
							  	  								%>
										...
										<tr>
							  				...
							  				<TD style="display: none" class="plainlabel">Kênh bán hàng </TD>
							  				...
							  				<TD style="display: none" class="plainlabel">Đơn vị kinh doanh </TD>
						  	  				<TD style="display: none" class="plainlabel">
						  	  					<SELECT name= "dvkdId" >
						  	  						<%if(rsdvkd!=null){ 
							  	  						while (rsdvkd.next()){
