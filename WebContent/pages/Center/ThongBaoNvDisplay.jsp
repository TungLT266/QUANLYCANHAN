...
<head>
	...
	<SCRIPT language="javascript" type="text/javascript">
		 ...
		 function BackHome()
		 {
			document.forms["congtyForm"].action.value = "backhome";
			document.forms["congtyForm"].submit();
		 }
...
<!-- 							  	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
<%-- 							  	<% if(thongbao.getHethieuluc().equals("1")) { %> --%>
<!-- 							  		<input type="checkbox" name="hethieuluc" checked="checked" ><i>Đã xem</i> -->
<%-- 							  	<% } else { %> --%>
<!-- 							  		<input type="checkbox" name="hethieuluc"  ><i>Đã xem</i> -->
<%-- 							  	<% } %> --%>
<!-- 							  </TD> -->
<!-- 							  </TR> -->
				  		<TR>
