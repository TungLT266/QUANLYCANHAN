...
<%@ page  import = "geso.traphaco.center.beans.dieuchinhtonkho.imp.*" %>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpChuyenkhoTTSvl?userId=<%= userId %>&loaidonhang=<%=lsxBean.getLoaidonhang() %>" >
        	<img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1px" longdesc="Quay ve" style="border-style:outset"></A>
       <A href="../../ErochuyenkhotTTpdfnew?userId=<%=userId%>&chuyenkho=<%=lsxBean.getId()%>&nppId=<%= lsxBean.getNppId()%>" >
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD colspan="3" class="plainlabel" >
                    	<input type="text"  readonly="readonly"  name="sochungtu" value="<%= lsxBean.getSoChungTu() %>"/></TD>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="15%">Kênh bán hàng</TD>
                    <TD class="plainlabel"  >
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							...
							<td > <input type="text" name="tonkho" value="<%= spSoluong[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > </td>
					                    ...
					                    <table width="95%" align="center">
			                            	...
			                            	<%
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			<tr>
				                        				<td>
				                        				<% if(sanpham_soluong.get(spMa[i] + "__" + spRs.getString("SOLO")) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( spMa[i] + "__" + spRs.getString("SOLO") ))) %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } else { %>
