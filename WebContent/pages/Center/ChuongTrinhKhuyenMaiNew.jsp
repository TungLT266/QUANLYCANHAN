...
<div id="main" style="width:100%; padding-left: 1px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý khuyến mãi > Khai báo > Chương trình khuyến mãi > Tạo mới
        </div>
                   ...
                   <% } else {%>                
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" colspan="4" >
                       		<input type="checkbox" name="codangki" value="1" checked="checked"><i> có đăng kí</i>
                        	&nbsp;&nbsp;&nbsp;
                       		<input type="checkbox" name="codieukien" value="1" ><i> có điều kiện</i>
                       		<% if (ctkmBean.getInchung().equals("1")){ %> 
                        		<input type="checkbox" name="inchung" value="1" checked="checked"><i> In chung hóa đơn hàng bán</i>
                        	<% } else { %>
                        		<input type="checkbox" name="inchung" value="1" ><i>In chung hóa đơn hàng bán</i>
