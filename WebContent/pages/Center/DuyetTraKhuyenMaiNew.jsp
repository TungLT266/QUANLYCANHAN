				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Duyệt trả khuyến mại tích lũy > Tạo mới</TD> 
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
						    ...
						    <A href="javascript: save();"  >
						    	<IMG src="../images/Save30.png" title="Luu lai" alt="Luu lai" border = "1"  style="border-style:outset" onclick="if(!confirm('Bạn chắc chắn muốn duyệt SCHEME này?')) return false;" >
						    </A>
						    </div>
						    </TD>
							<TD >&nbsp; </TD>						
		                    	...
		                    	if(nppId != null)
		                    	{
		                    		...
		                    		for(int i = 0; i < nppId.length; i++ )
		                    		{
		                    			...
		                    			<TR>
		                    				...
		                    				<TD>
		                    					<input type="hidden" name="donviThuong" value="<%= donviThuong[i] %>"  >
		                    					<select style="text-align: right;" disabled="disabled" >
