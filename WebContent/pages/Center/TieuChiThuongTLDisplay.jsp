...
<%
	...
	ResultSet rsDangky = obj.getKhDangKyRs();
					...
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <% if(obj.getPhanloai().equals("0")) { %>
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích lũy > Hiển thị</TD> 
						 <% } else if(obj.getPhanloai().equals("1")) { %>
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Khuyến mại tích điểm > Hiển thị</TD> 
						 <% } else { %>
						 	 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý trưng bày > Khai báo > Chương trình trưng bày > Hiển thị</TD> 
						 <% } %>
				  ...
				  <TD height="100%" width="100%">
						...
						<div id="tab4" class="tab_content">
								...
								<TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
				                    ...
				                    <TR class="tbheader">
				                        <td align="center" width="35%">Nhà phân phối</td>
				                    ...
				                    <% if(rsDangky != null ) { 
				                    	...
				                    	<TR >
					                        <td ><input type="text" style="width: 100%" value="<%= rsDangky.getString("nhaphanphoi") %>" > </td>
					                    	<td ><input type="text" style="width: 100%" value="<%= rsDangky.getString("khachhang_fk") %>" > </td>
					                    	<td ><input type="text" style="width: 100%" value="<%= rsDangky.getString("khachhang") %>" > </td>
					                    	<td align="center"> <input type="checkbox" value="<%= rsDangky.getString("khachhang_fk") %>" > </td>
					                    </TR>
