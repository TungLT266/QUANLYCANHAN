            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý khuyến mại > Duyệt trả khuyến mại tích lũy </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Duyệt trả khuyến mại tích lũy &nbsp;&nbsp;	   
                              <%if(quyen[0]!=0){ %>                      
                                    ...
                                    while ( tieuchiSKU.next()){
                                        ...
                                        <%}%>
                                                ...
                                                <% if( tieuchiSKU.getString("trangthai").trim().equals("0") ) { %>
					                               ...
					                               <%} %>
					                               	<%if(quyen[4]!=0){ %>
					                                <A href = "../../DuyettrakhuyenmaiSvl?userId=<%=userId%>&duyet=<%= tieuchiSKU.getString("pk_seq") %>"><img src="../images/Chot.png" alt="Duyet" width="20" height="20" longdesc="Duyet" border=0 onclick="if(!confirm('Bạn có muốn duyệt chỉ tiêu này?')) return false;"></A>&nbsp;
					                                <%} %>
					                                <%if(quyen[1]!=0) {%>
					                                <A href = "../../DuyettrakhuyenmaiSvl?userId=<%=userId%>&delete=<%= tieuchiSKU.getString("pk_seq") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa chỉ tiêu này?')) return false;"></A>									
							                    	<%} %>
							                    <%} else { %>
							                    	<%if(quyen[3]!=0){ %>
