...
<%@ page  import = "geso.traphaco.center.beans.ctkhuyenmai.imp.*" %>
   ...
   <script>
    ...
    function AjaxNpp()
	{
		...
		function saveform()
		{
			...
			if(checkNpp() == false)
			{
				alert('Lối...Không có Chi nhánh / Đối tác nào được chọn cho chương trình khuyến mại...');
				return;
			}
...
<div id="main" style="width:100%; padding-left: 1px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý khuyến mãi > Khai báo > Chương trình khuyến mãi > Cập nhật
        </div>
    ...
    <fieldset>
        ...
        <div style="width:100%; float:none" align="left">
                ...
                <TABLE width="100%" cellpadding="4" cellspacing="0">								
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" width="120px"  >Kho </TD>
                        <TD class="plainlabel"  >
                            <select name="kho" >
                            <% while(khoIds.next()) 
                            {
                              if(khoIds.getString("pk_seq").equals(ctkmBean.getkhoId())){ %>
                                <option value="<%=khoIds.getString("pk_seq") %>" selected><%= khoIds.getString("ten") %></option>
                                
                            <%}else { %>
                            	<option value="<%=khoIds.getString("pk_seq") %>"><%= khoIds.getString("ten") %></option>
                            <%} }%>
                   ...
                   <% } else {%>                
                    ...
                    <TR>
						...
						<TD class="plainlabel" width="230px">
						<select	name="_hangCuaHangs" id="_hangCuaHangs" multiple="multiple">
                        ...
                        <%-- <TD class="plainlabel" colspan="2" >
                        	...
                        	&nbsp;&nbsp;&nbsp;
                        	 ...
                        	 <% if (ctkmBean.getPhanbotheoDH().equals("1")){ %> 
                        		<input type="checkbox" name="PHANBOTHEODH" value="1" checked="checked" onchange="submitform()" ><i> Phân bổ ngân sách theo số xuất</i>
                        		&nbsp;&nbsp;&nbsp;
                        	...
                        	<% } else { %>
                        		<input type="checkbox" name="PHANBOTHEODH" value="0" onchange="submitform()" ><i> Phân bổ ngân sách theo số xuất</i>
                        		&nbsp;&nbsp;&nbsp;
                     ...
                     <TR>
                        ...
                        <TD class="plainlabel" colspan="4" >
                       		<input type="checkbox" name="codangki" value="1" <%if(ctkmBean.getCodangki().equals("1")){ %>checked="checked" <%} %>><i> có đăng kí</i>
                       	
                       		<input type="checkbox" name="codieukien" value="1" <%if(ctkmBean.getCodieukien().equals("1")){ %>checked="checked" <%} %> ><i> có điều kiện</i>
                   		 	<% if (ctkmBean.getInchung().equals("1")){ %> 
                        		<input type="checkbox" name="inchung" value="1" checked="checked"><i> In chung hóa đơn hàng bán</i>
                        	<% } else { %>
                        		<input type="checkbox" name="inchung" value="1" ><i>In chung hóa đơn hàng bán</i>
      ...
      <div id="accordion" style="width:100%; height:auto; float:none; font-size:1.0em" align="left">
       ...
       <h1 style="font-size:1.8em"><a href="#">Khai báo điều kiện khuyến mại</a></h1>
			                        ...
			                        <div id='dieukienkhuyenmai<%= i %>' style='padding:0px 5px; background:#fff;'>
										...
										<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
			                                ...
			                                <tr>
			                                	...
			                                	<% if(dkkm.isTheothung() ) { %>
			                                		<input type="checkbox" name="dieukienkhuyenmai<%= i %>.tinhtheothung" id="dieukienkhuyenmai<%= i %>.tinhtheothung" value='1' checked="checked" > <span style="font-style: italic;">Số lượng tính theo thùng 2 2</span> 
			                                	<%} else { %>
			                                		<input type="checkbox" name="dieukienkhuyenmai<%= i %>.tinhtheothung" id="dieukienkhuyenmai<%= i %>.tinhtheothung" value='1' > <span style="font-style: italic;">Số lượng tính theo thùng 3 3</span>
			                                	<%} %>
			                                	</td>
			                                </tr>
			                                <tr>
					                ...
					                <div style='display:none'>
				                        <div id='dieukienkhuyenmai<%= j %>' style='padding:0px 5px; background:#fff;'>
											...
											<table cellpadding="4px" cellspacing="2px" width="100%" align="center">
				                                ...
				                                <tr>
				                                	<td  align="left" colspan="2">
				                                		<input type="checkbox" name="dieukienkhuyenmai<%= j %>.tinhtheothung" id="dieukienkhuyenmai<%= j %>.tinhtheothung" value='1'  > <span style="font-style: italic;">Số lượng tính theo thùng</span>
				                                	</td>
				                                </tr>
				                                <tr>
				                                	<td colspan="2">
                ...
                <th >
			       ...
			       <option value="">Chọn hết</option>
					...
					<option value="">Chọn hết</option>
                     ...
                     <fieldset style="width: 30%; float: left;"> 
					<legend>Loại chi nhánh/đối tác&nbsp;</legend>
                ...
                <tr class="plainlabel" style="padding: 5px">
                	<th >
                		<a class="button" href="javascript:seach();">
        					<img style="top: -4px;" src="../images/button.png" alt=""> Hiển thị CN/ĐT theo điều kiện</a>
                	</th>
                </tr>
                </TABLE>
                <TABLE id="NppTable">
