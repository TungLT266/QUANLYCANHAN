...
<%@page import="geso.traphaco.center.beans.hoadongtgt.IHoaDonGTGT_SP"%>
<%@page import="geso.traphaco.center.beans.hoadongtgt.IHoaDonGTGT"%>
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
								<tr>
								 ...
								 <TD align="left" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%;margin:0px " readonly="readonly" rows="1"><%=hdGTGT.getMessage() %></textarea>
							  	</fieldset>
							  	 </TD>
								</tr>
