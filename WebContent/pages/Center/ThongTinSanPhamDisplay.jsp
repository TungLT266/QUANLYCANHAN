...
<%@ page import="geso.traphaco.center.beans.thongtinsanpham.IThongtinsanpham"%>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">
											&nbsp;Dữ liệu nền > Sản phẩm > Thông tin sản phẩm >  Hiển thị
					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD width="30" align="left"><A href="../../ThongtinsanphamSvl?userId=<%=userId%>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve" style="border-style: outset"></A></TD>
										...
										<FIELDSET>
											...
											<TABLE border="0" width="100%" cellpadding="4"
												...
												<TD class="plainlabel" >Sản phẩm mới &nbsp; <%
													...
													<TD class="plainlabel" colspan="2">Hoạt động &nbsp; <%
...
<%-- 													<TD class="plainlabel" > <input name="nguongoc" type="text" style="width: 200px" value='<%=spBean.getNguongoc()%>'></TD> --%>
													...
													<TD class="plainlabel" colspan = "5"> <input readonly="readonly" name="thuexuat" type="text" style="width: 200px" value='<%=spBean.getThuexuat()%>' onkeypress="return keypress(event);">%</TD>
															...
															<TABLE border="1" cellpadding="0" cellspacing="1" width="100%">
																...
																<%
																	String[] sl1 = spBean.getSl1();
																		...
																		System.out.println("in sl1 "+sl1[0]);
...
// 																		}
																...
																<TR class='tblightrow'>
																	...
																	<TD align="center"><select name="dvdl2" style="width: 100%; height: 22">
																			<%
																				if (i == 0)
																						{
																			%>
