<%@page import="geso.traphaco.center.beans.trakhuyenmainpp.ITrakhuyenmainpp"%>
<%@page import="geso.traphaco.center.beans.trakhuyenmainpp.ITrakhuyenmainppList"%>
	...
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div id="cotent" style="width:98%; float:none">
    	<div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
    		...
    		<textarea name="dataerror"  style="width: 100% ; font-weight:bold" readonly="readonly" rows="1"><%= obj.getMsg() %></textarea>
