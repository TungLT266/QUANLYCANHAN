		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   		Thiết lập dữ liệu nền > Dữ liệu nền kinh doanh > Khu Vực > Cập nhật </TD>
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="30" align="left"><A href="../../KhuvucSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
				  	...
				  	<tr>
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
									<TR>
									  <TD width="15%" class="plainlabel" >Khu Vực<FONT class="erroralert">*</FONT></TD>
								  ...
								  <TR>
									  ...
									  <TD class="plainlabel" ><SELECT name="vungmien" onChange="submitform();">
								      	<option value=''></option>
								  ...
								  <TD class="plainlabel"><input readonly="readonly"	type="text" name ="tenquocgia" value='<%= kvBean.getTenqg()%>' style="width:200px"></TD></TD>
							  	</TR> --%>
								     <TR>
