...
<%@ page  import = "geso.traphaco.center.beans.xuatkho.imp.*" %>
    	...
    	<legend class="legendtitle">Yêu cầu xuất kho </legend>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="8%" >Đã xuất</th>
					<th align="center" width="8%" >Số lượng xuất</th>
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr <%= style %> >
							...
							<td>
								<input type="text" name="soluong" value="<%= spSoluong[i] %>" style="width: 60%; text-align: right;" onkeypress="return keypress(event); " onkeyup="Dinhdang(this);" >
								<a href="" id="scheme_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" rel="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>">
	           	 		 		...
	           	 		 		<DIV id="subcontent_<%= spId[i] + "_" + spLoai[i] + "_" + spSCheme[i] %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 850px; max-height:300px; overflow:auto; padding: 2px;">
				                    <table width="98%" align="center">
				                        ...
				                        <tr>
				                            ...
				                            <th width="100px" style="font-size: 11px">Vị trí</th>
		                            	...
		                            	<%
		                            		ResultSet spRs = lsxBean.getSoloTheoSp(spId[i], spSoluong[i], spSCheme[i]);
			                        		if(spRs != null)
			                        		{
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("VITRI") + "__" + spRs.getString("MATHUNG") 
			                        						+ "__" + spRs.getString("MAME") + "__" + spRs.getString("MAPHIEU") + "__" + spRs.getString("MARQ") + "__" + spRs.getString("NSX")+ "__" + spRs.getString("NGAYNHAPKHO");
			                        			%>
							...
							<td>
								<input type="text" name="spKho" value="<%= spKho[i] %>" style="width: 100%; text-align: right;" readonly="readonly">							
							</td>
						</tr>	
