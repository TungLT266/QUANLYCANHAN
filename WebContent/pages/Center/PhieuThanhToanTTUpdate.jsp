...
<%@page import="geso.traphaco.center.beans.phieuthanhtoantt.IPhieuThanhToanTT_DH"%>
<%@page import="java.util.List"%>
<%@page import="geso.traphaco.center.beans.phieuthanhtoantt.IPhieuThanhToanTT"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "geso.traphaco.distributor.beans.phieuthanhtoan.*" %>
	...
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" style="width:100%%; float: none"> 
    	<fieldset>
            ...
            <textarea name="dataerror"  style="width: 100% ; font-weight:bold" style ="width:100%" rows="1" readonly="readonly"><%=obj.getMsg() %></textarea>
    ...
    <fieldset>
    	<legend class="legendtitle">Phiếu thu tiền</legend>
           <TABLE width="100%" cellpadding="5px" cellspacing="0px">
            ...
            <TR>
                <TD class="plainlabel">Chọn Chi nhánh / Đối tác</TD>
                <TD class="plainlabel" colspan="2">
