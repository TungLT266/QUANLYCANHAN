<%@page import="geso.traphaco.center.beans.banggiavontt.IBangGiaVonTT_SanPham"%>
<%@page import="java.util.List"%>
<%@page import="geso.traphaco.center.beans.banggiavontt.IBangGiaVonTT"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "geso.traphaco.center.beans.banggiamuanpp.IBanggiamuanpp" %>
	...
	<TR>
		<TD colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
			...
			<TR ><TD >
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR class = "tbdarkrow">
						<TD width="30" align="left"><A href="../../BangGiaVonTTSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
		...
		<TABLE width="100%"  border = "0" cellspacing="0" cellpadding="0">
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1" ><%=bgvon.getMessage()%></textarea>
						</FIELDSET>
				   </TD>
				</tr>			
