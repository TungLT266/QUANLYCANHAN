...
<%
    ...
    else
    {
    	...
    	{
			command = "select ma, ten from erp_sanpham where trangthai = '1'";
    	...
    	else
    	{
    	    ...
    	    command = command + " from dieukienkhuyenmai where nguoitao is not null ";
    	    //"and pk_seq in (select dieukienkhuyenmai_fk from DIEUKIENKM_SANPHAM where sanpham_fk in " + Ult.quyen_sanpham(userId) + ")";
