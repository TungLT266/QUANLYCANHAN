					...
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">
							   	Quản trị hệ thống > Thông báo > Tạo mới </TD>
		                  			...
		                  			<div style="font-size: 1.0em; font-weight: 500; display: none;">
		                  				<TABLE width="100%" cellspacing="1" cellpadding="4">
		                  					<TR>
		                  						<TH width="10%" align="center" class="plainlabel" >Mã văn bản</TH>
		                  						<TH width="80%" align="center" class="plainlabel" >Nội dung</TH>
		                  						<TH width="10%" align="center" class="plainlabel" >Chọn hết <input type="checkbox" id='chkAll3' onchange="sellectAll('chkAll3', 'vbccIds');" > </TH>
		                  					</TR>
