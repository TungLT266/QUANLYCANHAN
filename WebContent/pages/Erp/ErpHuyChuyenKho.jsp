...
<%@page import="geso.traphaco.erp.beans.huychungtu.IErpHuyChuyenKhoList"%>
...
<% IErpHuyChuyenKhoList obj = (IErpHuyChuyenKhoList)session.getAttribute("obj"); %>
...
<body>
<form name="erpHctmhForm" method="post" action="../../ErpHuyChuyenKhoSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý cung ứng > Quản lý tồn kho > Hủy chứng từ
        </div>
					...
					<%
                 		if(hctmhList != null)
                 		{
		                    ...
		                    <TD align="center"> 
		                    	...
		                    	<A href = "../../ErpHuyChuyenKhoUpdateSvl?userId=<%=userId%>&display=<%= hctmhList.getString("SOPHIEU") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
