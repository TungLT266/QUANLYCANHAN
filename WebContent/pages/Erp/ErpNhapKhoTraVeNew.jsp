		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">
					Quản lý tồn kho > Chức năng > Nhập kho hàng trả về > Tạo mới
				</div>
					...
					<div style="float: none; width: 100%" align="left">
						...
						<table cellpadding="0px" cellspacing="1px" width="100%">
							<tr class="tbheader">
								...
								<th align="center" width="44%">Tên sản phẩm</th>
									...
									<DIV id="subcontent_<%=count%>" style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 450px; max-height: 500px; overflow: auto; padding: 4px;">
										...
										<div style="max-height: 500px; overflow: auto;">
											<table width="95%" align="center">
												...
												<tr>
													<td width="100px" >
														<input type="text" style="width: 100%; text-align: right;" name="<%= spMa[i] %>_spSOLUONG" value="<%= _soluong %>" onkeyup="Dinhdang(this);">
													</td>
													<td width="100px" >
												...
												<%  } } } while ( kk < 5 ) { %>
													<tr>
														<td width="100px" >
															<input type="text" style="width: 100%; text-align: right;" name="<%= spMa[i] %>_spSOLUONG" value="" onkeyup="Dinhdang(this);">
														</td>
														<td width="100px" >
											...
											<table width="95%" align="center">
												<%
													ResultSet rsLO = lsxBean.getSoloTheoSp(spMa[i], "", "");
												...
												<tr>
													...
													<td width="100px" >
														<input type="text" style="width: 100%; text-align: center;" name="<%= spMa[i] %>_spSOLO" value="<%= rsLO.getString("solo") %>" readonly="readonly" >
													</td>
													<td width="100px" >
														<input type="text" style="width: 100%; text-align: center;" name="<%= spMa[i] %>_spNGAYHETHAN" value="<%= rsLO.getString("ngayhethan") %>" readonly="readonly" >
													</td>
													<td width="100px" >
														<input type="text" style="width: 100%; text-align: right;" name="<%= spMa[i] %>_spAVAILABLE" value="<%= rsLO.getString("AVAILABLE") %>" readonly="readonly" >
													</td>
