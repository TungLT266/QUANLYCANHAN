...
<script language="javascript" type="text/javascript">
	...
	function LaySanPham_ChiPhi(elements,view,event,pos){
		var sohieutaikhoan = $('input[name=taikhoankt]')[pos];
		ajax_showOptions(elements,view+'_'+sohieutaikhoan.value,event);
	}
	...
	<form name="dmhForm" method="post" action="../../ErpHoadonkhacNccUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý mua hàng > Nghiệp vụ khác > Hóa đơn điều chỉnh giá NCC > Cập nhật</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
						 ...
						 <TR>
	                      ...
	                      <TD class="plainlabel" valign="middle" colspan="3"   >
	                            ...
	                            <select name="loaihanghoa" id="loaihanghoa" onchange="submitform()" style="width: 200px">
	                              <option value=""></option>
							...
							<TR class="plainlabel">
							 ...
							 <TR>
								...
								<TD class="plainlabel"><input type="text" name="mauhoadon" id="mauhoadon" value="<%=dmhBean.getMauhoadon()%>" style="text-align: left;"
									 > </TD>
								
								<TD class="plainlabel">Ký hiệu hóa đơn</TD>
								<TD class="plainlabel"><input type="text" name="kyhieuhoadon" id="kyhieuhoadon" value="<%=dmhBean.getKyhieu()%>" style="text-align: left;"
									 > </TD>
							</TR>
							
							 <TR>
								<TD class="plainlabel">Số hóa đơn</TD>
								<TD class="plainlabel"><input type="text" name="sohoadon" id="sohoadon" value="<%=dmhBean.getSohoadon()%>" style="text-align: left;"
									 > </TD>
                              ...
                              <%
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<TD  align="center" width="8%" >
												<input type="text"  name="masp" style="width: 100%" value="<%= sp.getMasanpham() %>"  onkeyup="LaySanPham_ChiPhi(this,'donmuahang',event,<%=i %>)" AUTOCOMPLETE="off" > 
											</TD>
											...
											<TD align="center" width="8%">
												...
												<input type="text" value="<%= formatter.format(sp.getThanhtienNguyenTe()) %>"   readonly="readonly"  name="thanhtiennguyente" style="width: 100%; text-align: right;" > 
											</TD>
											 <TD align="center" width="8%">
												<input type="text" value="<%= formatter_0.format(sp.getThanhtien()) %>"   readonly="readonly"  name="thanhtientruocthue" style="width: 100%; text-align: right;" > 
											</TD>
											 <TD align="center" width="8%">
							...
							for(int i = count; i < t; i++) { %>
								...
								<tr>
								 	<TD align="center" width="2%">
											...
											<TD  align="center" width="8%" >
												<input type="text"  name="masp" style="width: 100%" value=""  onkeyup="LaySanPham_ChiPhi(this,'donmuahang',event,<%=i %>)" AUTOCOMPLETE="off" > 
											</TD>
