...
function thue_loaikhac_new(){
	...
	function ThanhToan(n)
	{
		...
		var i = 0.334;
		console.log("Thanh toan: " + i.toFixed(2));
		var trichphi = document.getElementsByName("trichphi");
...
// THANH TOÁN CHO HÓA ĐƠN VNĐ	 	
	 	if(tienteId.item(0).value == "100000"){ 
	 		...
	 		console.log("tongtienVND1: " + tongtienVND);
			...
			if(thuevatVND.item(0).value != ''){
 			...
 			console.log("tongtienVND3: " + tongthanhtoan);
...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ	 	
			...
			var tongttVND = 0;
	 		...
	 		document.getElementById("sotienHDNT").value = DinhDangDonGia((parseFloat(tongtienNT)).toFixed(2));
...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ + TRICH PHÍ VNĐ			
			...
			console.log("tongtienVND4: " + tongttVND);
	...
	// THANH TOAN VND
	  if(tienteId.item(0).value == "100000"){
		  ...
		  var pnhVND;
			...
			console.log("tongtienVND6: " + tongthanhtoan);
			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongthanhtoan));
...
// THANH TOÁN CHO HÓA ĐƠN VNĐ	 	
	 	if(tienteId.item(0).value == "100000"){ 
	 		console.log("tongtienVND8: " + tongtienVND);
	 		document.getElementById("sotienHDVND").value = DinhDangTien(Math.round(tongtienVND));
			...
			if(thuevatVND.item(0).value != ''){
 			...
 			console.log("tongtienVND9: " + tongthanhtoan);
 			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongthanhtoan));
...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ	 	
			...
			console.log("tongtienVND10: " + tongtienVND);
	 		document.getElementById("sotienHDVND").value = DinhDangTien(tongtienVND, 0);
...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ + TRICH PHÍ VNĐ			
			...
			console.log("tongtienVND11: " + tongttVND);
			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongttVND));
			document.getElementById("tongtienNT").value = DinhDangDonGia((tongttNT).toFixed(2));
	  ...
	  if(tienteId.item(0).value == "100000"){
		  ...
		  var pnhVND;
			...
			var tongthanhtoan = parseFloat(sotienthanhtoanVND) + parseFloat(pnhVND) + parseFloat(vatVND);
			console.log("tongtienVND12: " + tongthanhtoan);
			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongthanhtoan));
	   ...
	   // THANH TOÁN CHO LOAI "KHAC" BANG NGOẠI TỆ + TRICH PHÍ NGOẠI TỆ			
			...
			console.log("tongtienVND13: " + tongttVND);
			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongttVND));
			document.getElementById("tongtienNT").value = DinhDangDonGia((tongttNT).toFixed(2));		
	...
	function ThaydoiSotienNT(){
		...
		if(trichphi.item(0).checked == false){ // TRICH PHI BANG NGOAI TE 
			...
			console.log("tongNT: " + (parseFloat(tongNT)));
			console.log("tg: " + parseFloat(tg));
			console.log("tongtienVND14: " + (parseFloat(tongNT)*parseFloat(tg)));
			console.log("tongtienVND14: " + DinhDangTien(parseFloat(tongNT)*parseFloat(tg)));
...
// 			document.getElementById("tongtienNT").value = DinhDangDonGia((tongNT).toFixed(2));
			...
			console.log("tongtienVND15: " + tongVND);
	...
	function tinhthue(){
		...
		if(tienteId.item(0).value != "100000"){ //tien te la ngoai te
			...
			console.log("tongtienVND16 " + tongtienVND);
	...
	function a(){
		...
		if(tienteId.item(0).value != "100000"){ //tien te la ngoai te
			...
			console.log("tongtienVND20: " + tongtienVND);
 			document.getElementById("tongtienVND").value = DinhDangTien(Math.round(tongtienVND));
...
<%// THANH TOAN HOA DON DUNG NGOAI TE %>
            <% if(!tthdBean.getTienteId().equals("100000")){ %>
            	<TR>
                   <%if(tthdBean.getDoiTuongChiPhiKhac().equals("3")){  %>
                    <TD class="plainlabel">Số tiền thanh toán chưa VAT (Ngoại tệ) </TD>
                    <TD class="plainlabel">
			...
			<%  	 if(((Integer.parseInt(tthdBean.getNgayghinhan().substring(0, 4)) == 2014 & Integer.parseInt(tthdBean.getNgayghinhan().substring(5, 7)) < 4)
                       ...
                       <input type="text" style="text-align: right;" readonly="readonly" name="sotienHDNT" id = "sotienHDNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getSotienHDNT().replaceAll(",",""))) %>" onchange="ThanhToan(100)" onKeyPress = "return keypress(event);" >
            <%	 }else{ %>
                       <input type="text" style="text-align: right;" readonly="readonly" name="sotienHDNT" id = "sotienHDNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getSotienHDNT().replaceAll(",",""))) %>" onchange="ThanhToan_2(100)" onKeyPress = "return keypress(event);" >                       
            <%   } %>
                ...
                <TR>
	               ...
	               <%}else{ %> 
                    <TD class="plainlabel" style="display: none">Trích phí bằng VNĐ
...
<%// THANH TOAN HOA DON DUNG NGOAI TE - TRICH PHI BANG NGOAI TE
   	if(tthdBean.getTrichphi().equals("0")) { %>
			...
			<%  if( tthdBean.getLoaiThanhToan().equals("0")){ %>                    
            ...
            <%   } %>
	                   ...
	                   <DIV id="subcontentVATNT" style="position:absolute; visibility: hidden; border: 2px solid #80CB9B; background-color: white; width: 900px; padding: 4px; max-height: 300px; overflow: auto; ">
							<TABLE width="100%" align="center">
        						<TR class="tbheader">
									...
									<TH width="100px" align = "center">Diễn giải </TH>
            	...
            	<TR>
					...
					<% }else { // Loại thanh toán khác thì k cho sửa số tiền%>
					<TD class="plainlabel" style = "width:150px">Tổng tiền thanh toán  (Ngoại tệ)</TD>
                    <TD class="plainlabel">
                         <input type="text" style="text-align: right;" readonly="readonly" name="tongtienNT" id = "tongtienNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getSotienttNT().replaceAll(",",""))) %>"  onKeyPress = "return keypress(event);"  onChange = "ThaydoiSotienNT();"  > 
                     </TD> 
                    <% } %>
...
<%// THANH TOAN HOA DON VNĐ			%>
	<%}else{ %>
            	<TR>
           		 ...
           		 <%if(tthdBean.getDoiTuongChiPhiKhac().equals("3")){ %>
                    <TD class="plainlabel">Số tiền thanh toán chưa VAT (VND) </TD>
                    <TD class="plainlabel" colspan = 3>
			<%  	 if(((Integer.parseInt(tthdBean.getNgayghinhan().substring(0, 4)) == 2014 & Integer.parseInt(tthdBean.getNgayghinhan().substring(5, 7)) < 4)
					 	|| (Integer.parseInt(tthdBean.getNgayghinhan().substring(0, 4)) == 2014 & Integer.parseInt(tthdBean.getNgayghinhan().substring(5, 7)) >=8)
					 	|| (Integer.parseInt(tthdBean.getNgayghinhan().substring(0, 4)) > 2014)
            ...
            <%}else{ // NGOẠI TỆ %>
                ...
                <%} %>	
                	...
                	<TH align="center" width="10%">Số dư HĐ (Ngoại tệ)</TH>
               	 	...
               	 	<TH align="center" width="20%">Địa chỉ</TH>
               	 	<TH align="center" width="5%">Trả hết</TH>
               	 	<%System.out.println("Thanh toán ngoại tệ 1 ");
               	 	%>
                </TR>
			<%} %>
                <%
                	for(int i = 0; i < hoadonList.size(); i++)
                	{
                		...
                		System.out.println("getSotienNT"+hoadon.getSotienNT() ) ;
                		System.out.println("hoadon.getSoTienGoc2()"+hoadon.getSoTienGoc2());
	               		%>
	               		<tr>							
		                	<Td align="center" >
            ...
            <%}else{ // NGOẠI TỆ %>
                <TR class="tbheader"> 
                	...
                	<TH align="center" width="10%">Số dư HĐ (Ngoại tệ)</TH>
               	 	...
               	 	<TH align="center" width="10%">Tỉ giá</TH>
               	 	<TH align="center" width="5%">Trả hết</TH>
               	 	<%System.out.println("Thanh toán ngoại tệ 2"); %>
                </TR>
			<%} %>
                <%
                	for(int i = 0; i < hoadonList.size(); i++)
				 ...
				 <TD>
					<input type="text" name = "kyhieu_VAT_<%=i %>" class="uppercase"  value = "" style="width: 100%" >
						...
						<TD>
							...
							<%} else { %> --%>
								<input type="text" name= "tienhang_VAT_<%=i %>"  id= "tienhang_VAT_<%=i %>"  value = ''  style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new();" onKeyPress = "return keypress(event);">
							<%-- <%} %> --%>
						</TD>
						...
						<TD>
							...
							<%} else { %> --%>
								<input type="text" name= "thuesuat_VAT_<%=i %>"  id= "thuesuat_VAT_<%=i %>"  value = ''  style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new();" onKeyPress = "return keypress(event);">
							<%-- <%} %> --%>
						</TD>
						...
						<TD>
							...
							<%} else { %> --%>
								<input type="text" name= "tienthue_VAT_<%=i %>" id= "tienthue_VAT_<%=i %>" value = ''  style="width: 100%;text-align: right" onkeyup = "return keypress(event);"  onkeyup="tinhTienThueTuDo(this);">
							<%-- <%} %> --%>
						</TD>  		                         		
			</TR>
			<%
