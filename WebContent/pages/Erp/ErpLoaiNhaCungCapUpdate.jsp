...
<script type="text/javascript">
	...
	function Save() {
		...
		document.forms['lnccForm'].action.value = 'Update';
						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Loại Nhà Cung Cấp > Cập nhật</TD>
					...
					<table width="100%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr class="tbdarkrow">
										<td width="30" align="left"><a href="../../ErpLoaiNhaCungCapSvl"> <img src="../images/Back30.png" alt="Quay ve" title="Quay ve"
