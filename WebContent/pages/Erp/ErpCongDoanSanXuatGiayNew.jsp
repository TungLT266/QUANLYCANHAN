						...
						<TR>
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản xuất > Công đoạn sản xuất > Tạo mới</TD>
								...
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TD class="plainlabel"  width="130px">Kiểm định định lượng</TD>
											...
											<input type="checkbox" name="dinhluong" onchange="submitform();"   value="1" checked="checked" >
											<%}else { %>
											<input type="checkbox" name="dinhluong" onchange="submitform();" value="1">
										...
										<TD class="plainlabel"  width="130px">Kiểm định định tính</TD>
											...
											<input type="checkbox" name="dinhtinh" onchange="submitform();"   value="1" checked="checked" >
											<%}else { %>
											<input type="checkbox" name="dinhtinh" onchange="submitform();" value="1">
										...
										<TD class="plainlabel">
											<select name="loaimauinSxId" id= "loaimauinSxId" style="width: 250px">
											<option value=""></option>
											<%
