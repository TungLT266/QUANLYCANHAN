...
<% 
	...
	LinkedHashMap<String, String> sanpham_soluong = lsxBean.getSanpham_soluong_ordered();
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Nhập kho > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
       ...
       <%--  <A href= "../../InPDF_PhieuNhapThanhPhamSvl?userId=<%= userId %>" >
        	<img src="../images/pdf.jpg" alt="PDF"  title="PDF" border="1px" longdesc="PDF" style="border-style:outset"></A> --%>
        	
        <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>&loai=1" >
	    ...
	    <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>&loai=2" " >
	     ...
	     <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>&loai=3" " >
	    ...
	    <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>&loai=4" " >
	   	...
	   	<A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>&loai=5" >
	    	<img src="../images/Printer30.png" alt="In" title="In phieu nhap thanh pham" longdesc="In phieu nhap thanh pham" border=1 style="border-style:outset"></A>	
        
        <%if(lsxBean.getKhoNhapId().equals("100074")) %>
        <A href="../../XuatExcel_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=lsxBean.getId()%>" >
	    	<img src="../images/pdf_icon4.png" alt="NhanDan" title="Nhan Dan" longdesc="Nhan Dan" border=1 style="border-style:outset; width:30px; height:30px"></A>
