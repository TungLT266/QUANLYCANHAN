									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<%-- <tr>
											...
											<input
												...
												<textarea name="quycach" style="width: 70%; color: black;"
										...
										<TR>
											...
											<TD class="plainlabel"> 
												<input type="text" readonly="readonly" name="quytrinhsx" id= "quytrinhsx"  value="<%=obj.getQuytrinhsx()%>">
											</TD>
											
											<TD class="plainlabel"  valign="middle">Ngày ban hành QTSX</TD>
											<TD class="plainlabel"> 
												<input readonly="readonly" type="text" name="ngaybanhanhqtsx" id= "ngaybanhanhqtsx"  value="<%=obj.getNgaybanhanhQTSX() %>">
											</TD>
										</TR>
										...
										<TR>
											...
											<TD class="plainlabel"> 
												<input type="text" readonly="readonly" name="daychuyensanxuat" id= "daychuyensanxuat"  value="<%=obj.getDaychuyensanxuat() %>">
											</TD>
										</TR>
													...
													<div id="tab_1" class="tabContents" style="display: block">
														...
														<table width="100%" cellpadding="4" cellspacing="2">
															...
															<tr>
																...
																<td><input type="text" name="dungsai" value="<%=vattu.getDungsai()%>" style="width: 100%; text-align: right;" readonly></td>
															...
															<tr>
																...
																<td><input type="text" name="dungsai" value="" style="width: 100%; text-align: right;" readonly></td>
