				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý cung ứng > Lập kế hoạch > Đề nghị sản xuất > Cập nhật </TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Đề nghị sản xuất </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						 ...
						 <TR>
                          ...
                          <TR>
		                        <TD class="plainlabel" valign="middle" width="150px" >Nhà máy</TD>
		                        <TD class="plainlabel" valign="middle" colspan="3" >
		                            <select name="nhamayId" readonly=readonly style="width:350px">
		                            	<%
			                        		if(nhamayRs != null)
			                        		{
			                        			while(nhamayRs.next())
			                        			{  
			                        			if( nhamayRs.getString("id").equals(obj.getNhamayId())){ %>
			                        				<option value="<%= nhamayRs.getString("id") %>" selected="selected" ><%= nhamayRs.getString("ten") %></option>
			                        			<%}else { %>
			                        				<option value="<%= nhamayRs.getString("id") %>" ><%= nhamayRs.getString("ten") %></option>
			                        		 <% } } 
			                        			nhamayRs.close();
			                        		}
			                        	%>
