...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function kiemTraPhanBo(){
		...
		console.log("tongTienPhanBos: " + tongTienPhanBo + ", tongtienhang: " + parseFloat(tongtienhang));
...
// 				console.log(sp);
	...
	function Tinhtienthue(n)
	{
		...
		console.log("tienhang.item(n).value: " + tienhang.item(n).value);
	...
	function tinhPhanBo(n){
		...
		console.log("tongTienSanPham: " + tongTienSanPham);
		var tongPtSanPham = 0;
		if(phieunhan.item(0).value !=''){
			for( var i = 0; i < tienSanPham.length; i++){
				if(tienSanPham.item(i).value != ''){
					var tienSanPhamI = parseFloat(tienSanPham.item(i).value.replace(/,/g,""));
					console.log("tienSanPhamI: " + tienSanPhamI);
					if (tienSanPhamI > 0)
					{
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý mua hàng > Nghiệp vụ khác > Chi phí nhận hàng > Tạo mới</TD> 
					           	 				...
					           	 				<DIV  id="subcontentSanPhamKho_"  style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
								                     ...
								                     <table  align="center" class = "legendtitle" >
							                        	...
							                        	<%	 	for(int i =0; i< spList.size(); i++)
							                        			{  %>
							                        			<tr>
							                        				<td><input style="width: 100px" name="masanpham" id="masp" value="<%= spList.get(i).getMaLon() %>" readonly="readonly"  >
							                        					<input style="width: 100px" name="masp" id="masp" type = "hidden" value="<%= spList.get(i).getMaLon() %>"   >
							                        				...
							                        				<td><input style="width: 100%; text-align: right;"  name="phanboSanPham" id="phanboSanPham" value="<%= formatter.format(spList.get(i).getPhanBo()) %>" onchange="MyDinhDangTien(this)" readonly="readonly"></td>
							                        			</tr>
...
<!-- 											End Sản phẩm kho -->				           	 				
		                  ...
		                  <TR>
		                    ...
		                    <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="tongtienhang" id ="tongtienhang" value="<%= formatter1.format(Double.parseDouble(obj.getTongtienhang().replace(",", "")))  %> "  readonly="readonly" > 
		                        </TD> 
		                        	<TD class="plainlabel"></TD>
								<TD class="plainlabel"></TD>         
		                  </TR>
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="tongtienthue" value="<%=  formatter1.format(Double.parseDouble(obj.getTongtienthue().replace(",", "")))  %>"  readonly="readonly"> 
		                        </TD>  
		                        	<TD class="plainlabel"></TD>
								<TD class="plainlabel"></TD>        
		                  </TR>
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="tongtien" id = "tongtien" value="<%= formatter1.format(Double.parseDouble(obj.getTongtien_AVAT().replace(",", "")))  %>"  readonly="readonly"> 
		                        </TD>  
		                        	<TD class="plainlabel"></TD>
								<TD class="plainlabel"></TD>        
		                  </TR>
									...
									<table width="100%" cellpadding="0px" cellspacing="1px">
										...
										if(sochungtu != null) {  
											...
											for(int i = 0; i < sochungtu.length; i++)
											{
												...
												<TR>
													...
													<td>
														<input type="text" name="tienhang" style="width: 100%; text-align: right;" value="<%= tienhang[count].length() == 0?"":formatter.format(Double.parseDouble(tienhang[count].replaceAll(",",""))) %>" onchange="Tinhtienthue(<%=count%>);">
													</td>
													<td>
														<input type="text" name="thuesuat" style="width: 100%; text-align: right;" value="<%= thuesuat[count].length() == 0?"":formatter.format(Double.parseDouble(thuesuat[count].replaceAll(",",""))) %>"  onchange="Tinhtienthue(<%=count%>);">
													</td>
													<td>
														<input type="text" name="tienthue" style="width: 100%; text-align: right;" value="<%= tienthue[count].length() == 0?"":formatter.format(Double.parseDouble(tienthue[count].replaceAll(",",""))) %>"  onchange="Tinhthuesuat(<%=count%>);">
													</td>
													<td>
										...
										<% int i = 0; 
											...
											<TR>
												...
												<td>
													<input type="text" name="nhacungcap" id = <%= "nhacungcap"  + i %> style="width: 100%; text-align: right;" value="" >
												</td>
												<td>
													<input type="text" name="diaChiNCC" id = <%= "diaChiNCC"  + i %> style="width: 100%; text-align: right;" value="" >
												</td>
												<td>
											      			<input type="text" name= <%= "mst" %> id = <%= "mst"  + i %>  value = "" style="width: 100%; border-radius:4px; height: 20px;">
												      			<script type="text/javascript">
																	jQuery(function()
																		{		
																			$("#mst<%="" + i %>").autocomplete("MST_NCC_DNTT.jsp?");
																		});	
																</script>	
											      		
												</td>
												<td>
													<input type="text" name="tienhang" style="width: 100%; text-align: right;" value = "" onchange="Tinhtienthue(<%=i + count%>);">
												</td>
												<td>
													<input type="text" name="thuesuat" style="width: 100%; text-align: right;" value = "" onchange="Tinhtienthue(<%=i + count%>);">
												</td>
												<td>
													<input type="text" name="tienthue" style="width: 100%; text-align: right;" value = "" onchange="Tinhthuesuat(<%=i + count%>);">
												</td>
												<td>
													<input type="text" name="cong" style="width: 100%; text-align: right;" value = "" readonly="readonly" >
												</td>
											</TR>
