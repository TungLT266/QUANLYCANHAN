...
<%@ page  import = "geso.traphaco.erp.beans.erp_nhomtaisan.IErp_nhomtaisanList" %>
<%@ page  import = "geso.traphaco.erp.beans.erp_nhomtaisan.imp.Erp_nhomtaisanList" %>
...
<%
	...
	if(!util.check(userId, userTen, sum)){
		response.sendRedirect("/TraphacoHYERP/index.jsp");
 		...
 		IErp_nhomtaisanList ntsList = (Erp_nhomtaisanList)session.getAttribute("ntsList");
 		ResultSet RsTs = ntsList.getRsts();
		ResultSet ltsRs = ntsList.getRslts();
		ResultSet cdtsRs = ntsList.getRsCdts();
		
 		int[] quyen = new  int[5];
		quyen = util.Getquyen("Erp_NhomTaiSanSvl","",userId);
...
<form name="cnForm" method="post" action="../../Erp_NhomTaiSanSvl">
		...
		<td colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
			<table width="100%" cellpadding="0" cellspacing="1">		
				<tr>
					<td align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <td align="left" colspan="2" class="tbnavigation">&nbsp; Quản lý tài sản > Nhóm tài sản					   
						   </td>
					...
					<table border="0" width="100%" cellpadding="0" cellspacing="0">
						<tr>
							...
							<table width="100%" cellpadding="6" cellspacing="0">
								...
								<tr>
									<td width = "15%" class = "plainlabel">Loại tài sản </td> 
									<td class = "plainlabel"> 
								...
								<tr>
									<td width = "15%" class = "plainlabel">Công dụng tài sản </td> 
									<td class = "plainlabel"> 
				...
				<tr>
					<td width="100%">
						<fieldset>
						<legend class="legendtitle">&nbsp;Nhóm tài sản &nbsp;&nbsp;&nbsp;
		   				...
		   				<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  				<tr>
									...
									<table class = "tabletitle" width="100%" border="0" cellspacing="1" cellpadding="4">
										<tr class="tbheader">
											<th width="15%">Mã nhóm tài sản</th>
										...
										<td align = "center">
											<table border = 0 cellpadding="0" cellspacing="0">
												...
												<td>
													...
													<%if(quyen[2]!=0){ %>
													<a href = "../../Erp_NhomTaiSanUpdateSvl?userid=<%=userId%>&update=<%=RsTs.getString("pk_seq")%>"><img src="../images/Edit20.png" alt="Chinh sua" width="20" height="20" longdesc="Chinh sua" border = 0></A>
													<%} %>
												</td>
												<td>&nbsp;&nbsp;</td>
												<td>
												<%if(quyen[1]!=0){ %>
												<a href = ../../Erp_NhomTaiSanSvl?userid=<%=userId%>&delete=<%=RsTs.getString("pk_seq")%>><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa nhóm tài sản này ?')) return false;"></a> 
												<%}	 %>
												</td>
