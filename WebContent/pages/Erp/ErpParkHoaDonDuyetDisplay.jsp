...
<form name="erpParkForm" method="post" action="../../ErpParkHoadonduyetUpdateSvl">
...
<input type="hidden" name="loaihd" value='<%= pBean.getLoaihd() %>'>
<input type="hidden" name="action" value='1'>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Duyệt hóa đơn NCC > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpParkHoadonduyetSvl?userId=<%= userId %>" >
        	<img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1px" longdesc="Quay ve" style="border-style:outset"></A>
        
          <%if(pBean.getCoPhieuChi().equals("1")) { %>
        	 <span id="btnSave">
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                        <input type="text" class="days" 
                               id="ngayghinhan" readonly="readonly" name="ngayghinhan" value="<%= pBean.getNgayghinhan() %>" maxlength="10"  />
                    </TD>
                </TR>
                    <TR>
                   ...
                   <%} %>
                     ...
                     <% if(!pBean.getLoaihd().equals("0"))	 // CHI PHÍ DỊCH VỤ OR TRONG NƯỚC
                     	{
                     %>
	                      <TR >
					...
					<%} else { // HÓA ĐƠN NHẬP KHẨU %>
						
						<TR >
                        <TD class="plainlabel" width="15%">Số nhập kho nhập khẩu </TD>
                       	<TD class="plainlabel" colspan="3">
							
							<a href="" id="soPOLIST" rel="subcontentPO"><img alt="Số nhập kho nhập khẩu" src="../images/vitriluu.png"></a>
	                   		<DIV id="subcontentPO" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 350px; padding: 4px; max-height: 200px; overflow: auto;" >
					          <table width="100%" align="center">
						        <tr>
						         <th width="100px">Số nhập kho nhập khẩu</th>
						         <th width="100px">Ngày mua </th>
						         <th width="100px" align="center" >Chọn</th>
						        </tr>
						        <%
                    	...
                    	<TR>
                    		<TD>
                       		...
                       		<TD align="left">
    					          ...
    					          <table width="100%" align="center">
    						        <tr>
    						         <th width="100px">Số nhập kho</th>
    						         <th width="110px">Mã hàng</th>
    						         <th width="150px">Tên hàng</th>
    						         <th width="100px">ĐVT</th>
    						         <th width="100px">SL đặt</th> 
    						         <th width="100px">Số lô</th> 
    						         <th width="100px">SL HĐ</th>		 						        
    						        ...
    						        for(d = 0; d < hd.getPnkList().size(); d ++){
    						        	...
    						        	<tr >
    						        		<td>						        		  
    					        		  	...
    					        		  	<td>
    					        		  		<input type="text" id="sohoadon<%= i %>.soluongdat<%= d %>" readonly="readonly"   value="<%= formatter.format( Double.parseDouble(sp.getSoluong())) %>" name="sohoadon<%= i %>.soluongdat" style="width: 100%; text-align: right;" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
    					        		  						        		  		
    					        		  	</td>
    					        		  	<td>
    					        		  		<input type="text"  readonly="readonly" value="<%= sp.getSolo()  %>" name="sohoadon<%= i %>.solo" style="width: 100%">	
    				        		  			<input type="hidden"  readonly="readonly" value="<%= sp.getDungsai()  %>" name="sohoadon<%= i %>.dungsai" style="width: 100%">	
    				        		  		</td>
    					        		  	<td>
    					        		  		<input type="text" id="sohoadon<%= i %>.soluong<%= d %>"   value="<%= formatter.format( Double.parseDouble(sp.getSoluonghd())) %>" name="sohoadon<%= i %>.soluong" style="width: 100%; text-align: right;" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
    					        		  	...
    					        		  	<td>
    					        		  		 <%if(pBean.getLoaidonmh().equals("2")) { // NẾU LÀ ĐƠN MUA HÀNG CHI PHÍ DỊCH VỤ THÌ KHÔNG CHO PHÉP SỬA ĐƠN GIÁ %>
    					        		  			<input type="text" id="sohoadon<%= i %>.dongia<%= d %>"   value="<%= formatter1.format( Double.parseDouble(sp.getDongia())) %>" name="sohoadon<%= i %>.dongia" style="width: 100%; text-align: right;"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);" readonly="readonly">
    					        		  		 <%} else { %> 
    					        		  			<input type="text" id="sohoadon<%= i %>.dongia<%= d %>" value="<%= formatter1.format( Double.parseDouble(sp.getDongia())) %>" name="sohoadon<%= i %>.dongia" style="width: 100%; text-align: right;"  onchange="Kiemtra5(this);" onKeyPress = "return keypress(event);">
    					        		  		 <%} %>		        		  		
    					        		  	</td>

    					        		  	<td>
    					        		  		<input type="text"  id="sohoadon<%= i %>.thanhtien<%= d %>"   value="<%= formatter.format( Double.parseDouble(sp.getThanhtien())) %>" name="sohoadon<%= i %>.thanhtien" style="width: 100%; text-align: right;"  onkeyup="Kiemtra15(this);" onKeyPress = "return keypress(event);" >
                       		...
                       		<TD class="plainlabel" valign="middle" >
                       			...
                       			%>
                            	<input type="text" readonly="readonly" onkeyup="Dinhdang(this)" id="chietkhau<%= i %>" name="chietkhau<%= i %>" value="<%= tienCK %>"   style="text-align: right;" />
                       		</TD> 
                       		...
                       		<TD class="plainlabel" valign="middle">
                       			...
                       			%>
                            	<input type="text" name="vat<%= i %>"  id="vat<%= i %>" style="text-align: right;" onkeyup="Dinhdangvat(this)" style="text-align: right;"  value="<%=vat%>" onKeyPress = "return keypress(event);" />
                       		</TD> 
                       		<TD class="plainlabel" valign="middle">
