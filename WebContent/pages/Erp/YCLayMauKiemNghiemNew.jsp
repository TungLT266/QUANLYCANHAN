					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"
									<%System.out.println("LOAI KIEM DINH: " + obj.getLoaiKiemDinh());%>
									<%if(obj.getLoaiKiemDinh().equals("1")) {%> colspan="3"
									<%}%>><SELECT NAME="loaikiemdinh"
									id="loaikiemdinh" style="width: 200px; height: 20"
									onchange="thaydoiLoaiKD()">
										<option value="" SELECTED></option>
										<%
								...
								<TD class="plainlabel" width="15%">Số phiếu kiểm định chất
									lượng</TD>
								<TD class="plainlabel" width="15%"><SELECT NAME="sophieukd"
									id="sophieukd" style="width: 200px; height: 20"
									onchange="filter()">
										<option value="" SELECTED></option>
										<%
							...
							<TR>
								...
								<TD class="plainlabel" width="15%"><input type="text"
									name="soctmau" id="soctmau"
									value="<%=obj.getSoChungTuNhapMau()%>"></TD>
							...
							<TR>
								...
								<TD class="plainlabel" width="15%"><input type="text"
									name="hosokemtheo" id="hosokemtheo"
									value="<%=obj.getHosokemtheo()%>"></TD>
							...
							<TR>
								...
								<TD class="plainlabel" width="15%"><select id="khoanmuc"
									onchange="ChonKhoBietTru();" name="khoanmuc"
									style="width: 200px;">
										<option value="" SELECTED></option>
										<%
											if (rsKhoanMuc != null) {
								...
								<TD class="plainlabel" width="15%">Chọn kho theo dõi độ ổn
									định</TD>
								<TD class="plainlabel" width="22%"><select
					...
					<div align="left" style="width: 100%; float: none; clear: none;"
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="1"
							...
							<!-- <tr class="tbheader">
								...
								<th align="center" width="8%">Lô hàng</th>
								<th align="center" width="7%">Ngày SX</th>

								<th align="center" width="7%">Ngày HH</th>
								<th align="center" width="5%">Mã thùng</th>
								...
								<th align="center" width="8%">Thời gian hủy mẫu dự kiến</th>
