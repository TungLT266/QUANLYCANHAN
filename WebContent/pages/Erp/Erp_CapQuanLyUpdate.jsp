...
<%@ page  import = "geso.traphaco.erp.beans.erp_capquanly.IErp_capquanly" %>
<%@ page  import = "geso.traphaco.erp.beans.erp_capquanly.imp.Erp_capquanly" %>
				...
				<tr>
					...
					<tr>
					    ...
					    <TR>
							...
							<td class="plainlabel">
					  			<SELECT  name="ctyId" id="ctyId" class="select2" style="width: 500px;"  onchange=" submitform()">
								<option value= "" selected></option>	
								<%try {%>
								<% 	while (rsCty.next()){%>
										
										<%	if(rsCty.getString("PK_SEQ").equals(cnBean.getCtyId())){ %>											
