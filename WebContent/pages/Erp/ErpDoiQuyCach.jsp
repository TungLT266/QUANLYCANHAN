...
<% IErpDoiquycachList obj = (IErpDoiquycachList)session.getAttribute("obj"); %>
...
<%  
	...
	if(!util.check(userId, userTen, sum)){
		response.sendRedirect("/TraphacoHYERP/index.jsp");
		 ...
		 int[] quyen = new  int[5];
		 quyen = util.Getquyen("ErpDoiquycachSvl","",userId);
...
<head>
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 {
	 	 if(!confirm('Bạn có muốn chốt đổi quy cách này ?')) 
	 	 {
	 		 return false ;
	 	 }
	 ...
	 {
	 	 if(!confirm('Bạn có muốn bỏ chốt yêu cầu đổi quy cách này không?')) 
	 	 {
	 		 return false ;
	 	 }
...
<body>
<form name="erpLsxForm" method="post" action="../../ErpDoiquycachSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Đổi quy cách 
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR>
                        <TD class="plainlabel" width="10%">Ngày đổi:</TD>
                    ...
                    <TR>
                        <TD class="plainlabel" width="10%">&nbsp;</TD>
                         <TD class="plainlabel" width="10%">Kho đổi </TD>
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Đổi quy cách  </span>&nbsp;&nbsp;
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" width="8%">Ngày đổi</TH>
	                 	<TH align="center" width="12%">Kho xuất</TH>  
	                    <TH align="center" width="12%">Kho nhận</TH> 
	                    <TH align="center" width="20%">Lý do</TH>
					...
					<%
                 		if(lsxList != null)
                 		{
		                    ...
		                    <TD align="center"><%= lsxList.getString("ngaydoi") %></TD>
		                    ...
		                    <TD align="center"> 
		                    	...
		                    	<%if(quyen[2]!=0){ %>
                                	<A href = "../../ErpDoiquycachUpdateSvl?userId=<%=userId%>&update=<%=lsxList .getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                                <%} %>
                                 <%if(quyen[4]!=0){ %>
	                                <A href="javascript:duyetform(<%= lsxList.getString("PK_SEQ") %>, '<%= obj.getIsnhanHang() %>' );" >
									 	<img  src="../images/Chot.png" alt="Chốt đổi quy cách" width="20" height="20"  border='0' title="Chốt đổi quy cách"	 >
									</A>
                                <%} %>
                                 <%if(quyen[1]!=0){ %>
                                	<A href = "../../ErpDoiquycachSvl?userId=<%=userId%>&delete=<%= lsxList.getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><img src="../images/Delete20.png" alt="Xóa đổi quy cách" title="Xóa đổi quy cách" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa đổi quy cách này không?')) return false;"></A>
                                <%} %>	
                                								
		                    <% } else {  %>
		                    	<A href = "../../ErpDoiquycachUpdateSvl?userId=<%=userId%>&display=<%= lsxList.getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" width="20" height="20" border=0></A>&nbsp;	
		                    <% } %> 
