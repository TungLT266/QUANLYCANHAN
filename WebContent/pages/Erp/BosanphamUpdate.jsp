...
<div id="main" style="width:100%">
	...
	<% if (obj.getId().length() == 0) {%>
		<div style="width:70%; padding:5px; float:left" class="tbnavigation">&nbsp;Quản lý cung ứng &gt; Sản xuất  &gt; Bó sản phẩm  &gt; Tạo mới
	<%}else{ %>
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">&nbsp;Quản lý cung ứng &gt; Sản xuất  &gt; Bó sản phẩm  &gt; Cập nhật
    <%} %>
        </div>
        ...
        <div style="width:100%; float:none" align="left">
             			<TABLE border="0" width="100%" >
							...
							<TD align="left" colspan="4" class="legendtitle">
			    				...
			    				<textarea name="dataerror"  cols="100%" rows="1" style="background-color: white;color: red;"><%=obj.getmsg() %> </textarea>
									...
									<TABLE class="tblight" width="100%" cellpadding="6" cellspacing = "0" border = "0">
										...
										<TR>
											<TD class="plainlabel" width="120px" >Sản phẩm </TD>
										  	<TD width="420px" class="plainlabel" ><INPUT id = "spTen1" name="spTen1" type="text"  value="<%=obj.getSpTen1() %>" style="width:400px"></TD>
										  	
										  	<TD class="plainlabel" width="100px" >Đơn vị tính </TD>
										  	<TD width="100px" class="plainlabel" ><INPUT readonly="readonly" id = "dvt1" name="dvt1" type="text"  value="" style="width:100px"></TD>
										  	
											<TD width="100px" class="plainlabel" >Số lượng </TD>
											<TD width="105px" class="plainlabel" ><INPUT name="soluong1" type="text" value="<%=formatter1.format(Double.parseDouble(obj.getSoluong1())) %>" style = "width:100px" onkeypress = "return keypress(event);" ></TD>
					               ...
					               <% for(int i = 1; i < 5; i++){ %>
										...
										<TR>
											<TD class="plainlabel" width = "120px">Sản phẩm  <%= i %></TD>
										  	<TD  width="420px" class="plainlabel" ><INPUT Id = <%= "spTen" + (i+1)%> name=<%= "spTen" + (i+1)%> type="text" size="40" value="<%= spTen2[i-1]  %>" style="width:400px"></TD>
										  	
										  	<TD class="plainlabel" width="100px" >Đơn vị tính </TD>
										  	<TD width="100px" class="plainlabel" ><INPUT readonly="readonly" id = <%= "dvt" + (i+1)%> name="dvt1" type="text"  value="" style="width:100px"></TD>
										  	
											<TD  width="100px" class="plainlabel">Số lượng </TD>
											<TD  width="105px"  class="plainlabel" ><INPUT name=<%= "soluong" + (i+1)%> id=<%= "soluong" + (i+1)%> type="text" value="<%= formatter1.format(Double.parseDouble(soluong2[i - 1])) %>" style = "width:100px" onkeypress= "return keypress(event);"  ></TD>
...
<script type="text/javascript">
	...
	jQuery(function()
	{		
		$("#spTen1").autocomplete("SanPhamList.jsp");		

		$("#spTen2").autocomplete("SanPhamBoList_2.jsp");		
		$("#spTen3").autocomplete("SanPhamBoList_2.jsp");		
		$("#spTen4").autocomplete("SanPhamBoList_2.jsp");		
		$("#spTen5").autocomplete("SanPhamBoList_2.jsp");		
		$("#spTen6").autocomplete("SanPhamBoList_2.jsp");		
	});	
