...
<input type="hidden" name="id" value='<%= hctbhBean.getId() %>'>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý cung ứng > Quản lý bán hàng > Hủy chứng từ bán hàng > Cập nhật hủy chứng từ
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
            	 <TR>
                    ...
                    <TD colspan="2" class="plainlabel" valign="top">
                    	...
                    	//String mangten[] = new String[]{"Phiếu giao hàng", "Đơn hàng", "Xuất hóa đơn tài chính", "Xuất hóa đơn khác" };
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="2"  valign="top">
                    	<input type="text" id="sochungtu" name="sochungtu" value="<%= hctbhBean.getSochungtu() %>" onchange="submitform()"  />
                    </TD>                    
                </TR>
						...
						<img alt="Theo dõi thông tin hàng nhập" src="../images/vitriluu.png"></a>
    	 				<DIV style='display:none'>
                  		<DIV id="ndThongtinhangnhap" style='padding:0px 5px; background:#fff;'>
                  			...
                  			<h3 align="justify" style="font-weight: normal;"> Chúng tôi cam kết và hoàn toàn chịu trách nhiệm về việc thu hồi và xóa bỏ hóa đơn này. </h3>
                  			<h3 align="justify" style="font-weight: normal;"> Biên bản này lập thành 02 bản, Bên A giữ 01 bản, Bên B giữ 01 bản.</h3>
