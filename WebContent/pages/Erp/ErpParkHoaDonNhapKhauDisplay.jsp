...
<form name="erpParkForm" method="post" action="../../ErpParkHoadonnhapkhauUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng &gt; Mua hàng nhập khẩu &gt; Hóa đơn nhập khẩu &gt; Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
	    ...
	    <%--  <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=pBean.getId()%>&loai=1" >
	    	<img src="../images/Printer30.png" alt="In" title="In phieu nhap vat tu bao bi 1" longdesc="In phieu nhap vat tu bao bi 1" border=1 style="border-style:outset"></A>
	    <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=pBean.getId()%>&loai=2" " >
	    	<img src="../images/pdfblue.jpg" alt="In" title="In phieu nhap vat tu bao bi 2" longdesc="In phieu nhap vat tu bao bi 2" border=1 style="border-style:outset;width:30px; height:30px"></A>
	     <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=pBean.getId()%>&loai=3" " >
	    	<img src="../images/Pdf30.jpg" alt="In" title="In phieu nhap vat tu nguyen lieu" longdesc="In phieu nhap vat tu nguyen lieu" border=1 style="border-style:outset; width:30px; height:30px"></A>	
	   
	    <A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=pBean.getId()%>&loai=4" " >
	    	<img src="../images/pdf.jpg" alt="In" title="In phieu phap vat tu cao" longdesc="In phieu nhap vat tu cao" border=1 style="border-style:outset; width:30px; height:30px"></A>		
	   
	   	<A href="../../InPDF_PhieuNhapThanhPhamSvl?userId=<%=userId%>&id=<%=pBean.getId()%>&loai=5" >
	    	<img src="../images/Printer30.png" alt="In" title="In phieu nhap vat tu bao bi 1" longdesc="In phieu nhap vat tu bao bi 1" border=1 style="border-style:outset"></A>	
        	  --%>
	     ...
	     <% System.out.println ("id hoa don :"+ pBean.getId()) ;%>
	   	...
	   	<A href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=1&loaihd=0">
		...
		<A style="display: none" href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=2&loaihd=0">
      	<img src="../images/pdf_icon4.png" alt="In phieu nhap vat tu 2"  title="In phieu nhap vat tu 2" border="1px" longdesc="In phieu nhap vat bi 2" style="border-style:outset"></A>
			...
			<A href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=3&loaihd=0">
    	...
    	<legend class="legendtitle"> Hóa đơn NCC</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
					...
					<TD class="plainlabel" valign="middle" > Số PO </TD>   
                     ...
                     <TD class="plainlabel">
                       		<input name = "tigia" id = "tigia"  type = "text" value = "<%= pBean.getTigia() %>" 
						...
						<TR>
							...
							<TD class="plainlabel" width="15%"><input type="text"
								...
								<input type="hidden" readonly name="sotienchuathue"
								id="sotienchuathue" value="<%=pBean.getSoTienChuaThue()%>" />
							...
							<TD class="plainlabel" width="15%"><input type="text"
							 name="tongVND" id="tongVND" readonly value="<%= formatterVND.format( pBean.getTongVND()) %>" />
							</TD>
						...
						<TR>
							...
							<TD class="plainlabel" width="15%" colspan="3"><input type="text"
								...
								value="<%=pBean.getKyHieuHoaDon()%>" /> <input type="hidden"
								readonly name="thuegtgt" id="thuegtgt"
								value="<%=pBean.getThuegtgt()%>" /></TD>

						</TR>
						<TR>
							<TD class="plainlabel" width="15%">Ngày hoá đơn</TD>
							<TD class="plainlabel" width="15%" colspan="1"><input
								type="text" name="ngayhoadon" id="ngayhoadon"
								value="<%=pBean.getNgayHoaDon()%>" class="days" />
							</TD>
						...
						<TR>
								...
								<TD class="plainlabel" colspan="3"><SELECT NAME="khobiettruId"
									id="khobiettruId" style="width: 200px;">
									<option value=""></option>
										<%
											if (RsKhoTonTru != null) {
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="right">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= sp.getDongia() %>" 
           	 					name= "dongiaMua" readonly="readonly" >
           	 				</td>
           	 				
           	 				<td align="right"><input type="text"
								style="width: 100%; text-align: right;"
								value="<%=  formatter_4le.format( Double.parseDouble(sp.getDongiaVND().replaceAll(",","")))%>" 
							name="dongiaMuaVND" readonly="readonly">
								<input type="hidden" style="width: 100%; text-align: right;" 
													 ...
													 /></td>
							                            <td>
							                            	<input type="text" size="100px"  class="days" 
							                            		name="<%= sp.getId() +"."+sp.getMuahang_fk()+i+ ".ngaysanxuat" %>" value="<%= spDetail.getNgaySx() %>" readonly="readonly" onchange="replaces()" /></td>
							                            <td>
							                            	<input type="text" size="100px"  class="days" 
           	 				...
           	 				<td align="right">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= sp.getthanhtien() %>" name= "thanhtien" readonly="readonly" >
           	 				</td>
           	 				<td align="right"><input type="text"
									style="width: 100%; text-align: right;"
									value="<%=formatterVND.format( Double.parseDouble(sp.getThanhtienVND().replaceAll(",","")))%>" name="thanhtienVND"
									></td>
