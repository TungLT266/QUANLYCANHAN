		 ...
		 if(travay!=null)
		 {
			...
			for( i=0 ; i<travay.length;i++)
			{
			     if((ngaytravay.item(i).value!="")&&(travay.item(i).value!=""))
			     {
					 ...
					 tralai.item(i).value=DinhDangDonGia(Math.round((sotienconlai*ls*totalDays)/(100*365)));
...
<div id="main" style="width:100%">
	...
	<%}else{ %>
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">&nbsp;Quản lý kế toán &gt; Giải ngân  &gt; Hiển thị
    <%} %>
        </div>
                    		...
                    		<%} %>
								...
								<TR>
                						 ...
                						 <TD  class="plainlabel" width = "10%">Thời hạn trả vay</TD>
										  ...
										  <INPUT name="thoihan" id="thoihan" type="text" style="width:100" value="<%= obj.getThoihan() %>"  onkeypress="return isNumberKey2(event)" onChange = "submitform();"> Tháng</TD>
