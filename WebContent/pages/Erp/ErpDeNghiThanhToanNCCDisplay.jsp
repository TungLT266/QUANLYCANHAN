...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Đề nghị thanh toán NCC > Hiển thị
        </div>
    	...
    	<legend class="legendtitle"> Ủy nhiệm chi </legend>
           ...
           <TABLE width="100%" cellpadding="4" cellspacing="0" border = '0'>		
			...
			<%} else if (tthdBean.getDoiTuongChiPhiKhac().equals("3")) { %>
					     <TR>
					          <TD width="20%" class="plainlabel" valign="top">Định khoản nợ</TD>
					          <TD colspan="4" class="plainlabel" valign="top">
					          <input  type="text" name="dinhkhoanno" id="dinhkhoanno" value="<%= tthdBean.getDinhkhoanno()%>"  style="width:400px">
					          <input type="hidden" id="dinhkhoannoId" name="dinhkhoannoId" value = "<%=tthdBean.getDinhkhoannoId() %>" style="width: 400px">	
					          </TD>
					     </TR> 		
						 <TR>   
					            ...
					            <TD class="plainlabel">Mã và tên đối tượng</TD>
					             <TD class="plainlabel" valign="middle" colspan="4"  >
					                <input type="text" name="doituongdinhkhoan" id="doituongdinhkhoan" value="<%= tthdBean.getMaTenDoiTuongDinhKhoan()%>"  style="width:400px"  onchange="changeNcc()"> 
					             </TD> 		                    
					          <%}%>
...
<script type="text/javascript">
	jQuery(function()
		...
		{		
			...
			$("#doituongdinhkhoan").autocomplete("ErpDoiTuongTaiKhoanKeToanList.jsp");
			$("#nghangTen").autocomplete("ErpNganhangList.jsp");
		});	
