...
<%@page import="geso.traphaco.erp.beans.bobaocaotonghop.IBoBaoCaoTongHop"%>
...
<%
	...
	IBoBaoCaoTongHop obj = (IBoBaoCaoTongHop) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BoBaoCaoTongHopSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Kế toán - Tài chính > Bộ báo cáo tài chính</div>
...
<%--                 <% if(obj.getView().equals("TT")){ %>							                          
				...
				<%} %> --%>
                    ...
                    <TR>
                        <TD class="plainlabel" width="15%">Chọn công ty </TD>
                        <TD class="plainlabel" colspan = 2 >
                            <SELECT NAME = "nppId"  style = "width:300px;size:5" onChange = "Change();" id = "nppId">
                            	<OPTION VALUE = "">&nbsp;</OPTION>
				...
				<%} %>	
								<TR>	
                  				<TD class="plainlabel">Tiêu chí báo cáo</TD>
                  				<TD class="plainlabel">
										<SELECT name = "tieuChiLocBC" onChange = "Change();" >
										<% if(obj.getTieuChiLayBC().equals("1")) {%>
										<option value="1" selected="selected"> Theo tháng</option> 
										<option value="2"> Theo thời gian</option> 
										<% } else if(obj.getTieuChiLayBC().equals("2"))  { %>
										<option value="1" > Theo tháng</option> 
										<option value="2" selected="selected"> Theo thời gian</option> 
										<% } else {%>
										<option value="1" > Theo tháng</option> 
										<option value="2" > Theo thời gian</option> 
										<%} %>
