...
<script type="text/javascript">
	...
	function saveform()
	{	 
		var nhapp = document.forms['dhForm'].KhId.value;
		if(nhapp == "")
		{
			document.forms['dhForm'].dataerror.value = "Vui lòng chọn khách hàng để xuất hàng";
			return;
		}
		
		var ngaygiaodich = document.forms['dhForm'].NgayXuatHD.value;
		if(ngaygiaodich.value == "")
		{
			document.forms['dhForm'].dataerror.value="Vui lòng chọn ngày xuất hóa đon";
			return;
		}
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">Quản lý bán hàng > Nghiệp vụ khác > Nhập hóa đơn trả hàng > Hiển thị </TD>								   
								...
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
										    ...
										    <%-- <TD width="30" align="left" ><A href="../../ErpHdTraHangPdfSvl?userId=<%=userId %>&print=<%=hdthBean.getId() %>" ><img src="../images/Printer30.png" alt="Print"  title="Print"  border ="1px" longdesc="Print" style="border-style:outset"></A></TD> --%>						    
										    <TD width="2" align="left" >&nbsp;</TD>
							...
							<TABLE border="1" width="100%" cellpadding = "1" cellspacing = "0" style="border-color:gray;" >
								<tr>
								 ...
								 <TD align="left" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width:100%;margin:0px " readonly="readonly" rows="1"><%=hdthBean.getMsg() %></textarea>
							  	</fieldset>
							  	 </TD>
								</tr>
									...
									<TD align="left" >						
										...
										<TABLE  border="0" bordercolor="white" width="100%" cellpadding = "3" cellspacing = "0" style="padding-left:2px ;" >
											<TR class="plainlabel" >
											  ...
											  <TD class="plainlabel" colspan="4">                               
                                                 <input type="text" size="10" class="days"
                                     			   id="NgayXuatHD" name="NgayXuatHD" value="<%=hdthBean.getNgayXuatHD()%>" maxlength="10" /> 
											   </TD>
											</TR>
											<TR class="plainlabel" >
											<TD class="plainlabel">Khách hàng</TD>
											 ...
											 <% if(hdthBean.getKhongHD().equals("1")) { %>
											<TR class="plainlabel" >												
											...
											<TD class="plainlabel">Cấn trừ theo hóa đơn</TD>
											  ...
											  <fieldset  >
											   ...
											   <table width="100%">
												<TR class="tbheader">
								                        <TH align="center" width="30%">Số đơn trả hàng</TH>
                   									...
                   									if(rslistdh!=null)
                   									  ...
                   									  <tr class= 'tblightrow'>
                   										...
                   										<td>
                   										 ...
                   										 <%=rslistdh.getString("ngaytra") %> 	
                   										</td>
                   											<%if(htbddh.containsValue(rslistdh.getString("id").trim())){%>
                   											<TD align="center"><input type ="radio" checked="checked" name ="dthId" value ="<%=rslistdh.getString("id") %>" onchange="getinfoddh();" ></TD>
                   											<%}else{ %>
                   											<TD align="center"><input type ="radio" id="dthId" name ="dthId" value ="<%=rslistdh.getString("id") %>" onchange="getinfoddh();" ></TD>
                   											<%} %>
                   										</tr>
                   									<%} %>
