    ...
    <fieldset>
    	<legend class="legendtitle">Chuyển kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <%if( lsxBean.getNdxId().equals("100024") ){ %>
                <TR>
			...
			<tr class="tbheader">
				...
				<th align="center" width="35%">Tên sản phẩm</th>
				 <th align="center" width="7%">DVT</th>
			...
			{  
				...
				{ 
					...
					<tr>
						...
						<td> <input type="text" name="donvitinh" value="<%= yeucau.getDonViTinh() %>" style="width: 100%" readonly="readonly"> </td>
						
						<td> <input type="text" name="soluongchuyen" value="<%= yeucau.getSoluongYC() %>" style="width: 100%; text-align: right;" readonly="readonly" > </td>
			                        	...
			                        	if(spConList.size() > 0)
			                        	{
			                        		...
			                        		%>
			                        			...
			                        			<td> 
						                            ...
						                            <td> 
						                            	<input name="<%= yeucau.getId() + "ngayhethan" %>" 
						                            	type="text" style="width: 100%" value="<%= spCon.getNgayhethan() %>" readonly="readonly" /> 
						                            </td>
						...
						<td align="center"> 
							 <a href="" id="<%= yeucau.getId() + "pobup2"%>" rel="subcontent1<%= i %>">
		           	 							<img alt="Vi tri luu kho" src="../images/vitriluu.png"></a>
           	 					<DIV  id="subcontent1<%= i %>" style=" z-index=10; position:absolute; visibility: hidden; border: 9px solid #80CB9B;
			                             background-color: white; max-height :500px;width: 500px; padding: 1px; overflow: auto; ">
			                    <table width="100%" align="center">
			                        <tr>
