				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						  <TR height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý tài sản &gt; Khấu hao tài sản &gt; hiển thị</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" >
		                        	<select name="nam" disabled="disabled" style="width: 200px;">
		                            	<option value=""></option>
		                            	<%
			                        		if(namRs != null)
			                        		{
                           ...
                           <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" width="220px" >
		                            <select name="thang"  disabled="disabled" style="width: 200px;">
		                            	<option value=""></option>
		                            	<%
			                        		if(thangRs != null)
			                        		{
...
<!-- 		                  </TR> -->
 							 ...
 							 <TR>
		                        <TD class="plainlabel">Số chứng từ </TD>
											  <TD class="plainlabel" >                               
                                                 <input type="text" readonly="readonly" id="soChungTu" name="soChungTu" value="<%= khts.getSoChungTu() %>"  /> 
                            				  </TD>              
		                  </TR>
		                   <TR>
		                        <TD class="plainlabel">Diễn giải chứng từ </TD>
											  <TD class="plainlabel" >                               
                                                 <input type="text" readonly="readonly" id="dienGiaiCT" name="dienGiaiCT" value="<%= khts.getDienGiaiCT() %>"  /> 
                            				  </TD>              
		                  </TR>
