...
<%
	...
	{  
		...
		String thietbi= "0";
		if(tcknBean!=null){
			thietbi=tcknBean.getThietbiIDSS();
		}
	...
	command = 	"select top 10 PK_SEQ, MA, TEN, GHICHU from ERP_THIETBIKIEMNGHIEM where trangthai = '1' " +
				"and (upper(PK_SEQ) like upper((N'%" + query.toUpperCase() + "%')) " +
					" or upper(MA) like upper((N'%" + query.toUpperCase() + "%')) " +
				" or upper(TEN) like upper((N'%" + query.toUpperCase() + "%'))) ";
	...
	if(kh != null)
	{
		int m = 0;
			...
			{   
				...
				spGhichu = kh.getString("GHICHU");
               
                String sp = spMa + "-->[" + spTen + "] [" + spGhichu + "]";
