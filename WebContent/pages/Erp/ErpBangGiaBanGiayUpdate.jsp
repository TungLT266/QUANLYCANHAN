...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function ChangeSuDung()
	{
	  document.forms["bgban"].action.value = "change";
	  document.forms["bgban"].submit(); 
    }
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Định giá bán > Cập nhật</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  colspan = 3 >
		                        	<input type="text" name="tenbanggia" value="<%= obj.getTenbanggia() %>" readonly="readonly" > 
		                        </TD>          
		                  </TR> 
                          <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                         ...
                         <a href="" id="lspId" rel="subcontentLsp">
                          ...
                          <DIV id="subcontentLsp" style=" z-index=10; position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width:300px;  max-height:250px; overflow:auto; padding: 4px;"  >
				                    <table width="90%" align="center">
				                        <tr>
				                            
				                            <th width="200px">Tên </th>
				                            <th width="30px" align="center">Chọn hết <input type="checkbox" onchange="sellectAll3()" id="chkAll3" ></th>
				                        </tr>
		                            	<%
			                        		if(lspRs != null)
			                        		{
				                     ...
				                     <div align="right">
				                     	...
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontentLsp')" onclick="reload_sp();" >Hoàn tất</a>
				                     </div>
				            </DIV>                        
                        </TD>            
		                  </TR>
		       					...
		       					<% if(obj.getSudung().equals("0")){ %>		                  			
										...
										<table>
											 <TR>
						                        ...
						                        <TD valign="middle"  >
						                        	<select name="lkhId" id="lkhId" onchange="submitFrom();" >
														<option value=""></option>
														<% if (lkhList != null)
														{
															while (lkhList.next())
						                  ...
						                  <br />
											...
											<% } %>
														...
														<% if( obj.getKhApDungIds().indexOf(khList.getString("pk_seq")) >= 0 ) { %> 
															<TD align="center">
																<input type="checkbox" name="khApDung" value="<%= khList.getString("pk_seq") %>"  checked="checked" >
															</TD>
														<%  } else { %> 
															<TD align="center" > 
																<input type="checkbox" name="khApDung" value="<%= khList.getString("pk_seq") %>"   >
															</TD>	
														<% } %>
												...
												<% for(int i = 0; i < spList.size(); i++ ) { 
													...
													<TR>
														<TD>
															...
															<input type="text" style="width: 100%" name="masanpham" value="<%= sanpham.getMasp() %>" readonly="readonly" >
														</TD>
														<TD>
															<input type="text" style="width: 100%" name="tensanpham" value="<%= sanpham.getTensp() %>" readonly="readonly" >
														</TD>
														<TD>
															<input type="text" style="width: 100%; text-align: right;" name="giaban" value="<%= sanpham.getGiaban() %>" readonly="readonly" >
														</TD>
														<TD>
														
														<input type="text" style="width: 100%; text-align: right;" name="giamoi" value="<%= sanpham.getGiabanNew() %>" > <!-- onkeyup="FormatNumber(this);" > -->
														
															<%-- <% if(obj.getBlock().equals("1")) { %>
																<input type="text" style="width: 100%; text-align: right;" name="giamoi" value="<%= sanpham.getGiabanNew() %>" readonly="readonly" >
															<% } else { %>
																<input type="text" style="width: 100%; text-align: right;" name="giamoi" value="<%= sanpham.getGiabanNew() %>" > <!-- onkeyup="FormatNumber(this);" > -->
															<% } %> --%>
														</TD>
...
<%
	...
	obj.DbClose();
	session.setAttribute("bgBean", null) ;  
