...
<input type="hidden" name="nppId" value='<%= hdthBean.getNppdangnhap() %>'>
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation"> Quản lý bán hàng > Nghiệp vụ khác > Nhập hóa đơn trả hàng > Tạo mới </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../ErpHdTraHangSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							...
							while (m < size){
								...
								%>
									...
									<TD align="left" >
							        	...
							        	<TD align = "left" >
								        <input name="SoLuong" type="text" value="<%= sanpham.getSoLuong() %>" readonly="readonly" onkeypress="return keypress(event);" style="text-align:left;width:100%;">
								    </TD>								  
								    <TD align = "center" >
