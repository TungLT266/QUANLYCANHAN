...
<script language="javascript" type="text/javascript">
	...
	function TinhTrongLuong(){
	 ...
	 function Reload_NLCongDoan(idcd)
	 {
		 document.forms['hctmhForm'].action.value = 'Reload_NLCongDoan';
		 document.forms["hctmhForm"].cdidcurrent.value = idcd;
		 document.forms["hctmhForm"].submit(); 
	 }
	 function Yeucau_NLCongDoan(idcd)
	 {
		 document.forms['hctmhForm'].action.value = 'Yeucau_NLCongDoan';
		 document.forms["hctmhForm"].cdidcurrent.value = idcd;
		 document.forms["hctmhForm"].submit(); 
	 }
	 function View_NLCongDoan(idcd)
	 {
		 document.forms['hctmhForm'].action.value = 'view_NLCongDoan';
		 document.forms["hctmhForm"].cdidcurrent.value = idcd;
		 document.forms["hctmhForm"].submit(); 
	 }
	 ...
	 function Save_NLCongDoan(idcd)
	 {
		 document.forms['hctmhForm'].action.value = 'Save_NLCongDoan';
		 document.forms["hctmhForm"].cdidcurrent.value = idcd;
		 document.forms["hctmhForm"].submit(); 
	 }
	 ...
	 {	
	     ...
	     var kiemtra = KiemTra_CongDoanNhapXuat();
			if(kiemtra === false){
				alert("Lỗi !Kiểm ra lại công đoạn nhập xuất ! (Đảm bảo :  nhập >= xuất + dư phẩm + phếphẩm)");
			}else{
	 ...
	 function submitform()
	 { 
		 document.forms['hctmhForm'].action.value = 'c';
	     document.forms["hctmhForm"].submit();
	 }
	 function ChonlaiBOM(){
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					<% if(lsxBean.getId()!=null && lsxBean.getId().length()>0){ %>
			...
			<div align="left" id="button"
				...
				<span id="btnSave"> <A href="#" onclick="return saveform();"> <IMG
...
<tr>
												 ...
												 <tr>
																...
																<a class="button"
																href=" javascript: View_NLCongDoan(<%=lsxcd.getCongDoanId()%>)">
																<img style="top: -4px;" src="../images/button.png"
																alt="">View </a>
																
																
																<a class="button"
																href=" javascript: Reload_NLCongDoan(<%=lsxcd.getCongDoanId()%>)">
																<img style="top: -4px;" src="../images/button.png"
																alt="">Reload </a>
																...
																if(trangthai >=2 && lsxBean.getId()!=null && lsxBean.getId().length()>0  && lsxcd.getListDanhMuc().size()>0 ){ %>
																<a class="button"
																href=" javascript: Yeucau_NLCongDoan(<%=lsxcd.getCongDoanId()%>)">
																<img style="top: -4px;" src="../images/button.png"
																alt="">Yêu cầu nguyên liệu  </a>
																<%} %>
															 
															 <a class="button"
																href=" javascript:Save_NLCongDoan(<%=lsxcd.getCongDoanId()%>)">
																<img style="top: -4px;" src="../images/button.png"
																alt="">Lưu công đoạn </a>
