				...
				<TR>
					<TD align="left" class="tbnavigation">
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR height="22">
								<TD align="left" colspan="2" class="tbnavigation">Dữ liệu nền > Sản phẩm > Công bố sản phẩm > Hiển thị</TD>
					...
					<TD height="100%" width="100%">
						<FIELDSET >
							...
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle" width="25%" >
										<input type="text" readonly name="masp" value="<%= obj.getMasp() %>" readonly>
									</TD>
									<TD class="plainlabel" valign="middle" width="15%" >Tên sản phẩm</TD>
									<TD class="plainlabel" valign="middle" >
										<input type="text" readonly name="tensp" value="<%= obj.getTensp() %>" readonly style="width:350px">
									</TD>
								</TR>
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle">
										<input type="text" readonly name="mancc" value="<%= obj.getMancc() %>" readonly>
									</TD>
									<TD class="plainlabel" valign="middle">Tên nhà cung cấp</TD>
									<TD class="plainlabel" valign="middle" >
										<input type="text" readonly name="tenncc" value="<%= obj.getTenncc() %>" readonly style="width:350px">
									</TD>
								</TR>
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle" >
										<input type="text" readonly name="hancongbo" value="<%= obj.getHancongbo() %>"  class="days">
									</TD>

									<TD class="plainlabel" valign="middle" width="120px">Hồ sơ công bố</TD>
									<%-- <TD class="plainlabel" valign="middle" width="240px">
										<input type="text" readonly name="hinhcongbo" value="<%= obj.getHinhcongbo() %>"  >
									</TD> --%>
									
									<TD style="font-size: 9pt;" class="plainlabel">
	  									<input type="text" readonly name="hinhcongbo" value = "<%=obj.getHinhcongbo() %>" style="width: 22%; height:22px" readonly >	
							...
							<TR>
									...
									<TD class="plainlabel" valign="middle">
										<input type="text" name="sodangki" value="<%= obj.getSodangki()%>" readonly>
									</TD>
...
session.setAttribute("obj", null) ; obj.DbClose();
