...
<%
	String s = nvgnBean.getUserId();
%>
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý công nợ > Công nợ phải thu > Bù trừ công nợ KH > Cập nhật
        </div>
            ...
            <table width="100%" cellspacing="0" cellpadding="6px">                
                ...
                <TR>
					...
					<TD class="plainlabel" style = "width:100px" colspan = "3">
        				...
        				<SELECT  id="tienteId" name="tienteId" style = "width:200px" onChange = "submitform();" >
   						<option value = "" >&nbsp;</option>
   					<%
   					if(tienteList != null)
   					{
                 ...
                 <TR>
                    ...
                    <TD class="plainlabel" valign="middle">
						<input type="text" id="tongchuyenno" name="tongchuyenno" value="<%=formatter.format( Double.parseDouble(nvgnBean.getTongchuyenno())) %>"  readonly="readonly" > 													 
					</TD>	
             ...
             <div id="xoanokh" align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
	             <table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							<TD align="center">
								<input type="text" readonly="readonly" name="STT" style="width: 100% ; text-align: right;" value="<%= stt%>" > 						
							</TD>							
							<TD align="center">
			...
			<LEGEND class="legendtitle" style="color: black">Khách hàng nhận nợ</LEGEND>       
              <table width="100%" cellspacing="0" cellpadding="6px">
             	<TR>
        			...
        			<SELECT name="khnhannoId" id="khnhannoId" style = "width:200px" >
   					...
   					if(KHNhanNoList != null)
   					{
   						try
   						{
   							...
   							<option value="<%= KHNhanNoList.getString("pk_seq") %>" selected="selected" ><%= KHNhanNoList.getString("nppTen")%></option>
   								<%}else { %>
   							<option value="<%= KHNhanNoList.getString("pk_seq") %>" ><%= KHNhanNoList.getString("nppTen") %></option>
   		 						<%} 
   							} 
   							KHNhanNoList.close();
   						} 
					...
					<TD class="plainlabel" valign="middle">Tổng </TD> 
                    <TD class="plainlabel" valign="middle">
						<input type="text" id="tongnhanno" name="tongnhanno" value="<%=formatter.format( Double.parseDouble(nvgnBean.getTongnhanno())) %>"  readonly="readonly" > 													 
					</TD>
