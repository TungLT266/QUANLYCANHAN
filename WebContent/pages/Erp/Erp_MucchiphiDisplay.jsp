				...
				<TR>
					<TD align="left" class="tbnavigation">
				   		<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  		<tr height="22">
						  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng  &gt; Mức chi phí  &gt; Hiển thị</TD> 
							...
							<TABLE  width="100%" cellspacing="0" cellpadding="6">
								...
								<TR>
								    ...
								    <TD width="81%" class="plainlabel">
										<INPUT name="sotientu" type="text" readonly style="width:350px" size="40" value='<%= mcpBean.getSotientu() %>' >
									</TD>
								...
								<TR>
								    ...
								    <TD width="81%" class="plainlabel">
										<INPUT name="sotienden" type="text" readonly style="width:350px" size="40" value='<%= mcpBean.getSotienden() %>'>
									</TD>
						      	...
						      	<TR>
									<TD width="19%" class="plainlabel">Công ty </TD>
  								  	<TD class="plainlabel" >
										<select disabled style="width:350px" name="ctyId" >												
											<option value=""  ></option>
							      	...
							      	<TR>
										<TD width="19%" class="plainlabel">Hoạt động</TD>
  									  	<TD class="plainlabel" >
												...
												<INPUT NAME = "trangthai" TYPE = "checkbox" disabled  VALUE = "1" checked="checked">
											<%}else{ %>
							...
							try{
								...
								<%} %>										
									<TD  ><%= dvthlist.getString("DVTH")%></TD>
										...
										<INPUT NAME = "dvthIds" TYPE = "checkbox" disabled  VALUE = <%= dvthlist.getString("DVTHID")%> checked="checked">
										<%}else{ %>
										<INPUT NAME = "dvthIds" TYPE = "checkbox" disabled  VALUE = <%= dvthlist.getString("DVTHID")%> >
										<%} %>
									</TD>
								</TR>
							<%m++; }}
