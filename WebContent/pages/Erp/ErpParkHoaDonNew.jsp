...
<input type="hidden" id="sophieunhap" value="<%= pnkList.size() %>" />
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng &gt; Mua VT/ CPDV/ TSCĐ/ CCDC &gt; Hóa đơn NCC &gt; Tạo mới
        </div>
    ...
    <fieldset id="hoadon" >
    	<legend class="legendtitle"> Hóa đơn NCC</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
                    	...
                    	<% if(!pBean.getTtId().equals("100000")){ System.out.println(" tien fk: "+pBean.getTtId() +"  ti gia: "+pBean.getTigia()) ; %> 
		                    	...
		                    	<TD class="plainlabel" width="15%">Tỉ giá </TD>
		                       	...
		                       	<% System.out.println ( "so po: "+ pBean.getPoNkIdsId() ); %>
		                       	   ...
		                       	   <input name = "tigia" id = "tigia" value = "<%=  pBean.getTigia() %>"  readonly="readonly"
		                       		onchange="DinhDangTiGia();" onKeyPress = "return keypress(event);" />
		                       		<%} %>
                   ...
                   <%} else {%>
                    ...
                    <TR >
						...
						<%System.out.println (" kho nhan: "+pBean.getLoaihang() ) ;%>
					    
					    <% if( !pBean.getLoaihang().equals("1") &&  !pBean.getLoaihang().equals("2") &&  !pBean.getLoaihang().equals(""))  { //  mua tai san co dinh + chi phi dich vu : kho cho chon kho%>
					...
					<TD class="plainlabel" width="15%">Tiền nguyên tệ</TD>
                       	<TD class="plainlabel" colspan="1"> 
                       		<input  type="text"  readonly="readonly" value="0"  style="width:200px" id="tongtiennguyente" name="tongtiennguyente">					        		  	
                   </TD>
                   <TD class="plainlabel" width="15%" align="right">Tiền VNĐ</TD>
                       	<TD class="plainlabel" colspan="2" > 
                       		<input  type="text"  readonly="readonly" value="0"  style="width:200px" id="tongtienVND" name="tongtienVND">					        		  	
                   </TD>
            ...
            <hr> 
           	...
           	<div id="cotable" align="left" style="width:100%; float:none; clear:none; " class="plainlabel">
		 ...
		 <!-- HÓA ĐƠN NỘI ĐỊA  -->
                ...
                <%
                		...
                		<TD>
					          ...
					          <table width="100%" align="center">
					        	...
					        	<tr >
					        		<td>						        		  
				        		  	...
				        		  	<td>
				        		  		<input type="text"  readonly="readonly" value="<%= sp.getTen()  %>" name="sohoadon<%= i %>.tenhang" style="width: 100%">
				        		  	</td>
				        		  	...
				        		  	<td>
				        		  		<input type="text" id="sohoadon<%= i %>.soluongdat<%= d %>"  readonly="readonly"  value="<%= formatter.format( sp.getSoluong()) %>" name="sohoadon<%= i %>.soluongdat" style="width: 100%" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
				        		  	...
				        		  	<td>
				        		  		<input type="text" id="sohoadon<%= i %>.soluong<%= d %>"   value="<%= formatter.format( sp.getSoluonghd()) %>" name="sohoadon<%= i %>.soluong" style="width: 100%" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
				        		  		<input type="hidden"  value="<%= sp.getSoluongRaHD() %>" name="sohoadon<%= i %>.soluongRaHD" >				        		  		
				        		  	</td>
					        		  	<%--khong cho sua gia 2/11/2016 , tien khong le--%>
				        		  	<td>				        		  		
				        		  		<input type="text"   readonly="readonly" id="sohoadon<%= i %>.dongia<%= d %>"  value="<%= formatter2.format(sp.getDongia()) %>" name="sohoadon<%= i %>.dongia" style="width: 100%"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);">				        		  		        		  		
				        		  	</td>

				        		  	<td>
				        		  		<input type="text"  id="sohoadon<%= i %>.thanhtien<%= d %>"   value="<%= formatter3.format( Double.parseDouble(sp.getThanhtien())) %>" name="sohoadon<%= i %>.thanhtien" style="width: 100%"  onkeyup="Kiemtra15(this);" onKeyPress = "return keypress(event);" onkeyup="Kiemtra15(this);">
				        		  		<input type="hidden" id="sohoadon<%= i %>.ngaynhandk<%= d %>"   value="<%= sp.getNgaynhan() %>" name="sohoadon<%= i %>.ngaynhandk" style="width: 100%" onKeyPress = "return keypress(event);" >
				        		  	</td>
						        	<td>
				        		  	...
				        		  	<td>
				        		  		<input type="text"  id="sohoadon<%= i %>.sptienvat<%= d %>"   value="<%= formatter3.format( Double.parseDouble(sp.getTienVat())) %>" name="sohoadon<%= i %>.sptienvat" style="width: 100%; text-align: right;" readonly="readonly" onkeyup="Kiemtra155(this);"  onKeyPress = "return keypress(event);"  >				        		  		
                   		...
                   		<TD class="plainlabel" valign="middle" style="display: none;">
                   			<%  
                   				...
                   				{
                       				System.out.println("Thue suat tren dao dien la vao"+hd.getThuesuat());
                   		...
                   		<TD class="plainlabel" valign="middle" style="display: none">
                   			...
                   			%>
                        	<input type="text"  readonly="readonly" name="vat<%= i %>"  id="vat<%= i %>" style="text-align: right;" style="text-align: right;"  onkeyup="Dinhdangvat(this)"  value="<%=vat%>" onKeyPress = "return keypress(event);" />
                   		</TD> 
                   		<TD class="plainlabel" valign="middle">
                   ...
                   <% 
            		...
            		<TR>
            		<TD>
                    	<input type="hidden"   id="mauhoadon<%= j %>" name="mauhoadon<%= j %>" value=""  readonly="readonly"   />
               		
                    	<input type="text"   id="mausohoadon<%= j %>" name="mausohoadon<%= j %>" value=""  />
               		</TD>
               		<TD>
                    	<input type="text"   id="kyhieuhoadon<%= j %>" name="kyhieuhoadon<%= j %>" value=""     />
               		</TD> 
               		<TD >
                    	<input type="text"   id="sohoadon<%= j %>" name="sohoadon<%= j %>" value=""  onkeyup="Kiemtrasohd(this)"  />
               		</TD> 
               		<TD>
                    	<input type="text" readonly="readonly"   id="ngayhoadon<%= j %>" class="days" name="ngayhoadon<%= j %>" value=""   />
               		</TD> 
               		<TD align="left">
                       		<input type="text"  id="sotienchuathue<%= j %>" readonly="readonly" name="sotienchuathue<%= j %>" value="<%  if(hd.getSotienbvat().length()==0) {%> <%} else  %><%=formatter.format(Double.parseDouble(hd.getSotienbvat())) %>" style="width: 80%; text-align: right;" />              		
                       	 	
	                   		<a href="" id="ckDetail<%= j %>" rel="subcontent<%=j %>"><img alt="Số tiền chi tiết" title="Số tiền chi tiết" src="../images/vitriluu.png"></a>
	                   		<DIV id="subcontent<%= j %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 700px; padding: 4px; max-height: 200px; overflow: auto; ">
					          <table width="100%" align="center">
						        <tr>
						         <th width="100px">Số PO</th>
						         <th width="100px">Mã hàng</th>
					        	...
					        	ResultSet rs = pBean.getPoNk_SPRs();
						        int d = 0;
						        if(rs != null){
						        	while(rs.next()){
					        	%>
					        	<tr >
					        		<td>	
					        			<%-- <input type="hidden" name ="sohoadon<%= j %>.chiphikhac"  id= "sohoadon<%= j %>.chiphikhac"   value="<%= formatter.format(rs.getDouble("chiphikhac")) %>"> --%>					        		  
					        		  	<input type="hidden"  readonly="readonly" value="<%= rs.getString("LOAI") %>" name="sohoadon<%= j %>.loai" style="width: 100%">
					        		  	<input type="hidden"  readonly="readonly" value="<%= rs.getString("PK_SEQ") %>" name="sohoadon<%= j %>.poId" style="width: 100%">					        		  	
					        		  	<input  type="text"  readonly="readonly" value="<%= rs.getString("SoPO") %>" name="sohoadon<%= j %>.soPO" style="width: 100%">
					        		  	<input  type="hidden"  readonly="readonly" value="<%= rs.getString("MHSP_FK")%>" name="sohoadon<%= j %>.MHSP_FK" style="width: 100%">
					        		  	
					        		</td>
			                   			
		                   			<td>	
				        		  		<input type="text"  readonly="readonly" value="<%= rs.getString("MA") %>" name="sohoadon<%= j %>.ma" style="width: 100%">
				        		  		<input type = "hidden" value="<%= rs.getString("SPID") %>" name="sohoadon<%= j %>.mahang" style="width: 100%">
		                   			
				        		  	</td>
					        		  	
				        		  	<td><input type="text"  readonly="readonly" value="<%= rs.getString("TEN")  %>" name="sohoadon<%= j %>.tenhang" style="width: 100%"></td>

				        		  	<td>					        		  	
										<input type="text"  readonly="readonly" value="<%= rs.getString("DONVI")  %>" name="sohoadon<%= j %>.donvi" style="width: 100%">
									</td>
															        		  	
					        		<td>
				        		  		<input type="text" id="sohoadon<%= j %>.soluongdat<%= d %>"   value="<%= formatter.format( rs.getDouble("SOLUONGDAT")) %>" name="sohoadon<%= j %>.soluongdat" style="width: 100%" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
				        		  						        		  		
				        		  	</td>
				        		  	
				        		  	<td>
				        		  		<input type="text"  readonly="readonly" value="<%= rs.getString("DUNGSAI") %>" name="sohoadon<%= j %>.dungsai" style="width: 100%">	
				        		  	</td>
				        		  	
				        		  	<td>
				        		  		<input type="text" id="sohoadon<%= j %>.soluong<%= d %>"   value="<%= formatter.format(rs.getDouble("SOLUONGHD")) %>" name="sohoadon<%= j %>.soluong" style="width: 100%" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
				        		  		<input type="hidden"  value="<%= rs.getDouble("SOLUONGDARAHD") %>" name="sohoadon<%= j %>.soluongRaHD" >			        		  		
				        		  	</td>
				        		  	
				        		  	<td>
				        		  		<%-- <% if(pBean.getLoaidonmh().equals("0")){ %>
				        		  			<input type="text" id="sohoadon<%= j %>.dongia<%= d %>"   value="<%= formatter1.format(rs.getDouble("DONGIA")) %>" name="sohoadon<%= j %>.dongia" style="width: 100%"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);">
				        		  		<%} else {%> --%>
				        		  			<input type="text"  readonly="readonly" id="sohoadon<%= j %>.dongia<%= d %>"  value="<%= formatter2.format(rs.getDouble("DONGIA")) %>" name="sohoadon<%= j %>.dongia" style="width: 100%"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);">
				        		  		<%-- <%} %> --%>
				        		  						        		  		
				        		  	</td>

				        		  	<td>
				        		  		<input type="text" id="sohoadon<%= j %>.thanhtien<%= d %>"   value="<%= formatter3.format(rs.getDouble("THANHTIEN")) %>" name="sohoadon<%= j %>.thanhtien" style="width: 100%" onkeyup="Kiemtra15(this);"  >
				        		  		<input type="hidden" id="sohoadon<%= j %>.ngaynhandk<%= d %>"   value="<%= rs.getString("NGAYNHANDK") %>" name="sohoadon<%= j %>.ngaynhandk" style="width: 100%" onKeyPress = "return keypress(event);" >
				        		  		
				        		  	</td>
				        		  	
				        		  	<td>
				        		  		<input type="text"  id="sohoadon<%= j %>.spthuesuat<%= d %>"   value="<%= formatter.format( Double.parseDouble(rs.getString("VAT"))) %>" name="sohoadon<%= j %>.spthuesuat" style="width: 100%; text-align: right;" readonly="readonly"  onKeyPress = "return keypress(event);"  >				        		  		
				        		  	</td>
				        		  	
				        		  	<td>
				        		  		<input type="text"  id="sohoadon<%= j %>.sptienvat<%= d %>"   value="<%= formatter3.format( Double.parseDouble(rs.getString("TIENVAT"))) %>" name="sohoadon<%= j %>.sptienvat" style="width: 100%; text-align: right;"  onkeyup="Kiemtra155(this);"  onKeyPress = "return keypress(event);"  >				        		  		
				        		 		<input type="hidden"  id="sohoadon<%=j %>.sptienavat<%= d %>"   value="" name="sohoadon<%= j %>.sptienavat" style="width: 100%; text-align: right;"  readonly="readonly"  onKeyPress = "return keypress(event);"  >				        		  		
				        		  	</td>
					        ...
					        %>
						       ...
						       <div align="right">
				                     	<label style="color: red" ></label>
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:{dropdowncontent.hidediv('subcontent<%= j %>');Kiemtra3(<%= j %>);}">Đóng cửa sổ</a>
				                     </div>
						     </DIV>
                   		</TD> 
               		<TD class="plainlabel" valign="middle"  >
                    	<input type="text" onKeyPress = "return keypress(event);" onkeyup="Dinhdang(this)"  id="chietkhau<%= j %>" name="chietkhau<%= j %>" value=""  style=" text-align: right;" readonly="readonly" />
               		</TD> 
               		<TD class="plainlabel" valign="middle" style="display: none;">
                    	<input type="text" onKeyPress = "return keypress(event);" onkeyup="Dinhdangthue(this)"  id="thuesuat<%= j %>" style=" text-align: right;" maxlength="3" name="thuesuat<%= j %>" value=""  />
               		</TD> 
               		<TD class="plainlabel" valign="middle">
                    	<input type="text" readonly="readonly" id="vat<%= j %>" onKeyPress = "return keypress(event);"  onkeyup="Dinhdangvat(this)" style=" text-align: right;"  name="vat<%= j %>" value=""  />
               		</TD> 
               		<TD class="plainlabel" valign="middle">
                    	<input type="text" readonly="readonly" style=" text-align: right;"   id="tongcong<%= j %>" name="tongcong<%= j %>" value=""  />
               		</TD>              		
               		</TR>
