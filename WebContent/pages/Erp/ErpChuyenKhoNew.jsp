...
<script language="javascript" type="text/javascript">
	...
	function DinhDangDonGia(num) 
	{
	 ...
	 function ChangeNgaychuyen()
	 { 
		 document.forms['hctmhForm'].action.value='ChangeNgaychuyen';
	     document.forms["hctmhForm"].submit();
	 }
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Chuyển kho > <%= ( lsxBean.getId().length() >0 ? "Cập nhật" : "Tạo mới" ) %> 
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD style="width: 240px;" class="plainlabel" valign="top" colspan="3"  >
                    	<input type="text" class="days" readonly="readonly" onChange="ChangeNgaychuyen();"  name="ngaychuyen" value="<%= lsxBean.getNgayyeucau() %>"/>
                    </TD>
                    
                    <TD style="width: 120px; display:none;" class="plainlabel" valign="top">Ngày xuất thực tế</TD>
                    <TD  style="width: 120px; display:none;" class="plainlabel" valign="top" >
                    	<input type="text" class="days"  name="ngayxuatthucte" value="<%= lsxBean.getNgayxuatthucte() %>"/>
                    </TD>
                  
                </TR>
                <TR>
                	<TD style="width: 140px;" class="plainlabel" valign="top">Số phiếu  </TD>
                	<TD  class="plainlabel" valign="top" >
                    	<input type="text" class="days" readonly="readonly"   name="sophieu" value="<%= lsxBean.getId() %>"/>
                    </TD>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" <%= lsxBean.getCoDoituong().equals("1") ? "" : "colspan='3'" %>  >
                     ...
                     <TD class="plainlabel" >
                        	...
                        	<select name="doituongId" style="width: 200px;" onchange="submitform();" >
                    		<option value=""></option>
                    			<% if( doituongRs != null ) { %>
                ...
                <% if( lsxBean.getCochiphi().equals("1") ) { %>
                	<TR>
	                    ...
	                    <TD class="plainlabel" colspan="3"  >
	                    	...
	                    	<select name = "chiphiId" style="width: 200px;"  >
	                    		<option value=""> </option>
	                        	<%
	                        		if(chiphiRs != null)
	                        		{
                ...
                <!-- XUẤT CHUYỂN NỘI BỘ ==> Tất cả đều có số chứng từ -->
                ...
                <TR>
                	<TD class="plainlabel">Số lệnh SX</TD>
                   	<TD class="plainlabel"  >
                   		<select name="lsxId" style="width: 500px;" >
                   		<option value=""></option>
                   			<% if( lsxRs != null ) { %>
                    		<% while(lsxRs.next()) 
                    		{ 
                   	...
                   	<TD class="plainlabel"  >
                   		<select name="CdsxId" style="width: 200px;" onChange="submitform();" >
                   		<option value=""></option>
                   			<% if( cdsxRs != null ) { %>
                    		<% while(cdsxRs.next()) 
                    		{ 
                ...
                <%if( lsxBean.getMaNDX(lsxBean.getNdxId()).equals("XK17") ){
                	System.out.println("noi dung xuat "+ lsxBean.getNdxId());
                	%>
                <TR>
		                            	...
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = yeucau.getMa() + "__ " + "__" + spRs.getString("SOLO").trim() + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("NGAYNHAPKHO")  
			                        													+ "__" + spRs.getString("MAME") + "__" + spRs.getString("MATHUNG") + "__" + spRs.getString("VITRI")
			                        													+ "__" + spRs.getString("MAPHIEU").trim() + "__" + spRs.getString("PHIEUDT") .trim()+ "__" + spRs.getString("PHIEUEO").trim()
			                        													+ "__" + spRs.getString("MARQ").trim() + "__" + spRs.getString("HAMLUONG") + "__" + spRs.getString("HAMAM")
			                        													+ "__" + spRs.getString("spid") + "__" + spRs.getString("vitri")
			                        													+ "__" + spRs.getString("NSXMA") + "__" + spRs.getString("NSX_FK");
			                        				System.out.println("Key jsp: " + key);
			                        				
			                        				String key2 = yeucau.getMa() + "__" + spRs.getString("SOLO").trim() + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("NGAYNHAPKHO") 
								                        						 + "__" + spRs.getString("MAME") + "__" + spRs.getString("MATHUNG") + "__" + spRs.getString("VITRI")
								                        						 + "__" + spRs.getString("MAPHIEU").trim() + "__" + spRs.getString("PHIEUDT").trim() + "__" + spRs.getString("PHIEUEO").trim()
					        													 + "__" + spRs.getString("MARQ").trim() + "__" + spRs.getString("HAMLUONG") + "__" + spRs.getString("HAMAM") 
					        													 + "__" + spRs.getString("spid") + "__" + spRs.getString("vitri")
			                        			...
			                        			<tr>
			                        				...
			                        				<% } else { %>
			                        					<input type="text" style="width: 100%;text-align: right;font-size: 12px" name="<%= temID %>_spSOLUONG" value="<%= tudeXUAT  %>" onkeyup="CheckSoLuong_DeXuat(this);" >
			                        				<% } %>
			                        				</td>
			                        				<td>
			                        					<input type="hidden" style="width: 100%;text-align: center;font-size: 12px" name="<%= temID %>_spId" value="<%= yeucau.getId()%>" readonly="readonly">
