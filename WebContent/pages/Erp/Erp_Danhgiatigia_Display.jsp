...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	...
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">Quản lý kế toán > Đánh giá tỉ giá > Hiển thị
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" >
                 ...
                 <TR>
                        ...
                        <TD class="plainlabel" valign="middle" colspan = 3>
                            <SELECT id="nam"  name="nam" >
                            		<OPTION value=""></option>
									<OPTION value = <%= dgtigiaBean.getNam() %> selected><%= dgtigiaBean.getNam()%> </OPTION>                            	
                            </SELECT>
                 ...
                 <TR>
                        ...
                        <TD class="plainlabel" valign="middle" colspan = 3>
                            <SELECT id="thang"  name="thang" >
                            		<OPTION value=""></option>
									<OPTION value = <%= dgtigiaBean.getThang() %> selected><%= dgtigiaBean.getThang() %> </OPTION>
                            </SELECT>
                 ...
                 <TR>
                 	...
                 	<TD class="plainlabel" valign="middle" >
                 		<% if(ghidao.equals("1")){ %>
                 			<INPUT type="checkbox" name="ghidao" value="1" CHECKED readonly>
                 		<%}else{ %>
                 			<INPUT type="checkbox" name="ghidao" value="1" readonly>
                 		<%} %>
                 	</TD>
                 </TR> 						
			...
			<%try{ 
				if(kqlist != null){	
				    ...
				    <%  }%>
								...
								<TD align = "right"><%= formatter.format(Double.parseDouble(kqlist.getString("NGUYENTE"))) %></TD>
