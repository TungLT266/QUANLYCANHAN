...
<script language="javascript" type="text/javascript">
	...
	function replaces()
	{
		...
		for(var i = 0; i < sanpham.length; i++)
		{
			...
			{
				// them sothung
				//so luong tong cua moi dong
				//var soluongtong = document.getElementsByName(id + '.soluongtong');
				...
				var soluong = document.getElementsByName(id + '.soluongthung');
				...
				for( var j = 0; j < soluong.length; j++)
				{
					...
					if(solo.item(j).value != "" && soluong.item(j).value != "")
					{
						...
						var slg =( soluong.item(j).value.replace(/,/g,""))*(sothung.item(j).value.replace(/,/g,""));
						tongluong = parseFloat(tongluong) + parseFloat(slg);
						//khong cho load tu dong ngay het han , ma phai chon
						/*  if(ngaysanxuat.item(j).value != "" && hansudung.item(i).value != "" && ngayhethan.item(j).value=="")
						{
							var songay = parseFloat(hansudung.item(j).value) * 30;
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
       ...
       <% }else{ %>
       		Quản lý mua hàng > Mua hàng nhập khẩu > Nhận hàng > Tạo mới
       <% } %> --%>
       
       Quản lý mua hàng > Mua hàng VT/CPDV/TSCĐ/CCDC > Nhận hàng > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR >
                    ...
                    <TD class="plainlabel" valign="top" >
                    	<select name="khonhanId" id="khonhanId"  onChange="changePO()" style="width: 200px;">
                        	<%
                        		if(rskhoNhan != null)
                        		{
                        			try
                ...
                <TR>
                    ...
                    <TD class="plainlabel"  colspan="3">
                   		<input type = "hidden" name="loaikho" value=<%= nhBean.getLoaikho() %>>
                    ...
                    <TD class="plainlabel">
                	 ...
                	 <TD class="plainlabel" valign="middle" > Nhà cung cấp </TD>   
                      <TD class="plainlabel" valign="middle" colspan="3" >
                      	<select name="nccId" id="nccId" onchange="changeLHH();" style="width: 200px;" >
						<option value=""></option>
						<% if (nccList != null)
						{
							while (nccList.next())
				                        	...
				                        	if(spDetailList.size() > 0)
				                        	{
				                        		...
				                        		%>
				                        			...
				                        			<% if(nhBean.getLoaimh().trim().equals("1") || nhBean.getLoaimh().trim().equals("0")){ %>
							                            ...
							                            <td>
							                            	<input type="text" size="120px" name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() +  ".sothung" %>" value="<%= spDetail.getSothung() %>" id="sothung" onchange="replaces()" onkeypress="return keypress(event)" />
							                            ...
							                            <td>
							                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongthung" %>" value="" style="text-align: right;" id="soluongthung" onkeypress="return keypress(event)" onchange="replaces()"/>
							                            	<input type="hidden" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongmax" %>" value="<%= spDetail.getSoluongmax() %>" style="text-align: right;" onchange="replaces()"/>
							                            </td>
							                             <td>
							                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongtong" %>" value="<%=spDetail.getSoluong() %>" style="text-align: right;"  readonly="readonly"/>
							                            	<input type="hidden" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongmax" %>" value="<%= spDetail.getSoluongmax() %>" style="text-align: right;" onchange="replaces()"/>
							                            </td>
							                            <td>
				                        			...
				                        			<% } else { %>
							                            <td>
							                             ...
							                             <td>
							                            	<input type="text" size="120px" name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() +  ".sothung" %>" value="<%= spDetail.getSothung() %>" id="sothung" onkeypress="return keypress(event)" onchange="replaces()" />
							                            	
							                            </td>
							                            <td>
							                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongthung" %>" value="" id="soluongthung" onkeypress="return keypress(event)" onchange="replaces()" style="text-align: right;"   />
							                            </td>
							                             <td>
							                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongtong" %>" value=" <%=spDetail.getSoluong() %>"  readonly="readonly" />
							                            </td>
							                            <td>
							                            	<input type="text" size="100px"  class="days" 
				                        		...
				                        		<tr>
						                            <td>
						                            	<input type="text" size="100px" name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".solo" %>" value="" onchange="replaces()" /></td>
						                            	 <td>
							                            	<input type="text" size="120px" name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() +  ".sothung" %>" value="" id="sothung" onkeypress="return keypress(event)" onchange="replaces()" />
							                            	
							                            </td>
						                            <td>
						                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongthung" %>" value="" style="text-align: right;" id="soluongthung" onkeypress="return keypress(event)" onchange="replaces()" /></td>
						                            	  <td>
						                            	<input type="text" size="100px"  name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".soluongtong" %>" value="" style="text-align: right;"  readonly="readonly" /></td>
						                            <td>
