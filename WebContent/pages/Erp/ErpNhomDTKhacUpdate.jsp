...
<%  IErpNhomDTKhac nNccBean = (IErpNhomDTKhac)session.getAttribute("nNccBean"); 
...
<form name ="nkhForm" method="post" action="../../ErpNhomDTKhacUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Nhóm đối tượng khác &gt; Cập nhật</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Nhóm đối tượng khác </LEGEND>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">							
								<TR class="tbheader">
									<TH width="28%">Mã đối tượng </TH>
									<TH width="60%">Tên đối tượng </TH>
									<TH width="12%">Chọn
