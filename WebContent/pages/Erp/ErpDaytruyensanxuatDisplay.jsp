						...
						<TABLE border="0" width="100%" cellpadding="10" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan = 3 >
		                        	<input type="text" name="madaytruyensanxuat" value="<%= obj.getMa() %>"  readonly> 
		                        </TD>          
		                  </TR> 
                          <TR>
                          		<TD class="plainlabel" valign="middle" width="150px" >Diễn giải </TD>   
		                        <TD class="plainlabel" valign="middle" colspan = 3  >
		                        	<input type="text" name="diengiai" style = "width:300px" value="<%= obj.getDiengiai() %>" readonly > 
		                        </TD>          
		                  </TR> 
                          <TR>
                          		<TD class="plainlabel" valign="middle" >Nhà máy </TD>   
								<TD class="plainlabel" colspan = 3 >
									<SELECT name="nmId" style = "width:300px" disabled>
													<OPTION VALUE = ""></OPTION>
									<% if(nmRs != null){
											try{
												while(nmRs.next()){
                          ...
                          <TR>
								...
								<TD class="plainlabel" width = "5%" >
									<SELECT name="tugio" style = "width:100px" disabled >
								...
								<TD class="plainlabel" valign="left" >
									<SELECT name="dengio" style = "width:100px" disabled >
													<OPTION VALUE = "0"></OPTION>
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan = 3 >
		                            <% if(obj.getTrangthai().equals("1")) { %>
		                            	<input type="checkbox" name = "trangthai" value="1" checked="checked" disabled ><i> Hoạt động</i>
		                            <% } else { %>
