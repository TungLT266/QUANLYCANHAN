...
<%
	IErpCongDungCCDC cd = (IErpCongDungCCDC) session.getAttribute("cd");
	ResultSet rsNCC = cd.getCongDungRs();
	ResultSet rsTaiKhoan = cd.getTaiKhoanRs();
	int[] quyen = new  int[5];
	 quyen = util.Getquyen("ErpCongDungCCDCSvl","",userId);
...
<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="cdListForm" method="post" action="../../ErpCongDungCCDCSvl">
						...
						<tr>
							<td align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<td align="left" colspan="2" class="tbnavigation">Quản lý công cụ dụng cụ &gt; Công dụng</td>
											...
											<fieldset>
												...
												<table width="100%" cellpadding="6" cellspacing="0">
													...
													<tr>
														...
														<TD class="plainlabel"><select style="width: 200px;" name="TaiKhoan" onchange="submitform();">
																<option value=""></option>
																<%if (rsTaiKhoan != null)
				while (rsTaiKhoan.next()) {
					if (cd.getTaiKhoan().equals(
						...
						<tr>
							<td width="100%">
								<fieldset>
									<legend class="legendtitle">Công dụng công cụ dụng cụ &nbsp;&nbsp;&nbsp;&nbsp;
														...
														<td align="center">
															<table border=0 cellpadding="0" cellspacing="0">
																<tr>
																	<td> 
																			<%if(quyen[2]!=0){ %>
																	<a href="../../ErpCongDungCCDCUpdateSvl?userid=<%=userId%>&update=<%=rsNCC.getString("PK_SEQ")%>"><img
																	...
																	<td>
																	<%if(quyen[1]!=0){ %>
																	<a href="../../ErpCongDungCCDCSvl?userid=<%=userId%>&delete=<%=rsNCC.getString("PK_SEQ")%>"><img
