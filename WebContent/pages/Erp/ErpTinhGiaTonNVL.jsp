...
<% IErpTinhgiatonNVL obj = (IErpTinhgiatonNVL)session.getAttribute("obj"); %>
...
<body>
<form name="erpCngn" method="post" action="../../ErpTinhgiatonNVLSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
             Quản lý tồn kho > Chức năng > Tính giá tồn kho NVL
        </div>
