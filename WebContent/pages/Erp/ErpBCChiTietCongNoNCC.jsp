		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">&#160; Báo cáo quản trị > Công nợ > Công
					nợ chi tiết nhà cung cấp</div>
						...
						<TABLE width="100%" cellpadding="6px" cellspacing="0px"
							...
							<TR>
								...
								<TD class="plainlabel" valign="middle"><input type="text"
									id="khid" name="khid" value="<%=obj.getErpKhachHangId()%>"
...
<script type="text/javascript">
	jQuery(function()
		{		
			$("#khid").autocomplete("ErpNhaCungCapList.jsp");
		});	
</script>
</html>
<%	
