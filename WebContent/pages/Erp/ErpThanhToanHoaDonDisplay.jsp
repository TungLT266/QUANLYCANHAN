...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ + TRICH PHÍ VNĐ			
	...
	{    
	 ...
	 {	
		 ...
		 if(tigia.value == "" || tigia.value == "0")
		 {
			alert('Vui lòng nhập "Tỉ giá"');
			return;
		 } 
    	...
    	<legend class="legendtitle"> Phiếu chi  </legend>
	                ...
	                <TR>
	                    <TD class="plainlabel">Nhà cung cấp / Nhóm NCC
	                    	<% if(tthdBean.getNhomNCCCN().equals("1")) { %>
									<input type="checkbox" id="nhomncccn" name="nhomncccn" value="1" checked = "checked" onchange="ChangeTienTe();" readonly="readonly">
									<% } else {  %>
										<input type="checkbox" id="nhomncccn" name="nhomncccn" value="1" onchange="ChangeTienTe();" readonly="readonly" >
									<% } %>
	                    </TD>
	                    <% if(tthdBean.getNhomNCCCN().equals("1")) { %>
			...
			<% } else if (tthdBean.getDoiTuongChiPhiKhac().equals("3")) { %>  
			 			<TR>
					          ...
					          <TD colspan="4" class="plainlabel" valign="top">
					          <input  type="text" name="nguoiNhanTien" id="nguoiNhanTien" value="<%= tthdBean.getNguoiNhanTien()%>"  style="width:300px" readonly="readonly">
					          </TD>
					     </TR> 	
           ...
           <%
            ...
            <% }%>
            	...
            	<TR>
           		...
           		<%}else{ %>                  
           				<input type="text" name="tigia" Id="tigia" value="<%= formatter1.format(Double.parseDouble(tthdBean.getTigia().replaceAll(",","")))  %>" style = "width:100px;text-align: right;"  onchange="ThanhToan(100);" onKeyPress = "return keypress(event);" readonly="readonly">
            ...
            <% if(!tthdBean.getTienteId().equals("100000")){ %>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan = 5>Trích phí bằng VNĐ
							<input type="checkbox" id="trichphi" name="trichphi" value="1"  onChange= "ChangeTienTe();" readonly="readonly">
	                </TD>
	               <%}else{ %> 
                    <TD class="plainlabel">Trích phí bằng VNĐ
							<input type="checkbox" id="trichphi" name="trichphi" value="1" checked = "checked" onChange= "ChangeTienTe();" readonly="readonly">
	                </TD>
...
<%// THANH TOAN HOA DON DUNG NGOAI TE - TRICH PHI BANG NGOAI TE
               if(tthdBean.getTrichphi().equals("0")) { %>
				...
				<TR style="display: none;">
                    ...
                    <TD  class="plainlabel">                                      
                    	<input type="text" style="text-align: right;" name="pnganhangNT" id = "pnganhangNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getPhinganhangNT().replaceAll(",",""))) %>" onchange="ThanhToan(100)" onKeyPress = "return keypress(event);" readonly="readonly" >	                   
                     </TD> 
            	...
            	<TR style="display: none;">
                    ...
                    <TD  class="plainlabel">                 
                         <input type="text" style="text-align: right;" name="vatNT" id = "vatNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getThueVATNT().replaceAll(",",""))) %>"  onchange="ThanhToan(100)" onKeyPress = "return keypress(event);"readonly="readonly" > 
                     </TD> 
							...
							<TABLE width="100%" align="center">
        						<TR class="tbheader">
					      		...
					      		<TR>
									...
									<TD>
										<input type="text" name = "mauHD_VAT" id = "mauHD_VAT" value = "<%= tthdBean.getMauhoadon() %>" onChange = "javascript:mauhoadon();" style="width: 100%" readonly="readonly">
									</TD>
									<TD>
                	...
                	for(int i = 0; i < hoadonList.size(); i++)
                	{
						...
						<% if(!tthdBean.getTienteId().equals("100000")){ // Ngoại tệ%>           	 				
           	 			...
           	 			<%} %>
           	 				...
           	 				<td align="center"> 
           	 					<input type="text"  name = "diaChi" id="diaChi_<%= i %>" value="<%=hoadon.getDiaChi()%>" >
           	           	 	</td>
	       ...
	       <% if(tthdBean.getTienteId().equals("100000")){ // Don vi tien la VND %>
			...
			<tr class="tbheader">
				...
				<TH width = "150px" align = "center">Tên NCC </TH>
               	<TH align="center" width="250px">Địa chỉ</TH>
		...
		for(int i=0; i < count;i++){ 
			...
			<TR>
			  ...
			  <!-- KÊNH BÁN HÀNG  -->
				...
				<TD>											
					<input type="text" name = "diaChi_<%=i %>"  value = "<%= diaChiHd[i] %>" style="width: 100%" readonly="readonly">
				</TD>
		...
		<TR>
        	...
        	<%  } %> 
				...
				<TD  align="left" >  
				 ...
				 <TD>
					<input type="text" name = "mauHoaDon_VAT_<%=i %>" class="uppercase"  value = "" style="width: 100%" readonly="readonly">
				</TD>  
				<TD>
					<input type="text" name = "kyhieu_VAT_<%=i %>" class="uppercase" value = '' style="width: 100%;" readonly="readonly">
				</TD>      
				<TD>
				...
				<TD>											
					<input type="text" name = "diaChi_<%=i %>"  value = "" style="width: 100%" readonly="readonly">
				</TD>
				<TD>
