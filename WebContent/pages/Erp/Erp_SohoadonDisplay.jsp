				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Số hóa đơn &gt; Hiển thị</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><INPUT type="text" name="tuso" style="width:300px" value='<%= shdBean.getTuso()%>' onkeypress="return keypress(event);" readonly></TD>
							</TR>
							<TR>
							  	<TD class="plainlabel">Đến số<FONT class="erroralert"> *</FONT></TD>
						  	  	<TD class="plainlabel"><INPUT type="text" name="denso" style="width:300px" value='<%= shdBean.getDenso() %>' onkeypress="return keypress(event);" readonly></TD>
						  </TR>
						...
						<TR>
							<TD class="plainlabel"><input name="trangthai" type="checkbox" value="1" checked disabled>
							      Hoạt động </TD>
