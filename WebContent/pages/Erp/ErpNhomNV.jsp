<%@page import="geso.traphaco.erp.beans.NhomNhanVien.IErpNhomNhanVienList"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "java.util.List" %>
<%@ page  import = "java.util.Hashtable" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<%@ page  import = "geso.traphaco.erp.beans.NhomNhanVien.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.erp.beans.NhomNhanVien.*" %>
<% IErpNhomNhanVienList obj = (IErpNhomNhanVienList)session.getAttribute("obj"); %>
<% List<IErpNhomNhanVien> ncclist = (List<IErpNhomNhanVien>)obj.getNccList(); %>
...
<form name="nNccForm" method="post" action="../../ErpNhomNVSvl">
				...
				<TR>
					<TD align="left" class="tbnavigation">
				   		<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  		<tr height="22">
						  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Nhóm nhân viên</TD> 
									...
									<TD align="center">
										<TABLE>
											...
											<%if(quyen[2]!=0 && obj.getChixem().equals("0") ){ %>
												<A href = "../../ErpNhomNVUpdateSvl?userId=<%=userId%>&update=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img title="Cập nhật" src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>&nbsp;
											<%} %>
											</TD>
											<TD>
											<%if(quyen[1]!=0 && obj.getChixem().equals("0") ){ %>
												<A href = "../../ErpNhomNVSvl?userId=<%=userId%>&delete=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img title="Xóa" src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Ban có muốn xóa nhóm nhân viên này?')) return false;"></A>&nbsp; 
											<%} %>
											</TD>
											<!-- QUYEN VIEW DLN --> 
											<TD>
												<A href = "../../ErpNhomNVUpdateSvl?userId=<%=userId%>&display=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img src="../images/Display20.png" title="Hiển thị" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
											</TD>
											<!-- END QUYEN VIEW DLN --> 
											</TR>												
										</TABLE>									
