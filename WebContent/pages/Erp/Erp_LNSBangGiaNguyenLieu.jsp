...
<%@ page  import = "geso.traphaco.erp.beans.lapngansach.ILNSBanggianguyenlieuList" %>
...
<% ILNSBanggianguyenlieuList obj = (ILNSBanggianguyenlieuList)session.getAttribute("obj"); %>
<% List<ILNSBanggianguyenlieu> bgnllist = (List<ILNSBanggianguyenlieu>)obj.getBgnguyenlieuList(); %>
<% ResultSet bglist = (ResultSet)obj.getBglist();   

int[] quyen = new  int[5];
quyen = util.Getquyen("ErpLNSBanggianguyenlieuSvl","",userId);
%>
...
<form name="bgbanForm" method="post" action="../../ErpLNSBanggianguyenlieuSvl">
...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="1" >
			...
			<TR>
				<TD align="left" >
				  <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR height="22">
					  	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý ngân sách &gt; Bảng giá nguyên liệu</TD>
	...
	<img style="top: -4px;" src="../images/button.png" alt="" onClick="clearform()">Nhập lại</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					<TD width="100%">
					<FIELDSET>
					<LEGEND class="legendtitle">&nbsp;Bảng giá nguyên liệu &nbsp;&nbsp;&nbsp;
							  ...
							  <%}%>
									...
									<%} %>
										...
										<TD align="center">
											...
											<%if(quyen[2]!=0){ %>										
												<A href = "../../ErpLNSBanggianguyenlieuUpdateSvl?userId=<%=userId%>&update=<%= bglist.getString("id") %>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>
											<%} %>
											
											<%if(quyen[1]!=0){ %>		
												<A href = "../../ErpLNSBanggianguyenlieuSvl?userId=<%=userId%>&delete=<%= bglist.getString("id") %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Bạn có muốn xóa bảng giá này ?')) return false;"></A>  
											<%} %> 
