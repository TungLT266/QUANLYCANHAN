...
<% IErpTinhgianhap obj = (IErpTinhgianhap)session.getAttribute("obj"); %>
...
<body>
<form name="erpCngn" method="post" action="../../ErpTinhgiaxuatSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
             Quản lý cung ứng > Quản lý tồn kho > Tính giá tồn kho
        </div>
