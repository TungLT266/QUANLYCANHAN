...
<%@ page  import = "geso.traphaco.erp.beans.cophieu.imp.ErpCoPhieu" %>
...
function submitform(){
	...
	if(manh == "")                        
	{
		document.forms['nhForm'].dataerror.value = "Vui lòng nhập mã cổ phiếu.";
		return;              
	}
	...
	if(tennh == "")
	{
		document.forms['nhForm'].dataerror.value = "Vui lòng nhập tên cổ phiếu.";
		return;
	}
	
	var congtyphathanh = document.forms['nhForm'].congtyphathanh.value;
	if(congtyphathanh == "")
	{
		document.forms['nhForm'].dataerror.value = "Vui lòng nhập tên công ty phát hành cổ phiếu.";
		return;
	}
...
<form name="nhForm" method="post" action="../../ErpCoPhieuUpdateSvl" charset="UTF-8">
			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				<TR>
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Cơ bản &gt; Danh mục cổ phiếu   &gt; Tạo mới </TD>
					...
					<TABLE width="100%" cellspacing="0" cellpadding="6">
						   ...
						   <TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE  width="100%" cellspacing="0" cellpadding="6">		
									...
									<tr>
									<td width = "15%" class = "plainlabel">Tên cổ phiếu<font class = "erroralert">*</font> </td> 
									<td class = "plainlabel"> <input type = "text" name = "Ten" id = "ten" value="<%=nhBean.getTEN() %>"> </td>
									</tr>
									
									<tr>
									<td width = "15%" class = "plainlabel">Công ty phát hành cổ phiếu<font class = "erroralert">*</font> </td> 
									<td class = "plainlabel"> <input type = "text" name = "congtyphathanh" id = "congtyphathanh" value="<%=nhBean.getCongTyPhatHanh() %>"> </td>
									</tr>
