...
<% String userTen = (String) session.getAttribute("userTen");
    ...
    ResultSet khachHangRs = obj.getRsKhachHangBCTuoiNo();
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 function kiemTra(){
		...
		if (denNgay.value.trim().length ==0){
			...
			return false;
		}else if(denNgay.value.trim() <= '2016-09-30'){
	 ...
	 function sellectNhomAll()
	 {
		 ...
		 var khIds = document.getElementsByName("nspIds");
...
<body>
<form name="erpDmhForm" method="post" action="../../BCTongHopTuoiNo_MucHanNo">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Báo cáo quản trị > Công nợ > Tuổi nợ
        </div>
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
															...
															<select name="nhomkhachhang" id="nhomkhachhang" style="width: 300px;">
																...
																if (nhomKhachHangRs != null) {
																	while (nhomKhachHangRs.next()) {
																		String selected = "";
																		if (nhomKhachHangRs.getString("pk_seq").trim().equals(obj.getNhomKhId())){
																			selected = "selected";
																		}
                ...
                <TD class="plainlabel">Khách hàng</TD>
                            <TD class="plainlabel">
                              <select name="khachHangId" id="khachHangId" style="width: 300px;">
                                <option value="" selected></option>
                                <%
                                if (khachHangRs != null) {
                                  while (khachHangRs.next()) {
                                    String selected = "";
                                    if (khachHangRs.getString("pk_seq").trim().equals(obj.getKhachhangIds())){
                                      selected = "selected";
                                    }
                                  
                                %>
                                  <option value="<%=khachHangRs.getString("loai")+',' + khachHangRs.getString("pk_seq") %>" <%=selected %>><%=khachHangRs.getString(3) %></option>
                                <%} } %>
                              </select>
