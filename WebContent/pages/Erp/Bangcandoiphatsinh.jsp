...
<%@page import="geso.traphaco.erp.beans.bangcandoiphatsinh.IBangcandoiphatsinh"%>
...
<%
	...
	IBangcandoiphatsinh obj = (IBangcandoiphatsinh) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BangcandoiphatsinhSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Kế toán - Tài chính > Cân đối phát sinh</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Cân đối phát sinh
					</legend>
