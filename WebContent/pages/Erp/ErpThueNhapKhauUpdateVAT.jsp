...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function tinhtien(){
		...
		tienhang[0].value = tienhang[0].value.replace(",","");
		thueNK[0].value = parseFloat(tienhang[0].value)*parseFloat(ptThueNK[0].value);
		vat[0].value = (parseFloat(tienhang[0].value) + parseFloat(thueNK[0].value))*parseFloat(ptvat[0].value);		
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý mua hàng &gt; Mua hàng nhập khẩu &gt; Thuế nhập khẩu &gt; Cập nhật</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
	                     ...
	                     <TR>
								...
								<SELECT NAME = "cqtId" id = "cqtId"  style="width: 500px" >
										<OPTION VALUE = "" >&nbsp;</OPTION>
	                   ...
	                   <%--  <TR>
                        	...
                        	<TD class="plainlabel" valign="middle">
								<SELECT NAME = "poId" id = "poId"  style="width: 500px">
		                    <% rs = obj.getPoList();
       		                   if(rs != null){
       		                	   while(rs.next()){	
		                ...
		                <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan="5">
		                        	<input type="text" name="diengiai" value="<%= obj.getDiengiai() %>" style="width: 500px" > 
		                        </TD>          
		                </TR> 
	                    ...
	                    <TR>
                        	...
                        	<TD class="plainlabel" valign="middle">
		                     	<input type="text" id="tienhang" name="tienhang" value = "<%= formatter.format(Double.parseDouble(obj.getTienhang())) %>" style="width: 100px"  readonly="readonly"> 
<!--                         	</TD>                         -->
<!-- 						</TR> -->
...
<!-- 	                    <TR> -->
                         	<TD class="plainlabel" valign="middle" >Thuế nhập khẩu</TD>
                        	<TD class="plainlabel" valign="middle">
		                     	<input type="text" id="thueNK" name="thueNK" value = "<%= formatter.format(Double.parseDouble(obj.getThueNK())) %>" style="width: 100px" onKeyPress = "return keypress(event);" onKeyUp = "Dinhdang(this);" readonly="readonly">
                        	</TD>                        
<!-- 						</TR> -->
...
<!-- 		                        <TD class="plainlabel" valign="middle"  > -->
<%-- 		                        	<input type="text" name="ptVAT" value="<%= obj.getPtVAT() %>" style="width: 100px" onKeyPress = "return keypress(event);" onChange = "tinhtien();" onKeyUp = "Dinhdang(this);"> % --%>
<!-- 		                        </TD>           -->
<!-- 		                </TR>  -->
...
<!-- 		                <TR> -->
                          		<TD class="plainlabel" valign="middle" >VAT nhập khẩu</TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="VAT" value="<%= formatter.format(Double.parseDouble(obj.getVAT())) %>" style="width: 100px" onKeyPress = "return keypress(event);" onKeyUp = "DinhDangTien(this);" readonly="readonly"> 
		                        </TD>          
		                </TR> 
						</TABLE>
												<hr>
					...
					<div align="left" style="width: 100%; float: none; clear: none;"
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="0"
							...
							<TR class="tbheader">
								...
								<TH align="center" width="5%">Thuế suất NK</TH>
								<TH align="center" width="8%">Thuế NK</TH>
								<TH align="center" width="5%">% VAT NK</TH>
							...
							<tr>
								...
								<td align="left">
									<input type="text" name="donGiaVND" id="donGiaVND_<%=i %>" value="<%=formatter2.format(sp.getDonGiaVND())%>" style="width: 100%; text-align: left;" readonly="readonly">								
								</td>
								
								<td align="left">
									<input type="text" name="donGiaNT" id="donGiaNT_<%=i %>" value="<%=formatter2.format(sp.getDonGiaNT())%>" style="width: 100%; text-align: left;" readonly="readonly">								
								</td>

								<td align="left">
									<input type="text" name="thueSuat" id="thueSuat_<%=i %>" value="<%=formatter2.format(sp.getThueSuat())%>" style="width: 100%; text-align: left;" readonly="readonly">								
								</td>
