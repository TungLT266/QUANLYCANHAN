					...
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
						    ...
						    <%--if( tuBean.getDoiTuongTamUng().equals("1") ) {--%>
						    	<A href="../../ErpTamUngPdfSvl?userId=<%=userId %>&tuId=<%=tuBean.getId() %>&dtId=<%=tuBean.getDoiTuongTamUng() %>" >
						    	<img src="../images/Printer30.png" alt="In" title="In de nghi tam nghi" 
						    		longdesc="In de nghi tam nghi" border=1 style="border-style:outset"></A></TD>
						    <%--} --%>
						    <%-- <TD align="left" >
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  class="days" name="NgayTamUng" id="NgayTamUng" value="<%= tuBean.getNgayTamUng() %>"  maxlength="10" readonly> 
		                        </TD>          
		                  </TR>
		                  ...
		                  <TR>
                          		...
                          		<TD class="plainlabel" valign="middle"  >
									<select name="DoiTuongTamUng" id="DoiTuongTamUng"  style="width: 200px" >
										<option value=""></option>
										<%if(tuBean.getDoiTuongTamUng().equals("1")){ %>
                          ...
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="NhanVienId" id="NhanVienId" value="<%= tuBean.getTenHienThi() %>"  style="width:600px" readonly >
		                        </TD>          
		                  </TR>
		                  ...
		                  <%} %>
		                   ...
		                   <TR>											
		                     	 ...
		                     	 <TD class="plainlabel" valign="middle"  >								
									<select name="nccId" id="nccId"  style="width: 600px"  >		
										<option value=""></option>	
										<%if(rsNcc!=null){	
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="diachincc" id="diachincc" value="<%= tuBean.getdiachincc() %>"  readonly style="width: 600px;height:20px;"> 
		                        </TD>          
		                  </TR> 
		                  <%} %>
		                   ...
		                   <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
<%-- 		                        	<input type="text" name="LyDoTamUng" id="LyDoTamUng" value="<%= tuBean.getLyDoTamUng() %>"  readonly style="width: 600px;height:20px;"> --%>
		                  ...
		                  <%} %>	
	   					...
	   					<%if(!tuBean.getTienTeId().equals("100000")){ %>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input readonly="readonly" type="text" name="SoTienTamUngNT" id="SoTienTamUngNT" value="<%= formatter2.format(Double.parseDouble(tuBean.getSoTienNT()))%>" onkeypress="return keypress(event);" onchange="dinhdangNT();"> 
		                        </TD>          
		                  </TR> 	
		                  <TR>
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="ThoiGianHoanUng" id="ThoiGianHoanUng" value="<%= tuBean.getThoiGianHoanUng() %>" class="days" readonly="readonly" > 
		                        </TD>          
		                  </TR> 
		                     ...
		                     <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="HinhThucHoanUng" id="HinhThucHoanUng" value="<%= tuBean.getHinhThucHoanUng() %>"  readonly="readonly" > 
		                        </TD>          
		                  </TR> 
		                  <%} %>
						</TABLE>
