...
<%
	...
	List<IPhuongPhapThuNghiemThamSo> listTS=obj.getListThamSo();
...
function keypress(e) {    
	...
	function save(){
		...
		document.forms["pptnForm"].action.value="taomoi";
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ
											liệu nền > Hồ Sơ Kiểm Nghiệm > Phương Pháp Thử Nghiệm > Tạo mới</TD>
						...
						<TR>
							<TD height="100%" width="100%">
								<FIELDSET>
									...
									<input type="hidden" name="pk_seq" id="pk_seq" value="">
										...
										<TR class="plainlabel">
										 <TD class="plainlabel"  valign="middle">Số Lượng Tham Số Nhập Liệu</TD>
											<TD class="plainlabel"  > 
											<input type="number" onkeypress="return keypress(event);" name="sl" id="sl" value="<%=obj.getListThamSo().size() %>" style="width: 200px; ">
											</TD>
											...
											<%
												...
												for(int y=0;y < listTS.size();y++){
													...
													%>
															...
															<td >
																<input type="text" style="width: 100%; text-align: right;" name="congthuc" value="<%=ts.getCongthuc() %>">
															</td>
															<td align="center">
																<%
																	...
																	{
																		%>
																			<input type="checkbox" id="min_<%=y %>"  name="min_<%=y %>" checked="checked">
																		<% 
																	}else{
																		%>
																			<input type="checkbox" id="min_<%=y %>" name="min_<%=y %>" >
																	<% 
																	}
																%>
															</td>
															<td align="center">
																<%
																	...
																	{
																		%>
																			<input type="checkbox" id="max_<%=y %>" name="max_<%=y %>" checked="checked">
																		<% 
																	}else{
																		%>
																			<input type="checkbox" id="max_<%=y %>" name="max_<%=y %>" >
																	<% 
																	}
																%>
															</td>
															<td align="center">
																<%
																	...
																	{
																		%>
																			<input type="checkbox" id="avg_<%=y %>" name="avg_<%=y %>" checked="checked">
																		<% 
																	}else{
																		%>
																			<input type="checkbox" id="avg_<%=y %>" name="avg_<%=y %>" >
																	<% 
																	}
																%>
															</td>
															<td align="center">
																<%
																	...
																	{
																		%>
																			<input type="checkbox" id="sum_<%=y %>" name="sum_<%=y %>" checked="checked">
																		<% 
																	}else{
																		%>
																			<input type="checkbox" id="sum_<%=y %>" name="sum_<%=y %>" >
																	<% 
																	}
																%>
															</td>
										...
										<select name="tem" id="tem"  style="width:50px;display:none;">
										...
										<TR>
											...
											<input type="number" onkeypress="return keypress(event);" name="slmau" id="slmau"  value="<%=obj.getSoLuongMau()%>" style="width: 200px; ">
											</TD>
	...
	$('body').delegate('#sl', 'change', function(event) {
		...
		{ */
			...
			for(var i=0;i<sl;i++){
				...
				s+='<td align="center"> <input type="checkbox" id="min_'+i+'" name="min_'+i+'"> </td> ';
				s+='<td align="center"> <input type="checkbox" id="max_'+i+'" name="max_'+i+'"> </td> ';
				s+='<td align="center"> <input type="checkbox" id="avg_'+i+'" name="avg_'+i+'"> </td> ';
				s+='<td align="center"> <input type="checkbox" id="sum_'+i+'" name="sum_'+i+'"> </td> </tr>';
