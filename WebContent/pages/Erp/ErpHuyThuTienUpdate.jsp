...
<%@ page  import = "geso.traphaco.erp.beans.huythutien.imp.*" %>
...
<% IErpHuythutien hctmhBean = (IErpHuythutien)session.getAttribute("hctmhBean"); 
...
<form name="hctmhForm" method="post" action="../../ErpHuythutienUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải thu > Hủy phiếu thu tiền > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpHuythutienSvl?userId=<%= userId %>" >
        	<img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1px" longdesc="Quay ve" style="border-style:outset"></A>
        <A id = "btnSave" href="javascript:saveform()" ><img src="../images/Save30.png" alt="Luu lai"  title="Luu lai" border="1" longdesc="Luu lai" style="border-style:outset"></A>
    </div>
    ...
    <fieldset>
    	<legend class="legendtitle"> Hủy chứng từ </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD colspan="2" class="plainlabel" valign="top">
                    	<input type="hidden" id="sochungtu" name="sochungtu" value="<%= hctmhBean.getSochungtu() %>" onchange="submitform()"  />
                    	<input type="text" id="sochungtugoc" name="sochungtugoc" value="<%= hctmhBean.getSochungtugoc() %>" onchange="submitform()"  />
                    </TD>
                </TR>
                <TR>
	          			<TD class="plainlabel" valign="middle" >Ngày ghi nhận</TD>
						<TD class="plainlabel" valign="middle"  colspan="2">
							<input type="text" class="days" name="ngayghinhan"  id="ngayghinhan" value="<%= hctmhBean.getNgayghinhan() %>" >
						</TD>
			   </TR>	
			   <TR>
	          			<TD class="plainlabel" valign="middle" >Diễn giải chứng từ</TD>
						<TD class="plainlabel" valign="middle"  colspan="2">
							<input type="text" name="dienGiaiCT"  id="dienGiaiCT" value="<%= hctmhBean.getDienGiaiCT() %>" >
						</TD>
					</TR>	
           ...
           <% 
        	...
        	<TD align="center">
        		<input type="text" name="sochungtu" style="width: 100%" value="<%= soctRequest.getString("SOCHUNGTUGOC") %>" readonly="readonly" >
        	</TD>
        	<TD align="center">
        	...
        	<TD align="center">
        		<% if(hctmhBean.getSochungtugoc().equals(soctRequest.getString("SOCHUNGTUGOC"))){ %>
        			<input type="checkbox" name="sochungtuhuy" value="<%= soctRequest.getString("SOCHUNGTUGOC") %>" onchange="ReadOnly(<%= i - 1 %>)" checked="checked" readonly="readonly" >
        		<%} else { %>
        			<input type="checkbox" name="sochungtuhuy" value="<%= soctRequest.getString("SOCHUNGTUGOC") %>" onchange="HuyChungTu(<%= i - 1 %>)" >
        		<%} %>
        	</TD>
        </TR>
<% i++; } } %>
