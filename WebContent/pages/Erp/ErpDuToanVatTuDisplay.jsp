	...
	<form name="dmhForm" method="post" action="../../ErpDutoanvattuUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Dự toán vật tư > Hiển thị</div>
									...
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<TD  align="center" width="8%" >
												<input type="text"  name= <%= "masp" +j %> style="width: 100%" value="<%= sp.getMasanpham() %>"   > 
											</TD>
											<%-- <%} else {%>
											 <TD  align="center" width="8%" >
												<input type="text"  name= <%= "masp" +j %> style="width: 100%" value="<%= sp.getMasanpham() %>" > 
											...
											<TD align="center" width="8%">
												<%-- <input type="text" value="<%= sp.getDongia() %>" name=<%= "dongia" + j %> style="width: 100%; text-align: right;" > 
											 --%>
											<% if(dmhBean.getTienTe_FK().equals("100000")) {%>
