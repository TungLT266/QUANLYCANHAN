						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kho vận &gt; Định khu vực &gt; Hiển thị</TD>
								...
								<fieldset>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											<tr>
														...
														<td class="plainlabel"><input type="text" readonly style="width:350px" name ="ma" value="<%=kvkBean.getMa()%>" id="ma"/>
													
													</tr>
													<tr>
														<td class="plainlabel">Tên khu vực  <font class="erroralert">*</font></td>
													<td class="plainlabel"><input type="text" readonly style="width:350px" name ="ten" value="<%=kvkBean.getDienGiai()%>" id="ten"/>
													</tr>
													<tr>
														<td class="plainlabel">Thuộc kho <font class="erroralert">*</font></td>
														<TD class="plainlabel"><select disabled name="KhoId" style="width:350px" id="kho">
																<option value=""></option>
																<%if (rsKho != null)
				while (rsKho.next()) {
					if (kvkBean.getKhoId().equals(
							rsKho.getString("PK_SEQ"))) {%>
										...
										<TR>
											...
											<TD class="plainlabel">
												<%if (kvkBean.getTrangThai().equals("1")) {%> <input type="checkbox" disabled  name="trangthai" value="<%=kvkBean.getTrangThai()%>"
												checked="checked"> <%} else {%> <input type="checkbox" disabled  name="trangthai" value="<%=kvkBean.getTrangThai()%>"> <%}%>
											</td>
										</TR>
									</table>
									</fieldset>
