		...
		{		
			...
			if(dnmhId.value != '')
			{
				...
				for(var i = 0; i < nccid.length ; i ++)
				{
					...
					var idsp = document.getElementsByName("idsp" + i);
					...
					console.log(" tien viet truoc vat tung ncc : "+ tongtiendonghang_truocvat);
					console.log(" tien viet sau vat tung ncc: "+ tongtiendonghang_sauvat);
				...
				/* tienviettruocvat.value	 = DinhDangTien(tongtiendonghang_truocvat * tygia);
				tienvietsauvat.value	= DinhDangTien( tongtiendonghang_sauvat * tygia) ;
				console.log(" ty gia: "+ tygia);
				console.log(" tien viet truoc vat : "+ DinhDangTien(tongtiendonghang_truocvat * tygia));
				console.log(" tien viet sau vat : "+ tongtiendonghang_truocvat * tygia); */
	...
	<form name="dmhForm" method="post" action="../../ErpDutoanvattuUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Dự toán vật tư > Tạo mới</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel" valign="top" >
									<input type="text" class="days" id="ngaydutoan" name="ngaydutoan"
								...
								<TD class="plainlabel" colspan="3">
									<Select  style="width: 200px" name="tiente_fk" id="tiente_fk" onChange="submitform();">
										<option value=""></option>
										<% if (ttList.size() > 0)
											{
							...
							<TR>																																
								...
								<TD class="plainlabel" width="250px" colspan="1">
									<select name="dnmhId" id="dnmhId" onChange="submitform();" style="width: 200px">
										<option value = ""></option>
										<% if (dnmhList != null)
										{
											while (dnmhList.next())
								...
								<TD class="plainlabel" width="250px" colspan="3">		
									...
									<% } } } else {%>	
									<input type="text"  id="tygiaid" name="tygiaid"  value="1" readonly />				
									<%} %>	
								</TD>
							...
							<TD class="plainlabel">Loại hàng hóa</TD>
								<TD class="plainlabel">
									<select name="loaihh" id="loaihh" onChange="submitform();" style="width: 200px" disabled="disabled">
