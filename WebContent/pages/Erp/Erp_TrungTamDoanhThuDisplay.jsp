				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Trung tâm doanh thu &gt; Hiển thị</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
							  ...
							  <% if(TTDTBean.getPhanbo().equals("1")){%>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" disabled " name="pb" value = "1" checked onChange = "submitform();"></TD>
						  	  <%}else{ %>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" disabled " name="pb" value = "1" onChange = "submitform();"></TD>
						  	  <%} %>
							...
							<TR>
							  ...
							  <% if(TTDTBean.getNhanphanbo().equals("1")){%>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" disabled " name="pb" value = "1" checked disabled = "disabled"></TD>
						  	  <%}else{ %>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" disabled " name="pb" value = "1" disabled = "disabled"></TD>
						  	  <%} %>
										...
										if(TTDTList != null)
										{
	                                     ...
	                                     <%		  }%>
												...
												<%		if(pbIdList.indexOf(TTDTList.getString("TTDTID_NPB")) >= 0){
															...
															String[] pt = tmp.split("-");
												%>
														<INPUT type="text" readonly name = "<%= "pt" + TTDTList.getString("TTDTID_NPB") %>" style="width: 100%" value="<%= pt[1] %>" >
														
												<%		}else{ %>
												
														<INPUT type="text" readonly name = "<%= "pt" + TTDTList.getString("TTDTID_NPB") %>" style="width: 100%" value="<%= TTDTList.getString("PHANTRAM_NPB") %>" >
												...
												<%		} %>
													...
													<TD align="center">
														...
														<input type="checkbox" disabled " name="pbIds" value="<%= TTDTList.getString("TTDTID_NPB") %>" checked="checked" >
										...
										if(TTDTList != null)
										{
	                                     ...
	                                     <%		  }%>
												...
												<%		if(pbIdList.indexOf(TTDTList.getString("TTDTID")) >= 0){
															...
															String[] pt = tmp.split("-");
												%>
														<INPUT type="text" readonly name = "<%= "pt" + TTDTList.getString("TTDTID") %>" style="width: 100%" value="<%= pt[1] %>" >
														
												<%		}else{ %>
												
														<INPUT type="text" readonly name = "<%= "pt" + TTDTList.getString("TTDTID") %>" style="width: 100%" value="" >
												...
												<%		} %>
													...
													<TD align="center">
												<% if(pbIdList.indexOf(TTDTList.getString("TTDTID")) >= 0){ %>
														<input type="checkbox" disabled " name="pbIds" value="<%= TTDTList.getString("TTDTID") %>" checked="checked" >
												<% }else{ %>
														<input type="checkbox" disabled " name="pbIds" value="<%= TTDTList.getString("TTDTID") %>"  >
												<% } %>
