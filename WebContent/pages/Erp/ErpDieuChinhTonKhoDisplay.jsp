...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Điều chỉnh tồn kho > Hiển thị 
        </div>
							...
							<% if( soluongyeucau >= 0 && lsxBean.getKhoXuatId().trim().length() > 0  ) { %>
								<a href="" id="scheme_<%= yeucau.getMa() + "__ "  %>" rel="subcontent_<%= yeucau.getMa() + "__ " %>">
	           	 		 		...
	           	 		 		<DIV id="subcontent_<%= yeucau.getMa() + "__ " %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width:1115px; max-height:200px; overflow:auto; padding: 4px;">
				                    <table width="95%" align="center">
				                        ...
				                        <tr>
				                            <th width="95px" style="font-size: 10px">Tồn mới</th>
				                            <th width="95px" style="font-size: 10px">Tồn hiện tại</th>
		                            	...
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				...
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: center;" name="<%= temID %>_spPhieudt" value="<%= spRs.getString("PHIEUDT") %>" readonly="readonly">
			                        				</td>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: center;" name="<%= temID %>_spPhieueo" value="<%= spRs.getString("PHIEUEO") %>" readonly="readonly">
			                        				</td>
			                        				<td>
