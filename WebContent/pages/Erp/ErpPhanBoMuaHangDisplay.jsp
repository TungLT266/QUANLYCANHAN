	...
	<form name="timnccForm" method="post" action="../../ErpPhanbomuahangUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua hàng trong nước > Phân bổ cho Pha Nam MTV > Hiển thị</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<TD class="plainlabel">
									...
									<INPUT  name="donvithuchien_fk" style="width: 200px" type='hidden' value='<%=timnccBean.getDvth()%>'>
									<INPUT  name="nhacungcap_fk" style="width: 200px" type='hidden' value='<%=timnccBean.getNcc()%>'>
								</TD>
							</tr>
						</TABLE>
						<hr>
