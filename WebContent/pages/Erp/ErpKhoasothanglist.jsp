...
<%@page import="geso.traphaco.erp.beans.khoasothang.IErpkhoasothanglist"%>
...
<%
	...
	if(!util.check(userId, userTen, sum)){
		response.sendRedirect("/TraphacoHYERP/index.jsp");
 		...
 		IErpkhoasothanglist ltsList = (IErpkhoasothanglist)session.getAttribute("obj");
...
<form name="cnForm" method="post" action="../../ErpKhoasothangListSvl">
				...
				<tr>
					<td align="left">
					  <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
						   <td align="left" colspan="2" class="tbnavigation">Quản lý tồn kho-> Khóa sổ tháng					   
						   </td>
		   				...
		   				<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  				<tr>
									...
									<%}%>
										...
										if(RsTs.getString("trangthai").equals("1")){
										%>	
													<a href = "../../ErpKhoasothangListSvl?userid=<%=userId%>&Unchot=<%=RsTs.getString("SOPHIEU")%>"><img src="../images/unChot.png" alt="Chinh sua" width="20" height="20" longdesc="Chinh sua" border = 0></A>
												 <%}else{ %>
												 	<a href = "../../ErpKhoasothangSvl?userid=<%=userId%>&display=<%=RsTs.getString("SOPHIEU")%>"><img src="../images/Display20.png" alt="Xem" width="20" height="20" longdesc="Xem" border = 0></A>
												 <%} %>
												</td>
												<td>&nbsp;&nbsp;</td>
												<td>
...
<%
try{
	 if(ltsList!=null)ltsList.DbClose();
