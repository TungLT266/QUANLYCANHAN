...
<body>
<form name="erpDmhForm" method="post" action="../../XuatExcel_GiaoNhanPhieuXuatSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Báo cáo quản trị > Báo cáo khác > Báo cáo chuyển kho
        </div>
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" >
                            <input type="text" class="days" 
                                   id="tungay" name="tungay" value="" maxlength="10" />
                        </TD>
                    </TR>
                     <TR>
                        ...
                        <TD class="plainlabel" >
                            <input type="text" class="days" 
                                   id="denngay" name="denngay" value="" maxlength="10" />
                        </TD>
                    </TR>
                      ...
                      <tr>
                      			<TD class="plainlabel">Chọn báo cáo </TD>
									<TD class="plainlabel">
										...
										<select name="baocao" id="baocao"  >
											<option value=""></option>
											<option value="1">Phiếu nhập TP</option>
											<option value="2">Phiếu nhập</option>
											<option value="3">Phiếu xuất</option>
										</select>
