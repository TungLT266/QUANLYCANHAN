				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công nợ > Công nợ phải trả > Chi phí khác > Hiển thị</TD> 
	 										...
	 										%>
						         			 ...
						         			 <%		} %>
						         			 	...
						         			 	<%		} %>
											      		...
											      		<td>
											      			<input type="text" name=<%= "thue" + i %> value = "<%= formatter.format(Double.parseDouble(tienthue[m])) %>" style="width: 100%" readonly=readonly>
											      		</td>
					         			 	...
					         			 	<%		} %>
										      		...
										      		<td>
										      			<input type="text" name=<%= "thue" + i %> value = "0" style="width: 100%" readonly=readonly>
										      		</td>
									   ...
									   %>
										...
										<%	// Thêm 5 dòng trong cho chi phí
											...
											<TR>
												...
												<td>
													<input type="text" name="thue" value= "0" style="width: 100%" class="days" readonly = readonly>
												</td>
						         			...
						         			<%			} %>
					         			 	...
					         			 	<%		} %>
											      		...
											      		<td>
											      			<input type="text" name=<%= "thue" + j %> value = "0" style="width: 100%" readonly=readonly>
											      		</td>
