...
<%
	...
	{  
		...
		response.setHeader("Content-Type", "text/html; charset=UTF-8");
	   	...
	   	String command = " select cast(pk_seq as nvarchar(10)) + ' -- ' + MA + ', ' + ten as nccTen  from ERP_NHACUNGCAP where trangthai='1' and CONGTY_FK = "+ congtyId +" ";
		...
		if(ncc != null)
		{
			...
			{   
					...
					nccTen = Ult.replaceAEIOU(ncc.getString("nccTen"));
