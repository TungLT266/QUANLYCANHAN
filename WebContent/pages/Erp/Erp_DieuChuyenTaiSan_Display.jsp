...
<%@ page import="geso.traphaco.erp.beans.dieuchuyentaisan.IErp_DieuChuyenTaiSan"%>
<%@ page import="geso.traphaco.erp.beans.dieuchuyentaisan.imp.Erp_DieuChuyenTaiSan"%>
...
<%	Utility util = (Utility) session.getAttribute("util"); 
	...
	IErp_DieuChuyenTaiSan dcBean = (Erp_DieuChuyenTaiSan) session.getAttribute("dcBean");
...
<form name="tsForm" method="post" action="../../Erp_DieuChuyenTaiSanUpdateSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý tài sản > Điều chuyển tài sản > Hiển thị</TD>
					...
					<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD  width="30" align="left" ><A href="/TraphacoHYERP/Erp_DieuChuyenTaiSanSvl"> <img src="../images/Back30.png"
								...
								<FIELDSET>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											...
											<TR class="plainlabel">
                                          	...
                                          	<TR class="plainlabel">
											  <TD class="plainlabel">Tài sản </TD>
											 	<TD class="plainlabel">
                                          	...
                                          	<TD class="plainlabel">Trung tâm chi phí mới</TD>
										          <td class="plainlabel">
					...
					<%-- 	<TR>
							<td>
								...
								<div class="panes">
	                               ...
	                               <%	  	}%>
												<TD align = "center">
												<% if(dcBean.getCdId().indexOf(cdtsRs.getString("PK_SEQ"))>=0) {  %>	
													<INPUT TYPE = "checkbox" name="cdtsIds" value="<%= cdtsRs.getString("PK_SEQ") %>" checked="checked">
												<% } else { %>
													<INPUT TYPE = "checkbox" name="cdtsIds" value="<%= cdtsRs.getString("PK_SEQ") %>">
												<% } %>
													<INPUT TYPE = "HIDDEN" name="Ids" value="<%= cdtsRs.getString("PK_SEQ") %>" >
												</TD>

												<TD><%= cdtsRs.getString("TEN") %></TD>																									
													
												<TD align = "center">
													
													<INPUT TYPE = "text" name="<%= "pt1" + cdtsRs.getString("PK_SEQ") %>" value="<%= cdtsRs.getString("PHANTRAM") %>" style="width:100" onkeypress="return isNumberKey(event)">
												</TD>
									...
									<%		i++;
										...
										<div>
											<TABLE style="width: 70%" cellpadding="4px" cellspacing="1px" align="center">
												<TR><TD class= "legendtitle" >Chọn khoản mục để phân bổ khấu hao</TD></TR>
											</TABLE>
