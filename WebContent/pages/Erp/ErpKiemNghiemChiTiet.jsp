<%@page import="geso.traphaco.erp.beans.kiemnghiemchitiet.IErpKiemNghiemChiTietList"%>
...
<%
IErpKiemNghiemChiTietList obj = (IErpKiemNghiemChiTietList) session
			.getAttribute("obj");
%>
<%
...
<%
	...
	ResultSet rsKiemNghiemCT = obj.getRsKiemNghiemCT();
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="form" method="post"
		action="../../ErpKiemNghiemChiTietSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					...
					Chức năng &gt; Kiểm nghiệm chi tiết</div>
				...
				<fieldset id="hoadon">
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								<TD class="plainlabel" width="15%">Phòng ban thực hiện</TD>
					...
					<div align="left" style="width: 100%; float: none; clear: none;"
						...
						<TABLE class='customers' class="tabledetail" width="100%" border="0" cellpadding="1"
							...
							<tr class="tbheader">
								...
								<th align="center" width="5%">Ngày chứng từ</th>
								<th align="center" width="10%">Bộ phận thực hiện</th>
								<th align="center" width="10%">Sản phẩm</th>
								<!-- <th align="center" width="8%">Hồ sơ kiểm nghiệm</th>
								<th align="center" width="5%">Tiêu chuẩn kiểm nghiệm</th>
							...
							<% if(rsKiemNghiemCT != null){
								try{
									while(rsKiemNghiemCT.next()){
									if(rsKiemNghiemCT.getString("trangthai").equals("0")){%>
							<tr >
							<%}else if(rsKiemNghiemCT.getString("trangthai").equals("1")){ %>
							<tr >
							<%}else if(rsKiemNghiemCT.getString("trangthai").equals("2")){ %>
							<tr style="color:red">
							<%} %>
								<td align="center"  >
									 <%=rsKiemNghiemCT.getString("SOID") %> 
								</td>
								<td align="center">
									<%=rsKiemNghiemCT.getString("ngaychungtu") %>
								</td>
								<td align="left" >
									 <%=rsKiemNghiemCT.getString("PHONGBANTHUCHIEN") %> 
								</td>
								<td align="left" >
									 <%=rsKiemNghiemCT.getString("SANPHAM") %> 
								</td>
								<td align="left" style="display:none">
									 <%=rsKiemNghiemCT.getString("HOSOKIEMNGHIEM") %> 
								</td>
								<td align="left" style="display:none">
									 <%=rsKiemNghiemCT.getString("TIEUCHUANKIEMNGHIEM") %> 
								</td>
								<td align="left" style="display:none">
									 <%=rsKiemNghiemCT.getString("YEUCAUKYTHUAT") %> 
								</td>
								<td align="center" >
									 <%=rsKiemNghiemCT.getString("nguoitao") %> 
								</td>
								<td align="center" >
									 <%=rsKiemNghiemCT.getString("ngaytao") %> 
								</td>
								<%if(rsKiemNghiemCT.getString("trangthai").equals("0")){ %>
								<td align="center" >
									 Chưa chốt 
								...
								<TD align="center" width="5%">
									<%if(quyen[2]!=0){ %>
									<A
										href="../../ErpKiemNghiemChiTietUpdateSvl?task=capnhat&id=<%=rsKiemNghiemCT.getString("SOID")%>">
									...
									<%if(quyen[3]!=0){ %>
			                    		<A
										href="../../ErpKiemNghiemChiTietSvl?task=hienthi&id=<%=rsKiemNghiemCT.getString("SOID")%> ">
									...
									<%if(quyen[4]!=0){ %>
									<A
										href = "javascript:Chot('<%= rsKiemNghiemCT.getString("SOID") %>');">
									...
									<%if(quyen[1]!=0){ %>
									<A
										href="javascript:Xoa('<%= rsKiemNghiemCT.getString("SOID") %>');">
								...
								<td align="center" width="5%">
									...
									<%if(quyen[5]!=0){ %>
									<A
										href = "javascript:Bochot('<%= rsKiemNghiemCT.getString("SOID") %>');">
