...
<head>
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 function clearform()
	 {   
	    document.forms["erpTimnccForm"].sodenghi.value = "";
...
<body>
<form name="erpTimnccForm" method="post" action="../../TimnhaccSvl_nk">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Tìm nhà cung cấp
        </div>
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR>
                        <TD class="plainlabel" valign="middle">Mã mua hàng </TD>
                        <TD class="plainlabel" valign="middle" >
                            <input type="text" name="sodenghi" value="<%= obj.getSodenghi() %>" onchange="submitform()">
                        </TD>             
                    </TR>
                    <TR>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" width="7%">Mã mua hàng</TH>
                   		...
                   		if(timnccList != null)
                   		{
                   			...
                   			{  		
		                        ...
		                        <%}else{ %>
		                          	<TR class='tblightrow'  >
		                        <%} %>
				                    <TD align="center"><%= timnccList.getString("muahang_id") %></TD>
				                	...
				                	<% if(tt.equals("0")){ %>
				               			...
				               			<A href = "../../TimnhaccUpdateSvl_nk?userId=<%=userId%>&display=<%= timnccList.getString("id") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
				              			<%if(quyen[0] != 0 ){ %>
				                		
		                               	<A href = "../../TimnhaccUpdateSvl_nk?userId=<%=userId%>&update=<%= timnccList.getString("id") %>">
		                               	...
		                               	<%if(quyen[3]!=0){ %>
			                                 <A id='chotphieu<%=timnccList.getString("id")%>'
										      ...
										      border="0" onclick="if(!confirm('Bạn có muốn chốt tìm nhà cung cấp này?')) {return false ;}else{ processing('<%="chotphieu"+timnccList.getString("id")%>' , '../../TimnhaccSvl_nk?userId=<%=userId%>&chot=<%= timnccList.getString("id")%>');}"  >
										    </A>
									    	<%} %>
                                    ...
                                    <%if(quyen[2]!=0){ %>
                                		<A href = "../../TimnhaccSvl_nk?userId=<%=userId%>&delete=<%= timnccList.getString("id") %>"><img src="../images/Delete20.png" width="20" height="20" border=0 
                                					 alt="Xóa tìm nhà cung cấp" title="Xóa tìm nhà cung cấp" onclick="if(!confirm('Bạn có muốn xóa tìm nhà cung cấp này?')) return false;"></A>&nbsp;
                                	<%} %>	                                	
		                         	<%} else{  %>
		                         		<A href = "../../TimnhaccUpdateSvl_nk?userId=<%=userId%>&display=<%= timnccList.getString("id") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
		                            <%} %>
