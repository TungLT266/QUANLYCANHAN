...
<body>
<form name="THCongnoKHForm" method="post" action="../../ErpBCThongbaocongnoSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Báo cáo quản trị > Công nợ > Thông báo công nợ
        </div>
				...
				<%} %>
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                            <select name="khId" onChange="submitform1();" style="width: 200px">
                           		<option value=""> </option>
								<%  
   									if(khRs != null)
   									{
