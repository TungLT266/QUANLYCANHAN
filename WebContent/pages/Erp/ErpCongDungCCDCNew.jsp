...
<%
	IErpCongDungCCDC cdBean = (ErpCongDungCCDC) session.getAttribute("cdBean");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="cdForm" method="post" action="../../ErpCongDungCCDCUpdateSvl">
						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý công cụ dụng cụ &gt; Công dụng &gt; Tạo mới</TD>
					...
					<table width="100%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr class="tbdarkrow">
										<td width="30" align="left"><a href="/TraphacoHYERP/ErpCongDungCCDCSvl"> <img src="../images/Back30.png" alt="Quay ve" title="Quay ve"
							...
							<TD align="left" colspan="4" class="legendtitle">
								<fieldset>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											...
											<tr>
												<td class="plainlabel" width="15%">Thuộc tài khoản kế toán <font class="erroralert">*</font></td>
												<TD class="plainlabel"><select name="taikhoan" onchange="Submit()" id="taikhoan" style="width: 200px;">
														<option value=""></option>
														<%if (rsTaiKhoan != null)
