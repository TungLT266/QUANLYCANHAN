...
<%@page import="geso.traphaco.erp.beans.soquytienmat.ISoquytienmat"%>
...
<%
	...
	ISoquytienmat obj = (ISoquytienmat) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../SoquytienmatSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị &gt; Kế toán - Tài chính &gt; Sổ quỹ tiền mặt</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Sổ quỹ tiền mặt
					</legend>
            ...
            <%--     <% if(obj.getView().equals("TT")){ %>							                          
				...
				<%} %> --%>
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" >
                            <SELECT NAME = "chiNhanhId"  style = "width:300px;size:5" id = "chiNhanhId">
						...
						%>
								<TR>
									...
									<TD>
									<input type="text" class="days" id="tungay" name="tungay" value="<%= obj.getTungay() %>" maxlength="10" readonly="readonly"/>
									</TD>
									
									<TD class="plainlabel">Đến ngày</TD>
									<TD>
									<input type="text" class="days" id="denngay" name="denngay" value="<%= obj.getDenngay() %>" maxlength="10" readonly="readonly"/>
									</TD>
								</TR>
