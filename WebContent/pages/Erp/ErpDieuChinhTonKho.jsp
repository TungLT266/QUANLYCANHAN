...
<% IErpDieuchinhtonkhoList obj = (IErpDieuchinhtonkhoList)session.getAttribute("obj"); %>
...
<%  
	...
	if(!util.check(userId, userTen, sum)){
		response.sendRedirect("/TraphacoHYERP/index.jsp");
		 ...
		 int[] quyen = new  int[5];
		 quyen = util.Getquyen("ErpDieuchinhtonkhoSvl","",userId);
...
<body>
<form name="erpLsxForm" method="post" action="../../ErpDieuchinhtonkhoSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Điều chỉnh tồn kho 
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR>
                        <TD class="plainlabel" width="10%">Ngày điều chỉnh:</TD>
                    ...
                    <TR>
                        <TD class="plainlabel" width="10%">&nbsp;</TD>
                         <TD class="plainlabel" width="10%">Kho điều chỉnh </TD>
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Điều chỉnh tồn kho  </span>&nbsp;&nbsp;
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" width="8%">Ngày ĐC</TH>
	                 	<TH align="center" width="12%">Kho ĐC</TH>  
	                    <TH align="center" width="12%">Vị trí ĐC</TH> 
					...
					<%
                 		if(lsxList != null)
                 		{
		                    ...
		                    <TD align="center"><%= lsxList.getString("ngaydieuchinh") %></TD>
		                 	<TD align="left"><%= lsxList.getString("khochuyen") %></TD> 
		                   	<TD align="left"><%= lsxList.getString("vitrichuyen") %></TD>
		                    ...
		                    <TD align="center"> 
		                    	...
		                    	<%if(quyen[2]!=0){ %>
                                	<A href = "../../ErpDieuchinhtonkhoUpdateSvl?userId=<%=userId%>&update=<%=lsxList .getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                                <%} %>
                                 <%if(quyen[4]!=0){ %>
                                ...
                                <%} %>
                                 <%if(quyen[1]!=0){ %>
                                	<A href = "../../ErpDieuchinhtonkhoSvl?userId=<%=userId%>&delete=<%= lsxList.getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><img src="../images/Delete20.png" alt="Xóa chuyển kho" title="Xóa chuyển kho" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa yêu cầu chuyển kho này không?')) return false;"></A>
                                <%} %>	
                                								
		                    <% } else {  %>
		                    	<A href = "../../ErpDieuchinhtonkhoUpdateSvl?userId=<%=userId%>&display=<%= lsxList.getString("PK_SEQ") %>&task=<%=obj.getIsnhanHang()%>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" width="20" height="20" border=0></A>&nbsp;	
		                    <% } %> 
