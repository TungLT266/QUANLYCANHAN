...
<form name ="khtt" method="post" action="../../ErpNhamayUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản xuất > Phân xưởng  > Cập nhật</TD> 
				...
				<TR>
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							<TR>
                          		<TD class="plainlabel" valign="middle" width="120px" >Chọn nhà máy </TD>   
		                  ...
		                  <TR>
                          		<TD class="plainlabel" valign="middle"  >Chọn phòng ban </TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	   <select style="width: 300px" id="dvthId" name="dvthId" >
                    		<option value=""> </option>
                        	<%
                        		if(dvthRs != null)
                        		{
