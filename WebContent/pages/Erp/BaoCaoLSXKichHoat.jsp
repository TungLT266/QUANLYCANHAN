...
<%@ page  import = "geso.traphaco.erp.beans.lenhsanxuat.IBaoCaoTheoDoiLSX" %>



<% IBaoCaoTheoDoiLSX obj = (IBaoCaoTheoDoiLSX)session.getAttribute("obj"); %>
...
<body>
<form name="erpDmhForm" method="post" action="../../BaoCaoLSXSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý cung ứng > Sản xuất > Báo cáo theo dõi LSX
        </div>
