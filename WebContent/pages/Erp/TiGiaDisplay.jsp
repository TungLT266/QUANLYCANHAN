						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Mua hàng > Tỉ giá > Hiển thị</TD>
								...
								<FIELDSET>
									...
									<TABLE class="tblight" width="100%" cellspacing="0" cellpadding="6">
										...
										<TR>
											...
											<TD width="80%" class="plainlabel"> <input type="text" readonly value="<%=tigia.getMaTienTe() %> " name="MaTienTe" id="MaTienTe" readonly="readonly">
										</TD>
										</TR>
										
										<TR>
											<TD width="20%" class="plainlabel">Tên tiền tệ<FONT class="erroralert">*</FONT></TD>
											<TD width="80%" class="plainlabel"> <input type="text" readonly value="<%=tigia.getTenTienTe() %> " name="TenTienTe" id="TenTienTe" readonly="readonly">
										...
										<TR>
											...
											<TD width="80%" class="plainlabel">
												<input type="text" readonly value="<%=tigia.getSoLuongGoc() %>" name="SoLuongGoc" id="SoLuongGoc">
											</TD>
										</TR>
									  ...
									  %>
											<TD class="plainlabel"><input type="text" readonly class="txtsearch" id="tygia" name="TiGiaQuyDoi" size="20"
												value="<%=  tg %>" ></TD>
										</TR>
										...
										<TR>
											...
											<TD class="plainlabel"><input type="text" readonly class="days" id="TuNgay" name="TuNgay" size="10" value="<%= tigia.getTuNgay()%>"
												 readonly="readonly"></TD>
										</TR>
										<TR>
											<TD class="plainlabel">Đến ngày<FONT class="erroralert">*</FONT></TD>
											<TD class="plainlabel"><input type="text" readonly class="days" id="DenNgay" name="DenNgay" size="10" value="<%= tigia.getDenNgay()%>"
												 readonly="readonly"></TD>
										</TR>
											<TR>
											<TD width="15%" class="plainlabel"><label> <%  if (tigia.getTrangThai().equals("1")){%> <input name="TrangThai" type="checkbox" disabled 
													value="1" checked> <%} else {%> <input name="TrangThai" type="checkbox" disabled  value="0"> <%} %> Hoạt động
											</label></TD>
