...
function submitform()
{
	document.forms['cpttForm'].action.value='submit';
	document.forms["cpttForm"].submit();
}

function saveform(){
	document.getElementById("btnSave").innerHTML = "<a href='#'><img src='../images/waiting.gif'  title='cho thuc hien..' border='1' longdesc='cho thuc hien..' style='border-style:outset'> Processing...</a>";
	document.forms['cpttForm'].action.value='save';
	document.forms["cpttForm"].submit();
}
...
function TinhChenhLech()
{
	...
	document.forms['cpttForm'].action.value='change';
	document.forms["cpttForm"].submit();
...
function xuatExcel()
{
	document.forms['cpttForm'].action.value='Excel';
	document.forms["cpttForm"].submit();
}
function changeTscd()
{
...
<form name="cpttForm" method="post" action="../../Erp_DanhGiaLaiCPTTUpdateSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý chi phí trả trước > Đánh giá lại chi phí trả trước > Tạo mới</TD>
								...
								<FIELDSET>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											...
											<TR class="plainlabel">
											  ...
											  <TD class="plainlabel">                               
                                                 <input type="text" size="20"  id="nguyengiamoi" name="nguyengiamoi" value="<%= dcBean.getNguyengiamoi() %>" maxlength="10" onchange="javascript: TinhChenhLech();" /> 
                            				  </TD>
                            				  <TD class="plainlabel">Điều chỉnh </TD>
											  <TD class="plainlabel">                               
