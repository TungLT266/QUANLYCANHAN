...
{	
	...
	for(var i = 0; i < idhangmua.length; i++)
	{
		...
		for(var j = 0; j < sodong; j++)
		{
			...
			//	sln = sln + roundnumber4so(parseFloat(soluong.item(j).value.replace(/,/g,"")),4);
				sln = sln + roundnumber4so(parseFloat(soluong.item(j).value.replace(/,/g,"")),4);
	...
	var chenhlechhd = parseFloat(replaceAll(document.getElementsByName("chenhlechhd").value, ",", ""));
	document.getElementById("chenhlechhd").value= DinhDangDonGia(tongtien.toFixed(0));
...
/* 			var thuesuat = document.getElementById('thuesuat'+ i);
	...
	function keypress1(e) //Hàm dùng ngan khong cho nhap ki tu dac biet vao textbox khong cho nhap  '
	{    
		var keypressed = null;
		if (window.event)
			keypressed = window.event.keyCode; //IE
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0"
	...
	<form name="erpParkForm" method="post"
		action="../../ErpParkHoadontrongnuocUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Quản lý mua hàng > Mua hàng trong nước >
					Hóa đơn trong nước > Tạo mới</div>
				...
				<fieldset id="hoadon">
                   ...
                   <%} %> --%>
							...
							<TR>
								...
								<TD class="plainlabel" width="15%"><input type="text"
									 name="sotienchuathue" id="sotienchuathue" readonly
									value="<%=pBean.getSoTienChuaThue()%>" /></TD>								
							</TR>

							<TR>
							<TD class="plainlabel" width="15%">Số hoá đơn</TD>
								<TD class="plainlabel" width="15%"><input type="text"
									name="sohoadon" id="sohoadon" value="<%=pBean.getSoHoaDon()%>" /></TD>
									
								<TD class="plainlabel" width="15%">Thuế giá trị gia tăng</TD>
								<TD class="plainlabel" width="15%"><input type="text"
									 name="thuegtgt" id="thuegtgt" readonly
							...
							<TR>
								...
								<TD class="plainlabel" width="15%" ><input type="text"
									...
									value="<%=pBean.getKyHieuHoaDon()%>" /></TD>
							

								<TD class="plainlabel" width="15%">Tổng</TD>
								<TD class="plainlabel" width="15%"><input type="text"
									 name="tong" id="tong" readonly value="<%=pBean.getTong()%>" />
								</TD>
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="1"
							...
							<tr>
								...
								<td align="right"><input type="text"
									...
									name="vat" readonly="readonly"></td>
								<td align="right"><input type="text"
									style="width: 100%; text-align: right;"
									value="<%=DinhDang.dinhdangkho(Double.parseDouble(sp.getSoluongDaNhan().replaceAll(",","")))%>"
								...
								<td align="right"><input type="text"
									style="width: 100%; text-align: right;" onchange ="DieuChinhTien();"
									value="<%=formatter2.format( Double.parseDouble(sp.getThanhtienVATVND().replaceAll(",","")))%>" name="thanhtienVAT"
									></td>
