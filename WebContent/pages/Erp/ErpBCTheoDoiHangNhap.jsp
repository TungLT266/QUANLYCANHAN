...
<% ResultSet khonhanhRs = (ResultSet) obj.getKhonhanRs(); %>
...
<body>
<form name="erpDmhForm" method="post" action="../../ErpBCTheodoihangnhapSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	 Quản lý tồn kho > Báo cáo > Theo dõi hàng nhập
        </div>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                            <select name="loaisanpham" style="width: 400px;" class="select2" multiple="multiple" >
                            	<option value=""></option>
                            	<%
                            	try{	
	                        		if(lspRs != null)
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                            <select name="nccIds" style="width: 400px;" class="select2" multiple="multiple" >
                            	<option value=""></option>
                            	<%
                            	try{	
	                        		if(nccRs != null)
	                        		{
	                        			while(nccRs.next())
	                        			{  
	                        			if( nccRs.getString("PK_SEQ").equals(obj.getNccIds())){ %>
                       ...
                       <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                            <select name="khonhanId" id="khonhanId" style="width: 400px;" class="select2"  >
                            	<option value=""></option>
                            	<%
                            	try{	
	                        		if(khonhanhRs != null)
	                        		{
	                        			while(khonhanhRs.next())
	                        			{  
	                        			if( khonhanhRs.getString("PK_SEQ").equals(obj.getKhonhanIds())){ %>
	                        				<option value="<%= khonhanhRs.getString("PK_SEQ") %>" selected="selected" ><%= khonhanhRs.getString("khoTen") %></option>
	                        			<%}else { %>
	                        				<option value="<%= khonhanhRs.getString("PK_SEQ") %>" ><%= khonhanhRs.getString("khoTen") %></option>
	                        		 <% } } khonhanhRs.close();
	                        		} } catch(Exception e){e.printStackTrace();}
	                        	%>
                            </select>
                    ...
                    <TR>
                        <TD class="plainlabel" valign="middle" >Xem theo định dạng PIVOT </TD>
                        <TD class="plainlabel" valign="middle" >
