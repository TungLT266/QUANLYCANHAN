		...
		<td colspan="4" align='left' valign='top' bgcolor="#ffffff">
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr>
					...
					<tr height="22">
						<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Tiền tệ > Tạo mới
						</td>
				...
				<tr>
					...
					<tr>
						...
						<fieldset>
			    			...
			    			<textarea name="dataerror" style="width: 100%" readonly="readonly" rows="1" ><%=ttBean.getMsg()%></textarea>
						</fieldset>
						</td>
					</tr>								
					<tr>
					<TD align="left" colspan="4" class="legendtitle">
						...
						<td width="15%" class="plainlabel">Mã<font class="erroralert">*</font></td>
					 	<td  class="plainlabel" ><input type = "text" name="ma" id="ma" size="40" value="<%=ttBean.getMA()%>" ></td>
					</tr>

					<tr>
					  	<td class="plainlabel">Tên</td> <td class="plainlabel"> <input type = "text" name = "ten" value="<%=ttBean.getTEN()%>"> </td>
					</tr>
					<tr>
