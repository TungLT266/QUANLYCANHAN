...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý cung ứng > Quản lý tồn kho > <%=(lsxBean.gettask().equals("LSX")?"Chuyển nguyên liệu":"Chuyển kho")%> > Cập nhật
        </div>
			...
			{ 
				...
				{ 
					...
					<tr>
						...
						<td> <input type="text" name="soluongyeucau" value="<%= yeucau.getSoluongYC() %>" style="width: 100%; text-align: right; " readonly="readonly" onkeypress="return keypress(event);" > </td>
				...
				{ 
					...
					<tr>
						...
						<td> <input type="text" name="soluongyeucau" value="" style="width: 100%; text-align: right; " onkeypress="return keypress(event);" readonly="readonly" > </td>
