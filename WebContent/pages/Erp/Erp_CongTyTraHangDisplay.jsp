		...
		if(masp.item(i).value != "")
		{
			...
			{	
				...
				if(dongia.item(i).value != "")
				{
					...
					console.log ( "don gia :"+dgia );
					dongia.item(i).value = DinhDangDonGia_sole (dgia,4);  // don gia nguyen te
					console.log ( "don gia :"+DinhDangDonGia_sole (dgia,4) );
					...
					if(nguongoc == 'NN'){ // nhap khau ko co thue
						...
						for(var j = 0; j < soluongCT.length; j++)
						{
							...
							if(slct != "")
							{
								...
								tienthue = parseFloat(tienthue) +  Math.round(Math.round(parseFloat(dongia.item(i).value.replace(/,/g,""))*parseFloat(slct))  * parseFloat(thuevat1) / 100);
							}
						}
	...
	<form name="dmhForm" method="post" action="">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý mua hàng > Nghiệp vụ khác > Đơn trả hàng NCC > Hiển thị</div>
				...
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR class = "tbdarkrow">
						<TD width="30" align="left">
							...
							longdesc="Quay ve" style="border-style: outset">
			   				</A> 
					    <TD width="2" align="left" >&nbsp;</TD>
		    			<TD width="30" align="left" >
		    				<A href="../../Erp_CongtytrahangPdfSvl?userId=<%=userId %>&dthId=<%= dmhBean.getId() %>" ><img src="../images/Printer30.png" alt="Print"  title="Print" border="1"
		    				 longdesc="Print" style="border-style:outset">
		    			    </A>
		    			</TD>								    		
						<TD align="left" >&nbsp;</TD>
					</TR>
									...
									<a href="" id="nguoiDuyet" rel="thNguoiDuyet">
                          			...
                          			<DIV id="thNguoiDuyet" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
		                            	...
		                            	<%
		                            		...
		                            		{
		                            			System.out.println(" hk null:");
		                            			while (nguoiduyetRs.next())
		                            			{
		                            				%>
		                            				<Tr>
					                            		<td><input type="text" value="<%= nguoiduyetRs.getString("DIENGIAI") %>" style="width:100%" /></td>
					                            		<td><input type="text" value="<%= nguoiduyetRs.getString("TEN") %>" style="width:100%" /></td>
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<% if(sanpham_soluong.get( key ) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( key ).replaceAll(",", ""))) %>"  >
				                        				<% } else { %>
												...
												<%-- <input type="text" value="<%= sp.getDongia() %>" name="dongia" style="width: 100%; text-align: right;" >  --%>
													...
													<TD align="center" width="8%">
														...
														<%} else {%>
															...
															<TD align="center" width="8%">
																<input type="text" value="<%= sp.getThuexuat() %>" name="thuexuat" style="width: 100%; text-align: right;" >
															</TD>
															<TD align="center" width="8%">
																<input type="text" value="<%= sp.getTienVAT() %>" name="tienvat" style="width: 100%; text-align: right;" readonly="readonly" >
															</TD>
														<%} %> 
								...
								<tr>
									...
									<% if (dmhBean.getNguonGocHH().equals("NN") ){ %>
										...
										<%} else {%>
											...
											<TD align="center" width="8%">
												<input type="text" value="" name="tienvat" style="width: 100%; text-align: right;" readonly="readonly" >
											</TD>
										<%} %> 
