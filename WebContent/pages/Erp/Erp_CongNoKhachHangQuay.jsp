...
%>
<%
	IErp_CongNoKhachHangQuayList obj = (IErp_CongNoKhachHangQuayList) session.getAttribute("obj");
...
<%
int[] quyen = new  int[5];
quyen = util.Getquyen("Erp_CongNoKhachHangQuaySvl","",userId);
%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="xdForm" method="post" action="../../Erp_CongNoKhachHangQuaySvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán > Báo cáo > Theo dõi khách hàng quầy</TD>
...
<!-- 													style="display: none;" -->
													...
													<TR>
														<TD class="plainlabel">Quầy</TD>
														<TD class="plainlabel">
															<select name="quayId" id="quayId" style="width: 300px;">
																<option value=""></option>
																<%	for (Erp_Item item: obj.getDieuKienLoc().getQuayList())
																		if (obj.getDieuKienLoc().getQuay_fk().equals(item.getValue())){
																%>
																	<option value="<%=item.getValue() %>" selected><%=item.getName() %></option>
																<%
																		} else {
													...
													<TR>
														...
														<TR  style="display: none"> 
														<TD class="plainlabel" style="display: none">Nhóm khách hàng</TD>
...
<!-- 																	<TH width="5%">STT</TH> -->
																...
																<TR class=<%=darkrow%> >
																	...
																	<TD align="left"  width="20%"  style="word-wrap: break-word; max-width:230px;  overflow: hidden;text-overflow: ellipsis; white-space:nowrap;" ><%= item.getTenDoiTuong()%></TD>
