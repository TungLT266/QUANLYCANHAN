				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Chính sách duyệt mua hàng &gt; Cập nhật 
											...
											<TD>
												...
												<TR>
									  				...
									  				<TD class="plainlabel" width="30%">Phòng ban </TD>
						  			  				<TD class="plainlabel">
						  	  							<SELECT name= "dvthId" style="width: 200px" readonly = "readonly">
...
//														dbutils db = new dbutils();
														...
														<%  } %>	
											  					...
											  					<TD width="10%" align="center" >
																	<input name="sotientu" type="text" style="width:100%" value=<%= formatter.format(cs.getDouble("sotientu")) %> readonly="readonly">
																...
																<TD  align="center" > < - <= </TD>
											  					...
											  					<TD  align="center" >
											  						<%if (!cs.getString("sotienden").equals("-1")){ %>
																		<input name="sotienden" type="text" style="width:100%" value=<%= formatter.format(cs.getDouble("sotienden")) %> readonly="readonly">
																 	<%}else{ %>
											  					...
											  					<TD  align="center" >
				                    								...
				                    								<table width="100%" align="center">
									                        			...
									                        			<tr>
			            						            				...
			            						            				<td align="center"><input type="checkbox" name='<%="chon" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" checked="checked"></td>
			            						            				<td>
			            						            					<% if (rs1.getString("QUYETDINH").equals("1")){ %>
			            						            						<input type="checkbox" name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" checked="checked">
			            						            					<%}else{ %>
			            						            						<input type="checkbox" name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" >
			            						            					<%} %>
			            						            				</td>
									                        			...
									                        			<tr>
			            						            				...
			            						            				<td align="center"><input type="checkbox" name='<%="chon" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs2.getString("CDID")%>" ></td>  
			            						            				
			            						            				<td><input type="checkbox" name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs2.getString("CDID")%>" ></td>
			                        			                        </tr>
				                    							...
				                    							<hr/>
										                     	<div align="right" style="margin-right: 20px" class="legendtitle">
				                     								<a class="button2" href="javascript:dropdowncontent.hidediv('<%= "duyet" + cs.getString("KhoangchiphiId") %>')" 
				                     								onClick="javascript:cpsaveform(<%= cs.getString("KhoangchiphiId") %>)">
																	Lưu lại
																	</a>
				                     							</div>
				                     							<script type="text/javascript">
