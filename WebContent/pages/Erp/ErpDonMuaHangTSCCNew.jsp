...
/* 			else
	...
	{    
	 ...
	 function checkInput(){
		...
		// kiểm tra trường hợp thời hạn thanh toán nhập quá số tiền
		/* var soTienThanhToan = document.getElementsByName("soTienThanhToan");
		var tongSoTienThanhToan = 0;
		for(var i=0; i< soTienThanhToan.length; i++){
			tongSoTienThanhToan += parseFloat(replaceAll(soTienThanhToan.item(i).value,",",""));
		}
		
		var BVAT = document.getElementById("AVAT");
		var BVAT_ = parseFloat(replaceAll(BVAT.value,",",""));
		var checkTongThanhToan = tongSoTienThanhToan - BVAT_;
		if(checkTongThanhToan >0 ){
			alert("số tiền thanh toán vừa nhập vượt quá số tiền thực tế của hoá đơn, vui lòng xem lại");
			return false;
		} */
		return true;
	 }
	...
	<form name="dmhForm" method="post" action="../../ErpDonmuahangTSCCUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Đơn mua hàng > Tạo mới</div>
		                            	...
		                            	<%
		                            		...
		                            		if(thtt != null)
		                            		{
		                            			while (thtt.next())
		                            			{
		                            				%>
		                            				<Tr>
					                            		<td><input type="text" class="days" name="ngayThanhToan" value="<%= thtt.getString("NGAYTHANHTOAN") %>" style="width: 120px" /></td>
					                            		<td><input type="text" name="ptThanhToan" value="<%= thtt.getString("PTTHANHTOAN") %>" style="width: 150px;text-align: right;" /></td>
					                            		<td><input type="text" name="soTienThanhToan" value="<%= thtt.getLong("SOTIEN") %>" style="width:100%;text-align: right;" readonly/></td>
					                            	</Tr>
		                            			<% dong++; }
		                            		}
									...
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<%} %> 
												...
												</td><td><input type="text" name="donGiaUSD" style="width:100%;text-align:right" readonly="readonly"></td></tr></table>
											</TD>
											
											<TD align="center" width="8%">
												<input type="text" value="<%= sp.getThuexuat() %>" name="thuexuat" style="width: 100%; text-align: right;" readonly = readonly> 
											</TD>
											<TD align="center" width="8%">
							...
							<% for(int i = count; i < 40; i++) { %>
								...
								<tr>
									...
									<TD align="center" width="8%">
										...
										<table>
											<tr>
												<td><% if (dmhBean.getLoai().equals("1") ){ %>
									...
									<% }else{ %>
										...
										<td><input type="text" name="donGiaUSD" style="width:100%;text-align:right" readonly="readonly"></td>
											</tr>
									<% } %> 
										</table>
									</TD>
									...
									<TD align="center" width="7%">
										<input type="text" value="" name="thuexuat" style="width: 100%; text-align: right;" readonly = readonly> 
									</TD>
									<TD align="center" width="8%">
