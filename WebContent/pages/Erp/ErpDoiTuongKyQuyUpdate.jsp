						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Đối tượng ký quỹ > Cập nhật</TD>
								...
								<fieldset>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
										...
										<TR>
											...
											<TD class="plainlabel"><select name="taikhoan" id="taikhoan" style= "width:300px">
													<option value=""></option>
													<%
														if (rsTaiKhoan != null)
