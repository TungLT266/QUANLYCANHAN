...
<%@ page import="geso.traphaco.erp.beans.dieuchuyencptt.IErp_DieuChuyenCPTTList"%>
<%@ page import="geso.traphaco.erp.beans.dieuchuyencptt.imp.Erp_DieuChuyenCPTTList"%>
<%
	...
	if(!util.check(userId, userTen, sum)){
		...
		IErp_DieuChuyenCPTTList obj = (IErp_DieuChuyenCPTTList) session.getAttribute("obj");
		ResultSet RsDc = obj.getRsDc();
		ResultSet RsDvth = obj.getPbRs();
	
	 	int[] quyen = new  int[5];
	 	quyen = util.Getquyen("Erp_DieuChuyenCPTTSvl","",userId);
...
<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="tsForm" method="post" action="../../Erp_DieuChuyenCPTTSvl">
						...
						<tr>
							<td align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<td align="left" colspan="2" class="tbnavigation">Quản lý chi phí trả trước > Điều chuyển chi phí trả trước</td>
										...
										<td width="100%" align="center">
											<fieldset>
												...
												<table width="100%" cellpadding="6" cellspacing="0">
							                        ...
							                        <TD class="plainlabel" valign="middle">Số điều chuyển </TD>
							                        <TD class="plainlabel" valign="middle">
												 ...
												 <TD class="plainlabel">Phòng ban </TD>
										          <td class="plainlabel">
											          <select name="phongban" id= "phongban"  class="select2" style="width: 200px" onchange="javascript: changeTscd();">
														 <option value=""></option>
														  <% if(RsDvth != null){
															  try{ while(RsDvth.next()){ 				
												    			if(RsDvth.getString("pk_seq").trim().equals(obj.getPbId())){ %>
												     			...
												     			<%}
												    			}RsDvth.close();}catch(java.sql.SQLException e){}} %>	
														</select> 
										          </td>
												    </TR>	
													<tr>
										...
										<tr>
											<td align="left" colspan="4" class="legendtitle">
												<table width="100%" border="0" cellspacing="1" cellpadding="4">
													<tr class="tbheader">
														<th width="10%">Số điều chuyển</th>
														<th width="15%">Chi phí trả trước</th>
														<th width="15%">Trạng thái</th>
														<th width="25%">Ngày điều chuyển</th>
														...
														<td align="center">
															<table border=0 cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DieuChuyenCPTTUpdateSvl?userid=<%=userId%>&update=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<%if(quyen[3]!=0){ %>
																	<a href="../../Erp_DieuChuyenCPTTSvl?userid=<%=userId%>&chot=<%=RsDc.getString("pk_seq")%>"><img
																			src="../images/Chot.png" alt="Chốt" width="20" height="20" longdesc="Chot" border=0
																			onclick="if(!confirm('Bạn muốn chốt điều chuyển này ?')) return false;" ></A>
																			<%} %>
																	</td>
																	...
																	<a href=../../Erp_DieuChuyenCPTTSvl?userid=<%=userId%>&delete=<%=RsDc.getString("pk_seq")%>><img src="../images/Delete20.png"
																			alt="Xoa" width="20" height="20" longdesc="Xoa" border=0
																			onclick="if(!confirm('Bạn muốn xóa điều chuyển này ?')) return false;"></a> 
																	<%   } %>
																	</td>	
																	...
																	<td>
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DieuChuyenCPTTUpdateSvl?userid=<%=userId%>&display=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<%if(quyen[3]!=0){ %>
																	<td> 
																	<a href="../../Erp_DieuChuyenCPTTSvl?userid=<%=userId%>&unchot=<%=RsDc.getString("pk_seq")%>"><img
																			src="../images/unChot.png" alt="Bỏ chốt" width="20" height="20" longdesc="Un chot" border=0
																			onclick="if(!confirm('Bạn muốn bỏ chốt điều chuyển này ?')) return false;" ></A>
																			<%} %>
																	</td>
																	<%} %>
