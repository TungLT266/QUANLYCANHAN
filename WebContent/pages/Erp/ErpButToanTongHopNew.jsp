...
//	List<Erp_Item> tienTeList = btthBean.getTienTeList();
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán > Chức năng > Bút toán tổng hợp &gt; Tạo mới</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text"  class="days" name="NgayButToan" id="NgayButToan" value="<%= btthBean.getNgayButToan() %>"  onchange="LaySoChungTu();"> 
		                        </TD>          
		                  </TR> 
		                  <TR>
		                       ...
		                       <!--  CHE ĐI MÃ PK_SEQ CỦA BTTH TIẾP THEO -->
		                       <input type="hidden"  name="btthtieptheo" id="btthtieptheo" value="<%=btthBean.getBTTTHTiepTheo() %>"  > 
		                  </TR> 
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" name="tiGia" id="tiGia"
												value="<%= formatter2.format(btthBean.getTiGia())%>"
												onchange="dinhdangTG();"></TD>          
		                  </TR>
		                ...
		                <%--  <TR>
		                   ...
		                   <TR>
		                 	...
		                 	<%} %>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" style="width: 200px;text-align: right;" readonly="readonly" name="tongtienvn" id="tongtienvn" value="<%= formatter.format(tongVN) %>"  > 
		                        </TD>  
		                  ...
		                  <%if(!tienTe.equals("100000") && !tienTe.equals("")) {%>
		                   ...
		                   <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" style="width: 200px;text-align: right;" readonly="readonly" name="tongtiennt" id="tongtiennt" value="<%= formatter.format(tongNT) %>">
		                        </TD>  
		                  ...
		                  <%} %>
		                      ...
		                      double tongtienthue = 0;%>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" style="width: 200px;text-align: right;" readonly="readonly" name="tongtienthue" id="tongtienthue" value="<%=formatter.format(tongtienthue) %>"  > 
		                        </TD>     
		                  </TR>
						...
						<TR>
							...
							<td>
								  <input style="text-align: right; width: 80px;" type="text"
												name="SotienNT" id="SotienNT_<%=i %>" value='<%= 0%>'
												onkeypress="return keypress(event);"
												onChange="dinhdangNT(<%= i %>);" /></td>
							<%} %>
							<TD align="center" >
							 ...
							 <DIV id="subcontent_<%= pk_seq %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
			           	 	  ...
			           	 	  <table width="1500px" align="center">
			           	 	  	 <tr> <th width="80px" style="font-size: 11px">Mẫu HĐ</th>
			                            <th width="70px" style="font-size: 11px">Ký hiệu</th>
			                            <th width="80px" style="font-size: 11px">Số HĐ</th>
			                            <th width="70px" style="font-size: 11px">Ngày HĐ</th>
			                            <th width="200px" style="font-size: 11px">Tên NCC</th>
			                            <th width="200px" style="font-size: 11px">Địa chỉ</th>
			                            <th width="90px" style="font-size: 11px">MST</th>
			                            <th width="100px" style="font-size: 11px">Tiền hàng</th>
			                            <th width="100px" style="font-size: 11px">Thuế suất</th>
			                            <th width="100px" style="font-size: 11px">Tiền thuế</th>
                       		...
                       		<TD  align="center">
                       			...
                       			<input type="hidden" name = "dcCoIds" id = "dcCoIds_<%=i %>"  value=''/>
...
<script type="text/javascript">
	replaces();
	var ngay = document.getElementById("NgayButToan");
	var sct = document.getElementById("SoChungTu");
	if(ngay.value != "" && sct.value == ""){
		LaySoChungTu();
	}
</script>
