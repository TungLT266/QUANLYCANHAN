...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function upload(){
		document.forms["loaihoso"].setAttribute('enctype', "multipart/form-data", 0);
		document.forms["loaihoso"].submit();
	}

	function save() {
		if(document.getElementById("maloaihoso").value.trim() == ""){
			document.getElementById("dataerror").value = "Bạn chưa nhập mã loại hồ sơ.";
			return false;
		}
		
		if(document.getElementById("mabieumau").value.trim() == ""){
			document.getElementById("dataerror").value = "Bạn chưa nhập mã biểu mẫu.";
			return false;
		}
		
		if(document.getElementById("diengiai").value.trim() == ""){
			document.getElementById("dataerror").value = "Bạn chưa nhập diễn giải cho loại hồ sơ.";
			return false;
		}
		
		document.forms["loaihoso"].action.value = "save";
		document.forms["loaihoso"].submit(); 
    }
</SCRIPT>
</HEAD>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr height="22">
							  	<%if(obj.getId().length()>0){%>
							  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Hồ sơ kiểm nghiệm > Biểu mẫu hồ sơ > Cập nhật</TD>
							  	<%} else { %>
							  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Hồ sơ kiểm nghiệm > Biểu mẫu hồ sơ > Tạo mới</TD>
						  		<%} %>
				  	...
				  	<TD height="100%" width="100%">
						<FIELDSET>
							...
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          		<TR>
	                          		<TD class="plainlabel" valign="middle" width="200px" >Mã ID <FONT class="erroralert">*</FONT></TD>
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" style="width:300px" name="maloaihoso" id="maloaihoso" value="<%=obj.getMaLoaihoso() %>">
			                        </TD>
                  				</TR>
                  				
                  				<TR>
	                          		<TD class="plainlabel" valign="middle" width="200px" >Mã biểu mẫu <FONT class="erroralert">*</FONT></TD>
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" style="width:300px" name="mabieumau" id="mabieumau" value="<%=obj.getMaBieumau() %>">
			                        </TD>
                  				</TR>
                  			
	                          	<TR>
	                          		<TD class="plainlabel" valign="middle" width="200px">Diễn giải <FONT class="erroralert">*</FONT></TD>
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" style="width:300px" name="diengiai" id="diengiai" value="<%= obj.getDiengiai() %>"  > 
			                        </TD>          
			                  	</TR>
			                  	...
			                  	<TR>
			                        ...
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input class="days" type="text" style="width:150px" name="ngaybanhanh" value="<%= obj.getNgaybanhanh() %>" readonly="readonly" > 
			                        </TD>          
			                  	</TR>
			                  	...
			                  	<TR>
			                        ...
			                        <TD class="plainlabel" valign="middle">
			                        	...
			                        	<input type="file" name="file_bieumau" title="" style="width: 70px;" value='' onchange="upload();">
