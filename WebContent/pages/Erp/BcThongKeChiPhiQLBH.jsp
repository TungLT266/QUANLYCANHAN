...
<%@page import="geso.traphaco.erp.beans.bangchitiettaikhoan.IBcThongKeChiPhiQLBH"%>
...
<%
	...
	IBcThongKeChiPhiQLBH obj = (IBcThongKeChiPhiQLBH) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BcThongKeChiPhiQLBHSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Kế toán - Tài chính > Thống kê chi phí QL-BH </div>
