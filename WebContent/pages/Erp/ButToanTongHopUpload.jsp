<%@page import="geso.traphaco.erp.beans.buttoantonghopupload.IButToanTongHopUploadList"%>
...
<%
	System.out.print("geso.traphaco.erp.beans.buttoantonghopupload.IButToanTongHopUploadList");
...
%>
<%
	IButToanTongHopUploadList obj = (IButToanTongHopUploadList) session.getAttribute("obj");
	List<Erp_ListItem> hienThiList = obj.getList();
%>
<%
	int[] quyen = new int[5];
	quyen = util.Getquyen("ButToanTongHopUploadSvl","",userId);
%>
<%
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="xdForm" method="post" action="../../ButToanTongHopUploadSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;   Quản lý mua hàng > Nghiệp vụ khác > Upload Đơn mua hàng </TD>
