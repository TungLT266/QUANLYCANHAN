...
<%
	...
	String[] loaihoadon = obj.getLoaihoadon();
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán &gt; Giảm/Tăng giá hàng bán &gt; Tạo mới</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; color:red ; background-color: white ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1"><%= obj.getMsg() %></textarea>
						</FIELDSET>
				   </TD>
				</tr>			
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                        	...
                        	%>
	                          ...
	                          <TR>
			                        ...
			                        <TD class="plainlabel" valign="middle" colspan="3" >
			                        	...
			                        	<a href="" id="hdId" rel="subcontentHd" >
			           	 				...
			           	 				<DIV id="subcontentHd" style=" overflow:scroll ; position:absolute; visibility: hidden; border: 9px solid #80CB9B;
						                             background-color: white; width: 700px; height:300px;  padding: 4px;">
						                    <table width="90%" align="center">
						                        <tr>
						                            ...
						                            <th width="100px" style="font-size: 11px;"> Tổng tiền HD</th>
						                             <th width="100px" style="font-size: 11px;">Số tiền tăng giảm</th>
						                              <th width="100px" style="font-size: 11px;"> Ghi chú</th>
						                              
						                               <th width="100px" style="font-size: 11px;">Loại hóa đơn</th>
						                        ...
						                        <%
					                        			...
					                        			<tr>
								                        	...
								                        	<td>
								                        		<input  name="ghichuhd"  type="text" style="width: 100%; text-align: center;" readonly="readonly" value="<%=ghichuhd[i] %>" >
								                        	</td>
								                        	<td>
								                        		<input  name="loaihoadon"  type="text" style="width: 100%; text-align: center;" readonly="readonly" value="<%=loaihoadon[i] %>" >
								                        	</td>
			                  ...
			                  <TR  >
			                        ...
			                        <TD class="plainlabel"  valign="middle" colspan="3" >
			                        	<input type="text" id="avat"  name="avat"  style="text-align:right;" value="<%= obj.getAvat() %>"  > <%= obj.getDVTiente() %>
			                        </TD>                
			                  </TR> 
