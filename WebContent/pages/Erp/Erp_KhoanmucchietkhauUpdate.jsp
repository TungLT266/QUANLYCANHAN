			...
			<table  width="100%" cellspacing="0" cellpadding="4">
					...
					<tr>
						...
						<tr>	
							...
							<input type="hidden" name="PK_SEQ" id="PK_SEQ" value="<%=kmck.getPK_SEQ() %>" />
						</tr>
						<tr>
		                            	...
		                            	<%
			                        		...
			                        		for (int i = 0; i < chiTietList.size(); i++ )
			                        		{
			                        			...
			                        			<tr>	        
			                        				...
			                        				<select name="kenhBanHang" id="kenhBanHang" style="width:200px" class="select2">															
																<% try {
			                        				...
			                        				<td>
			                        					...
			                        					<select name="taiKhoan" id="taiKhoan" style="width:200px" class="select2">															
																<% try {
