	...
	<form name="dmhForm" method="post" enctype="multipart/form-data" action="../../ErpDenghimuahangUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua hàng VT/CPDV/TSCĐ/CCDC > Đề nghị mua hàng> Tạo mới</div>
...
<!-- 								<TD class="plainlabel" > -->
<%-- 									<input type="text" name="congvan" value="<%= dmhBean.getCongvan() %>" style="width: 200px" /> --%>
<!-- 								</TD> -->
...
<!-- 											</TD> -->
							...
							<% for(int i = count; i < 40; i++) { %>
								...
								<tr>
									...
									<%-- <%} else {%>
									<TD   align="center" width="8%" >
										<input type="text" name="masp" style="width: 100%" value="" readonly="readonly" > 
									</TD>
									<%} %> --%>
