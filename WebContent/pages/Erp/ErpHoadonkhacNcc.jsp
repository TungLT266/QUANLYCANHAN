...
<% IErpHoadonkhacNccList obj = (IErpHoadonkhacNccList)session.getAttribute("obj"); %>
...
<body>
<form name="erpDmhForm" method="post" action="../../ErpHoadonkhacNccListSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Nghiệp vụ khác > Hóa đơn điều chỉnh NCC 
        </div>
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle"> Hóa đơn điều chỉnh NCC </span>&nbsp;&nbsp;
            	<%if(quyen[0]!=0  ){  // Mua hàng nhập khẩu & trong nước mới cho tạo mới%>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" width="7%">Ngày hóa đơn</TH>
					...
					<%
                   		if(dmhList != null)
                   		{
                   			...
                   			{  		
								...
								<TD align="center"><%= dmhList.getString("ngayhoadon") %></TD>
				                    <TD align="center"><%= dmhList.getString("sohoadon") %></TD>	
				                 
				                    <TD align="left"><%= dmhList.getString("Ten") %></TD>
				                    ...
				                    <TD align="center">
				                     ...
				                     <A href = "../../ErpHoadonkhacNccUpdateSvl?userId=<%=userId%>&display=<%= dmhList.getString("dmhId") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
				                <% if(tt.equals("0")){ %>
				                 
				              			 <%if(quyen[0] != 0 ){ %>
				                		
		                               <A href = "../../ErpHoadonkhacNccUpdateSvl?userId=<%=userId%>&update=<%= dmhList.getString("dmhId") %>">
			                    	...
			                    	<%  
		                               ...
		                               <%if(quyen[3]!=0){ %>
			                                 <A id='chotphieu<%=dmhList.getString("dmhId")%>'
										      ...
										      border="0" onclick="if(!confirm('Bạn có muốn chốt đơn hàng này?')) {return false ;}else{ processing('<%="chotphieu"+dmhList.getString("dmhId")%>' , '../../ErpHoadonkhacNccListSvl?userId=<%=userId%>&chot=<%= dmhList.getString("dmhId")%>');}"  >
										    </A>
									    <%} %>
									 
		                            
                                    <%if(quyen[2]!=0){ %>
                                		<A href = "../../ErpHoadonkhacNccListSvl?userId=<%=userId%>&delete=<%= dmhList.getString("dmhId") %>"><img src="../images/Delete20.png" width="20" height="20" border=0 
