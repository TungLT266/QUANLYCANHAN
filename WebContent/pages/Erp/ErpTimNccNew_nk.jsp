	...
	<form name="timnccForm" method="post" action="../../TimnhaccUpdateSvl_nk">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua hàng nhập khẩu> Tìm nhà cung cấp > Tạo mới</div>
				...
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								<TD class="plainlabel">Tìm theo mã mua hàng</TD>
								<TD class="plainlabel">
									...
									<div align="center" style="width: 100%; float: none; clear: left">
						                ...
						                <TABLE class="tabledetail" width="100%" border="0" cellspacing="1px" cellpadding="0px">
						                    ...
						                    <TR class='tbdarkrow'   >
						                    	...
						                    	<TD align="center">
						                    		<INPUT type="hidden" name="tucach<%= n %>" style="width: 97%" value='<%=nccdetail.getTucach()%>' >
													<% if(nccdetail.getTucach().equals("1")) { %>
						              						<input type="checkbox" name="tc<%= n %>" value="1" checked="checked" >
						              					<% } else { %>
						              						<input type="checkbox" name="tc<%= n %>" value="0"  >
						              					<% } %>
												</TD>
						                    </tr>
						                    <TR class='tblightrow'  >
						                    	...
						                    	<TD align="center">
						                    		<INPUT type="hidden" name="uytin<%= n %>" style="width: 97%" value='<%=nccdetail.getUytin()%>' >
													<% if(nccdetail.getUytin().equals("1")) { %>
						              						<input type="checkbox" name="ut<%= n %>" value="1" checked="checked" >
						              					<% } else { %>
						              						<input type="checkbox" name="ut<%= n %>" value="0"  >
						              					<% } %>
												</TD>
						                    </TR>
						                    <TR class='tbdarkrow'   >
						                    	...
						                    	<TD align="center">
						                    		<INPUT type="hidden" name="chatluongsp<%= n %>" style="width: 97%" value='<%=nccdetail.getChatluong()%>' >
													<% if(nccdetail.getChatluong().equals("1")) { %>
						              						<input type="checkbox" name="clsp<%= n %>" value="1" checked="checked" >
						              					<% } else { %>
						              						<input type="checkbox" name="clsp<%= n %>" value="0"  >
						              					<% } %>
												</TD>
						                    </tr>
						                    <TR class='tblightrow'  >
						                    	...
						                    	<TD align="center">
						                    		<INPUT type="hidden" name="tggiaohang<%= n %>" style="width: 97%" value='<%=nccdetail.getTggiaohang()%>' >
													<% if(nccdetail.getTggiaohang().equals("1")) { %>
						              						<input type="checkbox" name="tggh<%= n %>" value="1" checked="checked" >
						              					<% } else { %>
						              						<input type="checkbox" name="tggh<%= n %>" value="0"  >
						              					<% } %>
												</TD>
						                    </TR>
						                </TABLE>
