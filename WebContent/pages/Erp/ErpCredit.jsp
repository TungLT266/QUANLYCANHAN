...
<%@ page import="geso.traphaco.erp.beans.debit.IErpCreditList"%>
<%@ page import="geso.traphaco.erp.beans.debit.imp.ErpCreditList"%>
...
<%	
	IErpCreditList obj =(IErpCreditList)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../ErpCreditSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán > Credit note </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Credit note &nbsp;&nbsp;	
                                ...
                                <% 
                                    ...
                                    while ( csxRs.next()){
                                        ...
                                        <%}%>
                                                ...
                                                <TD align="center"> 
                                                <% if( tt.equals("0") ) { %>
							                   		<A href = "../../ErpCreditUpdateSvl?userId=<%=userId%>&update=<%= csxRs.getString("pk_seq") %>">
							                   			<img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A> &nbsp;
							                   		<A href = "../../ErpCreditUpdateSvl?userId=<%=userId%>&chot=<%= csxRs.getString("pk_seq") %>">
													...
													<A href = "../../ErpCreditUpdateSvl?userId=<%=userId%>&delete=<%= csxRs.getString("pk_seq") %>">
												...
												<% } else { %>
													<A href = "../../ErpCreditUpdateSvl?userId=<%=userId%>&display=<%= csxRs.getString("pk_seq") %>">
