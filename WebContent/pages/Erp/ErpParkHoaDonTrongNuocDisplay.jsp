...
{	
	...
	for(var i = 0; i < idhangmua.length; i++)
	{
		...
		thanhtien.item(i).value = DinhDangDonGia(thanhtieni.toString());
	}
	
	// set tổng tiền và thuế giá trị gia tăng
	document.getElementById("thuegtgt").value= DinhDangDonGia(tienthuegtgt);
	document.getElementById("tong").value= DinhDangDonGia(tongtien+ tienthuegtgt);
	document.getElementById("sotienchuathue").value = DinhDangDonGia(tongtien);
}
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Mua hàng trong nước > Hóa đơn trong nước > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
	   ...
	   <% System.out.println ("id hoa don :"+ pBean.getId()) ;%>
	   	...
	   	<A href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=1&loaihd=1">
		...
		<A style="display: none;" href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=2&loaihd=1">
      	<img src="../images/pdf_icon4.png" alt="In phieu nhap vat tu 2"  title="In phieu nhap vat tu 2" border="1px" longdesc="In phieu nhap vat bi 2" style="border-style:outset"></A>
			...
			<A href= "../../ErpInHoaDonDuyetNCCPdfSvl?userId=<%=userId %>&id=<%=pBean.getId()%>&type=3&loaihd=1">
    	...
    	<legend class="legendtitle"> Hóa đơn NCC</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
		             ...
		             <TR>
		                    ...
		                    <select id="loaidonmuahangId" name="loaidonmuahangId" style="width: 350px;" >
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" width="22%" >
		                     <select id="nccId" name="nccId" style="width: 350px;" onChange="submitform();"  disabled >
		                     	<option value="" ></option>
		                     	<% if(rsNcc != null) {
		                     		while(rsNcc.next())
		                     		{
					...
					<TD class="plainlabel" valign="middle" > Số PO </TD>   
                      <TD class="plainlabel" valign="middle" colspan="3">
                      	<select name="poId" id="poId" onchange="changePO();" style="width: 400px;" multiple  disabled>
						<option value=""></option>
						<% if (poRs != null)
						{
							System.out.println("so PO" +pBean.getPoId());
							while (poRs.next())
							{
								if(pBean.getPoId().trim().equals(poRs.getString("pk_seq")) )
								{
								%>
					...
					<TR>
						...
						<TD class="plainlabel" width="15%">
							<input type="text" name="sohoadon" id="sohoadon"  readonly value="<%= pBean.getSoHoaDon() %>" />
 						</TD>
					...
					<TR>
						...
						<TD class="plainlabel" width="15%">
							<input type="text" name="kyhieuhoadon" id= "kyhieuhoadon"  readonly value="<%=pBean.getKyHieuHoaDon()  %>" />
 						</TD>
					...
					<TR>
						...
						<TD class="plainlabel" width="15%" colspan="3">
					...
					<TR>
								...
								<TD class="plainlabel" width="22%"><select id="khobiettruId"
							...
							<TR>
								...
								<TD class="plainlabel" valign="middle"  colspan="4">
									<input type="text" name="dienGiaiCT" value="<%= pBean.getDienGiaiCT() %>" readonly ="readonly" >
								</TD>
							</TR>
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="right">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%=  formatter3.format( Double.parseDouble(sp.getDongia().replaceAll(",",""))) %>" name= "dongiaMua" readonly="readonly" >
           	 				</td>
           	 				<td align="right">
				                        	...
				                        	if(spDetailList.size() > 0)
				                        	{
				                        		...
				                        		%>
				                        			<tr>
							                            ...
							                            <td>
							                            	<input type="text" size="100px"  name="<%= sp.getId() +"."+sp.getMuahang_fk()+i+ ".soluong" %>" value="<%= spDetail.getSoluong() %>" style="text-align: right;" onchange="replaces()"/></td>
           	 				...
           	 				<td align="right">
           	 					...
           	 					value="<%= formatter2.format(Math.round(Double.parseDouble(sp.getthanhtien().replaceAll(",","")))) %>" name= "thanhtien"  >
           	 				</td>
