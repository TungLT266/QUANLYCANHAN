	...
	{    
	 ...
	 {	
		 document.getElementById("btnSave").innerHTML = "<a href='#'><img src='../images/waiting.gif'  title='cho luu..' border='1' longdesc='cho luu..' style='border-style:outset'> Processing...</a>";
	 	 document.forms['dtltsForm'].action.value='createHD';
	     document.forms['dtltsForm'].submit();
	 }
	...
	<form name="dtltsForm" method="post" action="../../ErpThanhlytaisanUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý tài sản &gt; Thanh lý tài sản &gt; Xuất hóa đơn</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD class="plainlabel" valign="top" >
									<input type="text"  id="ngay" name="ngay"
											value="<%= dtltsBean.getNgay() %>" maxlength="10" readonly />
								</TD>
								
								<TD class="plainlabel" valign="middle" width="100px" style="color: red;" >Ngày hóa đơn</TD>   
		                        <TD class="plainlabel" valign="middle"  >
		                        	<input type="text" class="days" name="ngayhoadon" value="<%= dtltsBean.getNgayhoadon() %>"   > 
		                        </TD>  
								
							</TR>
							<TR  >
	                          		<TD class="plainlabel" valign="middle" style="color: red;" >Ký hiệu hóa đơn</TD>   
			                        <TD class="plainlabel" valign="middle" >
			                        	<input type="text"  name="kyhieuhoadon" value="<%= dtltsBean.getKyhieuhoadon() %>"   > 
			                        </TD>          
	                          		<TD class="plainlabel" valign="middle" width="120px" style="color: red;" >Số hóa đơn</TD>   
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text"  name="sohoadon" value="<%= dtltsBean.getSohoadon() %>"   > 
			                        </TD>          
			                  </TR> 
							<TR>
								<TD class="plainlabel">Mã khách hàng</TD>
								<TD class="plainlabel">
									<input type="text" id="khId" name="khId" value="<%= dtltsBean.getKH() %>"  readonly="readonly" >
								</TD>
								...
								if(spList.size() > 0) { 
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<TD align="center" width="8%">
												<input type="text" value="<%= sp.getChietkhau() %>" name="chietkhau" style="width: 100%; text-align: right;" > 
											</TD>
											
											<TD align="center" width="8%">
												<input type="text" value="<%= sp.getThanhtien() %>"  name="thanhtien" style="width: 100%; text-align: right;" readonly="readonly" > 
											</TD>
