<%@page import="geso.traphaco.erp.beans.baohong.imp.ErpBaoHongList"%>
...
%>
<%
	ErpBaoHongList obj = (ErpBaoHongList) session.getAttribute("obj");
	List<Erp_ListItem> viewList = obj.getViewList();
%>
<%
int[] quyen = new  int[5];
quyen = util.Getquyen("ErpBaoHongSvl","",userId);
%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="xdForm" method="post" action="../../ErpBaoHongSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công cụ dụng cụ &gt; Báo hỏng</TD>
													...
													<TR>
														<TD width="98%">
															<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
																<TR class="tbheader">
																	<TH width="5%">STT</TH>
																	<TH width="50%">Mã CPTT</TH>
																	<TH width="20%">Ngày báo hỏng</TH>
																...
																<%
																	if (viewList != null) {
																			try {
																				...
																				for (Erp_ListItem xuatDung : viewList) {
																					if (m % 2 != 0) {
																%>
																<TR class=<%=lightrow%>>
																	<%
																...
																<TR class=<%=darkrow%>>
																	...
																	<TD align="left"><%=xuatDung.getMa() + " - "  + xuatDung.getTen()%></TD>
																	<TD align="center" ><%= xuatDung.getNgayTao() %></TD>
																	<TD align="center">
																		<TABLE>
																			<TR>
																				<TD>
																					<A href="../../ErpBaoHongUpdateSvl?userId=<%=userId%>&display=<%=xuatDung.getId()%>">
																						<img title="Hiển thị" src="../images/Display20.png" alt="Hiển thị" width="20" height="20" longdesc="Hiển thị" border=0>
																					</A>
																				</TD>
																			</TR>
																		</TABLE>
