			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				<TR>
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Cơ bản &gt; Danh mục cổ phiếu &gt; Cập nhật
							   </TD>
				...
				<TR>
						   	<TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE width="100%" cellspacing="0" cellpadding="6">
									...
									<tr>
									<td class="plainlabel">Tên cổ phiếu<font class="erroralert">*</font></td> <td class = "plainlabel"> <input type = "text" name = "Ten" value="<%=nhBean.getTEN() %>"> </td>
									</tr>
									
									<tr>
									<td class="plainlabel">Công ty phát hành cổ phiếu<font class="erroralert">*</font></td> <td class = "plainlabel"> <input type = "text" name = "congtyphathanh" value="<%=nhBean.getCongTyPhatHanh() %>"> </td>
									</tr>
