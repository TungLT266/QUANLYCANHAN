...
<form name="dqcForm" method="post" action="">
...
<div id="main" style="width:100%">
	<div align="left" id="header" style="width:100%; float:none">
    	...
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">&nbsp;Quản lý cung ứng &gt; Quản lý tồn kho  &gt; Đổi quy cách  &gt; Hiển thị
									...
									<TABLE class="tblight" width="100%" cellpadding="6" cellspacing = "0" border = "0">
				                        ...
				                        %>
								                     ...
								                     <div align="right">
								                     	...
								                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                     	<a href="javascript:dropdowncontent.hidediv('subcontent1<%=i%>')" >Hoàn tất</a>
								                     </div>
								                </DIV>
											</TD>
											<% 
											...
											%>
											<TD  ><INPUT name="dongia1" id="dongia1" type="text" value="<%= formatter.format(dongiatmp)%>" style = "width:100%"  ></TD>
				                        ...
				                        <tr>
				                            ...
				                            <th width="50px">Số lượng </th>
								                     ...
								                     <div align="right">
								                     	<label style="color: red" ></label>
								                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                     	<a href="javascript:dropdowncontent.hidediv('subcontent1<%=j%>')" >Hoàn tất</a>
								                     </div>
								                </DIV>
											</TD>
											<% 
								...
								<LEGEND class="legendtitle">Sản phẩm nhận đổi quy cách</LEGEND>
					               ...
					               <% for(  i = 1; i < 8; i++){ %>
										...
										<TR>
											...
											<TD ><INPUT name=<%= "soluong" + (i+1)%> id=<%= "soluong" + (i+1)%>  type="text" value="<%= formatter1.format(Double.parseDouble(soluong2[i - 1])) %>"   onkeypress= "return keypress(event);" onchange="Tinhphanbo()" ></TD>
											
											
											<TD ><INPUT name=<%= "dongia" + (i+1) %> id=<%= "dongia" + (i+1)%> type="text" value="<%= formatter1.format(Double.parseDouble(dongia2[i - 1])) %>"   onkeypress= "return keypress(event);" onchange="Tinhphanbo()" ></TD>
...
<script type="text/javascript">
	...
	{		
		...
		$("#spma2").autocomplete("SanPhamList_2.jsp");		
		$("#spma3").autocomplete("SanPhamList_2.jsp");		
		$("#spma4").autocomplete("SanPhamList_2.jsp");		
		$("#spma5").autocomplete("SanPhamList_2.jsp");		
		$("#spma6").autocomplete("SanPhamList_2.jsp");	
		$("#spma7").autocomplete("SanPhamList_2.jsp");		
		$("#spma8").autocomplete("SanPhamList_2.jsp");		
	});	
...
<%
	try{
		...
		if(spDoiquycachlist != null) spDoiquycachlist.clear();
