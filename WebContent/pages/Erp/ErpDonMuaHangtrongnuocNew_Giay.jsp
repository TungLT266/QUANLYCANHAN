...
<%
	...
	quyen = util.Getquyen("ErpDonmuahangtrongnuocUpdate_GiaySvl","",userId);
...
<script language="javascript" type="text/javascript">
	...
	function ThayDoiDonViTinh(element)
	{
		alert(element.id);
	...
	function replaces()
	{
		...
		var mienthue = document.getElementsByName("mienthue");
		...
		for(var i=0;i<soTienThanhToan.length;i++ ){
			if(soTienThanhToan.item(i).value != ""){
				var sTienThanhToan = soTienThanhToan.item(i).value.replace(/,/g,"");
				if(isNaN(sTienThanhToan))
					sTienThanhToan = "0";
				var phTramThanhToan = phanTramThanhToan.item(i).value.replace(/,/g,"");
				if(isNaN(phTramThanhToan))
					phTramThanhToan = "0";
				soTienThanhToan.item(i).value = sTienThanhToan;
				phanTramThanhToan.item(i).value = phTramThanhToan;
				//soTienThanhToan.item(i).value =  DinhDangTien(sTienThanhToan);
			}
		 }  */
	...
	function tinhthuexuat(elementId,elementId1)
	{
	  ...
	  var gt=document.getElementById(elementId1).value;

	   if (document.getElementById(elementId).checked) 
	  {
		   document.getElementById(elementId1).value= 0;
		   //document.getElementById(elementId).value= 1;
		   document.getElementById(elementId1).readOnly = true;
	  } else {
		  document.getElementById(elementId1).value=gt;
	...
	function capNhatSoTienThanhToan(){
		...
		var tongTienSauVAT  = document.getElementById("AVAT").value;
		var tongTienSauVAT = replaceAll(tongTienSauVAT,",","");
		for ( var i = 0 ; i <phanTramThanhToan.length; i++){
			if(phanTramThanhToan.item(i).value.trim().length>0){
				...
				soTienThanhToan.item(i).value = replaceAll(soTienThanhToan.item(i).value,",","");
				soTienThanhToan.item(i).value = phanTramThanhToan.item(i).value * tongTienSauVAT /100;
				soTienThanhToan.item(i).value = DinhDangTien(soTienThanhToan.item(i).value);
			}
		}
	}
	...
	function ThayDoiDonViTinh(element)
	{
		...
		document.forms['dmhForm'].action.value='thaydoidvt';
		document.forms['dmhForm'].thaydoidvtinh.value = a[1];
	    document.forms['dmhForm'].submit();
	...
	/* 	 if(tongtienavat <=0){
		 ...
		 var tongTienSauVAT = replaceAll(tongtienavat,",","");
		// Kiểm tra Thời Hạn Thanh Toán
		 capNhatSoTienThanhToan();
		 tongTienSauVAT = replaceAll(tongTienSauVAT,",","");
		 ...
		 for (var i = 0 ; i<countSoTienThanhToan; i++){
			 if (i < (countSoTienThanhToan -1)){
				 soTienThanhToan.item(i).value = replaceAll(soTienThanhToan.item(i).value,",","");
				 tongSoTienTemp = parseInt(tongSoTienTemp) + parseInt(soTienThanhToan.item(i).value);
			 }
			 else {
				 soTienThanhToan.item(i).value= parseInt(tongTienSauVAT) - parseInt(tongSoTienTemp);
		 ...
		 for(var i=0;i<countSoTienThanhToan;i++ ){
			 if(soTienThanhToan.item(i).value.trim().length>0){
				 soTienThanhToan.item(i).value = replaceAll(soTienThanhToan.item(i).value,",","");
				 tongSoTienThanhToan =parseInt(tongSoTienThanhToan) + parseInt(soTienThanhToan.item(i).value);
			 }
		 }
		 
		 if (tongSoTienThanhToan >tongTienSauVAT){
			var x = parseInt(tongSoTienThanhToan) - parseInt(tongTienSauVAT);
			error.value="Tổng số tiền trong thời hạn thanh toán lớn hơn số tiền mua hàng :" +DinhDangTien(x)+" .Vui lòng nhập lại thời hạn thanh toán .";
			alert ("Tổng số tiền trong thời hạn thanh toán lớn hơn số tiền mua hàng ");
			return false;
		 }
		 if (tongTienSauVAT >tongSoTienThanhToan){
			 var x = parseInt(tongTienSauVAT) - parseInt(tongSoTienThanhToan);
			 error.value="Tổng số tiền trong thời hạn thanh toán nhỏ hơn số tiền mua hàng : " + DinhDangTien(x) +" .Vui lòng nhập lại thời hạn thanh toán .";
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../ErpDonmuahangtrongnuocUpdate_GiaySvl">
		...
		<input type="hidden" name="thaydoidvtinh" value="-1" />
		
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý mua hàng > Mua hàng trong nước > Đơn mua hàng > Tạo mới</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel" valign="top">
									<select name="loaiDMH_NK" id="loaiDMH_NK" onChange="submitform();" style=" width: 200px">
							...
							<TR>
								...
								<% if(dmhBean.getLoaihanghoa().equals("0")) { %>
									...
									<TD class="plainlabel">									
										<select name="loaisp" id="loaisp" style=" display: none" onChange="submitform();" style=" width: 200px">
											<option value=""></option>
											<% if (loaihhList != null)
											   {
							...
							<TD class="plainlabel">Thời hạn thanh toán </TD>
								...
								<td class="plainlabel" valign="middle">
									<% if(dmhBean.getIsGiaCong().equals("1")) {%>
										 ...
										 <input type="checkbox" name="isgiacong" value="1" checked onChange="changeNoiDung();"><br>
									<%} else { %>
										 <input type="checkbox" name="isgiacong" value="1" onChange="changeNoiDung();" ><br>
									<%} %>
							 ...
							 <tr>
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan="3">
		                            <select name="nhacungcapNK"  id="nhacungcapNK" onchange="submitform()" style="width: 300px">
		                            	<option value=""></option>
		                            	<%
			                        		if(nccRs != null)
			                        		{
									...
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											...
											<TD align="center" width="6%">
												...
												<select style="width: 100%" name="donvitinh" id="<%= "donvitinh_"+i %>" class="donvitinh" 
												style=" width: 200px" onchange="ThayDoiDonViTinh(this);">
															<option value=""></option>
														<% if (dvList.size() > 0)
															{
											...
											<TD align="center" width="7%">
												<input type="text" onkeyup="Lamtronso(this)" value="<%= sp.getSoluong() %>" name="soluong" style="width: 100%; text-align: right;" > 
												<input type="hidden" value="<%= sp.getSoluongOLD() %>" name="soluongOld" style="width: 100%; text-align: right;" >
											</TD>
											<TD align="center" width="4%">
											
											<%-- <% if (dmhBean.getLoai().equals("1") ){ %>
												<input type="text" value="<%= sp.getDongia() %>" name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber(this)" >
											<%} else {%>
												<input type="text" value="<%= sp.getDongia() %>" name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber(this)" >
											<%} %>  --%>
											...
											<% if (dmhBean.getLoai().equals("1") ){ %>
												<input type="text" value="<%= sp.getDongia() %>" name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber4sole(this)" >
											<%} else {%>
												<input type="text" value="<%= sp.getDongia() %>" name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber4sole(this)" >
											<%} %> 
										...
										<%} %>
											   ...
											   { %>
												...
												<% if( dmhBean.getKhoId().trim().length() > 0 ) { %>	
												 ...
												 <% } else { %>
												 		...
												 		<select style="width: 100%" name="khonhan" style=" width: 200px">
															<option value=""></option>
															<% if (khoList.size() > 0)
																{
																	for (int j = 0; j < khoList.size(); j++)
											...
											<TD align="center">
								                    ...
								                    <table width="90%" align="center">
								                        <tr>
								                            <th width="100px">Tên in trên PO</th>
								                        </tr>
					                        			<tr>
								                            <td>
							...
							<% for(int i = count; i < 40; i++) { %>
								...
								<tr>
									...
									<TD align="center" width="6%">
										...
										<select style="width: 100%" name="donvitinh"  class="donvitinh" id=<%= "donvitinh_"+ i%> 
										style=" width: 200px" onchange="ThayDoiDonViTinh(this);">
															<option value=""></option>
														<% if (dvList.size() > 0)
															{
									...
									<TD align="center" width="7%">
										<input type="text" value=""  onkeyup="Lamtronso(this)"  name="soluong" style="width: 100%; text-align: right;" > 
									...
									<%-- 	<% if (dmhBean.getLoai().equals("1") ){ %>
										<input type="text" value=""  name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber(this)" >
									<% }else{ %>
										<input type="text" value=""  name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber(this)" >
									...
									<% } %>  --%>
										...
										<% if (dmhBean.getLoai().equals("1") ){ %>
										<input type="text" value=""  name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber4sole(this)" >
									<% }else{ %>
										<input type="text" value=""  name="dongia" id="<%= "dongia_"+i  %>" style="width: 100%; text-align: right;" onkeyup="FormatNumber4sole(this)" >
									...
									<TD align="center" width="7%">
										<input type="text" value="" name="thuexuat" id="thuexuat<%=i%>" style="width: 100%; text-align: right;" > 
									</TD>
									<TD align="center" width="7%">
										<input type="checkbox" value="" name="mienthue" id="mienthue<%=i%>" style="width: 100%; text-align: right;" onclick="tinhthuexuat('mienthue<%=i%>','thuexuat<%=i%>');" > 
									</TD>
									<TD align="center" width="8%">
