...
<script language="javascript" type="text/javascript">
	 ...
	 { 
		 var ngaychungtu = document.getElementById("ngaychungtu");
		  if(ngaychungtu.value!="")
			  {
				document.forms['tthdForm'].action.value='changeNgayChungTu';
			     document.forms["tthdForm"].submit();
			  }
	 }
		...
		var tienteId = document.getElementsByName("tienteId");		
			...
			if (count == 0) {
			 ...
			 for(var i = 0; i < count; i++)
			 {
				 ...
				 document.getElementById("tienthue_VAT_"+i).value = DinhDangTien(tienthue);
	...
	function tinhthue_loaikhac_new(e){
	...
	if (count == 0) {
	 ...
	 for(var i = 0; i < count; i++)
	 {
		 ...
		 console.log(tienhangct +"||"+thuesuatct+"||"+tienthueVATct);	
...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ + TRICH PHÍ VNĐ			
	...
	{    
	 ...
	 {	
		 ...
		 if(sotienHDVND.value.trim() == "" || sotienHDVND.value == "0")
		 {
			alert("Vui long nhap so tien thanh toan");
			return;
		 } 
		
		 if (document.getElementById("doituongthanhtoan").value == "3") {
			 var nguoiNhanTien = document.getElementById("nguoiNhanTien");
			 if(nguoiNhanTien.value.trim() == "")
			 {
				alert("Vui long nhap người nhận tiền");
				return;
			 } 
...
<!-- <form name="tthdForm" method="post" action="../../ErpDuyetthanhtoanhoadonSvl"> -->
    ...
    <fieldset>
    	<legend class="legendtitle"> Phiếu chi  </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = '0'>		
                ...
                <TR>
                 <TD width="20%" class="plainlabel" valign="top">Ngày chứng từ</TD>
                    ...
                    <TD class="plainlabel">
                        <input type="text" name="soChungTu_Chu" readonly="readonly" id="soChungTu_Chu" value="<%= tthdBean.getSoChungTu_Chu() %>" onKeyPress = "return validateSpecialCharacters(event);" onchange="upperLetters(this);" style="width: 100px;">
                        <input type="text" name="soChungTu_So" id="soChungTu_So" value="<%= tthdBean.getSoChungTu_So() %>" style="width: 50px;" onkeypress="return keypress(event);">
                    </TD> 
			...
			<% } else if (tthdBean.getDoiTuongChiPhiKhac().equals("3")) { %>  
			 			<TR>
					          <TD width="20%" class="plainlabel" valign="top">Người nhận tiền</TD>
					          <TD colspan="4" class="plainlabel" valign="top">
					          <input  type="text" name="nguoiNhanTien" id="nguoiNhanTien" value="<%= tthdBean.getNguoiNhanTien()%>"  style="width:300px" >
					          </TD>
					     </TR> 	
			...
			<%} else if (tthdBean.getDoiTuongChiPhiKhac().equals("4")) { %>
					     <TR>
					          ...
					          <input type="hidden" id="bpId" name="bpId" value = "<%=tthdBean.getBophanId() %>" style="width: 400px" readonly>	
					          </TD>
					     </TR> 		
			...
			<% } else if (tthdBean.getDoiTuongChiPhiKhac().equals("3")) { %>  
			 			<TR>
					          <TD width="20%" class="plainlabel" valign="top">Người nhận tiền</TD>
					          <TD colspan="4" class="plainlabel" valign="top">
					          <input  type="text" name="nguoiNhanTien" id="nguoiNhanTien" value="<%= tthdBean.getNguoiNhanTien()%>"  style="width:300px"  disabled="disabled">
					          <input type="hidden" id="nguoiNhanTien" name="nguoiNhanTien" value = "<%=tthdBean.getNguoiNhanTien() %>" style="width: 400px">	
					          </TD>
					     </TR> 	
			<%} else if (tthdBean.getDoiTuongChiPhiKhac().equals("6")) { %>
                <TR>
...
<%// THANH TOAN HOA DON DUNG NGOAI TE - TRICH PHI BANG NGOAI TE
               if(tthdBean.getTrichphi().equals("0")) { %>
            	...
            	<TR>
                    ...
                    <TD class="plainlabel">
                         <input type="text" style="text-align: right;" name="tongtienNT" id = "tongtienNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getSotienttNT().replaceAll(",",""))) %> "  onKeyPress = "return keypress(event);"  onChange = "ThaydoiSotienNT();" readonly="readonly" > 
                     </TD> 
							...
							<TABLE width="100%" align="center">
        						<TR class="tbheader">
					      		...
					      		<TR>
									...
									<TD>
										<input type="text" name= "tienthue_VAT" id= "tienthue_VAT" value = "<%= formatter2.format(Double.parseDouble(tthdBean.getTienthue().replaceAll(",",""))) %>" style="width: 100%;text-align: right" onKeyPress = "return keypress(event);" readonly>
									</TD>
								</TR>
							</TABLE>
						    <DIV align="right">
	...
	<%}else{ %>
			...
			<%} else  {%>
            	...
            	<TR>
                    ...
                    <TD class="plainlabel" style = "display:none">
                         <input type="text" style="text-align: right;display:none" name="tongtienNT" id = "tongtienNT" value="<%= formatter1.format(Double.parseDouble(tthdBean.getSotienttNT().replaceAll(",",""))) %>" onKeyPress = "return keypress(event);" readonly="readonly" >
                     </TD> 
                    ...
                    <TD class="plainlabel" colspan = 3>
                     ...
                     <%} else { %>
                      <TD class="plainlabel" style = "width:150px">Tổng tiền thanh toán (VNĐ)</TD>
                    <TD class="plainlabel" colspan = 3>
                         <input type="text" style="text-align: right;" name="tongtienVND" id = "tongtienVND" value="<%= formatter2.format(Double.parseDouble(tthdBean.getSotientt().replaceAll(",",""))) %>" onKeyPress = "return keypress(event);" onChange = "ThaydoiSotienTT();" readonly="readonly"> 
                     </TD> 
                     <%} %> 
                </TR>			
	        ...
	        <% if(tthdBean.getTienteId().equals("100000")){ // Don vi tien la VND %>
                ...
                <!-- 	<TH align="center" width="10%">Số hợp đồng nội</TH>
                	...
                	<TH align="center" width="10%">Số HĐ</TH>
                	...
                	for(int i = 0; i < hoadonList.size(); i++)
                	{
                		IHoadon hoadon = hoadonList.get(i);
						  ...
						  <%if(tthdBean.getDoiTuongChiPhiKhac().equals("1")) { %>	                
           	 			...
           	 			<%} %>
           	 				...
           	 				<td align="center">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= hoadon.getConlai().replaceAll(",","") %>" name= "conlai" id="conlai<%= i %>" readonly="readonly" >
           	 				</td>
						...
						<% if(!tthdBean.getTienteId().equals("100000")){ // Ngoại tệ%>           	 				
           	 			...
           	 			<%} %>
           	 				...
           	 				<td align="center"> 
           	 					<input type="text" name = "diaChi" id="diaChi<%= i %>" value="<%=hoadon.getDiaChi()%>" >
           	           	 	</td>
			...
			<tr class="tbheader">
				...
				<TH align="center" width = "100px">Mẫu hóa đơn</TH>	
				...
				<TH width = "150px" align = "center">Tên NCC </TH>
               	<TH align="center" width="150px">Địa chỉ</TH>
				<TH width = "150px" align = "center">MST </TH>	
				<TH width = "150px" align = "center">Diễn giải </TH>
		...
		for(int i=0; i < count;i++){ 
			...
			<TR>
			  ...
			  <!-- KÊNH BÁN HÀNG  -->
				<TD  align="left" >  
        			<select name="KenhId" id="KenhId_<%=i %>" style="width: 100%;">
						<option value=""></option>
            			<%	
				...
				<!-- MÃ VỤ VIỆC  -->
				<TD  align="left" >  
        			<select name="mavvId" id="mavvId_<%=i %>" style="width: 100%;">
						<option value=""></option>
            			<%	
				...
				<!-- ĐỊA BÀN  -->
				<TD  align="left" >  
        			<select name="diabanId" id="diabanId_<%=i %>" style="width: 100%;">
						<option value=""></option>
            			<%	
				...
				<TD>											
					<input type="text" name = "diaChi_<%=i %>"  value = "<%= diaChiHd[i] %>" style="width: 100%">
				</TD>
				...
				<TD>
					<%if(Tienhanghd[i]!=null && Tienhanghd[i].trim().length()>0) {%>
						<input type="text" name= "tienhang_VAT_<%=i %>" id= "tienhang_VAT_<%=i %>" value = "<%= formatter2.format(Double.parseDouble(Tienhanghd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} else { %>
						<input type="text" name= "tienhang_VAT_<%=i %>" id= "tienhang_VAT_<%=i %>" value = "<%= Tienhanghd[i] %>" style="width: 100%;text-align: right" onChange = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} %>
				</TD>

				<TD>
					<%if(Thuesuathd[i]!=null && Thuesuathd[i].trim().length()>0) {%>								
						<input type="text" name= "thuesuat_VAT_<%=i %>"  id = "thuesuat_VAT_<%=i %>"  value = "<%= formatter2.format(Double.parseDouble(Thuesuathd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} else { %>
						<input type="text" name= "thuesuat_VAT_<%=i %>"  id = "thuesuat_VAT_<%=i %>" value = "<%= Thuesuathd[i] %>" style="width: 100%;text-align: right" onChange = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} %>
				</TD>

				<TD>
					<%if(Tienthuehd[i]!=null && Tienthuehd[i].trim().length()>0) {%>	
						<input type="text" name= "tienthue_VAT_<%=i %>"  id= "tienthue_VAT_<%=i %>" value = "<%= formatter2.format(Double.parseDouble(Tienthuehd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onKeyPress = "return keypress(event);" onkeyup="tinhTienThueTuDo(this)">
					<%} else { %>
						<input type="text" name= "tienthue_VAT_<%=i %>" id= "tienthue_VAT_<%=i %>"  value = "<%= Tienthuehd[i] %>" style="width: 100%;text-align: right" onKeyPress = "return keypress(event);" onkeyup="tinhTienThueTuDo(this)">
					<%} %>
				</TD>  		                    
			</TR>
     <% }
		...
		{ %>
        	...
        	<%  } %> 
				...
				<TD  align="left" >  
				 ...
				 <!-- KÊNH BÁN HÀNG  -->
				<TD  align="left" >  
        			<select style="width: 100%;" name="KenhId" id="KenhId_<%=i %>"  >
					<option value=""></option>
        			<%	
 ...
 for(int i = stt; i< bien; i++){ %>
		...
		<TR>
        	...
        	<%  } %> 
				...
				<TD>											
					<input type="text" name = "diaChi_<%=i %>"  value = "" style="width: 100%">
				</TD>
				<TD>
				...
				<TD>
					<%-- <%if(Tienhanghd[i]!=null && Tienhanghd[i].trim().length()>0) {%>
						<input type="text" name= "tienhang_VAT_<%=i %>"  id= "tienhang_VAT_<%=i %>" value = "<%= formatter2.format(Double.parseDouble(Tienhanghd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} else { %> --%>
						<input type="text" name= "tienhang_VAT_<%=i %>"  id= "tienhang_VAT_<%=i %>"   value = '' style="width: 100%;text-align: right" onChange = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%-- <%} %> --%>
				</TD>
				...
				<%-- 	<%if(Thuesuathd[i]!=null && Thuesuathd[i].trim().length()>0) {%>								
						<input type="text" name= "thuesuat_VAT_<%=i %>" id= "thuesuat_VAT_<%=i %>"  value = "<%= formatter2.format(Double.parseDouble(Thuesuathd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onkeyup = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%} else { %> --%>
						<input type="text" name= "thuesuat_VAT_<%=i %>"  id= "thuesuat_VAT_<%=i %>"  value = '' style="width: 100%;text-align: right" onChange = "javascript:tinhthue_loaikhac_new(this);" onKeyPress = "return keypress(event);">
					<%-- <%} %> --%>
				</TD>
				...
				<TD>
					<%-- <%if(Tienthuehd[i]!=null && Tienthuehd[i].trim().length()>0) {%>	
						<input type="text" name= "tienthue_VAT_<%=i %>" id= "tienthue_VAT_<%=i %>" value = "<%= formatter2.format(Double.parseDouble(Tienthuehd[i].replaceAll(",",""))) %>" style="width: 100%;text-align: right" onKeyPress = "return keypress(event);" onkeyup="tinhTienThueTuDo(this)">
					<%} else { %> --%>
						<input type="text" name= "tienthue_VAT_<%=i %>" id= "tienthue_VAT_<%=i %>" value = '' style="width: 100%;text-align: right" onKeyPress = "return keypress(event);" onkeyup="tinhTienThueTuDo(this)">
					<%-- <%} %> --%>
				</TD>  		                         		
	</TR>
	<%
