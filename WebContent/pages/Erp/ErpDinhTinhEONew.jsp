...
<script language="javascript" type="text/javascript">
	...
	function DinhDangDonGia(num) 
	{
	 ...
	 function saveform()
	 {	
		 var maphieueoNew = document.getElementsByName("maphieueoNew"); 
		 var maphieudinhtinhNew = document.getElementsByName("maphieudinhtinhNew");
		 
		 var tong = 0;
		 if( maphieueoNew!== null){
			 for(var i=0;i < maphieueoNew.length; i++){
				 if(maphieueoNew.item(i).value.trim().length > 0){
					 tong++;
				 }
			 }
		 }
		 if(maphieudinhtinhNew !== null){
			 for(var i=0;i < maphieudinhtinhNew.length; i++){
				 if(maphieudinhtinhNew.item(i).value.trim().length > 0){
					 tong++;
				 }
			 }
		 }
		 ...
		 if(tong == 0){
			 alert("Vui lòng điền phiếu kiểm định/EO vào các thùng trước khi lưu.");
			 return;
		 }
    ...
    <fieldset>
    	<legend class="legendtitle">Định tính/EO </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">
            	...
            	<TR>
                    ...
                    <TD class="plainlabel" width="200px"  >
                            <select name="loai" onchange="submitform()" style="width: 200px" class="select2">
                           	<option value="">  </option>
                   		    <%  
                     ...
                     <TD class="plainlabel" width="200px" >
                            <select name="khoId" id="khoId" onchange="submitform()" style="width: 200px" class="select2">
                        	<option value=""> </option>
                        	<%
                        		if(RsKho != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="200px" >
                            <select name="sanpham" id="sanpham" onChange="submitform();" style="width: 200px" multiple="multiple" class="select2">
                        	<option value=""> </option>
                        	<%
                        		if(RsSanPham != null)
                        		{
			...
			<tr class="tbheader">
				...
				<th align="center" width="6%"> Nhà sản xuất</th>
			...
			%> 
					<tr>
						<td> <%= i+1 %>  
							...
							<input type="hidden" value="<%=detail.getMaPhieuEO() %>" name="maphieueo" >
							<input type="hidden" value="<%=detail.getMaPhieuDinhTinh() %>" name="maphieudinhtinh" >
