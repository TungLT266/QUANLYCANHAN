...
<%@page import="geso.traphaco.erp.beans.chart.IChart"%>
	...
	gvChartInit();
		...
		jQuery(document).ready(function(){
			jQuery('#myTable4').gvChart({
				chartType: 'PieChart',
				gvSettings: {
					vAxis: {title: 'Tồn kho theo khu vực'},
					hAxis: {title: 'Nam'},
					width: 1200,
					height:500
					}
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Báo cáo đồ thị > Thực đạt & chỉ tiêu khu vực </div>
					...
					<div style="width: 100%; float: none" align="left">
						...
						<div class="main">
								<table align="left" id='myTable'>
									...
									<caption align="left" >Thực đạt & chỉ tiêu (Sản lượng Kg) </caption>
