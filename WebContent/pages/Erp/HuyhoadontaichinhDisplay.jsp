						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp; Quản lý cung ứng > Quản lý bán hàng > Hủy hóa đơn tài chính > Hiển thị </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../HuyhoadontaichinhSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay về"  title="Quay về" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							...
							<TR>
								...
								<TD class="plainlabel" >
									<input  type="text" class="days" name="ngayhuy" value="<%= hdBean.getNgayHuy() %>" size="20" readonly >
								</TD>
							</TR>
							...
							<TR>
								...
								<TD class="plainlabel" >
									...
									<input  type="text"   name="sochungtu" value="<%= hdBean.getSoCT() %>" size="20" readonly  >
								</TD>
							</TR>
									...
									<TD align="left" colspan = 2 >						
										...
										<TABLE  border="0" bordercolor="white" width="100%" cellpadding = "3" cellspacing = "0" style="padding-left:2px ;" >
											...
											<TR class="plainlabel" >
											  ...
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10" class="days" id="ngayxuathd" name="ngayxuathd" value="<%=hdBean.getNgayxuathd()%>" maxlength="10" readonly /> 
											  </TD>
											  
											  <TD class="plainlabel">Ngày ghi nhận công nợ </TD>
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10" class="days"
                                     			   id="ngaycongno" name="ngaycongno" value="<%=hdBean.getNgayghino()%>" maxlength="10" readonly /> 
											  </TD>
											</TR>
											...
											<TR class="plainlabel" >
											  ...
											  <TD >                               
                                                 <input type="text" size="10" 
                                     			   id="kyhieu" name="kyhieu" value="<%=hdBean.getKyHieu() %>" readonly > 
											    </TD>
											    <td>
											...
											<TR class="plainlabel" >
											    <td>Số hóa đơn</td>
												<td>
													<input type="text" id="sohoadon" name="sohoadon" onkeypress="return keypress(event);"  value="<%=hdBean.getSoHoaDon()%>" readonly >
												</td>
											...
											<td > Ghi chú </td>
											<td>
												<input style="width: 400px " type="text" id="ghichuhd" name="ghichuhd"  value="<%=hdBean.getGhiChu()%>" readonly >
											</td>
