...
<%@ page import="geso.traphaco.erp.beans.danhgialaitaisan.IErp_DanhGiaLaiTaiSanList"%>
<%@ page import="geso.traphaco.erp.beans.danhgialaitaisan.imp.Erp_DanhGiaLaiTaiSanList"%>
<%
	...
	if(!util.check(userId, userTen, sum)){
		...
		IErp_DanhGiaLaiTaiSanList obj = (IErp_DanhGiaLaiTaiSanList) session.getAttribute("obj");
		ResultSet RsDc = obj.getRsDc();
		ResultSet RsDvth = obj.getPbRs();
	
	 	int[] quyen = new  int[5];
	 	quyen = util.Getquyen("Erp_DanhGiaLaiTaiSanSvl","",userId);
...
<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="tsForm" method="post" action="../../Erp_DanhGiaLaiTaiSanSvl">
						...
						<tr>
							<td align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<td align="left" colspan="2" class="tbnavigation">Quản lý tài sản > Đánh giá lại tài sản</td>
														...
														<td align="center">
															<table border=0 cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DanhGiaLaiTaiSanUpdateSvl?userid=<%=userId%>&update=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<%if(quyen[3]!=0){ %>
																	<a href="../../Erp_DanhGiaLaiTaiSanSvl?userid=<%=userId%>&chot=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<a href=../../Erp_DanhGiaLaiTaiSanSvl?userid=<%=userId%>&delete=<%=RsDc.getString("pk_seq")%>><img src="../images/Delete20.png"
																	...
																	<td>
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DanhGiaLaiTaiSanUpdateSvl?userid=<%=userId%>&display=<%=RsDc.getString("pk_seq")%>"><img
