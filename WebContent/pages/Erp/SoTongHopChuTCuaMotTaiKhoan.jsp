...
<%@ page import="geso.traphaco.erp.beans.SoTongHopChuTMotTaiKhoan.*"%>
...
%>
<%
	ISoTongHopChuTMotTaiKhoan obj = (ISoTongHopChuTMotTaiKhoan) session.getAttribute("obj");
...
<%
int[] quyen = new  int[5];
quyen = util.Getquyen("SoTongHopChuTMotTaiKhoanSvl","&view=TT",userId);
%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="xdForm" method="post" action="../../SoTongHopChuTMotTaiKhoanSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán &gt; Báo cáo &gt; Sổ tổng hợp chữ T một tài khoản</TD>
