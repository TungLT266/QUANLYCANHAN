		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					...
					Kế hoạch lấy mẫu, đánh giá &gt; Hiển thị</div>
			...
			<div align="left" id="button"
				...
				<A href="javascript:goBack()"> <img src="../images/Back30.png"
					...
					style="border-style: outset"></A> <span id="btnSave">
				</span>
			</div>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel" colspan="3"><SELECT
									...
									style="width: 200px; height: 20" onchange="filter()" readonly="readonly">
							...
							<TR>
								...
								<TD class="plainlabel" colspan="3" width="60%" >
									<textarea rows="5" cols="5" name="diengiai" id="diengiai" style="width:730px" readonly="readonly"><%=obj.getDienGiai() %></textarea>
						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="1"
							...
							<tr >
								...
								<td align="center" width="5%">
									<input type="text" style="width: 100%;" value="<%=pkd.getNgayDanhGiaLai() %>" name= "ngaydanhgialai" readonly="readonly">
								</td>
								<td align="center" width="8%">
									<input type="text" style="width: 100%;" value="<%=pkd.getGhiChu() %>" name= "ghichu" readonly="readonly">
								</td>
