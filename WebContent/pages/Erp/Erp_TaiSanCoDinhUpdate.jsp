          ...
          <TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
            <TR>
              <TD>
                <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                  <TR class="tbdarkrow">
                    <TD  width="30" align="left" ><A href="/TraphacoHYERP/Erp_TaiSanCoDinhSvl?userId=<%=userId%>"> <img src="../images/Back30.png"
                        alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve" style="border-style: outset">
                    </A></TD>
                    
                    <TD width="2" align="left"></TD>
                    <TD  width="30" align="left" >
                   <div id="btnSave"> <A href="javascript: saveform();"><IMG src="../images/Save30.png"
                        title="Luu lai" alt="Luu lai" border="1" style="border-style: outset"></A></div></TD>
                                    <TD>&nbsp; </TD>            
                  </TR>
                </TABLE>
              </TD>
                  ...
                  <TABLE width="100%" cellspacing="0" cellpadding="6">
                    ...
                    <TR>
                      ...
                      <TD class="plainlabel">
                        ...
                        <SELECT name="nId" id="nId" class="select2" style="width: 200px" readonly=readonly>
                          <option value=""></option>
                          <%
                            try {
                              while (ntsList.next()) {
                    ...
                    <tr>
                       			  <td class="plainlabel">Đơn vị quản lý <font class="erroralert">*</font> </td>
                    ...
                    <TR>
                      ...
                      <TD class="plainlabel">
                        <INPUT type="text" name="soluong" id="soluong"  value="<%=obj.getSoLuong()%>" onkeypress="return keypress(event);" >
                      </TD>

                      <TD width="15%" class="plainlabel">Thành tiền </TD>
                      <TD  class="plainlabel">
                        <INPUT type="text" name="thanhtien" id="thanhtien" value="<%= formatter.format(Double.parseDouble(obj.getThanhTien()))%>"></TD>
                    </TR>
                    <TR>
                      <TD width="15%" class="plainlabel">Đơn giá </TD>
                      <TD  class="plainlabel"><input type="text" name="dongia" id="dongia"
                        value="<%=formatter.format(Double.parseDouble(obj.getDonGia()))%>" onkeypress="return keypress(event);" ></TD>
                    ...
                    <TR>
                      ...
                      <TD class="plainlabel">
                      <input class="days" type="text"  name="ngayghitang" id="ngayghitang" value="<%=obj.getNgayghitang()%>" maxlength="10" disabled="disabled"> </TD>
