						...
						<TR>
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Sản xuất > Công đoạn sản xuất > Hiển thị</TD>
								...
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										<TR>
											...
											<TD class="plainlabel" style="width: 300px"><input type="text" readonly="readonly" name="diengiai" style="width:250px" value="<%= obj.getDiengiai() %>"></TD>
											
											<TD class="plainlabel" colspan="2">
												<input type="checkbox" <%=obj.getYckn().equals("1") ? "checked" : "" %> name="yckn" disabled="disabled" value="1">Yêu cầu kiểm nghiệm
											</TD>
										</TR>
										<TR>
											<TD class="plainlabel" valign="middle" width="20%">Số nhân công <FONT class="erroralert">*</FONT></TD>
											<TD class="plainlabel">
												<input type="text" name="sonhancong" readonly="readonly" value="<%= obj.getSonhancong() %>" style="width:250px;text-align: right;">
											</TD>
					                        ...
					                        <TD class="plainlabel" valign="middle">
					                        	<div <%=obj.getYckn().equals("1") ? "" : "style=\"display: none;\"" %> id="lhskn2">
						                        	<select multiple="multiple" name="loaihosokn" style="width: 250px" class="select2" disabled="disabled">
														<%if(LhsknRs != null){
															while(LhsknRs.next()){ 
										...
										<TR>
											...
											<TD class="plainlabel" colspan="3">
												<select name="nmIds" style="width: 450px" class="select2" disabled="disabled">
													<option value=""></option>
													<% if(nmRs != null) {
			                        					while(nmRs.next()) {  
													...
													<div id="tabs-1">
														<TABLE border="0" width="100%" cellpadding="0" cellspacing="1">
															...
															if(phongbanIds != null)
															{
																...
																%>
																<TR>
																	<td><input type="text" readonly="readonly" id="sttpb" name="sttpb" style="text-align: center; width: 100%" value ="<%=i+1 %>"/>
																	<Td>
