...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Xuất trả TSCĐ > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpPhieuxuatkhoTSCDSvl?userId=<%= userId %>" >
   		 ...
   		 <A href="../../ErpPhieuxuatkhoTSCDPdfSvl?userId=<%= pxkBean.getUserId() %>&id=<%= pxkBean.getId() %>&task=xuatkho" >
	        <IMG src="../images/Printer30.png" title="In phieu xuat kho" alt="In phieu xuat kho" border ="1px" style="border-style:outset"></A>
    </div>
