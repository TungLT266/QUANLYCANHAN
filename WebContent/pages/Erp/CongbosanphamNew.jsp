	...
	function ValidateForm()
	 {
		 var masp=document.getElementById('masp');
			if (masp.value.trim().length == 0) {
				alert("Nhập mã sản phẩm");
				masp.focus();
				return false;
			}
			
		var tensp=document.getElementById('tensp');
				if (tensp.value.trim().length == 0) {
					alert("Nhập tên sản phẩm");
					tensp.focus();
					return false;
				}
		var mancc=document.getElementById('mancc');
			if (mancc.value.trim().length == 0) {
				alert("Nhập mã nhà cung cấp");
				mancc.focus();
				return false;
		}
		var tenncc=document.getElementById('tenncc');
			if (tenncc.value.trim().length == 0) {
				alert("Nhập tên nhà cung cấp");
				tenncc.focus();
				return false;
		}
		var hancongbo=document.getElementById('hancongbo');
			if (hancongbo.value.trim().length == 0) {
				alert("Nhập hạn công bố");
				hancongbo.focus();
				return false;
		}
	 }
							...
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle" width="25%" >
										<input type="text" name="masp" id="masp" value="<%= obj.getMasp() %>" >
									</TD>
									<TD class="plainlabel" valign="middle" width="15%" >Tên sản phẩm</TD>
									<TD class="plainlabel" valign="middle" >
										<input type="text" name="tensp" id="tensp" value="<%= obj.getTensp() %>"  style="width:350px">
									</TD>
								</TR>
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle">
										<input type="text" name="mancc" id="mancc" value="<%= obj.getMancc() %>" >
									</TD>
									<TD class="plainlabel" valign="middle">Tên nhà cung cấp</TD>
									<TD class="plainlabel" valign="middle" >
										<input type="text" name="tenncc" id="tenncc" value="<%= obj.getTenncc() %>"  style="width:350px">
									</TD>
								</TR>
								...
								<TR>
									...
									<TD class="plainlabel" valign="middle" >
										<input type="text" name="hancongbo" id="hancongbo" value="<%= obj.getHancongbo() %>"  class="days">
									</TD>
									...
									<TD style="font-size: 9pt;" class="plainlabel">
	  									...
	  									<input type="text" name="hinhcongbo" value = "<%=obj.getHinhcongbo() %>" style="width: 22%; height:22px"  >	
