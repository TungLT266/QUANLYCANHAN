...
function TinhKH(){
	...
	var DVKD=document.getElementById("DVKDID");
	if(mats.value == "")                        
	{
		mats.focus();
	...
	{
		tbdkh.focus();
		error.value = "Vui lòng nhập số tháng khấu hao.";
		return;
	}
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý tài sản > Tài sản > Cập nhật</TD>
					...
					<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD  width="30" align="left" ><A href="/TraphacoHYERP/Erp_TaiSanCoDinhSvl"> <img src="../images/Back30.png"
						...
						<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
										<tr>
											...
											<TD class="plainlabel" colspan="4">
												<SELECT  name="lnsId" id="lnsId" class="select2" style="width: 200px" onChange = "submitform();">
													<option value=""></option>
													<%
														try {
															while (lnsRs.next()) {
										...
										<TR>
											...
											<TD class="plainlabel">
												...
												<INPUT TYPE = "HIDDEN" ID = "ntsId"  NAME = "ntsId" VALUE = "<%= obj.getNtsId() %>" >
												<SELECT name="nId" id="nId" class="select2" style="width: 200px" onChange = "submitform();" <%= obj.getLapngansachId().trim().length() > 0 ? " disabled='disabled' " : " "  %> >
													<option value=""></option>
													<%
														try {
															while (ntsList.next()) {
                                       ...
                                       <SELECT name="ltsId" id="ltsId" class="select2" style="width: 200px"  >
													<option value=""></option>
													<%
														try {
															while (ltsRs.next()) {
                                   ...
                                   <td class="plainlabel">Đơn vị quản lý <font class="erroralert" onch>*</font> </td>
                                          <TD class="plainlabel" colspan="3"><select name="dvthId" id="dvthId" style="width: 200px" onchange="submitform()" >
                                              <option value=""></option>
                                              <%
                                                if (dvthRs != null){
                                                  while (dvthRs.next()) {
										...
										<TR>
											...
											<TD  class="plainlabel">
												<INPUT type="text" name="dvt" id="dvt" 	value="<%=obj.getDvt() %>">
											</TD>
										</TR>
										<TR>
										...
										<%-- <tr>
											...
											<td class="plainlabel">Trung tâm chi phí <font class="erroralert">*</font> </td>
												<TD class="plainlabel" colspan="3"><select name="ttcpId" id="ttcpId" style="width: 200px" >
														<option value=""></option>
														<%
															if (TtcpRs != null){
																while (TtcpRs.next()) {
						...
						<TR>
							<td>
                        		...
                        		<%			
		                            ...
		                            ResultSet cdtsRs =  obj.getChoncongdung();
	                               ...
	                               <%	  	}%>
												<TD align = "center">
													...
													<INPUT TYPE = "checkbox" name="Ids" value="<%= cdtsRs.getString("CDTSID") %>" checked="checked" disabled=disabled>
													<INPUT TYPE = "HIDDEN" name="cdtsIds" value="<%= cdtsRs.getString("CDTSID") %>" >
												</TD>
												...
												<TD align = "center">
													...
													<INPUT TYPE = "text" name="<%= "pt1" + cdtsRs.getString("CDTSID") %>" value="<%= cdtsRs.getString("PHANTRAM") %>" style="width:100" onkeypress="return isNumberKey(event)">
												</TD>
