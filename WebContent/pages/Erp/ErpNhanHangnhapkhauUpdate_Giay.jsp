	...
	<form name="nhForm" method="post"
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" id="button"
				...
				class="tbdarkrow">
				<A href="../../ErpNhanhangnhapkhau_GiaySvl?userId=<%= userId %>&loai=0"> 
										...
										<table width="80%" align="center" class="detail">
											...
											<% DetailMeSp temp = sp.getListDetailMeSp().get(j); %>
												<tr>
													...
													value="<%= temp.getMe() %>"   onchange= "TaoRaSoMe(this); " > --%>
													<input type="text" size="100px" name="<%= sp.getId() + "." + sp.getMuahang_fk() +i+ ".meX" %>"
													value="<%= temp.getMe() %>"    id= "<%=sp.getId() + "." + sp.getMuahang_fk() +i+ ".meX_"+j %>" onchange= "TaoRaSoMe(this); " onkeypress="return keypress(event)">
													</td>
													<td><input type="text" size="100px"  
