...
<script language="javascript" type="text/javascript">
	...
	{    
	 ...
	 function changeKhoNhan()
	 { 
		 document.forms['nhForm'].action.value='changeKhoNhan';
	     document.forms["nhForm"].submit();
	 }
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Mua hàng VT/CPDV/TSCĐ/CCDC > Nhận hàng > Cập nhật
        </div>
    	...
    	<legend class="legendtitle"> Nhận hàng</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR >
					...
					<% if(nhBean.getLoaihanghoa().equals("0")) { %>
                     ...
                     <TD class="plainlabel" valign="top" >
                    	...
                    	<select name="khonhanId" id="khonhanId" onChange="changeKhoNhan()">
                        	<%
                        		if(rskhoNhan != null)
                        		{
                        			try
                ...
                <TR>
                    ...
                    <TD class="plainlabel">
                    <% System.out.println("poid "+nhBean.getDonmuahangId());%>
                             <input type="hidden" id= "ngayhoadon" name ="ngayhoadon" value ="<%=nhBean.getNgayhoadon() %>" >
                    		<input type="hidden" name="sopo" value="<%= nhBean.getDonmuahangId()%>">
	               		...
	               		<tr>
           	 				...
           	 				<% if(nhBean.getLoaihanghoa().equals("0")){ %>
	           	 				...
	           	 				<DIV id="subcontent<%= i %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 550px; padding: 4px;">
