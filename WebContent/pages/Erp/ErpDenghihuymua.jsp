...
<%@ page import="geso.traphaco.erp.beans.lapkehoach.IErpDenghihuymua"%>
...
<%	
	IErpDenghihuymua obj =(IErpDenghihuymua)session.getAttribute("obj");
	ResultSet huyRs = obj.getDenghihuymuaRs();
...
<head>
	...
	{ 
	    ...
	    document.forms['dnhm'].trangthai.value = "";
...
<form name="dnhm" method="post" action="../../ErpDenghihuymuaSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý cung ứng > Lập kế hoạch > Đề nghị hủy mua</TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Đề nghị hủy mua nguyên liệu &nbsp;&nbsp;	      
                            </LEGEND>
                            		...
                            		<TD width="98%">
                            			<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
                                				<TR class="tbheader">
                                    				...
                                    				<TH width="7%" align="center">Đề nghị đặt</TH>                                    
                                    				<TH width="7%" align="center">Đã đặt</TH> 
                                    				<TH width="7%" align="center">Đề nghị hủy</TH>                                    
                                    		...
                                    		if(!Id.equals("Id_old")){
                                        		if (m % 2 != 0) {%>                     
                                       			...
                                       			<%} else {%>
                                            		<TR class= <%= darkrow%> >
                                       			<%}%>
														<TD align="center"><%= formatter.format(huyRs.getDouble("DENGHIHUY"))%> </TD>
														<TD align="left"><%= huyRs.getString("SP")%></TD>
														<TD align="center"><%= huyRs.getString("NAM")%></TD>
														<TD align="center"><%= huyRs.getString("THANG")%></TD>
                                                		<TD align="center"><%= formatter.format(huyRs.getDouble("QTY"))%></TD>
                                                		<TD align="center"><%= formatter.format(huyRs.getDouble("DADAT")) %> </TD>
                                                		<TD align="center"><%= formatter.format(huyRs.getDouble("DENGHIHUY")) %> </TD>
									  					<TD  align="center" >
						        			                 <a href="" id='<%="chitietId" + huyRs.getString("SPID") + huyRs.getString("NAM") + huyRs.getString("THANG") %>' rel= '<%="chitiet" + huyRs.getString("SPID") + huyRs.getString("NAM") + huyRs.getString("THANG") %>'>
                          										...
                          										<DIV id='<%= "chitiet" + huyRs.getString("SPID") + huyRs.getString("NAM") + huyRs.getString("THANG") %>' style="position:absolute; visibility: hidden; border: 2px solid #80CB9B;
				                    								...
				                    								<TABLE width="100%" align="center">
				                        								<TR class="tbheader">
				                            								<TH width="100px" align="center">Mã lệnh mua</TH>
				                            								<TH width="200px" align="center">Nhà cung cấp </TH>
				                            								<TH width="100px" align="center">Đã đặt</TH>
				                            								<TH width="100px" align="center">Ngày nhận hàng</TH>				                            								
												                        </TR>	
		                            									<%
									                        			...
									                        			<TR>
			            						            				<TD align="center"><%= rs.getString("POID") %></td>
			            						            				<TD align="left"><%= rs.getString("TEN")%></TD>
			            						            				<TD align="center"><%= formatter.format(rs.getDouble("DADAT"))%></TD>
			  		                        							    <TD align="center"><%= rs.getString("NGAYNHAN")%></TD>  
