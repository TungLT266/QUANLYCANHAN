...
<% IErpTaphopdulieuDMS obj = (IErpTaphopdulieuDMS)session.getAttribute("obj"); %>
...
<body>
<form name="erpCngn" method="post" action="../../ErpTaphopdulieuDMSSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
             Quản lý tồn kho > Khóa sổ > Tập hợp dữ liệu DMS
        </div>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px">								                          
                    ...
                    <tr>
                        <td colspan="2" class="plainlabel">
                            <a class="button2" href="javascript:TapHopDuLieuDMS();">
                                <img style="top: -4px;" src="../images/button.png" alt="">Tập hợp dữ liệu DMS</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>   
