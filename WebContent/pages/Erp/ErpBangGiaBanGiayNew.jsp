				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kinh doanh > Định giá bán > Tạo mới</TD> 
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  colspan = 3 >
		                        	<input type="text" name="tenbanggia" value="<%= obj.getTenbanggia() %>" > 
		                        </TD>          
		                  </TR> 
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  >
		                        	...
		                        	<select name="dvkdId" onChange = "submitFrom();" >
										<option value=""></option>
										<% if (dvkdList != null)
										{
											while (dvkdList.next())
                         ...
                         <a href="" id="lspId" rel="subcontentLsp">
                          ...
                          <DIV id="subcontentLsp" style=" z-index=10; position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                    ...
				                    <table width="90%" align="center">
				                        <tr>
				                            ...
				                            <th width="50px" align="center">Chọn hết <input type="checkbox" onchange="sellectAll3()" id="chkAll3" ></th>
				                        </tr>
		                            	<%
			                        		if(lspRs != null)
			                        		{
                          ...
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" >
		                        	...
		                        	<select name="kbhId" onChange = "submitFrom();" >
										<option value=""></option>
										<% if (kbhList != null)
										{
											while (kbhList.next())
