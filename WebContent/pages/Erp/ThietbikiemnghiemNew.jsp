...
<SCRIPT language="JavaScript" type="text/javascript">
	function save() {
		if(document.getElementById("ma").value.trim() == ""){
			document.getElementById("dataerror").value = "Bạn chưa nhập mã.";
			return false;
		}
		
		if(document.getElementById("ten").value.trim() == ""){
			document.getElementById("dataerror").value = "Bạn chưa nhập tên.";
			return false;
		}
		
		document.forms["thietbikn"].action.value = "save";
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr height="22">
							  	<%if(obj.getId().length()>0){%>
							  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Hồ sơ kiểm nghiệm > Thiết bị kiểm nghiệm > Cập nhật</TD>
							  	<%} else { %>
							  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Hồ sơ kiểm nghiệm > Thiết bị kiểm nghiệm > Tạo mới</TD>
						  		<%} %>
				  	...
				  	<TD height="100%" width="100%">
						<FIELDSET>
							...
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          		<TR>
	                          		<TD class="plainlabel" valign="middle" width="15%" >Mã <FONT class="erroralert">*</FONT></TD>
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" style="width:300px" name="ma" id="ma" value="<%=obj.getMa() %>">
			                        </TD>
                  				</TR>
                  				
                  				<TR>
	                          		<TD class="plainlabel" valign="middle">Tên <FONT class="erroralert">*</FONT></TD>
			                        <TD class="plainlabel" valign="middle"  >
	                          	...
	                          	<TR>
			                        ...
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" style="width:300px" name="ghichu" id="ghichu" value="<%= obj.getGhichu() %>"  > 
			                        </TD>          
			                  	</TR>
