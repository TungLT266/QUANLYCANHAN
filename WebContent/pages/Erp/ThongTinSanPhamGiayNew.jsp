						...
						<TR>
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Sản phẩm &gt; Thông tin sản phẩm &gt; Tạo mới
											...
											<FIELDSET>
												...
												<TABLE border="0" width="100%" cellpadding="4" cellspacing="0">
													...
													<TR >
														...
														<TD  class="plainlabel">
															<select style="width:200px" name="loaisp" id="loaisp"  onchange="submitloaisp();">
																<option value=""></option>
																<%
																	try
																		{
															...
															<input type = "hidden" name="loaispma" id="loaispma" value="<%=spBean.getLoaiSpMa()%>">
														</TD>
														...
														<div class="tabDetails">
				                             											...
				                             											background-color: white; max-height:600px;overflow:auto ; width: 700px; padding: 4px;" >
											  											...
											  											<% if(spBean.getKiemTraDinhTinh().equals("1") || spBean.getKiemTraDinhLuong().equals("1")) { %>
											  												...
											  												<TABLE style="width: 35%" cellpadding="0px" cellspacing="1px" align="center">
											  													<TR>
																									<TD style="width: 2%"><strong>Số lượng chuẩn</strong></TD>
																								<%
																...
																<div  id="tab_3" class="tabContents" style="display:none" >
																	...
																	<table style="width: 95%" cellpadding="0px" cellspacing="1px" align="center">
																		...
																		/* if (!(dvdl2!=null && dvdl2[0].trim().length()>0))
																		{
																			//ResultSet rs;
																			//dbutils db = new dbutils();
																			//rs = db.get("select * from quycach");
											  					...
											  					<%	
											  						if (!(dvdl1[i] == null)){
											  							if (dvdl1[i].trim().length()>0){   
											  										%>
																			<input name="sl1" type="text" style="width:100%; text-align:right;" value="<%=sl1[i] %>" >
																<%		}
											  							else{  %>
																			<input name="sl1" type="text" style="width:100%; text-align:right;" value="">
																<%		}	
																	}else{%>											    					
																		<input name="sl1" type="text" style="width:100%; text-align:right;" value="">
																<%	} %>										
											  					...
											  					<%	if (!(dvdl2[i] == null)){
											  							if (dvdl2[i].trim().length()>0){%>   
																			...
																			<input name="sl2" type="text" style="width:100%; text-align:right;" value=<%=sl2[i] %> >
																<%		}
											  							else{  %>
																			<input name="sl2" type="text" style="width:100%; text-align:right;" value="">
																<%		}	
																	}else{%>											    					
																		<input name="sl2" type="text" style="width:100%; text-align:right;" value="">
																<%	} %>										
															...
															<%		i++;
																...
																<div id="tab_7" class="tabContents" style="display:none" >
																	...
																	<TABLE style="width: 40%" cellpadding="0px" cellspacing="1px" align="center">
																		...
																		%>	
																			<Td style="width: 2%">
																					<input type="number" style="width: 95%" id="soLuongChuan" name="soLuongChuan" min="0" value="<%= soLuongChuan %>" align="center" > 
																			</Td>
																			<Td style="width: 2%">
																					<input type="text" style="width: 95%" name="donViChuan" value="<%= tenDonViDoLuong %>" align="center" readonly="readonly">
																	...
																	<TABLE border="0" style="width: 65%" cellpadding="1px" cellspacing="1px" align="center">
																		...
																		%>
																			<TR>
																				...
																				<Td>
																					<input type="text"  name="maHoaChat" style="width: 100%" value="<%= elementHoaChat.getMaHoaChatKiemDinh() %>" > 
																				</Td>
																				<Td>
