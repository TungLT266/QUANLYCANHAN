...
<% 
	...
	quyen = util.Getquyen("TimnhaccSvl","",userId);
%>
...
<body>
<form name="erpTimnccForm" method="post" action="../../TimnhaccSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Mua hàng VT/CPDV/TSCĐ/CCDC > Tìm nhà cung cấp
        </div>
                   		...
                   		if(timnccList != null)
                   		{
                   			...
                   			{  		
		                        ...
		                        <%}else{ %>
		                          	<TR class='tblightrow'  >
		                        <%} %>
				                    <TD align="center"><%= timnccList.getString("sodenghi") %></TD>
				                	...
				                	<% if(tt.equals("0")){ %>
				               			...
				               			<A href = "../../TimnhaccUpdateSvl?userId=<%=userId%>&display=<%= timnccList.getString("id") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
				              			<%if(quyen[0] != 0 ){ %>
				                		
		                               	<A href = "../../TimnhaccUpdateSvl?userId=<%=userId%>&update=<%= timnccList.getString("id") %>">
		                               	...
		                               	<%if(quyen[3]!=0){ %>
			                                 <A id='chotphieu<%=timnccList.getString("id")%>'
										      ...
										      border="0" onclick="if(!confirm('Bạn có muốn chốt tìm nhà cung cấp này?')) {return false ;}else{ processing('<%="chotphieu"+timnccList.getString("id")%>' , '../../TimnhaccSvl?userId=<%=userId%>&chot=<%= timnccList.getString("id")%>');}"  >
										    </A>
									    	<%} %>
                                    ...
                                    <%if(quyen[2]!=0){ %>
                                		<A href = "../../TimnhaccSvl?userId=<%=userId%>&delete=<%= timnccList.getString("id") %>"><img src="../images/Delete20.png" width="20" height="20" border=0 
