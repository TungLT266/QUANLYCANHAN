								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ
											liệu nền > Hồ Sơ Kiểm Nghiệm > Phương Pháp Thử Nghiệm >Hiển Thị</TD>
									...
									<input type="hidden" name="pk_seq" id="pk_seq" value="<%=obj.getPK_SEQ() %>">
										...
										<TR>
											...
											<TD class="plainlabel" valign="middle"><select
												name="sanphamid" id="sanphamid" class="select2" onChange="" style="width: 200px">
												<option value=""></option>
													 <%
														if (rsSanPham != null) {
										...
										<TR>
											...
											<TD class="plainlabel" valign="middle"><select name="loaitieuchi" id="loaitieuchi" class="select2" onChange="" style="width: 200px">
												<option value=""></option>
													 <%
										...
										<TR class="plainlabel">
										 <TD class="plainlabel"  valign="middle">Số Lượng Tham Số Nhập Liệu</TD>
											<TD class="plainlabel"  > 
											<input type="number" name="sl" id= "sl"  value="<%=obj.getListThamSo().size() %>">
											</TD>
										...
										<table  align="center" id="tblThamSo" width="100%">
											...
											<%
												...
												for(int y=0;y < listTS.size();y++){
													...
													<option value="<%=rsDonViDoLuong.getString("pk_seq")%>"
														selected><%=rsDonViDoLuong.getString("DONVI")%></option>
													<%
														} else {
													%>
	...
	<script type="text/javascript">
		...
		$('body').delegate('#sl', 'change', function(event) {
			...
			for(var i=0;i<sl;i++){
				...
				var s='<td > <input type="text" style="width: 150px; text-align: right;" name="popupThamSo"> </td>';
				s+='<td ><select name="dvdl_'+(i*1+$("#y").val()*1)+'" style="width: 100%"><option></option>';
		...
		$('body').delegate('#slmau', 'change', function(event) {
			...
			{ */
				...
				for(var i=0;i<slm;i++){
					s+='<tr> <td width="10%" > <input readonly="readonly" style="width: 100%; text-align: center;" name="stt" value='+(i+1)+'> </td>';
