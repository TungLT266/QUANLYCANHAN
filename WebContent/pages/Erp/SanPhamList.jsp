...
System.out.println("Vao day");
	...
	try
	{
		if(khoId.trim().length() > 0)
		{
			...
			command	=	" SELECT TOP(50) ISNULL(SP.MA, '') AS MA, "+
						" sp.ten, "+ 
						...
						" INNER JOIN DONVIDOLUONG DVDL ON DVDL.PK_SEQ = SP.DVDL_FK  WHERE 1=1 AND SP.TIMKIEM LIKE N'%"+query+"%' " ;
			...
			if(sp != null)
			{
				while(sp.next())
				{
					...
					if(hienhuu <= 0)
						...
						out.print("###" + sp.getString("ma") + " -- " + tensp +" [" + sp.getString("donvi") + "][" + sp.getString("DONGIA") + "][" + sp.getString("spId") + "]|"); //luu y: bat buoc phai co dau phan cach '|' o cuoi moi dong'
