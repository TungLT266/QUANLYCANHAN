...
<input type="hidden" name="csId" value="<%= csBean.getCsId() %>">
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Chính sách duyệt mua hàng &gt; Hiển thị 
											...
											<TD>
												...
												<TR>
									  				...
									  				<TD class="plainlabel" width="30%">Phòng ban </TD>
						  			  				<TD class="plainlabel">
						  	  							<select disabled name= "dvthId" style="width:350px" disabled>
												...
												<TR>
									  				...
									  				<TD class="plainlabel" width="120px">Chính sách duyệt </TD>
						  			  				<TD class="plainlabel">
						  	  							<input name="diengiai" type="text" style="width:350px" readonly value="<%= csBean.getDiengiai() %>" >
						  	  						</TD>
												</TR>
												...
												<TR>
									  				...
									  				<TD class="plainlabel" align = "left">
						  	  							<input name="hoatdong" type="checkbox" disabled  checked="checked">
						  	  						</TD>
									  				<%} else{%>
						  			  				<TD class="plainlabel">
						  	  							<input name="hoatdong" type="checkbox" disabled >
						  	  						</TD>
						  	  						<%} %>
												</TR>
												<!-- ########################### TABS CƠ CHẾ DUYỆT ########################### -->
...
//														dbutils db = new dbutils();
														...
														<%  } %>	
											  					...
											  					<TD width="10%" align="center" >
																	<input name="sotientu" type="text" readonly  style="width:100%" value=<%= formatter.format(cs.getDouble("sotientu")) %> readonly="readonly">
																    <input name="kcpIds" type="hidden" style="width:100%" value=<%= cs.getString("KhoangchiphiId") %> >
																</TD>
																
																<TD  align="center" > < - <= </TD>
																
											  					<TD  align="center" >
											  						<%if (!cs.getString("sotienden").equals("-1")){ %>
																		<input name="sotienden" type="text" readonly  style="width:100%" value=<%= formatter.format(cs.getDouble("sotienden")) %> readonly="readonly">
																 	<%}else{ %>
																 		<input name="sotienden" type="text" readonly  style="width:100%" value="Không giới hạn"   readonly="readonly">
																 	<%} %>
																</TD>
											  						<%
											  						ResultSet rs1 = csBean.Chinhsachduyet(cs.getString("KhoangchiphiId"));
																	String tmp = "";
											  						try{
											  							
											  							while(rs1.next()){
											  								
											  								tmp = tmp + " - " + rs1.getString("CHUCDANH") ;
											  							}
											  							rs1.close();
											  						}catch(java.sql.SQLException e){}
											  						%>
											  					...
											  					<TD  align="center" >
								        			                 <a href="" id='<%="duyetId" + cs.getString("KhoangchiphiId") %>' rel='<%= "duyet" + cs.getString("KhoangchiphiId") %>'>
	           	 														&nbsp; <img alt="Chi tiết duyệt" src="../images/vitriluu.png"></a>
	           	 		
                          											<DIV id='<%= "duyet" + cs.getString("KhoangchiphiId") %>' style="position:absolute; visibility: hidden; border: 2px solid #80CB9B;
				                    								...
				                    								<table width="100%" align="center">
		                            									...
		                            									rs1 = csBean.Chinhsachduyet(cs.getString("KhoangchiphiId"));
		                            									ResultSet rs2 = csBean.Chucdanhconlai(cs.getString("KhoangchiphiId"));
		                            									if(rs1 != null)
			                        									{
			                        										try{
			                        											while(rs1.next())
									                        			...
									                        			<tr>
			            						            				<td><input style="width: 100%" value="<%= rs1.getString("CHUCDANH") %>"></td>
			            						            				<td align="center"><input type="checkbox" disabled name='<%="chon" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" checked="checked"></td>
			            						            				<td>
			            						            					<% if (rs1.getString("QUYETDINH").equals("1")){ %>
			            						            						<input type="checkbox" disabled name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" checked="checked">
			            						            					<%}else{ %>
			            						            						<input type="checkbox" disabled name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs1.getString("CDID")%>" >
			            						            					<%} %>
			            						            				</td>
									                        			...
									                        			<tr>
			            						            				...
			            						            				<td align="center"><input type="checkbox" disabled name='<%="chon" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs2.getString("CDID")%>" ></td>  
			            						            				
			            						            				<td><input type="checkbox" disabled name='<%="quyetdinh" + cs.getString("KhoangchiphiId")%>' style="width: 100%" value="<%= rs2.getString("CDID")%>" ></td>
			                        			                        </tr>
				                    							...
				                    							<hr/>
				                     							...
				                     							<script type="text/javascript">
																	dropdowncontent.init('<%="duyetId" + cs.getString("KhoangchiphiId") %>', "left-bottom", 300, "click");
																</script>
												...
												<%																
														...
														//db.shutDown(); 		
															...
															<% } %>
																	...
																	<%  } %>	
																	  			<TD width="1%" align="center" >
																	  				<INPUT TYPE = "hidden" NAME = "nccthutu" VALUE = "<%= j %>" >
																					<%= j %>	
																				</TD>
																			<%  String tmp = csBean.getThutuDuyetNhaCC("" + j ).trim();
																			...
																			%> 
																	  			<TD  align="left" >																																		
																					<select disabled name="<%= "mancc" + j %>"  style="width: 400px">
								    													<option value=""></option>
																			 <% try{
																			    			ncc.beforeFirst();
																			 		while(ncc.next())
																			 		{ 
																			       		if(ncc.getString("PK_SEQ").equals(ncc_duyet[0].trim())){ %>
									                            					...
									                            					if(rs != null)
										                        					{
										                        						try{
																                		 ...
																                		 <tr>
										            						            		...
										            						            		<td align="center"><input type="checkbox" disabled  name='<%="nccchon" + j %>' style="width: 100%" value="<%= rs.getString("CDID")%>" checked="checked" ></td>  
										            						            		<%}else {%>
										            						            		<td align="center"><input type="checkbox" disabled  name='<%="nccchon" + j%>' style="width: 100%" value="<%= rs.getString("CDID")%>" ></td>  
										            						            		<%}
										            						            		
										            						            		if(rs.getString("QUYETDINH").equals("1")) {%>
										            						            		<td align="center" ><input type="checkbox" disabled name='<%="nccquyetdinh" + j %>' style="width: 100%" value='<%= rs.getString("CDID")%>' checked="checked" ></td>
										            						            		<%}else {%>
										            						            		<td align="center" ><input type="checkbox" disabled name='<%="nccquyetdinh" + j %>' style="width: 100%" value='<%= rs.getString("CDID")%>' ></td>
										            						            		<%} %>
										                        			              </tr>
															...
															<% } %>
																<TABLE  border="0" cellpadding="3"  cellspacing="1" width="100%">
																	...
																	<%  } %>	
																	  			<TD width="1%" align="center" >
																	  			<INPUT TYPE = "hidden" NAME = "spthutu" VALUE = "<%= j %>" >
																					<%= j %>	
																				</TD>
																	<%  String tmp = csBean.getThutuDuyetSp("" + j).trim();
																		System.out.println(tmp);
																		if(tmp.length() > 0 ){
																			sp_duyet = tmp.split(";");
																		}else{
																	...
																	%> 
																	  			<TD align="left" >
																	  				<select disabled name="<%= "masp"  + j %>"  style="width: 400px">
								    													<option value=""></option>
																			   		<% try{
																			   				sp.beforeFirst();
																			   				while(sp.next()){ 
																			       				if(sp.getString("PK_SEQ").equals(sp_duyet[0])){ %>
																			      				<option value='<%=sp.getString("PK_SEQ")%>' SELECTED><%=sp.getString("TEN") %></option>
																			      		<%  	}else{ %>
																				...
																				<%		ResultSet rs = csBean.ChucdanhconlaiSp("" + j );
																                        ...
																                        <tr>
																                        	<td><input style="width: 100%" value="<%= rs.getString("CHUCDANH") %>"></td>
										            						            		<%if(!rs.getString("CHON").equals("-1")){ %>
										            						            	<td align="center"><input type="checkbox" disabled  name='<%="spchon" + j%>' style="width: 100%" value="<%= rs.getString("CDID")%>" checked="checked"></td>   
										            						            	<%    }else {%>
										            						            	<td align="center"><input type="checkbox" disabled  name='<%="spchon" + j%>' style="width: 100%" value="<%= rs.getString("CDID")%>" ></td>  
										            						            		<%}
										            													            						            		
										            						            		if(rs.getString("QUYETDINH").equals("1")) {%>
										            						            	<td align="center" ><input type="checkbox" disabled name='<%="spquyetdinh" + j %>' style="width: 100%" value="<%= rs.getString("CDID")%>" checked="checked"></td>
										            						            		<%}else {%>
										            						            	<td align="center" ><input type="checkbox" disabled name='<%="spquyetdinh" + j %>' style="width: 100%" value="<%= rs.getString("CDID")%>" ></td>
										            						            		<%} %>
										                        			              </tr>
