	...
	function replaceAll(str, find, replace) {
	 ...
	 {	
		 ...
		 for(dem = 0 ; dem < muaHangFk.length;dem++){
			 ...
			 if(soLuongSum != tongChiTiet){
				 alert("Tổng số lượng trên từng mẻ không bằng số lượng tổng");
				 return ;
			 }
		 }
		 var check = true;
	 ...
	 function changePO()
	 { 
		 document.forms['nhForm'].theloai.value='changePO';
	     document.forms["nhForm"].submit();
	 }
	 function changeLHH()
	 { 
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="nhForm" method="post"
		action="../../ErpNhanhangnhapkhauUpdate_GiaySvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" id="button"
				...
				class="tbdarkrow">
				<A href="../../ErpNhanhangnhapkhau_GiaySvl?userId=<%= userId %>"> <img
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
										...
										<% if (nccList != null)
						{
							...
							<TR>
								...
								<TD class="plainlabel"><select name="ldnId" id="ldnId" style="width:200px;">
										<option value=""></option>
										<%
                        		if(ldnList != null)
                        		{
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		...
                		System.out.println("ngaofi giao dienj : dong gia:  "+sp.getDongiaViet());
	               		%>
							<tr>
										...
										<table width="80%" align="center" class="detail">
											...
											<tr>
												...
												<td><input type="text" size="100px"
													...
													name="<%= sp.getId() + "." + sp.getNgaynhandukien() + "." + sp.getMuahang_fk() + ".dongialo"%>" />
												</td>
												...
												<td><input type="text" size="100px"
													...
													name="<%= sp.getId()  + "." + sp.getMuahang_fk() + ".dongialo"%>" />
												</td>
												<td><input type="text" size="120px"
													name="<%= sp.getId() + "." + sp.getMuahang_fk() + i+  ".sothung" %>"
													value="<%= spDetail.getSothung() %>" id="sothung"
												...
												<tr>
													...
													<td>
														<% if(sp.getIsKiemDinh().equals("0")){ %>
															...
															id = "<%= "sp"+ sp.getId() + sp.getMuahang_fk() +i+ "khuvucX_" +j %>"  onchange= "TaoRaKhuVuc(this); " style="width: 270px;">
