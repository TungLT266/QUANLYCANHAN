			...
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				<TR>
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Cơ bản &gt; Nhà sản xuất &gt; Cập nhật
							   </TD>
						   	...
						   	<TD align="left" colspan="4" class="legendtitle">
								...
								<TABLE width="100%" cellspacing="0" cellpadding="6">
									<%-- <TR>		
									  	...
									  	<TD class="plainlabel" >
									  		<INPUT type = "text" name="Ma" size="40" type="text" value="<%=nsxBean.getMA() %>" >
										</TD>
								    </TR> --%>
	
									<tr>
										<td class="plainlabel">Tên<font class="erroralert">*</font></td> 
										<td class = "plainlabel"> <input type = "text" name = "Ten" value="<%=nsxBean.getTEN() %>"> </td>
									</tr>
