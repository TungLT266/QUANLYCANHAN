...
<%@ page import="geso.traphaco.erp.beans.danhgialaitaisan.IErp_DanhGiaLaiTaiSan"%>
<%@ page import="geso.traphaco.erp.beans.danhgialaitaisan.imp.Erp_DanhGiaLaiTaiSan"%>
...
<%	Utility util = (Utility) session.getAttribute("util"); 
	...
	IErp_DanhGiaLaiTaiSan dcBean = (Erp_DanhGiaLaiTaiSan) session.getAttribute("dcBean");
	if (dcBean == null)
...
<form name="tsForm" method="post" action="../../Erp_DanhGiaLaiTaiSanUpdateSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý tài sản > Đánh giá lại tài sản > Hiển thị</TD>
					...
					<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
						<TR>
							<TD>
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR class="tbdarkrow">
										<TD  width="30" align="left" ><A href="/TraphacoHYERP/Erp_DanhGiaLaiTaiSanSvl"> <img src="../images/Back30.png"
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											...
											<TR class="plainlabel">
											  ...
											  <TD class="plainlabel">Tài sản </TD>
											 	<td>
											          <select name="taisancodinh"  id= "taisancodinh" disabled onchange="javascript: changeTscd();" class="select2" style="width: 200px">
														 <option value=""></option>
														  <% if(tsRs != null){
															  try{ while(tsRs.next()){ 				
											  ...
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10"  id="dieuchinhsothangkh" name="dieuchinhsothangkh" value="<%= dcBean.getDieuchinhsothangkh() %>" maxlength="10"  /> 
                            				  </TD>
                                          	</TR>
                            				  ...
                            				  <TD class="plainlabel">Điều chỉnh </TD>
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10"  id="dieuchinhnguyengia" name="dieuchinhnguyengia" value="<%= dcBean.getDieuchinhnguyengia() %>" maxlength="10"  /> 
                            				  </TD>
                                          	</TR>
