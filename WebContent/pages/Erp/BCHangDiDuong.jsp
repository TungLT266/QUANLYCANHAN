...
<%@page import="geso.traphaco.erp.beans.BCHangDiDuong.*"%>
...
<%
	...
	IBCHangDiDuong obj = (IBCHangDiDuong) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post"
		action="../../BCHangDiDuongSvl">
		<input type="hidden" name="action" value='1'> <input
			type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý tồn kho &#62; Báo cáo &#62; Hàng đi đường</div>
			...
			<div align="left"
				...
				<fieldset>
					<legend class="legendtitle">Hàng đi đường</legend>
						...
						<div style="width: 100%; float: none" align="left"
							...
							<TABLE width="70%" cellpadding="6" cellspacing="0">
								...
								<TR>
									...
									<TD class="plainlabel"><select name="dvkdId" id="dvkdId" style="width: 200px;">
										<option value="" ></option>
										<%
										if (rsTdv != null)
											while (rsTdv.next()) {
								...
								<%-- <TR>
                           		...
                           		<%-- <TR>
                           			...
                           			<%if(obj.getChiTietXNT_Lo().trim().equals("1")){ %>
							  				<input name="layctnxsolo" checked="checked" value="1"  type="checkbox" /> Lấy chi tiêt nhập xuất theo lô
							  				<%}else{ %>
							  				<input name="layctnxsolo" value="1"  type="checkbox" />Lấy chi tiêt nhập xuất theo lô
							  				<%} %>	
                           			</TD>
                           		</TR>  --%>
