...
<%
		...
		IErpDanhMucVatTuThanhPhan bomThanhPhan = (IErpDanhMucVatTuThanhPhan) session.getAttribute("bomThanhPhan");
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ
											liệu nền > Sản xuất > Danh mục vật tư (BOM) > Tạo mới</TD>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<tr>
											...
											<%-- <input
												...
												<textarea name="quycach"  style="width: 100% ;height:50px;"
										...
										<TR>
											...
											<TD class="plainlabel" valign="middle">Sử dụng để lên kế hoạch</TD>
											...
											<td class="plainlabel" colspan="3" align=left><A href=""
												...
												<DIV id="subcontentMaThanhPham"
													...
													<div align="right">
														...
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
															href="javascript:dropdowncontent.hidediv('subcontentMaThanhPham')">Đóng
															lại </a>
													</div>
												</DIV></td>
													...
													<div id="tab_1" class="tabContents" style="display: block">
														...
														<table width="100%" cellpadding="4" cellspacing="2">
															<tr class="tbheader">
																...
																<th align="center" width="5%">Nguyên liệu thay thế</th>
															...
															<tr>
																...
																<td><input type="text" name="mavattu"
																	...
																	onkeyup="ajax_showOptions(this,'abc',event);" onblur="kiemTraVT(<%=i %>)"
																	autocomplete='off'></td>
															...
															%>
															<tr>
																<td><input type="hidden" name="vtId" value=""
																	style="width: 100%"></td>

																<td><input type="text" name="mavattu" value=""
																	style="width: 100%"
																	onkeyup="ajax_showOptions(this,'abc',event)" onblur="kiemTraVT(<%=count %>)"
																	autocomplete='off'></td>

																<td><input type="text" name="tenvattu" value=""
																	style="width: 100%" readonly="readonly"></td>
																<td><input type="text" name="donvitinh" value=""
																	style="width: 100%" readonly="readonly"></td>
