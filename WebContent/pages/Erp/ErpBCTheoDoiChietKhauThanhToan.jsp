...
<body>
<form name="THCongnoKHForm" method="post" action="../../ErpReportChietKhauThanhToan">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Báo cáo quản trị > Công nợ > Báo cáo theo dõi đối chiếu thanh toán
        </div>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    ...
                    <TR>
                     ...
                     <TR>
                         ...
                         <TD class="plainlabel" valign="middle" >
                        	<select name="vungid" id = "vungid" style="width: 200px"> 
                        		<option value=""></option>
		                            	<%
			                        		if( RsVung!= null)
			                        		{
			                        			...
			                        			{ 
			                        				...
			                        				<option value="<%= RsVung.getString("PK_SEQ") %>" SELECTED ><%= RsVung.getString("ten") %></option>
			                        				<%}else{ %>
