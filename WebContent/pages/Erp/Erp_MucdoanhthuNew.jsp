				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Khoản mục doanh thu &gt; Tạo mới</TD> 
						  ...
						  <TR>
								...
								<TD class="plainlabel" >
									<TABLE cellpadding="0" cellspacing="0" border="0">
										<TR>
									  		<TD><SELECT  name="tkId" onChange = "submitform();" style="width:200px" class="select2" >												
														<option value=""  ></option>												
											<% 	if(tklist != null){
												try{
													while (tklist.next()){%>
