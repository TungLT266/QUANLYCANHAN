...
<%@ page import="geso.traphaco.erp.beans.dieuchuyentaisan.IErp_DieuChuyenTaiSanList"%>
<%@ page import="geso.traphaco.erp.beans.dieuchuyentaisan.imp.Erp_DieuChuyenTaiSanList"%>
<%
	...
	if(!util.check(userId, userTen, sum)){
		...
		IErp_DieuChuyenTaiSanList obj = (IErp_DieuChuyenTaiSanList) session.getAttribute("obj");
		ResultSet RsDc = obj.getRsDc();
		ResultSet RsDvth = obj.getPbRs();
	
	 	int[] quyen = new  int[5];
	 	quyen = util.Getquyen("Erp_DieuChuyenTaiSanSvl","",userId);
...
<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="tsForm" method="post" action="../../Erp_DieuChuyenTaiSanSvl">
						...
						<tr>
							<td align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<td align="left" colspan="2" class="tbnavigation">Quản lý tài sản > Điều chuyển tài sản</td>
														...
														<td align="center">
															<table border=0 cellpadding="0" cellspacing="0">
																<tr>
																	...
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DieuChuyenTaiSanUpdateSvl?userid=<%=userId%>&update=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<%if(quyen[3]!=0){ %>
																	<a href="../../Erp_DieuChuyenTaiSanSvl?userid=<%=userId%>&chot=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<a href=../../Erp_DieuChuyenTaiSanSvl?userid=<%=userId%>&delete=<%=RsDc.getString("pk_seq")%>><img src="../images/Delete20.png"
																	...
																	<td>
																	<%if(quyen[2]!=0){ %>
																	<a href="../../Erp_DieuChuyenTaiSanUpdateSvl?userid=<%=userId%>&display=<%=RsDc.getString("pk_seq")%>"><img
																	...
																	<%if(quyen[3]!=0){ %>
																	<td> 
																	<a href="../../Erp_DieuChuyenTaiSanSvl?userid=<%=userId%>&unchot=<%=RsDc.getString("pk_seq")%>"><img
