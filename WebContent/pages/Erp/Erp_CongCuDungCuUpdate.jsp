						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý Chi phí trả trước &gt; Chi phí trả trước &gt; Cập nhật</TD>
								...
								<FIELDSET>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
										<TR class="plainlabel" style="display: none;">
											<TD >Nhóm Chi phí trả trước<FONT class="erroralert"> *</FONT></TD>
											<TD>
												<INPUT  TYPE = "HIDDEN"  ID = "nccdcId" NAME = "nccdcId" VALUE = "<%= obj.getNccdcId() %>" >
												<SELECT style="width: 200px" name="nId" id="nId" readonly=readonly>
													<option value=""></option>
													<%
														try {
											...
											<tr>
														...
														<td  colspan = "3" class="plainlabel"><select style="width: 200px" name="LccdcId" onchange="submitform()">
																<option value=""></option>
																<%if (RsLccdc != null) {
																while (RsLccdc.next()) {
										...
										<TR>
											...
											<TD class="plainlabel"><INPUT type="text" name="ma" id="ma" size="40" type="text" value="<%=obj.getMa()%>"></TD>
												
											<TD width="15%" class="plainlabel">Diễn giải <font class="erroralert">*</font></TD>
											
											<TD class="plainlabel"><input type="text" name="diengiai" id="diengiai" value="<%=obj.getDiengiai() %>"></TD>											
										...
										<TR>
											...
											<TD class="plainlabel"><input type="text" name="stkh" id="stkh" value="<%=obj.getSothangKH()%>" onkeypress="return keypress(event);" maxlength="4"></TD>

											<TD width="15%" class="plainlabel">Ngày bắt đầu khấu hao <font class="erroralert">*</font>	</TD>
											
											<TD class="plainlabel">
											<input class="days" type="text" name="tbdkh" id="tbdkh" value="<%=obj.getThangbatdauKH()%>" maxlength="10"></TD>
                                    ...
                                    <% while  (dcNguyenGiaRs.next()) {%>
                                              <tr>
                                                <td>
                                                  ...
                                                  <td>
                                                    <input type="text"  style="width: 100%" name="giatri" value="<%= dcNguyenGiaRs.getString("GIATRI") %>" />
                                                  </td>
                                                   <td>
						...
						<TR>
							<td>
								...
								<ul class="tabs">
									 ...
									 <li ><a href="#" class= "legendtitle">Phân bổ dự kiến</a></li>							
								</ul>
                        		...
                        		<%			
									...
									<%if(khRs != null){
										...
										<%} %>
												...
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("KHAUHAODUKIEN")))) %> </TD>
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("KHAUHAOLUYKEDUKIEN")))) %> </TD>
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("GIATRICONLAIDUKIEN")))) %>	</TD>
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("KHAUHAOTHUCTE")))) %>  	</TD>
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("KHAUHAOLUYKETHUCTE")))) %>  	</TD>
												<TD align="center"><%= formatter.format(Math.round(Double.parseDouble(khRs.getString("GIATRICONLAITHUCTE")))) %>  	</TD>
											</TR>	
