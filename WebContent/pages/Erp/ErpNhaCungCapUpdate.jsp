...
<%
	...
	int[] quyen = new  int[5];
	quyen = util.Getquyen("ErpNhaCungCapUpdateSvl","",userId);
...
<script language="javascript" type="text/javascript">
	...
	function Save() 
	{
		...
		var taikhoan = document.getElementById('taikhoan');
		 ...
		 if(taikhoan.value == "")
		 {
			 alert("Vui lòng chọn tài khoản ghi nhận công nợ ");
			 taikhoan.focus();
			 return;
		 }
		
		
		document.forms['nccBeanForm'].action.value = 'Update';
		document.forms['nccBeanForm'].submit();
	}
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="nccBeanForm" method="post" action="../../ErpNhaCungCapUpdateSvl">
		...
		<input type="hidden" name="Id" id="Id" value='<%=nccBean.getId() %>' /> 
						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Nhà cung cấp &gt; Cập nhật</TD>
