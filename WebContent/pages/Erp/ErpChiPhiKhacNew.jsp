...
<form name ="cpk" method="post" action="../../ErpChiphikhacUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công nợ > Công nợ phải trả > Chi phí khác > Tạo mới</TD> 
									...
									<table width="100%" cellpadding="0px" cellspacing="1px">
										...
										if(chiphi != null){
											...
											%>
												...
												<td>
													<input type="text" name="diengiaicp" value = "<%= diengiaicp[i] %>" style="width: 100%" readonly = readonly>
												</td>
												...
												<td align = "center">
	                   								...
	                   								<DIV id="subcontent<%= i %>" style="position:absolute; visibility: hidden; border: 2px solid #80CB9B; background-color: white; width: 1000px; padding: 4px; max-height: 300px; overflow: scroll; ">
	 										...
	 										%>
						         			 ...
						         			 <%		} %>
						         			 	...
						         			 	<%		} %>
											      		...
											      		<td>
											      			<input type="text" name=<%= "thue" + i %> value = "<%= formatter.format(Double.parseDouble(tienthue[m])) %>" style="width: 100%"  onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue_new();"  >
											      		</td>
					         			 	...
					         			 	<%		} %>
										      		...
										      		<td>
										      			<input type="text" name=<%= "thue" + i %> value = "0" style="width: 100%"  onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" onChange="tinhthue_new();" >
										      		</td>
									   ...
									   %>
										...
										<%	// Thêm 5 dòng trong cho chi phí
											...
											<TR>
												<td>
													<input type="text" name="chiphi" style="width: 100%" value= "" onkeyup="ajax_showOptions(this,'chiphi',event)" AUTOCOMPLETE="off"  id="chiphi_<%=j %>">
												...
												<td>
													<input type="text" name="thue" value= "0" style="width: 100%"   readonly = readonly>
												</td>
