...
<%@ page  import = "geso.traphaco.erp.beans.nhapkhoNK.imp.*" %>
...
<% IErpNhapkhoNK nhBean = (IErpNhapkhoNK)session.getAttribute("nhBean"); %>
...
<script language="javascript" type="text/javascript">
	...
	function DinhDang()
	{
		var masp = document.getElementsByName("mahangmua");
		var soluongnhan = document.getElementsByName("soluongnhan");
		var songayluukho = document.getElementsByName("songayluukho");
		
		for(var i = 0; i< masp.length; i ++)
		{
			var sl = soluongnhan.item(i).value.replaceAll(",", "");
			var songay = songayluukho.item(i).value.replaceAll(",", "");
			
			if( sl == '') sl = '0';
			if( songay == '') songay = '0';
			
			soluongnhan.item(i).value = DinhDangTien(sl);
			songayluukho.item(i).value = DinhDangTien(songay);
		}
	}
...
<form name="nhForm" method="post" action="../../ErpNhapkhoNKUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	 Mua hàng nhập khẩu > Nhập kho nhập khẩu > Tạo mới
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpNhapkhoNKSvl?userId=<%= userId %>" >
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> Nhập kho nhập khẩu</legend>
        	<div style="float:none; width:100%" align="left">
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    <TD width="150px" class="plainlabel" valign="top">Ngày nhập</TD>
                    <TD class="plainlabel" valign="top" colspan="3">
                    	<input type="text"  class="days" id="ngaynhap" name="ngaynhap" 
               	...
               	<TR>
					 <TD class="plainlabel" valign="middle" > Nhà cung cấp</TD>   
                      <TD class="plainlabel" valign="middle" colspan="3" >
                      	<select name="nccId" id="nccId" style="width: 300px;" onchange="changePO();" readonly="readonly">
						<option value=""></option>
						<% if (nccList != null)
						{
							while (nccList.next())
				...
				<TR>
					<TD class="plainlabel" valign="middle" > Số PO </TD>   
                      <TD class="plainlabel" valign="middle" colspan="3">
                      	<select name="poId" id="poId"  style="width: 300px;" onchange="changePO();">
						<option value=""></option>
						<% if (poList != null)
						{
							while (poList.next())
        ...
        <div align="left" style="width:100%; float:none; clear:none;" class="plainlabel">
            <TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1" >
                <TR class="tbheader"> 
                	...
                	<TH align="center" width="8%">Kho nhập</TH> 
               	 	<TH align="center" width="6%">Số lượng đặt </TH>
               	 	<TH align="center" width="6%">Số lượng nhận </TH>               	 	              	 	
               	 	<TH align="center" width="9%">Ngày nhập</TH>               	 	 
 					<TH align="center" width="8%">Số ngày lưu kho miễn phí</TH>             	 	          	 	
                		...
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="left">
           	 					...
           	 					<input type="hidden" value="<%= sp.getVat() %>" name= "vat">
           	 				...
           	 				<td align="right">
           	 					<input type="hidden" style="width: 100%; text-align: right;" value="<%= sp. getKhonhanId() %>" readonly="readonly" name= "khonhapId">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= sp. getKhonhanTen() %>" readonly="readonly" name= "khonhapten">
           	 				</td>
           	 				<td align="right">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= sp.getSoluongdat() %>" name= "soluongdat" readonly="readonly" >
           	 				</td>
           	 				<td align="right">
           	 					<input type="text" style="width: 80%; text-align: right;" value="<%= sp.getSoluongnhan() %>" name= "soluongnhan" 
           	 				...
           	 				<td align="right">
           	 					<input type="text" class="days" style="width: 100%; text-align: right;" value="<%= sp.getNgaynhandukien() %>" name= "ngaynhap" readonly="readonly" >
           	 				</td>
         	 				
           	 				<td align="right">
           	 					<input type="text"   style="width: 100%; text-align: center; " value="<%= sp.getSongayluukho() %>" name= "songayluukho" onKeyPress = "return keypress(event);" onchange="DinhDang();">
           	 				</td>
