				...
				<TR>
					<TD align="left" class="tbnavigation">
				   		<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  		<tr height="22">
						  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng  &gt; Mức chi phí  &gt; Tạo mới</TD> 
							...
							<TABLE  width="100%" cellspacing="0" cellpadding="6">
								...
								<TR>
								    ...
								    <TD width="81%" class="plainlabel">
										<INPUT name="sotientu" type="text" size="40" value='<%= mcpBean.getSotientu() %>' onkeyup="formatTien(this);" >
									</TD>
								...
								<TR>
								    ...
								    <TD width="81%" class="plainlabel">
										<INPUT name="sotienden" type="text" size="40" value='<%= mcpBean.getSotienden() %>' onkeyup="formatTien(this);" >
									</TD>
