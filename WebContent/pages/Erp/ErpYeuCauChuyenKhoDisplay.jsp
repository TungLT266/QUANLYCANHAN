...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Yêu cầu chuyển kho > Hiển thị 
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" <%= lsxBean.getCoDoituong().equals("1") ? "" : "colspan='3'" %>  >
                    	<select name = "khoxuatId" style="width: 200px;"  onchange="changeKHO();" >
                    		<option value=""> </option>
                        	<%
                        		if(khoxuatRs != null)
                        		{
                ...
                <% if( lsxBean.getCoKhonhan().equals("1")  ) {   %>
	                <TR>
	                    ...
	                    <TD class="plainlabel" <%= lsxBean.getCoDoituongNhan().equals("1") ? "" : "colspan='3'" %>  >
	                    	...
	                    	<select name = "khonhapId" style="width: 200px;"  >
	                    		<option value=""> </option>
	                        	<%
	                        		if(khonhapRs != null)
	                        		{
	                    ...
	                    <% if( lsxBean.getCoDoituongNhan().equals("1") ) { %>
		                     ...
		                     <TD class="plainlabel" >
		                        	...
		                        	<select name="doituongNhanId" style="width: 200px;" >
		                    		<option value=""></option>
                ...
                <TR>
                	<TD class="plainlabel">Số lệnh SX</TD>
                   	<TD class="plainlabel" colspan="3" >
                   		<select name="lsxId" style="width: 200px;" >
                   		<option value=""></option>
                   			<% if( lsxRs != null ) { %>
                    		<% while(lsxRs.next()) 
                    		{ 
			...
			{ 
				...
				{ 
					...
					<tr>
						...
						<td> <input type="text" name="soluongyeucau" value="<%= formatter3.format( Double.parseDouble( yeucau.getSoluongYC() )) %>"   style="width: 97%; text-align: right; " onkeypress="return keypress(event);" > </td>
						<td> 
