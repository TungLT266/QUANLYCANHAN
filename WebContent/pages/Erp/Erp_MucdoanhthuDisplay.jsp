				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Khoản mục doanh thu &gt; Hiển thị</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><INPUT type="text" readonly style="width:300px" name="ten" style="width:300px" value='<%= DtBean.getTen()%>'></TD>
							</TR>
							<TR>
							  	<TD class="plainlabel">Diễn giải</TD>
						  	  	<TD class="plainlabel"><INPUT type="text" readonly style="width:300px" name="diengiai" style="width:300px" value='<%= DtBean.getDiengiai() %>'></TD>
						  </TR>
						  	<TR>
						   		<TD class="plainlabel">Đơn vị / Phòng ban thực hiện</TD>
						  	  	<TD class="plainlabel">
						  			<select disabled style="width:300px"  name="dvttId" style="width:200px" class="select2"  >
						  					<option value=""  ></option>
						  				<%
						  ...
						  <TR>
								...
								<TD class="plainlabel" >
									<TABLE cellpadding="0" cellspacing="0" border="0">
										<TR>
									  		<TD><select disabled style="width:300px"  name="TtdtId" style="width:200px" class="select2" >												
														<option value=""  ></option>												
											<% 	try{
													while (Ttdtlist.next()){%>
