...
//		PhanBoTien();
	...
	{    
		...
		{ 
			if (keypressed == 9 || keypressed == 8 || keypressed == 127 || keypressed == 37 || keypressed == 39 || keypressed == 0 || keypressed == 46|| keypressed == 45)
	...
	{ 
		...
		{ 
			if (keypressed == 9 || keypressed == 8 || keypressed == 127 || keypressed == 46|| keypressed == 45 || keypressed == 47)
			{
				return;
			}
			return false;
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Quản lý công nợ &gt; Công nợ phải thu &gt; Thu tiền &gt; Cập nhật</div>
        </div>
