...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Hóa đơn nhà cung cấp > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
                    ...
                    <TR >
                        <TD class="plainlabel" width="15%">	Chọn tiền tệ</TD>
                       	<TD class="plainlabel" colspan="3">
							<SELECT NAME = "ttId"  id = "ttId"  style="width: 200px;height:20" onChange = "submitform();">
										<OPTION VALUE = ""></OPTION>
						<% 	if(ttRs != null){
								while(ttRs.next()){			
                ...
                <%
                	...
                	<TR>
                		<TD>
                   		...
                   		<TD align="left">
	                   		...
	                   		<DIV id="subcontent<%= i %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 550px; padding: 4px; max-height: 200px; overflow: auto; ">
					          <table width="100%" align="center">
						        <tr>
						         <th width="100px">Số PO</th>
					        		...
					        		<td>						        		  
				        		  	...
				        		  	<td>
				        		  		<%if(pBean.getLoaidonmh().equals("2")) { // NẾU LÀ ĐƠN MUA HÀNG CHI PHÍ DỊCH VỤ THÌ KHÔNG CHO PHÉP SỬA ĐƠN GIÁ %>
				        		  			<input type="text" id="sohoadon<%= i %>.dongia<%= d %>"   value="<%= formatter1.format(sp.getDongia()) %>" name="sohoadon<%= i %>.dongia" style="width: 100%"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);" readonly="readonly">
				        		  		<%} else {%> 
				        		  		<input type="text" id="sohoadon<%= i %>.dongia<%= d %>"  value="<%= formatter1.format(sp.getDongia()) %>" name="sohoadon<%= i %>.dongia" style="width: 100%"  onkeyup="Kiemtra5(this);" onKeyPress = "return keypress(event);">
				        		  		 <%} %>			        		  		
				        		  	</td>

				        		  	<td>
				        		  		<input type="text" readonly="readonly" id="sohoadon<%= i %>.thanhtien<%= d %>"   value="<%= formatter.format(sp.getThanhtien()) %>" name="sohoadon<%= i %>.thanhtien" style="width: 100%"  >
                   ...
                   <% 
            		...
            		<TD>
                    	...
                    	<input type="hidden"   id="mausohoadon<%= j %>" name="mausohoadon<%= j %>" value=""  />
               		...
               		<TD align="left">
	                   		...
	                   		<DIV id="subcontent<%= j %>" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 500px; padding: 4px; max-height: 200px; overflow: auto; ">
					          <table width="100%" align="center">
						        <tr>
						         <th width="100px">Số PO</th>
						         <th width="100px">Mã hàng</th>
					        	...
					        	<tr >
					        		...
					        		<td>
				        		  	...
				        		  	<td>
				        		  		<input type="text" readonly="readonly" id="sohoadon<%= j %>.thanhtien<%= d %>"   value="<%= formatter.format(rs.getDouble("THANHTIEN")) %>" name="sohoadon<%= j %>.thanhtien" style="width: 100%"  >
               		...
               		<TD class="plainlabel" valign="middle">
                    	<input type="text" onKeyPress = "return keypress(event);" onkeyup="Dinhdang(this)"  id="chietkhau<%= j %>" name="chietkhau<%= j %>" value=""  style=" text-align: right;"  />
               		</TD> 
               		<TD class="plainlabel" valign="middle">
               		...
               		<TD class="plainlabel" valign="middle">
                    	<input type="text"  id="vat<%= j %>" onKeyPress = "return keypress(event);"  onkeyup="Dinhdangvat(this)" style=" text-align: right;"  name="vat<%= j %>" value=""  />
               		</TD> 
               		<TD class="plainlabel" valign="middle">
