            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
             <TR>
                    ...
                    /* 
                    	...
                    	String mangten[] =new String[]{"Yêu cầu nguyên liệu","Chuyển kho","Tiêu hao nguyên liệu" ,"Nhập kho","Lệnh sản xuất","Kiểm định chất lượng"};
 */
                    	String mang[] =new String[]{"LSX","CHUYENKHO", "NK","NKM", "KDCL","KDCLM","THNL"};
                    	String mangten[] =new String[]{"Lệnh sản xuất","Chuyển kho nguyên liệu","Nhập kho","Nhập kho mới","Kiểm định chất lượng","Kiểm định chất lượng mới","Tiêu hao nguyên liệu"};
				...
				<%-- <TR>
					...
					<TD class="plainlabel" valign="middle"  colspan="2">
						<input type="text" name="dienGiaiCT" value="<%= hctmhBean.getDienGiaiCT() %>" readonly="readonly" >
					</TD>
				</TR> --%>
