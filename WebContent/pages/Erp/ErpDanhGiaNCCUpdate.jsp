...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="timnccForm" method="post" action="../../Erp_DanhgianccUpdateSvl">
		...
		<input type="hidden" name="id" value='<%=dgnccBean.getId() %>' />
		<input type="hidden" name="action" value="1" />
		
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Nghiệp vụ khác > Đánh giá nhà cung cấp > Cập nhật</div>
			...
			<div align="left" id="button" style="width: 100%; height: 32px; padding: 0px; float: none" class="tbdarkrow">
				...
				<A href="../../Erp_DanhgianccUpdateSvl?userId=<%=userId %>&id=<%= dgnccBean.getId() %>&task=print" >
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TD class="plainlabel" valign="top" width="150px"> Đơn mua hàng</TD>
                            	...
                            	<OPTION value="nulls" selected></OPTION>
									<% try{
										if(poList != null)
										while(poList.next()){ 
                    ...
                    <TR class='tbdarkrow'   >
                    	...
                    	<TD align="center">
							<% if(dgnccBean.getTucach().equals("1")) { %>
              					...
              					<% } else { %>
              						<input type="checkbox" name="tucach" value="0"  >
              					<% } %>
						</TD>
                    </tr>
                    <TR class='tblightrow'  >
                    	...
                    	<TD align="center">
							<% if(dgnccBean.getUytin().equals("1")) { %>
              					...
              					<% } else { %>
              						<input type="checkbox" name="uytin" value="0"  >
              					<% } %>
						</TD>
                    </TR>
                    <TR class='tbdarkrow'   >
                    	...
                    	<TD align="center">
							<% if(dgnccBean.getChatluong().equals("1")) { %>
              					...
              					<% } else { %>
              						<input type="checkbox" name="chatluongsp" value="0"  >
              					<% } %>
						</TD>
                    </tr>
                    <TR class='tblightrow'  >
                    	...
                    	<TD align="center">
							<% if(dgnccBean.getTggiaohang().equals("1")) { %>
              					...
              					<% } else { %>
              						<input type="checkbox" name="tggiaohang" value="0"  >
              					<% } %>
						</TD>
                    </TR>
                </TABLE>
