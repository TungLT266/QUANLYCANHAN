<%@page import="geso.traphaco.erp.beans.NhomNhanVien.IErpNhomNhanVien"%>
...
<%  IErpNhomNhanVien nNccBean = (IErpNhomNhanVien)session.getAttribute("nNccBean"); 
...
function submitform()
{
	document.nkhForm.action.value='update';
...
<form name ="nkhForm" method="post" action="../../ErpNhomNVUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Nhóm nhân viên &gt; Cập nhật</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Nhóm nhân viên </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							
							<TR>
							  	<TD class="plainlabel">Mã nhóm</TD>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">							
								<TR class="tbheader">
									<TH width="28%">Mã nhân viên </TH>
									<TH width="60%">Tên nhân viên </TH>
									<TH width="12%">Chọn
										<input type="checkbox" name="chon" onClick="checkedAll(document.nkhForm.ncc)">								
