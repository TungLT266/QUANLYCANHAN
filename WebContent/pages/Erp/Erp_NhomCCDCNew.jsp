...
<%@ page  import = "geso.traphaco.erp.beans.erp_nhomtaisan.IErp_nhomCCDC" %>
<%@ page  import = "geso.traphaco.erp.beans.erp_nhomtaisan.imp.Erp_nhomCCDC" %>
...
<%
	...
	IErp_nhomCCDC ntsBean =(Erp_nhomCCDC)session.getAttribute("ntsBean");
...
function submitform(){
	...
	if(mats == "")                        
	{
		document.forms['tsForm'].dataerror.value = "Vui lòng nhập mã Nhóm chi phí trả trước.";
		return;              
	}
	...
	if(tents == "")
	{
		document.forms['tsForm'].dataerror.value = "Vui lòng nhập diễn giải Nhóm chi phí trả trước.";
		return;
	}
	...
	if(ltsId == "")
	{
		document.forms['tsForm'].dataerror.value = "Vui lòng chọn loại Công Cụ Dụng Cụ.";
		return;
	}
...
<form name="tsForm" method="post" action="../../Erp_NhomCCDCUpdateSvl" charset ="UTF-8">
		...
		<TD colspan="4" align='left' valign='top' bgcolor="#ffffff">
			<TABLE width="100%" cellpadding="0" cellspacing="1">
				<TR>
					<TD align="left" class="tbnavigation">
						  ...
						  <tr height="22">
							   <TD align="left" colspan="2" class="tbnavigation">Quản lý công cụ dụng cụ &gt; Nhóm chi phí trả trước &gt; Tạo mới </TD>
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR ><TD >
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								<TR class = "tbdarkrow">
									<TD width="30" align="left"> <A href="/TraphacoHYERP/Erp_NhomCCDCSvl" > <img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"> </A></TD>
			...
			<TABLE width="100%" cellspacing="0" cellpadding="6">
						...
						<TR>
						   <TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
								<LEGEND class="legendtitle">Thông tin Nhóm chi phí trả trước
								</LEGEND>
								<TABLE  width="100%" cellspacing="0" cellpadding="6">		
									<TR>
									...
									<TR>
										<TD width = "15%" class = "plainlabel">Loại công cụ dụng cụ <font class = "erroralert">*</font> </TD> 
										<TD class = "plainlabel"> 
						...
						<TR>
								<TD colspan = 2>
									...
									<div class="panes">
		                                ...
		                                ResultSet cdtsRs =  ntsBean.getChoncongdungthem();
	                               ...
	                               <%	  	}%>
									...
									<%		i++;
										...
										ResultSet ttcpRs = ntsBean.getChonTTCPThem();
