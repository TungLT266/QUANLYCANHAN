...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải thu > Bảng kê thu tiền > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = 0>							
                <TR>
                    ...
                    <TD class="plainlabel" width="300px" valign="top">
                    	<input type="text"  class="days" id="ngaychungtu" name="ngaychungtu" value="<%= tthdBean.getNgaychungtu() %>" maxlength="10" readonly /></TD>
                    <TD width="150px" class="plainlabel" >Ngày ghi sổ</TD>
                    <TD class="plainlabel" valign="top">
                    	<input type="text"  class="days" id="ngayghiso" name="ngayghiso" value="<%= tthdBean.getNgayghiso() %>" maxlength="10" readonly onchange="submitform()" /></TD>
                </TR> 
