...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function replaces()
	{ 
 		var doanhthuId = document.getElementById("doanhthuId");
 		if(doanhthuId.value == "400002" ||doanhthuId.value == "400003" ){
     		...
     		for(i = 0; i < diengiai_sanpham.length; i++){
    			if(maSP.item(i).value != ""){
    				...
    				if(pos > 0)
    				{
    					...
    					maSP.item(i).value = sp.substring(0, parseInt(sp.indexOf("][")));
	...
	function doiTienThue()
	{
		bvat = document.getElementById("bvat");
		avat = document.getElementById("avat");
		tienVAT = document.getElementById("tienVAT");
		avat.value = DinhDangDonGia(parseFloat(bvat.value.replace(/,/g,"")) + parseFloat(tienVAT.value.replace(/,/g,"")));
		tienVAT.value = DinhDangDonGia(tienVAT.value.replace(/,/g,""));
	}
	...
	function DinhDangTT()
	{
		...
		for(i = 0; i < diengiai_sanpham.length; i++)
		{
			if((diengiai_sanpham.item(i).value != '' && doanhthuId != '400002' && doanhthuId != '400003') 
					|| ( (doanhthuId == '400002' || doanhthuId == '400003') && idSP != null && idSP.item(i).value != '') )
			{
				...
				if(doanhthuId == '400002'){// HÓA ĐƠN ĐIỀU CHỈNH TĂNG - ĐƠN GIÁ || ĐƠN GIÁ ĐÃ GIẢM || THÀNH TIỀN > 0
					...
					var tt = Math.round(parseFloat(sl)*(parseFloat(dgdc) - parseFloat(dg)));
					if(tt > 0){
					...
					sl = soluong.item(i).value.replace(/,/g,"") ;
					dg = dongia.item(i).value.replace(/,/g,"") ;
					var tt = Math.round(parseFloat(sl)*parseFloat(dg));
...
//		alert(total);
		...
		document.getElementById("tienVAT").value = DinhDangDonGia( Math.round (  total * parseFloat(vat) / 100 ));
	}
	...
	function save()
	{
		 var ngayghinhan = document.getElementById("ngayghinhan").value;
		  var ngayhoadon = document.getElementById("ngayhoadon").value;
		  if (ngayhoadon  > ngayghinhan){
			  alert("Ngày hóa đơn phải <= ngày ghi nhận . Vui lòng nhập lại thông tin");
			  return ;
		  }	
	...
	<TR>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công nợ > Công nợ phải thu > Hóa đơn khác > Cập nhật</TD> 
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../ErpHoadonkhacSvl?userId=<%= userId%>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							 ...
							 <TR>
	                          ...
	                          <TR  >
			                        ...
			                        <TD class="plainlabel" valign="middle" width="280px" >
			                        	<input type="text" class="days" name="ngayghinhan" id="ngayghinhan" value="<%= obj.getNgayghinhan() %>"  onchange="submitform();"  > 
			                        </TD>          
	                          		<TD class="plainlabel" valign="middle" width="100px" >Ngày hóa đơn</TD>   
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text" class="days" name="ngayhoadon" id="ngayhoadon" value="<%= obj.getNgayhoadon() %>"   > 
			                        </TD>          
			                  </TR> 
			                  <TR class="plainlabel">
			                  ...
			                  <TR  >
			                        ...
			                        <TD class="plainlabel" valign="middle" >
			                        	<input class="uppercase" type="text"  name="kyhieuhoadon" value="<%= obj.getKyhieuhoadon() %>"   > 
			                        </TD>          
	                          		<TD class="plainlabel" valign="middle" width="120px" >Số hóa đơn</TD>   
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input class="uppercase" type="text"  name="sohoadon" value="<%= obj.getSohoadon() %>" onchange="submitform();"   > 			           	 				
			                        </TD>          
			                  </TR> 
			                  <TR>
			          ...
			          <%} %>
			                ...
			                <%--  <TR>
			                  ...
			                  <TR>
			                        ...
			                        <TD class="plainlabel" valign="middle" >
			                        	<input type="text" id="bvat"  name="bvat"  style="text-align:right;"  value="<%= formatter.format(Double.parseDouble( obj.getBvat().replaceAll(",",""))) %>" readonly="readonly"  > VNĐ
			                        </TD>          
	                          		<TD class="plainlabel" valign="middle" width="120px" >VAT</TD>   
			                        <TD class="plainlabel" valign="middle"  >
			                        	<input type="text"  id="vat" name="vat" style="text-align:right;"  value="<%= formatter.format(Double.parseDouble(obj.getVat().replaceAll(",",""))) %>"  onchange="DinhDangTT();"> %
			                        </TD>          
			                  </TR> 
                        ...
                        <TD class="plainlabel" valign="middle" >Số tiền VAT</TD>   
                              <TD class="plainlabel" valign="middle" >
                                <input type="text" id="tienVAT"  name="tienVAT"  style="text-align:right;"  value="<%= formatter.format(Double.parseDouble(obj.getTienVat())) %>" onchange = "doiTienThue();" > VNĐ
                              </TD>
	                          		<TD class="plainlabel" valign="middle" >Số tiền sau VAT</TD>   
			                        <TD class="plainlabel"  valign="middle">
                            
			                        	<input type="text" id="avat"  name="avat"  style="text-align:right;" value="<%= formatter.format(Double.parseDouble(obj.getAvat().replaceAll(",",""))) %>" readonly="readonly" > VNĐ
			                        </TD>                
			                  </TR>
