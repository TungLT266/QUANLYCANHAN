...
<script language="javascript" type="text/javascript">
	...
	{	
		...
		{
			var soluong = document.getElementsByName(idhangmua.item(i).value + ".soluong");
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	 Quản lý mua hàng > Mua hàng nhập khẩu > Nhập kho nhập khẩu > Hiển thị
        </div>
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="right">
           	 					<input type="text" style="width: 80%; text-align: right;" value="<%= sp.getSoluongnhan() %>" name= "soluongnhan" readonly = "readonly">
           	 				...
           	 				<td align="right">
           	 					<input type="text"   style="width: 100%; text-align: center; " value="<%= sp.getSongayluukho() %>" name= "songayluukho"  >
           	 				</td>
