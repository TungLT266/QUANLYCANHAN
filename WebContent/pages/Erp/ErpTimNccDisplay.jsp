	...
	<form name="timnccForm" method="post" action="../../TimnhaccUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua VT/ CPDV/ TSCĐ/ CCDC/ > Tìm nhà cung cấp > Hiển thị</div>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TD class="plainlabel" valign="top" width="200px"> Mã đề nghị mua hàng</TD>
								...
								<select name="dnmhId" disabled="disabled">
                            	...
                            	<input type="hidden" name="dnmhId" value='<%=timnccBean.getDnmhId() %>'/>
							...
							<tr>
								...
								<% if(timnccBean.getHinhthuc().equals("1")){ %>
									<INPUT type="checkbox" name="hinhthuc" value='1' checked  disabled="disabled"">
								<% }else{ %>
									<INPUT type="checkbox" name="hinhthuc" value='1'   disabled="disabled"">
								<% } %>
								</TD>
							</tr>
						</TABLE>
                    ...
                    if(nccList != null)
					{
						...
						while (nccList.next()){
	                        ...
	                        <%}else{ %>
	                          	<TR class='tblightrow'  >
	                        <%} %>
	                        <td class="plainlabel"><input value=" <%=nccList.getString("pk_seq")%> " name= "idncc<%=n %>" type='hidden' >
							...
							<td class="plainlabel"><input name= "dongia<%= n %>" type="text" value="<%=dongia%>" readonly style="width:100%"></td>
							
							<td align="center">
              					<% if(nccList.getString("pk_seq").equals(nccList.getString("ncc_fk")==null?"":nccList.getString("ncc_fk"))) { %>
