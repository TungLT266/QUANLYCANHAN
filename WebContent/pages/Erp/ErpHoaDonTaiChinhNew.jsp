...
<script type="text/javascript">
	...
	function confirmLogout()
	 ...
	 function loadcontent_kh()
	 {             
		document.forms['dhForm'].action.value='reload_kh';
	...
	function saveform()
	 {	 
		 ...
		 if(document.forms["dhForm"]["hinhthucxhd"].value == '100001'|| document.forms["dhForm"]["hinhthucxhd"].value == '100002')
		 {
			 if(document.forms["dhForm"]["ttcpId"].value.length == 0){
				 setErrors("Bạn phải chọn trung tâm chi phí !");
				 return;
			 }			 	
		 }
											...
											<TR class="plainlabel" >
											  ...
											  <TD class="plainlabel">                               
                                                 <input type="text" size="10" class="days"
                                     			   id="ngayxuathd" name="ngayxuathd" value="<%=hdBean.getNgayxuathd()%>" maxlength="10" onchange="loadcontent();" /> 
											  </TD>
											   ...
											   <table id="tableDDH" width="100%">												
			         							...
			         							if(ddhRs != null)
			         							{
			         								...
			         								while(ddhRs.next()){ %>
			  										...
			  										<% 
			   										 if(hdBean.getDonhangId().trim().contains(ddhRs.getString("pk_seq").trim())){%>
			       										<TD align="center" width="8%"><input type ="checkbox" checked="checked" name ="ddhid" value ="<%= ddhRs.getString("pk_seq") %>"  onchange="loadcontent();" ></TD>
			       									<%}else{ %>
			       										<TD align="center" width="8%"><input type ="checkbox" id="ddhid" name ="ddhid" value ="<%= ddhRs.getString("pk_seq") %>" onchange="loadcontent();" ></TD>
			       									<%}%>
                   								...
                   								<td colspan="2" valign="bottom" >
                   								  <table class="plainlabel" width="100%"  style="padding-top:0 ; margin-top:0">
                   								    ...
                   								    <%	double tongtien = hdBean.getThanhTien();
                   								     	double ckthuongmai= hdBean.getTienCKThuongMai();
                   								     	double tienvat = hdBean.getTienVat();                   								                        								     	
                   								     	double tienthucthu = tongtien - ckthuongmai + tienvat;
                   								    %>
                   								    ...
                   								    <td>Tiền Vat</td>
                   								    <td>
                   								      <input type="text" style="text-align:right" id="total_tienvat" name="total_tienvat" value="<%=formatter.format(tienvat)%>" readonly="readonly">
                   								    </td>
                   								    </tr>
                   								      <tr>
                   								    <td>
                   								    ...
                   								    <td>
                   								      <input type="text" style="text-align:right" id="tienavat" name="tienavat" value="<%=formatter.format(tienthucthu)%>" readonly="readonly">
                   								    </td>
                   								    </tr>
                   								  </table>
                   								</td>
