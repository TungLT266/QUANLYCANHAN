...
<%	
	...
	if(ddh!=null){
	while(i< ddh.length){
		System.out.println("Dhdhdd :"+ddh[i]);
		if(ddh[i]!=null){	
...
{	
	 ...
	 document.forms['dhForm'].action.value='savesohoadon';
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation"> Quản lý cung ứng > Quản lý bán hàng > Xuất hóa đơn tài chính > Xem và In ấn </TD>								   
                   					...
                   					<%-- 		<%} %> --%>
                   								...
                   								<td colspan="2" valign="bottom" >
                   								  <table class="plainlabel" width="100%"  style="padding-top:0 ; margin-top:0">
                   								    <tr>
                   								    <%	double tongtien = hdBean.getThanhTien();
                   								     	double ckbanhang= hdBean.getTienCK();
                   								     	double ckhoadon= hdBean.getTienCKThuongMai();
                   								     	double tienvat = hdBean.getTienVat();
                   								     	                   								     	
                   								     	double tienthucthu = tongtien - ckbanhang - ckhoadon + tienvat;
                   								     	
                   								    %>
                   								    <td width="30%"> Tổng tiền </td> 
                   								    <td width="70%"> 
                   								    	<input type="text" style="text-align:right" id="total_thanhtien" name="total_thanhtien" value="<%=formatter.format(hdBean.getThanhTien()) %>">
                   								    </td>
                   								    </tr>
                   								    <tr>
                   								    <td>Chiết khấu thương mại</td>
                   								    <td>                   								      
                   								      <input type="text" style="text-align:right"  id="ckthuongmaihd" name="ckthuongmaihd" value="<%=formatter.format(ckhoadon)%>">
                   								    ...
                   								    <td>Tiền Vat</td>
                   								    <td>
                   								      <input type="text" style="text-align:right" id="total_tienvat" name="total_tienvat" value="<%=formatter.format(tienvat)%>">
                   								    </td>
                   								    </tr>
                   								      <tr>
                   								    <td>
                   								    ...
                   								    <td>
                   								      <input type="text" style="text-align:right" id="tienavat" name="tienavat" value="<%=formatter.format(tienthucthu)%>">
                   								    </td>
                   								    </tr>
                   								  </table>
                   								</td>
							   		...
							   		<TD>
										...
										<tbody id="san_pham">
												...
												<TH width="5%" height="5">STT</TH>
													...
													<TH  style="display: none" width="5%">VAT </TH>
													<TH width="10%">Đơn giá đã giảm giá</TH>
													<TH  style="display: none" width="10%">Tiền thuế </TH>	
								...
								<%
									...
									if(spMa != null)
									{
										...
										<tr>
											...
											<td  style="display: none">
												<input type="text" name="tienthue" value="<%= formatter.format(Double.parseDouble(spTienThue[k])) %>" style="width: 100%; text-align: right;" readonly="readonly">							
												<%-- <input type="text" name="khott" value="<%= spKhoTT[k] %>" style="width: 100%; text-align: right;" readonly="readonly"> --%>
											</td>
											<td>
