...
<input type="hidden" name="duyet" value="<%=pBean.getDuyet()%>"> 

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng &gt; Mua VT/CPDV/TSCĐ/CCDC &gt; Hóa đơn NCC &gt; Cập nhật
        </div>
                ...
                <TR>
                   ...
                   <%} else {%>
                    ...
                    <TR >
						...
						<%System.out.println (" kho nhan update: "+pBean.getLoaihang() ) ;%>
                	...
                	<TR>
                		<TD>
						        ...
						        for(d = 0; d < hd.getPnkList().size(); d ++){
						        	...
						        	<tr >
						        		<td>						        		  
					        		  	...
					        		  	<% double soluonghdd= 0;
											try{
												soluonghdd=Double.parseDouble(sp.getSoluonghd().replaceAll(",",""));
											}catch(Exception er){
												
											}
					        		  	%>
					        		  		<input type="text" id="sohoadon<%= i %>.soluong<%= d %>"   value="<%= formatter.format( soluonghdd) %>" name="sohoadon<%= i %>.soluong" style="width: 100%" onKeyPress = "return keypress(event);" onkeyup="Kiemtra2(this)" onchange="ktMaxnhan();" >
					        		  	...
					        		  	<td>
					        		  		<%--  <%if(pBean.getLoaidonmh().equals("2")) { // NẾU LÀ ĐƠN MUA HÀNG CHI PHÍ DỊCH VỤ THÌ KHÔNG CHO PHÉP SỬA ĐƠN GIÁ %>
					        		  		 ...
					        		  		 <%} else { %>  --%>
					        		  			<input type="text" readonly="readonly" id="sohoadon<%= i %>.dongia<%= d %>" value="<%= formatter2.format(Double.parseDouble(sp.getDongia())) %>" name="sohoadon<%= i %>.dongia" style="width: 100%"  onchange="Kiemtra5(this);" onKeyPress = "return keypress(event);">
					        		  		<%--  <%} %>		 --%>        		  		
					        		  	</td>

					        		  	<td>
					        		  		<input type="text"  id="sohoadon<%= i %>.thanhtien<%= d %>"   value="<%= formatter3.format( Double.parseDouble(sp.getThanhtien())) %>" name="sohoadon<%= i %>.thanhtien" style="width: 100%"  onkeyup="Kiemtra15(this);" onKeyPress = "return keypress(event);" >
				        		  		...
				        		  		<td>
				        		  			<input type="text"  id="sohoadon<%= i %>.sptienvat<%= d %>"   value="<%= formatter3.format( Double.parseDouble(sp.getTienVat())) %>" name="sohoadon<%= i %>.sptienvat" style="width: 100%; text-align: right;"  onkeyup="Kiemtra155(this);" onKeyPress = "return keypress(event);"  >				        		  		
                   		...
                   		<TD class="plainlabel" valign="middle">
                   			...
                   			%>
                        	<input type="text" readonly="readonly" name="vat<%= i %>"  id="vat<%= i %>" style="text-align: right;" style="text-align: right;"  value="<%=vat%>"  onkeyup="Dinhdangvat(this)" onKeyPress = "return keypress(event);" />
                   		</TD> 
                   		<TD class="plainlabel" valign="middle">
