...
<%
	...
	ResultSet rs;
	 ResultSet soHDRs = obj.getSoHoaDonUpdate();
%>
...
<!--                         	<TD class="plainlabel" valign="middle"> -->
<%-- 		                     	<input type="text" id="ptThueNK" name="ptThueNK" value = "<%= obj.getPtThueNK() %>" style="width: 100px" onKeyPress = "return keypress(event);" onChange = "tinhtien();" > % --%>
<!--                         	</TD>                         -->
<!-- 						</TR> -->
...
<!-- 	                    <TR> -->
                         	<TD class="plainlabel" valign="middle" >Thuế nhập khẩu</TD>
                        	<TD class="plainlabel" valign="middle">
		                     	<input type="text" id="thueNKTong" name="thueNKTong" value = "<%= formatter.format(Double.parseDouble(obj.getThueNK())) %>" style="width: 100px" onKeyPress = "return keypress(event);" onKeyUp = "Dinhdang(this);" readonly="readonly">
                        	</TD>                        
<!-- 						</TR> -->
