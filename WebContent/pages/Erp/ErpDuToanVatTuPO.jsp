...
List<ISanpham> spList = dmhBean.getSanphamList();
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../ErpDutoanvattuPOSvl">
		<input type="hidden" name="userId" value='<%=userId%>'> 
		<input type="hidden" name="action" value="1" />
		<input type="hidden" name="id" value="<%= dmhBean.getId() %>" />
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Dự toán vật tư > Chuyển sang PO</div>
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<TR>
								...
								<TD TD class="plainlabel" valign="top">
								 <input type="hidden" name = "tigia" value = <%= dmhBean.GetTyGiaQuyDoi() %>>
									<Select name="tiente_fk" id="tiente_fk" onChange="submitform();" style="width: 200px" disabled="disabled">
										<option value=""></option>
										 <% if (ttList.size() > 0)
											{
							...
							<TR>																																
								...
								<TD class="plainlabel" width="250px">
									...
									<input type="hidden" name="dnmhId" id="dnmhId"  value =<%= dmhBean.getDnmhId() %>  />
								</TD>
								...
								<TD class="plainlabel" width="250px">
									...
									<select name="timnccId" id="timnccId" style="width: 200px" disabled="disabled">
										<option value = ""></option>
										<% if (timnccList != null)
										{
									...
									<input type="hidden" name="timnccId" value='<%=dmhBean.getTimNCCId()%>'> 
							...
							<TR>
								...
								<TD class="plainlabel">
									<select name="loaihh" id="loaihh" style="width: 200px" disabled>
									...
									<input type="hidden" name="loaihh" value="<%= dmhBean.getLoaihanghoa() %>" />
								</TD>
				  ...
				  <div  class="plainlabel" id="accordion" style="width:100%; height:auto; float:none; font-size:1.0em" align="left">
					 ...
					 <h1 class="plainlabel" style= "height:auto;font-size:1.0em;"><a  href="#">Chọn nhà cung cấp</a>
					 </h1>
									...
									for(int i = 0; i < spList.size(); i++) { 
										...
										<tr>
											<TD align="center" width="2%">
												...
												<input type="hidden" value="<%= sp.getId() %>" name="idsp" style="width: 100%" readonly="readonly" > 
											
											</TD>
											<TD  align="center" width="8%" >
												<input type="text" value="<%= sp.getMasanpham() %>" name = "masp" style="width: 100%" readonly="readonly" > 
											</TD>
											<TD align="left" width="10%">
												<input type="text" value="<%= sp.getTensanpham() %>" name = "tensp" style="width: 100%" readonly="readonly" >
											</TD>
											<TD align="center" width="6%">
												<select style="width: 250px" id="nccId" name = "nccId">
					                            <%
					                            ResultSet nccRs = sp.getNccRs();
				                            	if(nccRs != null)
				                            	{
			                            			while(nccRs.next())
			                            			{
			                            			%>
			                            				<option value="<%= nccRs.getString("ID") %>" > <%= nccRs.getString("TENNCC") %> </option>
