...
<form name ="tieuchikiemnghiem" method="post" action="" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr height="22">
								<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Hồ sơ kiểm nghiệm > Loại tiêu chí kiểm nghiệm > Hiển thị</TD>
				  	...
				  	<TD height="100%" width="100%">
						<FIELDSET>
							...
							<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          		<TR>
	                          		<TD class="plainlabel" valign="middle" width="250px" >Mã loại tiêu chí kiểm nghiệm </TD>   
	                          	...
	                          	<TR>
	                          		<TD class="plainlabel" valign="middle" width="250px">Tên loại tiêu chí kiểm nghiệm </TD>
			                        <TD class="plainlabel" valign="middle"  >
