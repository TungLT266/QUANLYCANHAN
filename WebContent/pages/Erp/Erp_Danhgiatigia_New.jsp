...
<% String userTen = (String) session.getAttribute("userTen");  
	...
	if(!util.check(userId, userTen, sum)){
		response.sendRedirect("/SalesUp/index.jsp");
		 ...
		 ResultSet thangList = (ResultSet) dgtigiaBean.getThangRS(); 
%>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	...
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">Quản lý kế toán > Đánh giá tỉ giá > Tạo mới 
        </div>
    	...
    	<legend class="legendtitle">Đánh giá tỉ giá</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" >
                 ...
                 <TR>
                        ...
                        <TD class="plainlabel" valign="middle" colspan = 3>
                            <SELECT id="thang"  name="thang" onChange="submitform();">
                            		<OPTION value=""></option>
					<% 
						try
						{
							if(thangList != null){
								while(thangList.next()){
					  				if (dgtigiaBean.getThang().equals(thangList.getString("THANG"))){ %>
									<OPTION value = <%= thangList.getString("THANG")%> selected><%= thangList.getString("THANG")%> </OPTION>
							<%  	}else{ %>
							  	  	<OPTION value = <%= thangList.getString("THANG")%> ><%= thangList.getString("THANG")%></OPTION>
						  	 <% 	} 
								}
						  	}
						}catch(java.sql.SQLException e){}%>	  					
					...
					<TD align="left" colspan="4">
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
							...
							<TR class="tbheader">
								...
								<TH width="12%" align="center">Tài khoản</th>
								<TH width="18%" align="center">Tiền tệ</th>
...
session.setAttribute("dgtigiaBean", null) ; %>
