	...
	<form name="dmhForm" method="post" action="../../ErpHoadonkhacNccUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý mua hàng > Nghiệp vụ khác > Hóa đơn điều chỉnh giá NCC > Tạo mới</div>
	                      ...
	                      <TD class="plainlabel" valign="middle" colspan="3"   >
							...
							<TR class="plainlabel">
							 ...
							 <TR>
								...
								<TD class="plainlabel"><input type="text" class = "uppercase" name="mauhoadon" id="mauhoadon" value="<%=dmhBean.getMauhoadon()%>" style="text-align: left;"
									 > </TD>
								
								<TD class="plainlabel">Ký hiệu hóa đơn</TD>
								<TD class="plainlabel"><input type="text" class = "uppercase" name="kyhieuhoadon" id="kyhieuhoadon" value="<%=dmhBean.getKyhieu()%>" style="text-align: left;"
									 > </TD>
							</TR>
