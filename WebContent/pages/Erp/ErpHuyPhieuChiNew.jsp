...
<%@ page  import = "geso.traphaco.erp.beans.huyphieuchi.*" %>
<%@ page  import = "geso.traphaco.erp.beans.huyphieuchi.imp.*" %>
...
<% IErpHuyphieuchi hctmhBean = (IErpHuyphieuchi)session.getAttribute("hctmhBean"); %>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải trả > Hủy chứng từ > Tạo mới
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpHuyphieuchiSvl?userId=<%= userId %>" >
  	...
  	<div align="left" style="width:100%%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  rows="1" readonly="readonly" style ="width:100%;color: white;"><%= hctmhBean.getMsg() %></textarea>
		         <% hctmhBean.setMsg(""); %>
    	</fieldset>
  	</div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
            	...
            	<TR class="plainlabel" >
                     ...
                     <TD class="plainlabel" valign="middle">
                        <select name="loaict"  id="loaict" onChange="submitform();"  style="width: 200px">
					<% if (hctmhBean.getLoaiCTId().equals("3")){	%>
					  	<option value="3" selected>Hóa đơn NCC</option>
					  	<option value="2">Phiếu chi/Ủy nhiệm chi</option>
					  	<option value=""> </option>					  
					<%} else if(hctmhBean.getLoaiCTId().equals("2")) { %>
					 	<option value="2" selected>Phiếu chi/Ủy nhiệm chi</option>
					  	<option value="3" >Hóa đơn NCC</option>
					  	<option value="" > </option>					  		  	
					<%} else { %>
						<option value="" ></option> 									  	
					  	<option value="2" >Phiếu chi/Ủy nhiệm chi</option>
                ...
                <TR>
                 ...
                 <TR>
                    <TD width="15%" class="plainlabel" valign="top"> Diễn giải chứng từ </TD>
                    <TD colspan="2" class="plainlabel" valign="top">
                    	<input type="text" id="dienGiaiCT" name="dienGiaiCT" value="<%= hctmhBean.getDienGiaiCT() %>" onchange="submitform()"  />
                    </TD>
                </TR>
                 	 <TR>
        	...
        	<% while(soctRequest.next()){ %>
	                <TR>
	                	...
	                	<TD align="center">
	                		...
	                		<input type="hidden" name="sochungtugocct" style="width: 100%" value="<%= soctRequest.getString("SOCHUNGTUGOC") %>" readonly="readonly" >
	                	</TD>
	                	<TD align="center">
	                	...
	                	<TD align="center">
	                		...
	                		<%} else { %>
	                			<input type="checkbox" name="sochungtuhuy" value="<%= soctRequest.getString("SOCHUNGTUGOC") %>" onchange="HuyChungTu(<%= i - 1 %>)" disabled="disabled" >
	                		<%} %>
	                	</TD>
	                </TR>
           <% i++; } } %>
