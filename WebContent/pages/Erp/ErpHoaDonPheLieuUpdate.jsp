				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý cung ứng > Quản lý bán hàng > Xuất hóa đơn khác > Cập nhật</TD> 
			                  			...
			                  			<% 
			    							...
			    							int stt = 0;
			                  				...
			                  				<tr>
			                  					...
			                  					<td>
			                  						<input style="display: none type="text" name="dongiadagiam" value="<%= sanpham.getDonGiaDaGiam() %>" style="width: 100%; text-align: right; "  onKeyPress = "return keypress(event);" onchange="DinhDangTT();">
			                  					</td>
