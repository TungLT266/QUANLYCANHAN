<%@page import="geso.traphaco.erp.beans.baocaocongnoquay.IErp_CongNoKhachHangQuayChiTietList"%>
<%@page import="geso.traphaco.erp.beans.baocaocongnoquay.IErp_CongNoKhachHangQuayList"%>
...
%>
<%
	IErp_CongNoKhachHangQuayChiTietList obj = (IErp_CongNoKhachHangQuayChiTietList) session.getAttribute("obj");
											...
											<FIELDSET>
												...
												<TABLE class="tblight" width="100%" cellpadding="6"
													...
													<TR>
														...
														<TD class="plainlabel" colspan=5><INPUT name="tuNgay"
