						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">Quản lý tài sản &gt; Công dụng tài sản &gt; Tạo mới</TD>
								...
								<fieldset>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											...
											<tr>
												...
												<TD class="plainlabel"><select name="taikhoan" onchange="Submit()" id="taikhoan" style= "width:20% " >
														<option value=""></option>
														<%if (rsTaiKhoan != null)
