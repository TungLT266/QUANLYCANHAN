...
<%@ page import="geso.traphaco.erp.beans.baocaosocaitaikhoan.*"%>
...
%>
<%
	IErp_BaoCaoSoCaiTaiKhoanList obj = (IErp_BaoCaoSoCaiTaiKhoanList) session.getAttribute("obj");
...
<%
int[] quyen = new  int[5];
quyen = util.Getquyen("Erp_BaoCaoSoCaiTaiKhoanSvl","",userId);
%>
...
<SCRIPT language="JavaScript" type="text/javascript">
	...
	function kiemTra(check){
		if (check == "1")
		{
			...
			var NhomTaiKhoanNo = document.getElementById("nhomTaiKhoanId").value;
			if (soHieuTaiKhoanNo == "" && NhomTaiKhoanNo == "")
			{
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="xdForm" method="post" action="../../Erp_BaoCaoSoCaiTaiKhoanSvl">
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
									<TR height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán &gt; Báo cáo &gt; Sổ cái tài khoản</TD>
...
<!-- 													style="display: none;" -->
													...
													<TR>
														...
														<TD class="plainlabel">Tài khoản đối ứng</TD>
														<TD class="plainlabel" colspan="5">
															<select name="soHieuTaiKhoanCo" id="soHieuTaiKhoanCo" style="width: 300px;" >
																<option value=""></option>
																<%
																	for (Erp_Item item: obj.getDieuKienLoc().getTaiKhoanList())
																		if (obj.getDieuKienLoc().getSoHieuTaiKhoanCo().equals(item.getValue())){
																%>
																	<option value="<%=item.getValue() %>" selected><%=item.getName() %></option>
																<%
																		} else {
														...
														<TD width="98%">
															<TABLE width="100%" border="0" cellspacing="1" cellpadding="2">
																...
																<TR class=<%=darkrow%>>
																	...
																	%>
																	<TD align="left" width="5%"><%=item.getStt()%></TD>
																	<TD align="left" width="8%"><%= item.getSoChungTu()%></TD>
																	<TD align="left" width="8%"><%= item.getNgayGhiNhan()%></TD>
																	<TD align="right" width="8%"><%=(item.getNgayChungTu())%></TD>
																	<TD align="right" width="8%"><%= (item.getDienGiai())%></TD>
																	<TD align="right" width="8%"><%= (item.getSoHieuTaiKhoanDoiUng())%></TD>
																	<TD align="right" width="8%"><%= formatter.format(item.getNo())%></TD>
																	<TD align="right" width="8%"><%= formatter.format(item.getCo())%></TD>
																	<TD align="left" width="8%"><%= item.getLoaiChungTu()%></TD>
																	<TD align="left" width="8%"><%= item.getMaChungTu()%></TD>
																	<TD align="right"  width="8%"><%= (item.getDoiTuong())%></TD>
																	<TD align="right"  width="8%"><%= (item.getDoiTuongDoiUng())%></TD>
																</TR>
																<%
																	m++;
																				}
