<%@page import="geso.traphaco.erp.beans.nhapkho.giay.ISanpham"%>
<%@page import="geso.traphaco.erp.beans.nhapkho.giay.IErpNhapkho"%>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý cung ứng > Sản xuất > Nhập kho > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
	    ...
	    <%-- <A href="../../ErpPhieunhapkhoPdfSvl?userId=<%= nkBean.getUserId() %>&id=<%= nkBean.getId() %>&task=nhapkho" >
	        <IMG src="../images/Printer30.png" title="In phieu nhap kho" alt="In phieu nhap kho" border ="1px" style="border-style:outset"></A> --%>
	         <A href="../../ErpInPhieuNhapKhoPdfSvl?userId=<%= nkBean.getUserId() %>&id=<%= nkBean.getId() %>&task=nhapkho&congtyId=<%=nkBean.getCongtyId() %>" >
	        <IMG src="../images/Printer30.png" title="In phiếu nhập kho" alt="In phiếu nhập kho" border ="1px" style="border-style:outset"></A>
    </div>
                    ...
                    <TD class="plainlabel" valign="top">
                    	 ...
                    	 <option   value="">  </option>
                   		    <%  
 								...
 								String[] mangten=new String[]{"Thành phẩm","Bán thành phẩm","Phế phẩm"};
                ...
                <TR class="tbheader"> 
	                ...
	                <TH align="center" width="30%">Tên sản phẩm</TH>
	                 <TH align="center" width="10%">Đơn vị</TH>
               	 	...
               	 	<TH align="center" width="10%">Số lượng lấy mẫu</TH>
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="center">
           	 					 	<input type="text" style="width: 100%; text-align: left;" value="<%= sp.getDVT() %>" name= "dvt" readonly="readonly" >
           	 				...
           	 				<td align="center">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= sp.getSoluonglaymau() %>" name= "soluongmau" >
           	 				</td>
