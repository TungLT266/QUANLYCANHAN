...
<%@ page  import = "geso.traphaco.erp.beans.erp_chinhanh.IErp_chinhanh" %>
<%@ page  import = "geso.traphaco.erp.beans.erp_chinhanh.imp.Erp_chinhanh" %>
...
<html>
<head>
<title>Traphaco - Update Chi Nhánh</title>
