...
<input type="hidden" name="flag" value='<%= khccdc.getFlag() %>' >
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE class="tabledetail" border="0" width="100%" cellpadding="6" cellspacing="1">
							<TR class="tbheader">
								...
								<TH width="25%" align="center"  >Loại chi phí trả trước</TH>
				...
				int m = 0;
								...
								if(khauhaoList!=null){
									  ...
									  <%} %>
												...
												<TD align = "center">
													<INPUT TYPE = "checkbox" checked="checked" disabled="disabled" NAME = "chbox">		
													<INPUT TYPE = "hidden" NAME = "maccdc"  value="<%= giaTriKhauHao.getMataisan() %>" >					`					`							
												</TD>
											</TR>										  
						<%			 	
									}
