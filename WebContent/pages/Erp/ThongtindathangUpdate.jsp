					...
					<% if(obj.getIsMua().equals("1")){ %>				
							...
							<TR>
								...
								<TD class="plainlabel" valign="middle" >
									<input type="text" name="mou" value="<%= formatter.format(Double.parseDouble(obj.getMOU().replaceAll(",",""))) %>" >
								</TD>
					...
					<% }else{ %>		
							<TR>
								...
								<TD class="plainlabel" valign="middle" colspan = 3>
									<input type="text" name="lotsize" value="<%= formatter.format(Double.parseDouble(obj.getLotsize().replaceAll(",",""))) %>" >
								</TD>
