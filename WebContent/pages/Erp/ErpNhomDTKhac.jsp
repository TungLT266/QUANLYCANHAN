...
<%@ page  import = "geso.traphaco.erp.beans.NhomDTKhac.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<% IErpNhomDTKhacList obj = (IErpNhomDTKhacList)session.getAttribute("obj"); %>
<% List<IErpNhomDTKhac> ncclist = (List<IErpNhomDTKhac>)obj.getNccList(); %>
<%	String userId = (String) session.getAttribute("userId");  
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[5];
		quyen = util.Getquyen("ErpNhomNVSVl","",userId);
...
function clearform()
{
	document.nNccForm.diengiai.value = "";
...
<form name="nNccForm" method="post" action="../../ErpNhomDTKhacSvl">
				...
				<TR>
					<TD align="left" class="tbnavigation">
				   		<table width="100%" border="0" cellpadding="0" cellspacing="0">
					  		<tr height="22">
						  		<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Mua hàng &gt; Nhóm đối tượng khác</TD> 
	...
	<img style="top: -4px;" src="../images/button.png" alt="">Nhập lại</a>&nbsp;&nbsp;&nbsp;&nbsp;	
			...
			<TABLE width="100%" border = "0" cellpading = "0" cellspacing = "0">
				<TR>
					...
					<LEGEND class="legendtitle">&nbsp;Nhóm đối tượng khác &nbsp;&nbsp;&nbsp;
									...
									<TD align="center">
										<TABLE>
											...
											<%if(quyen[2]!=0 && obj.getChixem().equals("0") ){ %>
												<A href = "../../ErpNhomDTKhacUpdateSvl?userId=<%=userId%>&update=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img title="Cập nhật" src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A>&nbsp;
											<%} %>
											</TD>
											<TD>
											<%if(quyen[1]!=0 && obj.getChixem().equals("0") ){ %>
												<A href = "../../ErpNhomDTKhacSvl?userId=<%=userId%>&delete=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img title="Xóa" src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Ban có muốn xóa nhóm nhân viên này?')) return false;"></A>&nbsp; 
											<%} %>
											</TD>
											<!-- QUYEN VIEW DLN --> 
											<TD>
												<A href = "../../ErpNhomDTKhacUpdateSvl?userId=<%=userId%>&display=<%=nNcc.getId()%>&chixem=<%=obj.getChixem()%>"><img src="../images/Display20.png" title="Hiển thị" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0></A>
											</TD>
											<!-- END QUYEN VIEW DLN --> 
											</TR>												
										</TABLE>									
