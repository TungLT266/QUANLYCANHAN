				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Khoản mục chi phí &gt; Cập nhật</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						  	...
						  	<TR>
								...
								<TD class="plainlabel" >
									<TABLE cellpadding="0" cellspacing="0" border="0">
										<TR>
									  		<TD><SELECT  name="tkId"  style=" width: 250px">												
														<option value=""  ></option>												
											<% 	if(tklist != null){
												try{
													while (tklist.next()){%>
						...
						<TR>
							<% if(ncpBean.getKmDacBiet().equals("1")) {%>						
						  		<TD class="plainlabel"><input name="kmdacbiet" type="checkbox" value="1" checked>
						  	<%}else{ %>
						  		<TD class="plainlabel"><input name="kmdacbiet" type="checkbox" value="0" >
						  	<%} %>
							      Khoản mục chi phí đặc biệt </TD>
							<TD class="plainlabel">&nbsp;</TD>
						</TR>
