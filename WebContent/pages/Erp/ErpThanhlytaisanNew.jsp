...
{ 
	...
	else
	{
		if(parseInt(tem.indexOf(" - ")) > 0)
		{
			...
			khTen.value = tem.substring(0, tem.length);
...
//			phantramthue.item(i).value = "";
	...
	function ChangeKH()
	{
		 document.forms['dtltsForm'].action.value='changeKH';
	     document.forms["dtltsForm"].submit();
	}
	function TinhTien()
	{
		 ...
		 var soluongton = document.getElementsByName("soluongton");
			...
			for(i = 0; i < sodong; i++)
			{
				if(masp.item(i).value != "")
				{
					 ...
					 console.log("da vao dk");
					 console.log(soluong.item(i).value);
					 console.log(soluongton.item(i).value);
		  			if(parseFloat(soluong.item(i).value)>parseFloat(soluongton.item(i).value))
			  			{
						 
						   alert("Số lượng thanh lý phải nhỏ hơn số lượng CCDC tồn");
						   console.log("sai");
			 			 } else{
			 				console.log("cho phpe");
			 			 }
				}
			}
	 }
	...
	<form name="dtltsForm" method="post" action="../../ErpThanhlytaisanUpdateSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation">Quản lý tài sản &gt; Thanh lý tài sản &gt; Tạo mới</div>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel">
									<input type="text" id="khTen" name="khTen" value="<%= dtltsBean.getKhTen() %>" readonly="readonly" onChange="changeKH();" >
					...
					<div align="left" style="width: 100%; float: none; clear: none;">
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="1" cellspacing="1">
							<TR class="tbheader">
								...
								<% if ((dtltsBean.getLoai().equals("1"))||(dtltsBean.getLoai()==null)||(dtltsBean.getLoai()=="")){ %>
								<TH align="center" width="10%" >Mã tài sản</TH>
								<% } %>
								<% if(dtltsBean.getLoai().equals("2")){ %>
								<TH align="center" width="10%" >Mã công cụ dụng cụ</TH>
								<% } %>
							...
							<% for(int i = count; i < 40; i++) { %>
								...
								<tr>
									<TD align="center" width="2%">
										...
										<input type="hidden" value="" name="soluongton" style="width: 100%" readonly="readonly" > 
									</TD>
									<TD align="center" width="8%" >
									...
									<TD align="center" width="7%">
									<% if(dtltsBean.getLoai().equals("1")) { %>
										<input type="text" value="" name="soluong" readonly style="width: 100%; text-align: right;" > 
									<% } else {%>
										<input type="text" id="soluong" value="" name="soluong" onChange="changeSoluong();" style="width: 100%; text-align: right;" > 
									<%} %>
									</TD>
									<TD align="center" width="8%">
...
}catch (Exception ex)
{
	...
	session.removeAttribute("dtltsBean");	
