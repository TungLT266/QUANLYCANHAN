...
replaces();
	...
	{    
		...
		{ 
			if (keypressed == 8 || keypressed == 127 || keypressed == 37 || keypressed == 44 || keypressed == 0 || keypressed == 46)
	...
	function Xoafile()
	 {
	 	...
	 	{
	 		xmlhttp.open("GET","../../ErpDenghimuahangUpdateSvl?userId="+document.getElementById("userId").value+"&id=" + document.getElementById("id").value+"&task=xoafilenew",true);
	 		xmlhttp.send();
	 	}
	 	else
	 		return false;
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" enctype="multipart/form-data" action="../../ErpDenghimuahangUpdateSvl">
...
<%-- 		<input type="hidden" name="duyet" value="<%= dmhBean.getCanDuyet() %>" /> --%>
		...
		<input type="hidden" name="duyetmh" id="duyetmh" value="<%=dmhBean.getDuyetdnmh()%>"> 
		<div id="main" style="width: 100%; padding-left: 2px">
			 <div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua hàng VT/CPDV/TSCĐ/CCDC > Đề nghị mua hàng > Cập nhật</div>
...
<%-- 									<% } %> --%>
									...
									<A href="../../ErpDenghimuahangUpdateSvl?userId=<%=userId %>&id=<%= dmhBean.getId() %>&task=print" >
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel" >
									<Select name="tiente_fk" id="tiente_fk" >
										<option value=""></option>
										<% if (ttList.size() > 0)
											{
...
<%-- 								<% } %> --%>
							...
							<TR>
								...
								<TD class="plainlabel" >
									<input type="text" name="ghichu" value="<%= dmhBean.getGhiChu() %>" style="width: 200px"  onKeyPress = "return keypress1(event);" />
								</TD>
								...
								<TD class="plainlabel" >
									<INPUT type="file" name="filename" value="">
						  	  		...
						  	  		<% if(dmhBean.getCongvan().length() > 0 ) {	%>
						  	  			<div id="tenfilea"><p><%= dmhBean.getCongvan() %><img src="../images/Delete20.png" onclick="Xoafile()" style="cursor: pointer;" alt="Xóa" width="20" height="20" longdesc="Cap nhat" border = 0></p></div>
						  	  		<%} %>
								</TD>
							</TR>
...
<%-- 								 <% } } %> --%>
										...
										<tr>
											...
											<TD align="left" width="10%">
												<% if ( dmhBean.getLoaihanghoa().trim().equals("0") ) { System.out.println("_____TEN SP: " + sp.getTensanpham()); %>
													<input type="text" value="<%= sp.getTensanpham() %>" name="tensp" style="width: 100%" readonly="readonly" onKeyPress = "return keypress1(event);" > 
												<% } else {  %>
													<input type="text" value="<%= sp.getTensanpham() %>" name="tensp" style="width: 100%"  onKeyPress = "return keypress1(event);" > 
												<%  } %>
											</TD>
											...
											<TD align="center" width="7%">
												<input type="text" value="<%= sp.getSoluong() %>" name="soluong" style="width: 100%; text-align: right;" onKeyPress = "return keypress(event);"  > 
											</TD>
							...
							<% for(int i = count; i < 40; i++) { %>
								...
								<tr>
									...
									<TD align="left" width="10%">
									<% if ( dmhBean.getLoaihanghoa().trim().equals("0") ) { %>
										<input type="text" value="" name="tensp" style="width: 100%" readonly="readonly" onKeyPress = "return keypress1(event);" > 
									<% } else { %>
										<input type="text" value="" name="tensp" style="width: 100%" onKeyPress = "return keypress1(event);" > 
									<% } %>
									</TD>
									<TD align="center" width="6%">
									...
									<TD align="center" width="7%">
										<input type="text" value="" name="soluong" style="width: 100%; text-align: right;" onKeyPress = "return keypress(event);"  > 
									</TD>
