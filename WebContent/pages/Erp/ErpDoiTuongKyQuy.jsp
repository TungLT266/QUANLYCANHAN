...
if(!util.check(userId, userTen, sum)){
	...
	IErpDoiTuongKyQuy lspList = (IErpDoiTuongKyQuy) session
	...
	ResultSet rsLSP = lspList.getLoaiSanPhamRs();
	 ...
	 int[] quyen = new  int[5];
	 quyen = util.Getquyen("ErpDoiTuongKyQuySvl","",userId);
	 System.out.println(quyen[0]);
		System.out.println(quyen[1]);
		System.out.println(quyen[2]);
		System.out.println(quyen[3]);	
		System.out.println(quyen[4]);
		System.out.println("lít sp= "+lspList.getChixem());
%>
...
<body leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	...
	<form name="lspListForm" method="post" action="../../ErpDoiTuongKyQuySvl">
						...
						<tr>
							<td align="left">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kế toán > Đối tượng ký quỹ</td>
										...
										<td width="100%" align="left">
											<fieldset>
												...
												<table width="100%" cellpadding="6" cellspacing="0">
													<tr>
														<td width="15%" class="plainlabel" >Mã đối tượng</td>
														<td class="plainlabel"><input type="text" name="ma"
															onchange="Submit()" value="<%=lspList.getMa()%>" />
													</tr>
													<tr>
														<td width="15%" class="plainlabel" >Tên đối tượng</td>
				...
				while (rsTaiKhoan.next()) {
					if (lspList.getTaiKhoan().equals(
						...
						<tr>
							...
							<fieldset>
							<legend> <span class="legendtitle">Khu vực&nbsp;&nbsp;&nbsp;&nbsp; </span>
										<%if(quyen[0]!=0){ %>
															...
															<table border=0 cellpadding="0" cellspacing="0">
																<tr>
																	<td>
																		...
																		<a href="../../ErpDoiTuongKyQuyUpdateSvl?userid=<%=userId%>&update=<%=rsLSP.getString("PK_SEQ")%>"><img
																	...
																	<%if(quyen[1]!=0 && lspList.getChixem().equals("0") ){ %>
																		<a
																		href="../../ErpDoiTuongKyQuySvl?userid=<%=userId%>&delete=<%=rsLSP.getString("PK_SEQ")%>"><img
																	...
																	<td>
																		<!-- QUYEN VIEW DLN -->
																		<a href="../../ErpDoiTuongKyQuyUpdateSvl?userid=<%=userId%>&display=<%=rsLSP.getString("PK_SEQ")%>">
