				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán > Giảm giá hàng mua > Hiển thị</TD> 
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Thông tin giảm giá hàng mua</LEGEND>
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                        	...
                        	%>
						                    ...
						                    <table width="90%" align="center">
						                        ...
						                        <%
					                        		if(poRs != null)
					                        		{
					                        			...
					                        			<tr>
								                        	<td>
								                        		<input type="text" style="width: 100%; text-align: left;" value="<%= poRs.getString("sohoadon") %>" > 
								                        	</td>
								                        	<td>
								                        		<input type="text" style="width: 100%; text-align: left;" value="<%= poRs.getString("kyhieu")  %>" > 
								                        	</td>
								                        	<td>
								                        		<input type="text" style="width: 100%; text-align: center;" readonly="readonly" value="<%= poRs.getString("ngayxuatHD") %>" >
								                        	</td>
								                        	<td align="center">
								                        			<input type="checkbox" name="poIds" value="<%= poRs.getString("pk_seq") %>" checked="checked"  onclick="changePO(<%= poRs.getString("pk_seq") %>)" disabled>
								                        	</td>
								                        </tr>
								                        		<% } %>
			                  ...
			                  <TR  >
			                        ...
			                        <TD class="plainlabel" valign="middle" >
			                        	<input type="text" id="bvat"  name="bvat"  style="text-align:right;" value="111" readonly="readonly"  > 
			                        	<%= obj.getDVTiente() %>
			                        	<%System.out.println("Bvat....gfgfdg.."+obj.getBvat()); %>
			                        </TD>          
	                          		<TD class="plainlabel" valign="middle" width="120px" >VAT</TD>   
			                        <TD class="plainlabel" valign="middle"  >
			                   		<% if(obj.getTienteId().equals("100000")){ %>
			                        	<input type="text"  id="vat" name="vat" style="text-align:right;" value="<%= obj.getVat() %>"   readonly="readonly" > %
			                        <%}else{ %>
			                  		...
			                  		<table width="100%; " cellpadding="0" cellspacing="1"  >
			                  			...
			                  			<% if(idSanpham != null ) { for(int i = 0; i < idSanpham.length; i++ ) { %> 
			                  				...
			                  				<tr>
			                  					...
			                  					<td>
			                  						<input type="text" name="soluong" value="<%= soluong[i] %>" style="width: 100%; text-align: right; " readonly="readonly" >
			                  					</td>
			                  					<td>
			                  						<input type="text" name="dongia" value="<%= dongia[i] %>" style="width: 100%; text-align: right; " readonly="readonly" >
			                  					</td>
			                  					<td>
			                  					<% if(obj.getTienteId().equals("100000")){ %>			                  					
