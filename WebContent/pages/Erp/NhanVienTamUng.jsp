<%@page import="geso.traphaco.erp.beans.tamung.INhanvienList"%>
...
function xuatexcel()
{
	document.forms['nvtuForm'].action.value= 'excel';
	document.forms['nvtuForm'].submit();
	document.forms['nvtuForm'].action.value= '';
}
</SCRIPT>
							...
							<TR>
								<TD width="100%" align="left"><FIELDSET>
									...
									<TABLE class="tblight" width="100%" cellpadding="6" cellspacing = "0">
										...
										<TR>
											<TD  class="plainlabel" >Bộ phận / Chi nhánh</TD>
											<TD class="plainlabel" >
