...
// THANH TOÁN CHO HÓA ĐƠN NGOẠI TỆ + TRICH PHÍ VNĐ			
	...
	{    
	 ...
	 function ChangeNCT()
	 { 
		 var ngaychungtu = document.getElementById("ngayghinhan");
		  if(ngaychungtu.value!="")
			  {
			  //submit form để load lại số chứng từ
                ...
                <TR>
                 <TD width="20%" class="plainlabel" valign="top">Ngày chứng từ</TD>
                    ...
                    <TD class="plainlabel" colspan="2">
                        <input type="text" name="soChungTu" value="<%= tthdBean.getSoChungTu() %>" onKeyPress = "return validateSpecialCharacters(event);" onchange="upperLetters(this);" > </TD>  --%>
                    <TD class="plainlabel">Số chứng từ</TD>
                    <TD class="plainlabel">
			...
			<TR>
			  ...
			  <!-- KÊNH BÁN HÀNG  -->
				...
				<TD>
					...
					<%} else { %>
						<input type="text" name= "tienhang_VAT_<%=i %>" id= "tienhang_VAT_<%=i %>" value = "<%= Tienhanghd[i] %>" style="width: 100%;text-align: right" onkeyup= "javascript:tinhthue_loaikhac_new();" onKeyPress = "return keypress(event);">
					<%} %>
				</TD>
				...
				<TD>
					...
					<%} else { %>
						<input type="text" name= "thuesuat_VAT_<%=i %>"  id = "thuesuat_VAT_<%=i %>" value = "<%= Thuesuathd[i] %>" style="width: 100%;text-align: right" onkeyup= "javascript:tinhthue_loaikhac_new();" onKeyPress = "return keypress(event);">
					<%} %>
				</TD>
