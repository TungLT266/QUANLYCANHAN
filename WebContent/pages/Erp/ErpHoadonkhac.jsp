...
<%@ page import="geso.traphaco.erp.beans.hoadonkhac.IErpHoadonkhacList"%>
...
<%	
	IErpHoadonkhacList obj =(IErpHoadonkhacList)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../ErpHoadonkhacSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation"> Quản lý công nợ > Công nợ phải thu > Hóa đơn khác </TD>  
                            ...
                            <TR>
                             ...
                             <TR>
								...
								<TD class="plainlabel" colspan="3">
									<input  type="text" name="maHD" value="<%=obj.getMa()%>" size="20" onchange=submitform();>
								</TD>
								</TR>
    							...
    							{  
                                	IThongTinHienThi ht = htList.get(i);
    		                        	...
    		                        	<%} %>
                                                ...
                                                <TD align="center"> 
                                                <% if( tt.equals("0") ) { %>
							                   		<A href = "../../ErpHoadonkhacUpdateSvl?userId=<%=userId%>&update=<%= ht.getId() %>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" longdesc="Cập nhật" border = 0></A> &nbsp;
							                   		<A href = "../../ErpHoadonkhacSvl?userId=<%=userId%>&chot=<%= ht.getId() %>"><img src="../images/Chot.png" alt="Duyệt" width="20" height="20" longdesc="Duyệt" border=0 onclick="if(!confirm('Bạn Muốn Chốt Hóa Đơn Này?')) return false;"></A>&nbsp;
													<A href = "../../ErpHoadonkhacSvl?userId=<%=userId%>&delete=<%= ht.getId() %>"><img src="../images/Delete20.png" alt="Xóa" width="20" height="20" longdesc="Xóa" border=0 onclick="if(!confirm('Bạn Muốn Xóa Hóa Đơn Này?')) return false;"></A>
												...
												<% } else if(tt.equals("1") ) { %>
													<A href = "../../ErpHoadonkhacUpdateSvl?userId=<%=userId%>&display=<%= ht.getId() %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>&nbsp;
												<A href = "../../ErpHoadonkhacSvl?userId=<%=userId%>&unchot=<%= ht.getId() %>"><img src="../images/unChot.png" alt="Bỏ Chốt" width="20" height="20" longdesc=" Bỏ chốt" border=0 onclick="if(!confirm('Bạn Muốn Bỏ Chốt Hóa Đơn Này?')) return false;"></A>&nbsp;
											                	...
											                	if(hdLichSuIn.size() > 0)
											                	{
											                		for(int k =0; k < hdLichSuIn.size() ; k++)
											                		{
											                			...
											                			<tr>
											                				...
											                				<td>								                				
											                				<A href="../../ErpHoaDonkhacPdfSvl?userId=<%=userId%>&lsinId=<%= hdLichSu.getId() %>" >
											                				    &nbsp;&nbsp;	
