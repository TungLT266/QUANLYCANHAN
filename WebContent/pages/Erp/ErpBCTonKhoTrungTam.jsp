...
<head>
    ...
    <SCRIPT language="javascript" type="text/javascript">
	 ...
	 function sellectAll3()
	 {
		 ...
		 var spIds = document.getElementsByName("maspIds");
	 ...
	 function sellectAll4()
	 {
		 ...
		 var spIds = document.getElementsByName("maspCTIds");
...
<body>
<form name="erpDmhForm" method="post" action="../../ErpTonkhotrungtamSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Báo cáo > Tồn kho hiện tại
        </div>
            ...
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR style="display: none">
                        <TD class="plainlabel" width="15%">Ngày báo cáo </TD>
                        <TD class="plainlabel" >
                     ...
                     <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                            <select name="khoId" id="khoId" onchange="locsanpham();"  class="select2" style="width: 400px;" >
                            <option value=""></option>
                            	<%
	                        		if(khoRs != null)
	                        		{
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" valign="middle" >
                        	<select name = "lspIds"   id="lspIds" onchange="locsanpham()" class="select2" style="width: 600px" multiple="multiple" >
                            ...
                            <DIV id="subcontentCl" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
						                      background-color: white; width: 590px; max-height:100px; overflow:auto; padding: 4px;">
						                		...
						                		if(lspRs != null)
						                		{
						                			...
						                			<tr>
						                				...
						                				<% if(obj.getLoaiSanPhamIds().indexOf(lspRs.getString("pk_seq")) >= 0 ){ %>
						                					<input type="checkbox" name="lspIds" checked="checked" value="<%= lspRs.getString("pk_seq") %>">
						                				<%}else{ %>
						                					<input type="checkbox" name="lspIds" value="<%= lspRs.getString("pk_seq") %>">
						                				<%} %>
						                				</td>
						                			</tr>
                        ...
                        <TD class="plainlabel" valign="middle" >
                         ...
                         <%-- <a href="" id="spId" rel="subcontentSp">
	           	 		 ...
	           	 		 <DIV id="subcontentSp" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 790px; max-height:300px; overflow-y:scroll; padding: 4px;">
				                    <table width="90%" align="center">
				                        <tr>
				                            <th width="200px">Mã sản phẩm</th>
				                            <th width="450px">Tên sản phẩm</th>
				                            <th width="80px" align="center">Chọn hết <input type="checkbox" onchange="sellectAll()" id="chkAll" ></th>
				                        </tr>
		                            	<%
			                        		if(spRs != null)
			                        		{
                    ...
                    <tr>
                        ...
                        <tr>
                        <td class="plainlabel">Lấy kho tổng </td>
                        <td class="plainlabel">
                        	<input type="checkbox" name="khotong" value="1">
                         </td>
                    </tr>  
                    <tr style="display: none;" >
                        <td class="plainlabel">Xem theo lô hàng </td>
                        <td class="plainlabel">
                        	<% if(obj.getXemtheolo().equals("1")){ %>
                        		<input type="checkbox" name="xemtheolo" value="1" checked="checked">
                        	<%} else { %>
                        		<input type="checkbox" name="xemtheolo" value="1" checked="checked" >
                        	 <% } %>
                         </td>
