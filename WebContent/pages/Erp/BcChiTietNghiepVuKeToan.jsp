...
<%@page import="geso.traphaco.erp.beans.bangchitiettaikhoan.IBcchitietnghiepvuketoan"%>
...
<%
	...
	IBcchitietnghiepvuketoan obj = (IBcchitietnghiepvuketoan) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post" action="../../BcchitietnghiepvuketoanSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị > Công nợ > Báo cáo kế toán CT</div>
			...
			<div align="left"
				...
				<%} %>
								...
								<%-- <TR>	
									...
									<TD>
										<SELECT name = "nhomtkId" style="width: 200px" onChange="submitform();">
										<%	if(nhomtk != null){ 
												while(nhomtk.next()){ 
