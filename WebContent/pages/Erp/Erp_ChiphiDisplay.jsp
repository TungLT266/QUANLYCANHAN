				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kế toán &gt; Khoản mục chi phí &gt; Hiển thị</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><INPUT type="text" readonly name="ten" style="width:300px" value='<%= ncpBean.getTen()%>'></TD>
							</TR>
							<TR>
							  	<TD class="plainlabel">Diễn giải</TD>
						  	  	<TD class="plainlabel"><INPUT type="text" readonly name="diengiai" style="width:300px" value='<%= ncpBean.getDiengiai() %>'></TD>
						  </TR>
						  	<TR>
						   		<TD class="plainlabel">Đơn vị / Phòng ban thực hiện</TD>
						  	  	<TD class="plainlabel">
						  			<select disabled  name="dvttId"  style=" width: 250px">
						  					<option value=""  ></option>
						  				<%
						  	...
						  	<TR>
								...
								<TD class="plainlabel" >
									<TABLE cellpadding="0" cellspacing="0" border="0">
										<TR>
									  		<TD><select disabled  name="tkId"  style=" width: 250px">												
														<option value=""  ></option>												
											<% 	if(tklist != null){
												try{
													while (tklist.next()){%>
																
													<%	if(tklist.getString("MA").equals(ncpBean.getTkId())){ %>											
						  ...
						  <TR>
								...
								<TD class="plainlabel" >
									<TABLE cellpadding="0" cellspacing="0" border="0">
										<TR>
									  		<TD><select disabled  name="ttcpId" style=" width: 250px">												
														<option value=""  ></option>												
											<% 	try{
													while (ttcplist.next()){%>
