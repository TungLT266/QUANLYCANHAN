...
<html>
<head>
<title>Khai báo Phòng ban</title>
		...
		<td colspan="4" align='left' valign='top' bgcolor="#ffffff">
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr>
					...
					<tr height="22">
						<td align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Cơ bản &gt; Phòng ban &gt; Tạo mới
						</td>
			...
			<tr>
				...
				<TR>
						<TD class="plainlabel">Hoạt động</TD>
							<TD class="plainlabel">
								<input type="checkbox" name="trangthai" value="<%=dvthBean.getTrangThai()%>"  checked="checked"> 
							</td>
						</TR>
...
<%
	dvthBean.DBClose();
	session.removeAttribute("dvthBean");
}%>