...
//	{
//		if(chonddh.item(i).checked == true){ 
//			alert(i);
//			chon = 1;
//		}
//	}
		 
//	if(!pxkBean.getNdxId().equals("100007") ) {
//		if(chon == 0)
//		{
//			alert('Ban phai chon so don dat hang');
//			return;
//		}
//	} else {
	...
	if(!pxkBean.getNdxId().equals("100007")) {	
	 ...
	 if(document.getElementById("khoxuat").value == "")
	 {
		 alert('Ban phai chon kho xuat');
		 return;
	 }*/
...
function TinhTongSoLuongXuat()
{
		...
		for(var i = 0; i < sanpham.length; i++)
		{
			...
			if(sanpham.item(i).value != "")
			{
				...
				var khochitietId = document.getElementsByName(id + '.khochitietId');
				...
				{
					if(khochitietId.item(j).value != "" && soluong.item(j).value != "")
					{
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng > Nghiệp vụ khác > Phiếu xuất kho > Tạo mới
        </div>
    	...
    	<legend class="legendtitle"> Phiếu xuất kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = '0'>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" valign="top" colspan="3">
                    	<input type="text"  class="days" id="ngayxuatkho" name="ngayxuatkho" value="<%= pxkBean.getNgayxuatkho() %>" maxlength="10" readonly />
                    	<input type="hidden"   id="ngayhoadon" name="ngayhoadon" value="<%= pxkBean.getNgayhoadon()%>"/>
                    </TD>
                </TR> 
                <TR style="display: none">
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                        <select name="noidungxuat" id="noidungxuat" onChange="changeNdx();" style="width: 400px;" >
                        	<option value=""> </option>
                        	<%
                        		if(ndxList != null)
                        		{
			    ...
			    <TR>
                    ...
                    <TD class="plainlabel" >
                        <select name="hdtcId" id="hdtcId" onchange="changeform()" style="width: 400px;" >
                        	<option value=""> </option>
                        	<%
                        		if(hdtcList != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                        <select name="nccId" id="nccId" onchange="LocChungTu()" style="width: 400px;" >
                        	<option value=""> </option>
                        	<%
                        		if(nccList != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                        <select name="trahangId" id="trahangId" onchange="changeform()" style="width: 400px;" >
                        	<option value=""> </option>
                        	<%
                        		if(trahangList != null)
                        		{
                ...
                <tr>
                    ...
                    <td class="plainlabel" colspan="3" >
                    	<select name="khoxuat" id="khoxuat" onChange="changeform();" style="width: 400px;" >
                        	<option value=""> </option>
                        	<%
                        		if(khoList != null)
                        		{
                	...
                	for(int i = 0; i < spList.size(); i++)
                	{
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td>
           	 				  <input type="text" style="width: 100%; text-align: right;" value="<%= DinhDang.dinhdangso(Double.parseDouble(sp.getSoluongDaXuat())) %>" name= "soluongdaxuat" readonly="readonly" >
           	 				</td>
           	 				
           	 				<td>
           	 				  <input type="text" style="width: 100%; text-align: right;" value="<%= DinhDang.dinhdangso(Double.parseDouble(sp.getSoluong())) %>" name= "soluong" readonly="readonly" >
           	 				</td>
           	 				<td align="right">
	           	 				...
	           	 				<DIV id="subcontent<%= i %>" style=" position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; max-height:300px;overflow:auto ; width:1080px; padding: 2px;">
				                        		...
				                        		%>
				                        			<tr>
							                            ...
							                            <td>
							                             ...
							                             <td>
							                            	<input type="text" size="50px"  name="<%= sp.getId() + ".soluong" %>" value="<%= DinhDang.dinhdangso(Double.parseDouble(spDetail.getSoluong().replace(",",""))) %>"  
...
<% 
	...
	//if(nppList2 != null) nppList2.close();
