...
<body>
<form name="erpCngn" method="post" action="../../ErpCapnhatgnkUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:70%; padding:5px; float:left" class="tbnavigation">
        	&#160; Quản lý cung ứng > Quản lý tồn kho > Cập nhật giá nhập kho > Tạo mới
        </div>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR>
                     ...
                     <TR>
                        ...
                        <TD class="plainlabel" >
                            <input type="text" class="days" 
                                   id="denngay" name="denngay" value="<%= obj.getDenngay() %>" onchange="submitform()" maxlength="10" />
                        </TD>
                    </TR>
                    <TR>
                    ...
                    <TR>
                        <TD class="plainlabel" valign="middle" >Chọn phiếu nhập kho </TD>
                        <TD class="plainlabel" valign="middle" >
                         
                         <a href="" id="pnkId" rel="subcontentPnk">
	           	 							&nbsp; <img alt="Chọn phiếu nhập kho" src="../images/vitriluu.png"></a>
	           	 		
                          <DIV id="subcontentPnk" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width: 490px; max-height:300px; overflow:auto; padding: 4px;">
				                    <table width="90%" align="center" cellpadding="0px" cellspacing="1px">
				                        <tr>
				                            <th width="100px">Số phiếu</th>
				                            <th width="100px">Ngày nhập</th>
				                            <th width="100px">Ngày chốt NV</th>
		                            	...
		                            	<%
			                        		if(pnkRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				<td><input style="width: 100%" value="<%= pnkRs.getString("sonhapkho") %>"></td>
			                        				<td><input style="width: 100%" value="<%= pnkRs.getString("ngaynhapkho") %>"></td>
			                        				<td><input style="width: 100%" value="<%= pnkRs.getString("ngaychot") %>"></td>
			                        				<td align="center">
			                        				<% if(obj.getPnkIds().indexOf(pnkRs.getString("nkId")) >= 0 ){ %>
			                        					<input type="checkbox" name="pnkIds" checked="checked" value="<%= pnkRs.getString("nkId") %>">
			                        				<%}else{ %>
			                        					<input type="checkbox" name="pnkIds" value="<%= pnkRs.getString("nkId") %>">
			                        				<%} %>
			                        				</td>
			                        			</tr>
				                     ...
				                     <div align="right">
				                     	...
				                     	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                     	<a href="javascript:dropdowncontent.hidediv('subcontentPnk')" onclick="submitform()">Hoàn tất</a>
				                     </div>
				            </DIV>                        
                        </TD>                        
                    </TR> 
                    ...
                    <TABLE width="100%" cellpadding="0px" cellspacing="1px">
                    	<tr class="tbheader">
                    		...
                    		<th style="width: 10%"> Ngày chốt NV</th>
                    	...
                    	<tr>
                    		...
                    		<td>
                    			<input type="text" name="ngaynhap" style="width: 100%" value="<%= sp.getNgaynhap() %>" readonly="readonly" >
                    		</td>
                    		<td>
                    			<input type="text" name="ngaynhap" style="width: 100%" value="<%= sp.getNgaychot() %>" readonly="readonly" >
                    		</td>
                    		<td>
                    			<input type="hidden" name="idsanpham" style="width: 100%" value="<%= sp.getSpId() %>" >
                    			<input type="text" name="masanpham" style="width: 100%" value="<%= sp.getSpMa() %>" readonly="readonly" >
                    		</td>
                    		<td>
                    			<input type="text" name="tensanpham" style="width: 100%" value="<%= sp.getSpTen() %>" readonly="readonly">
                    		</td>
                    		<td>
                    			<input type="text" name="soluong" style="width: 100%; text-align: right;" value="<%= sp.getSoluong() %>" readonly="readonly" >
                    		</td>
                    		<td>
                    			<input type="text" name="gianhap" style="width: 100%; text-align: right;" value="<%= sp.getGiaOld() %>" readonly="readonly">
                    		</td>
                    		<td>
