...
<%
 	IErpLenhmuahangdk obj =(IErpLenhmuahangdk)session.getAttribute("lmhBean");
...
<form name ="khtt" method="post" action="../../ErpLenhmuahangdukienUpdateSvl" >
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý cung ứng > Lập kế hoạch > Đề nghị mua nguyên liệu > Cập nhật </TD> 
			...
			<TABLE width="100%" border="0" cellpadding="3" cellspacing="0">
				<TR>
					<TD>
						<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							<TR class="tbdarkrow">
								<TD width="30" align="left"><A href="../../ErpLenhmuahangdukienSvl?userId=<%= userId %>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve"
										border="1" longdesc="Quay ve" style="border-style: outset"></A></TD>
								<TD width="2" align="left"></TD>
								<TD width="30" align="left"><A href="javascript: save()"><IMG src="../images/Save30.png" title="Luu lai" alt="Luu lai"
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
				...
				<TR>
				  <TD height="100%" width="100%">
						<FIELDSET >
						<LEGEND class="legendtitle" style="color:black">Đề nghị mua nguyên liệu </LEGEND>
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						 <TR>		                  
		                  ...
		                  <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle" style="display: none;"  >Đơn vị </TD>   
						 ...
						 <TR style="display: none;" >
		                        ...
		                        <TD class="plainlabel" valign="middle" colspan = 3>
		                        	<input type="text" name="tensp" value="<%= obj.getTensp() %>" readonly="readonly" style="width:500px"> 
		                        </TD>                
						 </TR>
						 ...
						 <TR>
                          ...
                          <TR>
		                        <TD class="plainlabel" valign="middle" width="150px" >Tháng-Năm</TD>
		                        <TD class="plainlabel" valign="middle" colspan="3" >
									<input type="text" name="ngay" value="<%= obj.getNgay() %>" style="width:100px" readonly = "readonly">		                        
		                        </TD>                        
		                  </TR> 
...
<% 
session.setAttribute("lmhBean", null) ; obj.DbClose();
