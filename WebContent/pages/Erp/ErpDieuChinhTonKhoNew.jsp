...
<%@page import="geso.traphaco.erp.beans.yeucauchuyenkho.IErpDieuchinhtonkho"%>
...
<% IErpDieuchinhtonkho lsxBean = (IErpDieuchinhtonkho)session.getAttribute("ckBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpDieuchinhtonkhoUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Điều chỉnh tồn kho > <%= ( lsxBean.getId().length() >0 ? "Cập nhật" : "Tạo mới" ) %> 
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDieuchinhtonkhoSvl?userId=<%= userId %>&goBack" >
    ...
    <fieldset>
    	<legend class="legendtitle">Điều chỉnh tồn kho </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    <TD class="plainlabel" >Vị trí điều chỉnh </TD>
						...
						<td align='center' > 
							...
							<% if( soluongyeucau >= 0 && lsxBean.getKhoXuatId().trim().length() > 0  ) { %>
								<a href="" id="scheme_<%= yeucau.getMa() + "__ "  %>" rel="subcontent_<%= yeucau.getMa() + "__ " %>">
	           	 		 		...
	           	 		 		<DIV id="subcontent_<%= yeucau.getMa() + "__ " %>" style="position:absolute;z-index:999; visibility: hidden; border: 9px solid #80CB9B;
				                             background-color: white; width:90%; max-height:200px;  overflow-x:scroll ; overflow-y: scroll; padding: 4px; float: left;">
				                    <table width="100%" align="center">
				                        ...
				                        <tr>
				                            <th width="65px" style="font-size: 10px" rowspan="2" >Tồn mới</th>
				                            <th width="65px" style="font-size: 10px" rowspan="2" >Tồn kho NXT</th>
				                            <th width="120px" style="font-size: 10px; text-align: center;" colspan="3" >Tồn hiện tại</th>
				                         	<th width="100px" style="font-size: 10px" rowspan="2" >Số lô</th>
				                            <th width="70px" style="font-size: 10px" rowspan="2" >Ngày HH</th>
				                            <th width="70px" style="font-size: 10px" rowspan="2" >Ngày NK</th>
				                            <th width="25px" style="font-size: 10px" rowspan="2" >Mẻ</th>
				                            <th width="25px" style="font-size: 10px" rowspan="2" >Thùng</th>
				                            <th width="100px" style="font-size: 10px" rowspan="2" >Vị trí</th>
				                            <th width="100px" style="font-size: 10px" rowspan="2" >Mã phiếu</th>
				                            <th width="70px" style="font-size: 10px" rowspan="2" >Phiếu ĐT</th>
				                            <th width="50px" style="font-size: 10px" rowspan="2" >Phiếu EO</th>
				                            <th width="70px" style="font-size: 10px" rowspan="2" >Marquette</th>
				                            <th width="25px" style="font-size: 10px" rowspan="2" >Hàm lượng</th>
				                            <th width="25px" style="font-size: 10px" rowspan="2" >Hàm ẩm</th>
				                             <th width="100px" style="font-size: 10px">NSX</th>
				                        </tr>
				                        <tr>
				                        	<th width="40px" style="font-size: 10px">Số lượng</th>
				                        	<th width="40px" style="font-size: 10px">Booked</th>
				                        	<th width="40px" style="font-size: 10px">Available</th>
				                        </tr>
		                            	<%
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			...
			                        			while(spRs.next())
			                        			{
			                        				...
			                        				String key = yeucau.getMa() + "__ " + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN") + "__" + spRs.getString("NGAYNHAPKHO")  
			                        													...
			                        													+ "__" + spRs.getString("MARQ") + "__" + spRs.getString("HAMLUONG") + "__" + spRs.getString("HAMAM")+ "__" + (spRs.getString("NSX_FK")==null?"":spRs.getString("NSX_FK")) + "__" + spRs.getString("NSX");
			                        			...
			                        			<tr>
			                        				...
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spTONKHO" value="<%= formater.format(spRs.getDouble("SOLUONG")) %>" readonly="readonly">
			                        				</td>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONGHT" value="<%= formater.format(spRs.getDouble("SOLUONGHT")) %>" readonly="readonly">
			                        				</td>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spBOOKEDHT" value="<%= formater.format(spRs.getDouble("BOOKED")) %>" readonly="readonly">
			                        				</td>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spAVAIHT" value="<%= formater.format(spRs.getDouble("AVAILABLE")) %>" readonly="readonly">
			                        				</td>
			                        				<td>
			                        				...
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: center;font-size: 12px" name="<%= temID %>_spNSX" value="<%= spRs.getString("NSX") %>" readonly="readonly">
			                        					<input type="hidden" style="width: 100%;text-align: center;font-size: 12px" name="<%= temID %>_spNSXID" value="<%= spRs.getString("NSX_FK")==null?"":spRs.getString("NSX_FK") %>" readonly="readonly">
			                        				</td>
			                        			</tr>
