		...
		<td colspan="4" align='left' valign='top' bgcolor="#ffffff">
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr>
					...
					<tr height="22">
						<td align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý ngân sách &gt; Khởi tạo ngân sách > Tạo mới
						</td>
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1">
				<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr class = "tbdarkrow">
						<td width="30" align="left"> <a href="../../KhoitaongansachSvl" > <img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"> </a></td>
					...
					<TD align="left" colspan="4" class="legendtitle">
						<FIELDSET>
							...
							<TABLE  width="100%" cellspacing="0" cellpadding="6">
								...
								<tr>
					  				<td class="plainlabel">Năm </td> <td class="plainlabel"> <input type = "text" name = "nam" value="<%=nsList.getNamNew() %>" readonly=readonly ></td>
								</tr>
