<%@page import="geso.traphaco.erp.beans.thongtinsanphamgiay.imp.MayMoc_SanPham"%>
...
function replacesTSCD()
{
	...
	for(i = 0; i < sodong; i++)
	{
		...
		var idhc = document.getElementsByName("PK_SEQHC");
		...
		for(i = 0; i < soDongHoaChat; i++)
		{
			...
			{ 
				...
				if(pos > 0)
				{
					...
					hc = hc.substr(parseInt(hc.indexOf("] [")) + 3);
					idhc.item(i).value = hc.substring(0, parseInt(hc.indexOf("]")));
				}
						...
						<TR>
							<TD align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Kho vận > Sản phẩm > Hiển thị
							...
							<TD>
												...
												<TABLE border="0" width="100%" cellpadding="4" cellspacing="0">
													...
													<TR >
														...
														<TD  class="plainlabel">
															...
															<select name="loaisp" id="loaisp" style="width:200px" >
																<%
																	try
																		{
																			while (loaisp.next())
														...
														<%}%>
															<input type = "hidden" name = "loaispma" value="<%=spBean.getLoaiSpMa()%>">
														</TD>
														...
														<TD class="plainlabel">
															<a href="" id="thongtinhosolo" rel="subcontent_hosolo">
								           	 				...
								           	 				<DIV id="subcontent_hosolo" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 700px; max-height:200px; overflow:auto; padding: 4px;">
											                        ...
											                        <tr>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="ycnlsx" value="<%=spBean.getYcnlsx() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="motasp" value="<%=spBean.getMotaSp() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="yeucaudonggoi" value="<%=spBean.getYeucaudonggoi() %>"></td>
											                        	<td>
																			<select disabled="disabled" style="width:130px" name="thietbicanid" id="thietbicanid">
																				<option value=""></option>
																				<%if(tscdRs != null){
																					tscdRs.beforeFirst();
																					while(tscdRs.next()){
																		...
																		<td>
																			<select disabled="disabled" style="width:130px" name="thietbicankhacid" id="thietbicankhacid">
																				<option value=""></option>
																				<%if(tscdRs != null){
																					tscdRs.beforeFirst();
																					while(tscdRs.next()){
														...
														<TD class="plainlabel">
															<a href="" id="thongtinhosokiemnghiem" rel="subcontent_hosokiemnghiem">
								           	 				...
								           	 				<DIV id="subcontent_hosokiemnghiem" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 500px; max-height:200px; overflow:auto; padding: 4px;">
											                        ...
											                        <tr>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="dactinhkythuat" value="<%=spBean.getDactinhkythuat() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="congthuchoahoc" value="<%=spBean.getCongthuchoahoc() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="nhomluutru" value="<%=spBean.getNhomluutru() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="mucdonguyhiem" value="<%=spBean.getMucdonguyhiem() %>"></td>
											                        	<td><input readonly="readonly" type="text" style="width: 100%;" name="khuvucbaoquan" value="<%=spBean.getKhuvucbaoquan() %>"></td>
											                        </tr>
								           	 					</table>
														...
														<TD class="plainlabel" colspan="2">
															<div <%=spBean.getThuocloaisp().equals("2") ? "" : "style=\"display: none;\"" %>>
																<%if(spBean.getKhongqlsl().equals("1")){ %>
									                            	<input type="checkbox" name="khongqlsl" id="khongqlsl" value="1" checked disabled="disabled"> Không quản lý số lượng
									                            <%} else { %>
									                            	<input type="checkbox" name="khongqlsl" id="khongqlsl" value="1" disabled="disabled"> Không quản lý số lượng
									                            <%} %>
								                            </div>
														</TD>
													</TR>
						     ...
						     <!-- CÒN NẾU LOẠI SP LÀ CCDC THÌ CÓ NHỮNG CÁI NÀY -->
														...
														<TD class="plainlabel">
													  	...
													  	<TR>
													  	<TD class="plainlabel">Thuế suất</TD>
														<TD class="plainlabel" align="left" colspan="5"><input name="thueSuat" type="text" size="10"
													...
													<TR>
														...
														<div id="tabContaier">
																...
																<% } %>
																	...
																	<div class="titleTab" <%=spBean.getKhongqlsl().equals("1") ? "style=\"display: none;\"" : "" %> id="chonkho1"><a  class="active" href="#tab_6">Chọn kho</a></div>
																																 
																<div class="titleTab"><a  class="active" href="#tab_3">Quy cách</a></div>
																
																<% if(spBean.getKiemTraDinhLuong().equals("1")) { %>
																	 
																	<div class="titleTab"><a  class="active" href="#tab_4">Kiểm định định lượng</a></div>
																<% } %>
																
																<% if(spBean.getKiemTraDinhTinh().equals("1")) { %>
																	 
																	<div class="titleTab"><a  class="active" href="#tab_5">Kiểm định định tính</a></div>
																<% } %>
																	...
																	<%for(int i = 0; i < ThongtinNCCList.size(); i++){	
													 				...
													 				%>
																		<TR class= 'tblightrow' style="height:30px">
											  								<TD align="center">
											  									<select name="nhacungcap" id = "<%="nhacungcap" + i %>" style="width:100%;height:22" >
											  										<option value=""> </option>
											  										<%	
											  										String ma = "";
											  								...
											  								<TD align="left">
											  									<INPUT type="file" name="<%="filehinhcb" + i%>" title="<%=chuthich %>" style="width: 70px;" value='<%=fh %>' >
																		...
																		<% if(spBean.getKiemTraDinhTinh().equals("1") ) { %>
																			...
																			<TABLE border="0" width="100%" cellpadding="0" cellspacing="1">
											  								...
											  								<TD align="center"><!-- Hóa chất kiểm định của nhà cung cấp-->
											  									<a href="" id="<%=ncc%>hdkd_ncc" rel="hckd_ncc_subcontent<%=ncc%>">
										           	 								...
										           	 								<DIV id="hckd_ncc_subcontent<%=ncc%>"  style=" position:absolute; visibility: hidden; border: 9px solid #80CB9B;
				                             											background-color: white; max-height:600px;overflow:auto ; width: 600px; padding: 4px;" >
											  										
											  											<% if(spBean.getKiemTraDinhTinh().equals("1") || spBean.getKiemTraDinhLuong().equals("1")) { %>
											  												<p>Khai báo hóa chất dùng trong kiểm định</p>
											  												<TABLE style="width: 40%" cellpadding="0px" cellspacing="1px" align="center">
											  													<TR>
																								...
																								%>	
																									<Td style="width: 2%">
																											<input type="number" style="width: 95%" name="soLuongChuan<%=ncc%>" min="0" value="<%= soLuongChuan %>" align="center" readonly="readonly" > 
																									</Td>
																									<Td style="width: 2%">
																											<input type="text" style="width: 95%" name="donViChuan<%=ncc%>" value="<%= tenDonViDoLuong %>" align="center" readonly="readonly">
											  												...
											  												<TABLE border="0" style="width: 100%" cellpadding="1px" cellspacing="1px" align="center">
																								...
																								%>
																									<TR>
																										...
																										<Td>
																											<input type="text"  name="maHoaChat<%=ncc%>" style="width: 100%" value="<%= elementHoaChat.getMaHoaChatKiemDinh() %>"  readonly="readonly" AUTOCOMPLETE="off" > 
																										</Td>
																										<Td>
																											<input type="text"  name="tenHoaChat<%=ncc%>" style="width: 100%" value="<%= elementHoaChat.getTenHoaChatKiemDinh() %>" readonly="readonly" > 
																										</Td>
																										<Td>
																											<input type="number"  name="soLuongChatKiemDinh<%=ncc%>" style="width: 100%" value="<%= elementHoaChat.getSoLuongChatKiemDinh() %>" align="center" readonly="readonly"> 
																										</Td>
																										<Td>
																								...
																								<% } %>	
											  													<% for(int dem = countHoaChat; dem < 15; dem++) { %>
											  														<TR>
																										...
																										<Td>
																											<input type="text"  name="maHoaChat<%=ncc%>" style="width: 100%" value="" readonly="readonly" > 
																										</Td>
																										<Td>
																											<input type="text"  name="tenHoaChat<%=ncc%>" style="width: 100%" value="" readonly="readonly" > 
																										</Td>
																										<Td>
																											<input type="number"  name="soLuongChatKiemDinh<%=ncc%>" style="width: 100%" value="" align="center" min="0" readonly="readonly"> 
																										</Td>
																										<Td>
													  													...
													  													<% } %>
											  												</TABLE><!-- Kết thúc bahóa chất kiểm định của nhà cung cấp-->
					                             											...
					                             											<TABLE border="0" style="width: 100%" cellpadding="1px" cellspacing="1px" align="center">
																								...
																								%> 
																									<TR>
																										...
																										<Td>
																											<input type="text"  name="maMayMoc<%=ncc%>" style="width: 100%" value="<%= elementMayMoc.getMayMocKiemDinh().getMa() %>" readonly="readonly"> 
																										</Td>
																										<Td>
																								...
																								<% for(int dem = countMayMoc; dem < 15; dem++ ) { %>
																									<TR>
																										...
																										<Td>
																											<input type="text"  name="maMayMoc<%=ncc%>" style="width: 100%" value=""  readonly="readonly" > 
																										</Td>
																										<Td>
											  								...
											  								</TD><!-- Máy móc kiểm định --> 
																	  	</TR><!-- Ket thuc 1 dong thong tin ncc -->
																	<% } %>
	                               ...
	                               <%	  	}%>
									...
									<%		i++;
																...
																<div id="tab_7" class="tabContents" style="display:none" >
																	...
																	<TABLE style="width: 35%" cellpadding="0px" cellspacing="1px" align="center">
																		<TR>
																			<TD style="width: 1%"><strong>Số lượng chuẩn</strong></TD>
																		<%
																		...
																		%>	
																			<Td style="width: 1%">
																					<input type="number" style="width: 95%" name="soLuongChuan" min="0" value="<%= soLuongChuan %>" align="center" readonly="readonly" > 
																			</Td>
																			<Td style="width: 1%">
																	...
																	<TABLE border="0" style="width: 65%" cellpadding="1px" cellspacing="1px" align="center">
																		...
																		%>
																			<TR>
																				...
																				<Td>
																					<input type="text"  name="maHoaChat" style="width: 100%" value="<%= elementHoaChat.getMaHoaChatKiemDinh() %>"  readonly="readonly" AUTOCOMPLETE="off" > 
																				</Td>
																				<Td>
																					<input type="text"  name="tenHoaChat" style="width: 100%" value="<%= elementHoaChat.getTenHoaChatKiemDinh() %>" readonly="readonly" > 
																				</Td>
																				<Td>
																					<input type="number"  name="soChatKiemDinh" style="width: 100%" value="<%= elementHoaChat.getSoLuongChatKiemDinh() %>" align="center" readonly="readonly"> 
																				</Td>
																				<Td>
																		...
																		<% for(i = countHoaChat; i < 15; i++) { %>
																			<TR>
																				...
																				<Td>
																					<input type="text"  name="maHoaChat" style="width: 100%" value="" readonly="readonly" > 
																				</Td>
																				<Td>
																					<input type="text"  name="tenHoaChat" style="width: 100%" value="" readonly="readonly" > 
																				</Td>
																				<Td>
																					<input type="number"  name="soChatKiemDinh" style="width: 100%" value="" align="center" min="0" readonly="readonly"> 
																				</Td>
																				<Td>
																	...
																	<TABLE border="0" style="width: 65%" cellpadding="1px" cellspacing="1px" align="center">
																		...
																		%> 
																				<TR>
																					...
																					<Td>
																						<input type="text"  name="maMayMoc" style="width: 100%" value="<%= elementMayMoc.getMayMocKiemDinh().getMa() %>" readonly="readonly"> 
																					</Td>
																					<Td>
																		...
																		<% for(i = countMayMoc; i <= 15; i++ ) { %>
																			...
																			<TR>
																				...
																				<Td>
																					<input type="text"  name="maMayMoc" style="width: 100%" value=""  readonly="readonly" > 
																				</Td>
																				<Td>
