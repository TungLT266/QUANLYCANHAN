...
function replaces()
{
	var manpp = document.getElementById("nppId");
	if( manpp.value.indexOf(" -- ") > 0 )
	{
		var str = manpp.value;
		manpp.value = str.substring(0, manpp.value.indexOf(" -- "));
		document.getElementById("nppTen").value =str.substring(str.indexOf(" -- ") + 4);
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Phiếu xuất kho > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = '0'>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                        <select name="noidungxuat" id="noidungxuat" onChange="changeNdx();" style="width: 200px;" >
                        	<option value=""> </option>
                        	<%
                        		if(ndxList != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                        <select name="trahangId" id="trahangId" onchange="changeform()" style="width: 200px;" >
                        	<option value=""> </option>
                        	<%
                        		if(trahangList != null)
                        		{
                ...
                <tr>
                    ...
                    <td class="plainlabel" colspan="3" >
                    	<select name="khoxuat" id="khoxuat" onChange="changeform();" style="width: 200px;" >
                        	<option value=""> </option>
                        	<%
                        		if(khoList != null)
                        		{
				                        	...
				                        	if(spDetailList.size() > 0)
				                        	{
				                        		...
				                        		%>
				                        			<tr>
							                            ...
							                            <%} %>
							                            <td>
							                            <input type="hidden" size="100px" name="<%= sp.getId() + ".ngaybatdau" %>" value="<%= spDetail.getNgaybatdau() %>" readonly="readonly" />
							                            ...
							                            <td>
							                             ...
							                             <td>
							                            	<input type="text" size="50px"  name="<%= sp.getId() + ".soluong" %>" value="<%= spDetail.getSoluong() %>"  onKeyPress = "return keypress(event);" readonly/></td>
							                        </tr>
				                        		<%}
				                        	}
				                        %>
