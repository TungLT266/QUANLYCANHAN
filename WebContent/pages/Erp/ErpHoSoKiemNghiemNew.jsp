...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	IHoSoKiemNghiem obj=(IHoSoKiemNghiem)session.getAttribute("obj");
...
<script type="text/javascript">
	...
	function submitformloaimau() {
		document.forms["hstnForm"].action.value = "submitloaimau";
		document.forms["hstnForm"].submit();
	}
	function taomoi() {
		document.forms["hstnForm"].action.value = "taomoi";
		document.forms["hstnForm"].submit();
	}
</script>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Hồ
											Sơ Thử Nghiệm > Chức Năng > Hồ Sơ Kiểm Nghiệm > Tạo mới</TD>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR>
											...
											<TD class="plainlabel" valign="middle" width="15%">Loại
												Mẫu Kiểm Nghiệm</TD>
											<TD class="plainlabel" valign="middle">
											<select name="loaimaukiemnghiem" id="loaimaukiemnghiem"
												class="select2"  onChange="submitformloaimau()" style="width: 200px">
													<option></option>
													<%
														if (RsLMKN != null) {
																while (RsLMKN.next()) {
														...
														<table width="100%" cellpadding="4" cellspacing="2">
															...
															<tr>
																...
																<td><input style="width: 150px" type="text"
																	 name="thoigianbatdau" readonly="readonly"
																	value="<%=ct.getThoiGianBD()%>"></td>
																<td><input style="width: 150px" type="text"
																	 name="thoigianketthuc" readonly="readonly"
																	value="<%=ct.getThoiGianKT()%>"></td>
																<td><input style="width: 150px" type="text" readonly="readonly"
																	name="thoiluongtn" value="<%=ct.getThoiLuong()%>"></td>
																<td><input style="width: 100px" type="text" readonly="readonly"
												...
												<div id="tab_2" class="tabContents" style="display: none">
													<table width="100%" cellpadding="0" cellspacing="2">
														...
														<tr>
															...
															<td align="center"><input type="text" 
																name="ngaydanhgia" class="days" readonly="readonly" /></td>
															<td align="center"><input type="text" 
																name="ngaykiemdinh" class="days" readonly="readonly"/></td>
