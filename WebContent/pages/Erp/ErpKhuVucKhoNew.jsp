...
<script type="text/javascript">
	function Save() {
		...
		if(msg.value==''){
		document.forms['cdForm'].action.value = 'Create';
						...
						<tr>
							<td align="left" class="tbnavigation">
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kho vận &gt; Định khu vực &gt; Tạo mới</TD>
						...
						<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<fieldset>
									...
									<TABLE width="100%" cellspacing="0" cellpadding="6">
											<tr>
														<td class="plainlabel">Mã khuc vực <font class="erroralert">*</font></td>
