...
function inExcel()
{
 ...
 <script type="text/javascript">
	...
	{    
	 ...
	 function readExcel()
	 {
		 document.forms['bgnlForm'].action.value='readExcel';
		 document.forms['bgnlForm'].setAttribute('enctype', "multipart/form-data", 0);
	     document.forms['bgnlForm'].submit();
	 }
 </script>
...
<input type="hidden" name="id" value='<%= bgnlBean.getId() %>'>
	...
	<TR>
		<TD colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						   <tr height="22">
 							   <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý ngân sách &gt; Bảng giá nguyên liệu &gt; Cập nhật</TD>
			...
			<TR ><TD >
				<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
					<TR class = "tbdarkrow">
						<TD width="30" align="left"><A href="../../ErpLNSBanggianguyenlieuSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay về"  title="Quay về" border="1" longdesc="Quay về" style="border-style:outset"></A></TD>
				    	...
				    	<TD width="2" align="left" >&nbsp;</TD>
				    	<TD width="30" height="30" align="left" ><A href="javascript: inExcel()" ><IMG src="../images/excel.gif" title="Xuất ra Excel" alt="Xuất ra Excel" border = "1"  style="border-style:outset" width="30" height="30"></A></TD>
...
<% 
			bgnlBean.closeDB();  
			session.setAttribute("bgnlBean", null) ; 
