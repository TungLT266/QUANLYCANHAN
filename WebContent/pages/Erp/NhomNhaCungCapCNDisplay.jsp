				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Kinh doanh &gt; Nhóm nhà cung cấp &gt; Hiển thị</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
							  	<TD class="plainlabel">Diễn giải</TD>
						  	  	<TD class="plainlabel"><INPUT type="text" name="diengiai" style="width:400px" value='<%= nNccBean.getDiengiai() %>' readonly='readonly'></TD>
						  </TR>
							  ...
							  <TD colspan="2" class="plainlabel" ><label>
							  	<% if(nNccBean.getTrangthai().equals("1")){ %>
							    	<input name="trangthai" type="checkbox" value="1" checked  disabled readonly>
							    <%}else{ %>
							    	<input name="trangthai" type="checkbox" value="0"disabled readonly >
							    <%} %>
							   Hoạt động</label></TD>
						  </TR>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">							
								<TR class="tbheader">
									...
									<TH width="12%">Chọn
										<input type="checkbox" name="chon" onClick="checkedAll(document.nkhForm.khachhang)" disabled readonly>								
								...
								<% ResultSet rs = null;
								   ...
								   if (!(rs == null)){			
										...
										<%  } %>	
												...
												<TD align="center">
													<input type="checkbox" name="ncc" value='<%= rs.getString("pk_seq") %> ' checked disabled readonly>									
												</TD>
									...
									if (!(rs == null)){													    
										...
										<%  } %>	
												...
												<TD align="center"><div align="left"><%= rs.getString("ten")%></div></TD>
												<TD align="center">
													<input type="checkbox" name="ncc" value='<%= rs.getString("pk_seq") %> 'disabled readonly>									
												</TD>
