		...
		if(ngoaite !== null){
			...
			for(i=0; i<ngoaite.length; i++){
				if( ngoaite[i].value.trim().length > 0){
					...
					console.log("ngoại tệ :"+ tongnguyente);
					// tính tổng vnd
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán &gt; Debit note  &gt; Hiển thị </TD> 
						...
						<table cellpadding="0px" cellspacing="1px" width="100%">
							...
							<% for(int i=0; i< TaiKhoans.size(); i++){ %>
							 <% if (i % 2 != 0) { %>                     
								...
								<td align="center">
									<input type="text" name="nonguyente" style="width: 100px;" 
										 onkeypress="return isNumberKey2(event)" onchange="TongTien(this);" 
										value="<%= formatter.format( NoNguyenTes.get(i))%>"/>
								</td>
