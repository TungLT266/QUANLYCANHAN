				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền > Mua hàng > Bảng giá mua NCC > Cập nhật</TD> 
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
                          <TR>
		                        ...
		                        <TD class="plainlabel" valign="middle"  ><input type="text" name="ten" value="<%= obj.getTen() %>" readonly="readonly" >  </TD>          
				                  			...
				                  			<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
												...
												<% for(int i = 0; i < spList.size(); i++ ) { 
													...
													<TR>
														...
														<TD>
															<input type="text" style="width: 100%; text-align: right;" name="giaban"  onkeyup="Dinhdang(this)"  value="<%= sanpham.getGiaban() %>"   >
														</TD>
														<TD>
