...
function search()
{
	document.forms["TTDTForm"].action.value = "search";
    document.forms["TTDTForm"].submit();
}
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation"> Dữ liệu nền  &gt; Kế toán  &gt; Nhóm tài khoản &gt; Tạo mới</TD> 
									...
									<div class="panes">
										...
										<div>
											<TABLE style="width: 95%" cellpadding="4px" cellspacing="1px" align="center">
												<TR><TD class= "legendtitle" >Chọn tài khoản kế toán</TD>
													<TD class= "legendtitle" >Tìm kiếm
														<INPUT TYPE = "text" NAME = "timkiem" VALUE = "<%= TTDTBean.getTimkiem() %>" onChange="search();">
													</TD>
													<TD width = "50%">&nbsp;</TD>
												</TR>
											</TABLE>
											...
											<TABLE style="width: 95%" cellpadding="4px" cellspacing="1px" align="center">
												...
												ResultSet khoanmucCP_Rs = TTDTBean.getChophanbothem(TTDTBean.getId());
												
												if(khoanmucCP_Rs != null){
													int stt = 0;
													while(khoanmucCP_Rs.next())
													{
														if(TTDTBean.getKhoanmucCPIds().contains(khoanmucCP_Rs.getString("pk_seq")))
														{
															%>
															
															<TR <%= stt % 2 == 0 ? "class='tblightrow'" : "class='tbdarkrow'" %> >
																<TD><%= khoanmucCP_Rs.getString("SOHIEUTAIKHOAN") %></TD>
																<TD><%= khoanmucCP_Rs.getString("TENTAIKHOAN") %></TD>
																<TD align="center" >
																	<input type="checkbox" name="khoanmucIds" value="<%= khoanmucCP_Rs.getString("PK_SEQ") %>" checked="checked" >
																</TD>
															</TR>
														...
														<% } else { %> 
															...
															<TR <%= stt % 2 == 0 ? "class='tblightrow'" : "class='tbdarkrow'" %> >
																...
																<TD><%= khoanmucCP_Rs.getString("TENTAIKHOAN") %></TD>
																<TD align="center" >
																	<input type="checkbox" name="khoanmucIds" value="<%= khoanmucCP_Rs.getString("PK_SEQ") %>"  >
																</TD>
															</TR>
