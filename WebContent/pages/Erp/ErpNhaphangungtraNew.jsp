...
<script type="text/javascript" src="../scripts/erp_splist_yeucaunhaphang.js"></script>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho &gt; Chức năng &gt; Yêu cầu nhập hàng khác &gt; <%=(lsxBean.getId().length() >0?"Cập nhật":"Tạo mới") %> 
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" valign="top">Kho nhận </TD>
	                      <TD class="plainlabel"  colspan="4" >
	                      	<input type="hidden" name="khonhap" value="<%=lsxBean.getKhoNhapId()%>"/>
	                    	<select name ="khonhapId" id="khonhapId" onchange="submitform();" style="width: 200px" >
	                    		<option value=""> </option>
	                        	<%
	                        		if(khonhapRs != null)
	                        		{
