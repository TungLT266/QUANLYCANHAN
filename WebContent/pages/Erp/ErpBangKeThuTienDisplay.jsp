...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý công nợ > Công nợ phải thu > Bảng kê thu tiền > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
       ...
       <A href="../../ErpBangKePdfSvl?userId=<%= tthdBean.getUserId() %>&id=<%= tthdBean.getId() %>&httt=<%= tthdBean.getHtttId() %>&inchitiet=0" >
    	...
    	<legend class="legendtitle"> Bảng kê thu tiền </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = 0>							
                ...
                <TR>
                    ...
                    <TD class="plainlabel">
                       	<input type="text" name="makhachhang" value="<%= tthdBean.getMakhachhang() %>" onchange="submitform();" >
                     </TD> 
						...
						<td align="center">							
						 ...
						 <!-- Tổng số tiền HĐ  -->	
       	 				...
       	 				<td align="center">
       	 				 ...
       	 				 <!-- số thực thu  -->	
       	 				<td align="center">
       	 					<input type="text" style="width: 100%; text-align: right;" name= "thucthu" id= <%= "thucthu_"+ hoadon.getId() %> value="<%= formatter.format(Double.parseDouble(hoadon.getthucthu().replaceAll(",",""))) %>"  onkeypress="return keypress(event);" onchange="TraTienHDSP();" >
       	 				</td>
								      ...
								      <% 
								        ...
								        int dem = 0;
								      	List<IHoadonct> HdctList = hoadon.getHoadonList();
								      		...
								      		<td>
								      			<input type="hidden" name=<%= "maspct_" + hoadon.getId() %> value = "<%=hdct.getspId() %>" style="width: 100%" readonly="readonly"  >
								      			<input type="hidden" name=<%= "hdIdct_" + hoadon.getId() %> value = "<%=hdct.gethdId() %>" style="width: 100%"  readonly="readonly" >
								      		...
								      		<td>
								      			<input type="text" name=<%= "thanhtienttct_" + hoadon.getId() %> style="width: 100%; text-align: right;" value = "<%= hdct.getThanhtoan() %>" style="width: 100%" onkeypress="return keypress(event);" onkeyup="Dinhdangdukien(this)" readonly="readonly">
								      		</td>
											<!-- pt chiết khấu  -->	
								      		<td>
								      			<input type="text" name=<%= "ptckct_" + hoadon.getId() %> style="width: 100%; text-align: right;" value = "<%= hdct.getptchietkhau() %>" style="width: 100%" onkeypress="return keypress(event);" readonly="readonly">											      			
								      		</td>
								      		<!-- tiền chiết khấu  -->	
											<td>				
											 ...
											 <!-- số thực thu  -->	
								      		<td>
								      			<input type="text" name=<%= "thucthuct_" + hoadon.getId() %> style="width: 100%; text-align: right;" value = "<%= hdct.getThucthu() %>"  onchange="Dinhdangdukien(this)" style="width: 100%" onkeypress="return keypress(event);" readonly="readonly" >
								      		</td>
