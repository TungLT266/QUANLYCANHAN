...
<body>
<form name="erpDmhForm" method="post" action="../../ErpBCHansudungSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	 Quản lý tồn kho > Báo cáo > BC Hạn sử dụng SP
        </div>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror" style="width: 100%; background-color:white; color: red" readonly="readonly" rows="1" readonly="readonly"><%= obj.getMsg() %></textarea>
		         <% obj.setMsg(""); %>
    	</fieldset>
  	</div>
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >								                          
                    <TR >
                        <TD class="plainlabel" width="15%">Ngày lấy </TD>
                        <TD class="plainlabel" >
