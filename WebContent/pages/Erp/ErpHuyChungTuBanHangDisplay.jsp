...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý cung ứng > Quản lý bán hàng > Hủy chứng từ > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
        ...
        <span id="pr">    			
    			<A href = "../../ErpHuyChungTuBanHangPdfSvl?userId=<%=userId%>&pdf=<%=hctbhBean.getId() %>">
  	...
  	<div align="left" style="width:100%%; float:none; clear:left">
  		<fieldset>
    		...
    		<textarea name="dataerror"  rows="1" readonly="readonly" style ="width:100%%"><%= hctbhBean.getMsg() %></textarea>
		         <% hctbhBean.setMsg(""); %>
    	</fieldset>
  	</div>
    	...
    	<legend class="legendtitle"> Hủy chứng từ </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                 <TR>
                    ...
                    <TD colspan="2" class="plainlabel" valign="top">
                    	...
                    	String mang[] =new String[]{"XUATKHO","DONDATHANG","HOADON", "HOADONKHAC"};
                    	String mangten[] =new String[]{"Xuất kho","Đơn hàng","Xuất hóa đơn tài chính" ,"Xuất hóa đơn khác"};
                    	%>                     
                ...
                <TR>
                    ...
                    <TD colspan="2" class="plainlabel" valign="top">
                    	<input type="text" id="sochungtu" name="sochungtu" value="<%= hctbhBean.getSochungtu() %>" readonly="readonly" /></TD>
                </TR>
    	 				...
    	 				<DIV style='display:none'>
                  		<DIV id="ndThongtinhangnhap" style='padding:0px 5px; background:#fff;'>
                  			...
                  			<h3 align="justify" style="font-weight: normal;">
                  				Hôm nay, ngày <input type="text" id="ngaybienban" name="ngaybienban" value="<%= hctbhBean.getNgaybienban() %>" style="width: 80px; border-left: none; border-right: none; border-top: none" />, đại diện hai bên gồm có:
                  			</h3>
                  			...
                  			<input type="text" id="ngayhoadon1_bb" name="ngayhoadon1_bb" value="<%= hctbhBean.getNgayhoadon1_bb() %>" style="width: 120px; border-left: none; border-right: none; border-top: none;" />
                  			...
                  			ngày
                  			<input type="text" id="ngayhoadon2_bb" name="ngayhoadon2_bb" value="<%= hctbhBean.getNgayhoadon2_bb() %>" style="width: 60px; border-left: none; border-right: none; border-top: none;" />
                  			...
                  			<h3 align="right" style="font-weight: normal;"> TP.HCM, ngày 
                  				<input type="text" id="ngaybb" name="ngaybb" class="days"  value="<%= hctbhBean.getNgaybb() %>" style="width: 80px; border-left: none; border-right: none; border-top: none;" /> 
                  			</h3>
            ...
            <%--  <% if(hctbhBean.getSoHoadon().length() > 0){ %>
             ...
             <% if(hctbhBean.getSophieuxuatkho().length() > 0){ %>
               	<TR>
                    <TD width="12%" class="plainlabel" valign="top"> Số phiếu xuất kho </TD>
                    <TD colspan="2" class="plainlabel" valign="top">
                    	<input type="text" id="soxuatkho" name="soxuatkho" value="<%= hctbhBean.getSophieuxuatkho() %>" readonly="readonly" /></TD>
               	</TR>
             <%} %>
             <% if(hctbhBean.getSoDondathang().length() > 0){ %>
               	<TR>
                    <TD width="12%" class="plainlabel" valign="top"> Số đơn đặt hàng </TD>
                    <TD colspan="2" class="plainlabel" valign="top">
                    	<input type="text" id="sodathang" name="sodathang" value="<%= hctbhBean.getSoDondathang() %>" readonly="readonly" /></TD>
               	</TR>
             <%} %>
            </TABLE>
            <hr> 
           ...
           int i = 1;
         	...
         	<% while(soctRequest.next()){ %>
 	                <TR>
 	                	...
 	                	<TD align="center">
 	                		<input type="text" name="sohoadon" style="width: 100%" value="<%= soctRequest.getString("SOHOADON") %>" readonly="readonly" >
 	                	</TD>
 	                	<TD align="center">
 	                	...
 	                	<TD align="center">
 	                		<% if(hctbhBean.getSochungtu().equals(soctRequest.getString("SOCHUNGTU"))){ %>
 	                		...
 	                		<%} else { %>
 	                			<input type="checkbox" name="sochungtuhuy" value="<%= soctRequest.getString("SOCHUNGTU") %>" onchange="HuyChungTu(<%= i - 1 %>)" disabled="disabled" >
 	                		<%} %>
 	                	</TD>
 	                </TR>
            <% i++; } } %>
             ...
             <table cellpadding="0px" cellspacing="1px" width="100%">
				...
				<%
					if(tthdRequest != null)
					{
						...
						<tr>
							<td>
								<input type="hidden" name="spId" value="<%= tthdRequest.getString("SPID") %>" style="width: 100%"   > 
								<input type="text" name="spMa" value="<%= tthdRequest.getString("MA") %>" style="width: 100%"  readonly="readonly"  > 
							</td>
							<td> <input type="text" name="spTen" value="<%= tthdRequest.getString("TEN") %>" style="width: 100%" > </td>
							<td>
								 <input type="text" name="donvi" value="<%= tthdRequest.getString("DONVITINH") %>" style="width: 100%; text-align: right;" readonly="readonly">	 						
							</td>
							<td>
								<input type="text" name="soluong" value="<%= formatter.format(Double.parseDouble(tthdRequest.getString("soluong"))) %>" style="width: 100%; text-align: right;" readonly="readonly" >															
														
							</td>
							<td>
								<input type="text" name="spDongia" value="<%= formatter2.format(Double.parseDouble(tthdRequest.getString("dongia"))) %>" style="width: 100%; text-align: right;"   >
										
							</td>							
							<td>
								<input type="text" name="spChietkhau" value="<%= formatter.format(Double.parseDouble(tthdRequest.getString("chietkhau"))) %>" style="width: 100%; text-align: right;" readonly="readonly">
							</td>
							<td>
								<input type="text" name="spTienthue" value="<%= formatter.format(Double.parseDouble(tthdRequest.getString("tienVAT"))) %>" style="width: 100%; text-align: right;"   >
							</td>
							<td>
								<input type="text" name="thanhtien" value="<%= formatter2.format(Double.parseDouble(tthdRequest.getString("THANHTIEN"))) %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event); " readonly="readonly" > 
							</td>
							<td >
								<input type="text" name="scheme" id = "scheme"   value="<%= tthdRequest.getString("scheme") %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event); " >							
							</td>
				...
				<%-- 	<% if(ttckRequest!=null) {
							...
							{ %>
								...
								<td><input type="text" style="width: 100%;" > </td>
								<td><input type="text" style="width: 100%;" > </td>
								<td><input type="text" style="width: 100%; text-align: right; " value="<%= formatter2.format(Double.parseDouble(tthdRequest.getString("giatri"))) %>" readonly="readonly" > </td>
								<td><input type="text" style="width: 100%;" value="<%= tthdRequest.getString("scheme") %>" readonly="readonly" > </td>
								<td></td>
							</TR>
							<%}		%>	
