				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý công nợ > Công nợ phải thu > Hóa đơn khác > Tạo mới</TD> 
                            ...
                            <%} %> 
			                  		...
			                  		<%} %> 
										...
										<% } %>
			                  					...
			                  					<td>
			                  						<input type="text" name="thanhtien" value="<%= formatter.format(Double.parseDouble(sanpham.getThanhTien())) %>" style="width: 100%; text-align: right; " onKeyPress = "return keypress(event);" onchange="DinhDangTT();" >
			                  					</td>
