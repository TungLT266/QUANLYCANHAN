	...
	<form name="dmhForm" method="post" action="../../ErpDonmuahangUpdate_GiaySvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left" class="tbnavigation"> Quản lý mua hàng > Mua hàng nhập khẩu > Đơn mua hàng > Tạo mới</div>
									...
									<a class="ndThongtinhdngoai" href="#"  >
	           	 					...
	           	 					<div style='display:none'>
               							<DIV id="ndThongtinhdngoai" style='padding:0px 5px; background:#fff;'>
			                            	...
			                            	<tr>
			                            		<TD > <font size=2> Tên nhà xuất khẩu </font> </TD>
												<TD > 
