...
function submitform()
{
	document.forms["ttcpForm"].action.value = "submit";
    document.forms["ttcpForm"].submit();
}

function search()
{
	document.forms["ttcpForm"].action.value = "search";
    document.forms["ttcpForm"].submit();
}

function saveform()
{
	document.forms["ttcpForm"].action.value = "save";
    document.forms["ttcpForm"].submit();
}
...
<input type="hidden" name="ttcpId" value=''>
	...
	<TR>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Dữ liệu nền &gt; Tài chính  &gt; Trung tâm chi phí &gt; Tạo mới</TD> 
		...
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="1">
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../Erp_TrungTamChiPhiSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
			...
			<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100%" readonly="readonly" rows="1"><%=ttcpBean.getMsg() %></textarea>
						<% ttcpBean.setMsg("") ; %>
						</FIELDSET>
				   </TD>
				</tr>			
				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><INPUT type="text" name="ma" style="width:300px" value='<%= ttcpBean.getMa()%>'></TD>
							</TR>
							
							<TR>
							  	<TD class="plainlabel">Diễn giải <FONT class="erroralert"> *</FONT></TD>
						  	  	<TD class="plainlabel"><INPUT type="text" name="diengiai" style="width:300px" value='<%= ttcpBean.getDiengiai() %>'></TD>
						  	</TR>
							...
							<TR>
							  ...
							  <% if(ttcpBean.getCongansach().equals("1")){%>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" name="ngansach" value = "1" checked></TD>
						  	  <%}else{ %>
						  	  	<TD class="plainlabel"><INPUT type="checkbox" name="ngansach" value = "1" ></TD>
						  	  <%} %>
							...
							<TR>
							  ...
							  <% if(ttcpBean.getNhanphanbo().equals("1")){%>							  
						  	  	<TD class="plainlabel">
						  	  	<INPUT type="checkbox" name="npb" value = "1" checked disabled = "disabled">
						  	  	<INPUT type="hidden" name="npbId" value = "1" >
						  	  	</TD>
						  	  <%}else{ %>
						  	  	<TD class="plainlabel">
						  	  	<INPUT type="checkbox" name="npb" value = "1" disabled = "disabled">
							...
							<% if(ttcpBean.getPhanbo().equals("1")){ %>
											...
											<TABLE style="width: 95%" cellpadding="4px" cellspacing="1px" align="center">
												<TR>
													...
													<TD class= "legendtitle" >Tìm kiếm
														<INPUT TYPE = "text" NAME = "timkiem" VALUE = "<%= ttcpBean.getTimkiem() %>" onChange="search();">
													</TD>
													<TD width = "50%">&nbsp;</TD>
												</TR>
											</TABLE>
										...
										if(ttcpList != null)
										{
	                                     ...
	                                     <%		  }%>
												...
												%>
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID_NPB") %>" style="width: 100%" value="<%= pt[1] %>" onkeypress="return isNumberKey2(event)">
														
												<%			}else{	%>
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID_NPB") %>" style="width: 100%" value="" disabled=disabled>
												...
												<%			}
														...
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID_NPB") %>" style="width: 100%" value="<%= ttcpList.getString("PHANTRAM_NPB") %>" onkeypress="return isNumberKey2(event)">
												...
												<%			}
													...
													<TD>
														<SELECT NAME = "<%= "ptds" + ttcpList.getString("TTCPID_NPB") %>"  OnChange = "SetDisabled(<%= ttcpList.getString("TTCPID_NPB") %>)">
												...
												<%		}
													...
													<TD align="center">
														...
														<input type="checkbox" name="pbIds" value="<%= ttcpList.getString("TTCPID_NPB") %>" checked="checked" >
										...
										if(ttcpList != null)
										{
	                                     ...
	                                     <%		  }%>
												...
												<%		if(pbIdList.indexOf(ttcpList.getString("TTCPID")) >= 0){
															...
															if(Double.parseDouble(pt[1]) != 1002 & Double.parseDouble(pt[1]) != 1003  & Double.parseDouble(pt[1]) != 1004 & Double.parseDouble(pt[1]) != 1005){
												%>
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID") %>" style="width: 100%" value="<%= pt[1] %>" onkeypress="return isNumberKey2(event)">
														
												<%			}else{ %>
														
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID") %>" style="width: 100%" value="" disabled = disabled>
												
												<%			}
														}else{ %>
												
														<INPUT type="text" name = "<%= "pt" + ttcpList.getString("TTCPID") %>" style="width: 100%" value="" onkeypress="return isNumberKey2(event)">
												...
												<%		} %>
													...
													<TD>
														<SELECT NAME = "<%= "ptds" + ttcpList.getString("TTCPID") %>"  OnChange = "SetDisabled(<%= ttcpList.getString("TTCPID") %>)" >
															<OPTION VALUE = "0">&nbsp;</OPTION>
												<%	if(pbIdList.indexOf(ttcpList.getString("TTCPID")) >= 0){
														String tmp = pbIdList.substring(pbIdList.indexOf(ttcpList.getString("TTCPID")), pbIdList.indexOf(";", pbIdList.indexOf(ttcpList.getString("TTCPID"))));
														String[] pt = tmp.split("-");
												...
												<%		}
													...
													<TD align="center">
												<% if(pbIdList.indexOf(ttcpList.getString("TTCPID")) >= 0){ %>
														<input type="checkbox" name="pbIds" value="<%= ttcpList.getString("TTCPID") %>" checked="checked" >
												<% }else{ %>
														<input type="checkbox" name="pbIds" value="<%= ttcpList.getString("TTCPID") %>"  >
												<% } %>
