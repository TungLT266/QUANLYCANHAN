	...
	<form name="nhForm" method="post"
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" id="button"
				...
				class="tbdarkrow">
				<A href="../../ErpNhanhangtrongnuoc_GiaySvl?userId=<%= userId %>&loai=1"> <img
							...
							<tr>
								...
								<td align="left">
									...
									<DIV id="subcontent<%= i %>"
										style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; 
											background-color: white; width: 1000px; z-index:20;  padding: 4px; height: 400px;overflow-y: scroll;">
								...
								<td align="right" style="display: none">
									<%
           	 						...
           	 						{
           	 							conlai = formatter_4le.format(Double.parseDouble(conlai) - Double.parseDouble(sp.getSoluongnhan().replaceAll(",", "") ));
           	 						}
           	 					%> <input type="text"
