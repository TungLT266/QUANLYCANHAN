...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Chức năng > Điều chỉnh thông tin kho > Hiển thị 
        </div>
							...
							<% if( soluongyeucau >= 0 && lsxBean.getKhoXuatId().trim().length() > 0  ) { %>
								<a href="" id="scheme_<%= yeucau.getMa() + "__ "  %>" rel="subcontent_<%= yeucau.getMa() + "__ " %>">
				                    ...
				                    <table width="100%" align="center">
		                            	...
		                            	<%
		                            		ResultSet spRs = lsxBean.getSoloDisplay(yeucau.getMa(), yeucau.getDonViTinh(), yeucau.getSoluongYC() );
			                        		if(spRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				<td>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= spRs.getString("soluong") %>"  >
			                        				</td>
			                        				
			                        				<td>
				                        				<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spTHONGTINDOI" value="<%= spRs.getString("thongtinDoi") %>"  >
			                        				</td>
			                        				
			                        				<% if( lsxBean.getLoaidieuchinh().equals("0") || lsxBean.getLoaidieuchinh().equals("6") ) { %>
			                        				<td>
			                        					<% if( lsxBean.getLoaidieuchinh().equals("0") ) { %>
					                        				<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spNGAYHHDOI" value="<%= spRs.getString("ngayhethanMOI") %>"    >
				                        				<% } else { %>
					                        				<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spNGAYHHDOI" value="<%= spRs.getString("hamluongMoi") %>"    >
				                        				<% } %>
			                        				</td>
			                        				<% } %>
