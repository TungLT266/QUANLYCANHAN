...
<%@ page import="geso.traphaco.erp.beans.giamgiahangmua.IErpGiamgiahangmuaList"%>
...
<%	
	IErpGiamgiahangmuaList obj =(IErpGiamgiahangmuaList)session.getAttribute("obj");
...
<form name="khtt" method="post" action="../../ErpGiamgiahangmuaSvl">
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý kế toán > Giảm giá hàng mua </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Giảm giá hàng mua &nbsp;&nbsp;	
                        ...
                        <TR>
                            ...
                            <TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
                                <TR class="tbheader">
                                    ...
                                    <TH width="15%" align="center">Nhà cung cấp</TH>
                                ...
                                <% 
                                    ...
                                    for(int i =0; i < htList.size(); i ++)
									{
                                        ...
                                        <%}%>
                                                ...
                                                <TD align="left"><%= obj.getSohoadon(ht.getId()) %></TD>
                                                <% if( tt.equals("0") ) { %>
                                                ...
                                                <TD align="center"> 
                                                <% if( tt.equals("0") ) { %>
							                   		<A href = "../../ErpGiamgiahangmuaUpdateSvl?userId=<%=userId%>&update=<%= ht.getId() %>"><img src="../images/Edit20.png" alt="Cap nhat" width="20" height="20" longdesc="Cap nhat" border = 0></A> &nbsp;
							                   		<A href = "../../ErpGiamgiahangmuaSvl?userId=<%=userId%>&chot=<%= ht.getId() %>"><img src="../images/Chot.png" alt="Duyet" width="20" height="20" longdesc="Duyet" border=0 onclick="if(!confirm('Ban Muon Duyet Giam Gia Nay?')) return false;"></A>&nbsp;
													<A href = "../../ErpGiamgiahangmuaSvl?userId=<%=userId%>&delete=<%= ht.getId() %>"><img src="../images/Delete20.png" alt="Xoa" width="20" height="20" longdesc="Xoa" border=0 onclick="if(!confirm('Ban Muon Xoa Giam Gia Nay?')) return false;"></A>
												...
												<% } else if(tt.equals("1")){ %>
													<A href = "../../ErpGiamgiahangmuaUpdateSvl?userId=<%=userId%>&display=<%= ht.getId() %>"><IMG src="../images/Display20.png" alt="Hien thi" title="Hien thi" border=0></A>&nbsp;
