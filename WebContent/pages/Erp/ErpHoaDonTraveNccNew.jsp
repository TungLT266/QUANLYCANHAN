						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Quản lý mua hàng > Nghiệp vụ khác > Xuất HD trả về NCC > <%=(hdBean.getId().length() >0 ? "Cập nhật":"Tạo mới")%> </TD>								   
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="0">
								<TR ><TD >
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR class = "tbdarkrow">
											<TD width="30" align="left"><A href = "../../ErpHoaDonTraveNccSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							...
							while (m < size){
								...
								%>
									...
									<TD align="left" >
										...
										<input name='hansudung' id='<%=sanpham.getIdSanPham()+"["+m+"]"+"hansudung"%>' type='hidden' value=<%=sanpham.getHansudung() %> >
...
<script type="text/javascript">
	...
	jQuery(function()
	{		
		$("#nhappid").autocomplete("ErpNccList.jsp");
	});	
