...
{	
	...
	for(var i = 0; i < idhangmua.length; i++)
	{
		...
		for(var j = 0; j < sodong; j++)
		{
			if(solo.item(j).value != "" && soluong.item(j).value != "")
			{
				...
				sln = sln + parseFloat( replaceAll(soluong.item(j).value,",",""));
		...
		thanhtien.item(i).value = DinhDangDonGia(Math.round(thanhtieni.toString()*1000)/1000);
	...
	document.getElementById("tong").value= DinhDangDonGia(Math.round((tongtien+ tienthuegtgt)*1000)/1000);
	...
	function Kiemtramoithu()
	{
		...
		for(var i=0; i< idhangmua.length; i++){
			if(soluongdanhan.item(i).value.trim().length >0){
				...
				console.log(" so luong dung sai : "+ (parseFloat(dungsai) * parseFloat(soluongdat_)/100));
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý mua hàng &gt; Mua hàng nhập khẩu &gt; Hóa đơn nhập khẩu &gt; Cập nhật
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">	
					...
					<TR>
						...
						<TR>
							...
							<TD class="plainlabel" width="15%"><input type="text"
								readonly name="tong" id="tong" value="<%=formatter_4le.format(pBean.getTong())%>" />
							</TD>
						...
						<TR>
							...
							<TD class="plainlabel" width="15%"><input type="text"
							 name="tongVND" id="tongVND" readonly value="<%= formatter_4le.format( pBean.getTongVND()) %>" />
							</TD>
						...
						<TR>
							...
							<TR><TD class="plainlabel" width="15%">Kho biệt trữ</TD>
                		...
                		ISanpham sp = spList.get(i);
	               		...
	               		<tr>
           	 				...
           	 				<td align="right">
           	 					...
           	 					name= "soluongdanhan" readonly="readonly" >
           	 				</td>
           	 				<td align="right">
				                        ...
				                        <%
				                        	for(int k = 0; k < 10 - spDetailList.size(); k++)
				                        	{
				                        		...
				                        		<tr>
						                            ...
						                            <td>
						                            	<input type="text" size="100px"  name="<%= sp.getId() +"."+sp.getMuahang_fk()+i+ ".soluong" %>" value="" style="text-align: right;" onchange="replaces()"/></td>
						                             <td><input type="text" size="100px"  
													name="<%=sp.getId() + "." + sp.getMuahang_fk() +i+ ".nsxten"%>"
													value="" 
													 />
           	 				...
           	 				<td align="right">
           	 					<input type="text" style="width: 100%; text-align: right;" value="<%= formatter.format( Double.parseDouble(sp.getthanhtien().replaceAll(",",""))) %>" name= "thanhtien" readonly="readonly" >
           	 				</td>
           	 				<td align="right"><input type="text"
									style="width: 100%; text-align: right;" onchange ="DieuChinhTien(this);"
