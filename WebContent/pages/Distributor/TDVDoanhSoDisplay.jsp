								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết
											lập dữ liệu nền> Dữ liệu nền kinh doanh > Bổ sung doanh số CTV > Hiển thị
...
<!-- 											<TH width="20%">Doanh số</TH> -->
										...
										<TR class=<%=darkrow%>>
											...
											<TD align="center">
											<input name='doanhso' type="text" value="<%=kh_dsrs.getString("doanhso") %>" maxlength="10"  style="width: 100%">
											</TD>
<!-- 											<TD align="center"> -->
<%-- 											<input name='doanhsobosung' type="text" value="<%=kh_dsrs.getString("doanhsobosung") %>" maxlength="10"  style="width: 100%"> --%>
<!-- 											</TD> -->
										</TR>
										<%
