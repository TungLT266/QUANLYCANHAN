<%@page import="geso.traphaco.distributor.beans.chuyenkhonoibo.IErpChuyenKhoNoiBo"%>
<%@page import="geso.traphaco.center.util.Utility"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.sql.SQLException"%>
<%@ page  import = "geso.traphaco.distributor.beans.chuyenkho.*" %>
<%@ page  import = "geso.traphaco.distributor.beans.chuyenkho.imp.*" %>
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Kho TDV > Chuyển kho nội bộ > Hiển thị
        </div>
