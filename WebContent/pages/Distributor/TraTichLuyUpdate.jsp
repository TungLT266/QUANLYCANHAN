...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function duyetform()
		{  
		    document.forms['dktbForm'].action.value='duyet';
		    document.forms['dktbForm'].submit();
		}
   ...
   <div id="main" style="width:99%; padding-left:2px">
	 <div align="left" id="header" style="width:100%; float:none">
    	  <div style="width:40%; padding:5px; float:left" class="tbnavigation">
        	Quản lý KM, trưng bày > Khuyến mại > Duyệt trả khuyến mãi tích lũy > Duyệt 
          </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../TratichluySvl?userId=<%= userId %>" >
        	...
        	<IMG src="../images/Chot.png" title="Duyệt" alt="Duyệt" border ="1px" width="30px" height="30px" style="border-style:outset"></A>
			  	...
			  	<TD class="plainlabel">Chọn tập tin</TD>
		  	  	<TD class="plainlabel" colspan="3" >
		  	  		<INPUT type="file" name="filename" size="40" value=''>&nbsp;&nbsp;&nbsp;&nbsp;
			  	  		<a class="button2"  href="javascript:upload();"><img style="top: -4px;" src="../images/button.png" alt="">Upload File duyệt trả</a>
		  	  	</TD>
		   </TR>
