...
<%@ page  import = "geso.traphaco.distributor.beans.dieuchinhtonkho.IDieuchinhtonkhoList" %>
                                        ...
                                        <%}%>
                                             ...
                                             <% if (dctklist.getString("trangthai").equals("0")){ %>                                                
                                                   ...
                                                   <%if(quyen[Utility.SUA]!=0){ %>
                                                    	 <A href = "../../DieuchinhtonkhoUpdateSvl?userId=<%=userId%>&update=<%= dctklist.getString("chungtu")%>"><img src="../images/Edit20.png" alt="Cập nhật" width="20" height="20" longdesc="Cập nhật" border = 0 "></A>
                                                   <%} %>
                                                    </TD>
                                                   <TD>&nbsp;</TD>
                                                   <TD>
                                                   <%if(quyen[Utility.XOA]!=0){ %>
                                                        <A href = "../../DieuchinhtonkhoSvl?userId=<%=userId%>&delete=<%= dctklist.getString("chungtu")%>"><img src="../images/Delete20.png" alt="Xóa" width="20" height="20" longdesc="Xóa" border = 0 "></A>
                                                   <%} %>
                                                   </TD>
                                                   </TR>
                                            <%}else{ %>
                                                    ...
                                                    <%if(quyen[Utility.XEM]!=0){ %>
                                                        ...
                                                        <A href = "../../DieuchinhtonkhoDisplaySvl?userId=<%=userId%>&display=<%= dctklist.getString("chungtu")%>"><img src="../images/Display20.png" alt="Hiển thị" width="20" height="20" longdesc="Hiển thị" border = 0 "></A>
                                                    <%} %>
                                                    </TD></TR>
                                            <%} %>                                             
                                               </TABLE>
