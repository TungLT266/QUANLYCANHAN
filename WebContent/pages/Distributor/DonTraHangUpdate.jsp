	...
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	<% if(lsxBean.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng cho NPP > Đơn trả hàng > Cập nhật
			<% } else if(lsxBean.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng thầu > Đơn trả hàng  > Cập nhật
			<% } else { %>
				Quản lý bán hàng > Bán hàng không thầu > Đơn trả hàng  > Cập nhật
			<% } %>
        </div>
