...
<% IErpSoxuathangNpp lsxBean = (IErpSoxuathangNpp)session.getAttribute("lsxBean"); %>
...
<script type="text/javascript">
	function CheckALL()
	{
		...
		var ddhIds = document.getElementsByName("ddhIds");
...
<form name="hctmhForm" method="post" action="../../ErpSoxuathangNppUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng không thầu > Sổ xuất hàng > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpSoxuathangNppSvl?userId=<%= userId %>&loai=1" >
    ...
    <fieldset>
    	<legend class="legendtitle">Sổ xuất hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    <TD width="130px" class="plainlabel" >Ngày xuất hàng </TD>
                    <TD class="plainlabel" >
                    ...
                    <TD class="plainlabel" >
                    	<%-- <input name="xuatchoId"  style="width: 200px" value="<%= lsxBean.getXuatcho() %>" > --%>
				...
				<TR>
                    ...
                    <TD class="plainlabel" >
                    	<select name = "quanhuyenId" class="select2" style="width: 400px" multiple="multiple" onchange="LocLaiPO();" >
                        	<option value=""> </option>
                        	<%
                        		if(quanhuyenRs != null)
                        		{
                        			...
                        			{  
                        			if( lsxBean.getQuanhuyenId().contains( quanhuyenRs.getString("pk_seq") ) ){ %>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="250px" >
                    	<select name = "khId" class="select2" style="width: 200px" onchange="LocLaiPO();" >
                    		<option value=""> </option>
                        	<%
                        		if(nppRs != null)
                        		{
                    ...
                    <TD class="plainlabel" >
                    	<select name = "khonhapId" class="select2" style="width: 400px" multiple="multiple" onchange="submitform();">
                    		<option value="" ></option>
                        	<%
                        		if(khonhapRs != null)
                        		{
                        			...
                        			{  
                        			if( lsxBean.getKhoNhapId().contains( khonhapRs.getString("pk_seq") ) ){ %>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    		...
                    		<table style="width: 100%" cellpadding="1" cellspacing="1" >
                    			<TR class="tbheader">
				                    ...
				                    <TH align="center" style="width: 30%" >Khách hàng</TH>
				                    <TH align="center" style="width: 25%" >Tên xuất HĐ</TH>
				                    <TH align="center" style="width: 10%" >Tổng tiền</TH>
				                    <TH align="center" style="width: 10%" >Chọn ALL <input type="checkbox"  id='chkALL' name='chkALL' value="1" onchange="CheckALL();" <%= lsxBean.getCheckAll().equals("1") ? "checked='checked'" : "" %>  > </TH>
				                </TR>
				             </table>
				             
				             <div style="width: 100%; max-height: 150px; overflow: auto;" >
					             <table style="width: 98%" cellpadding="1" cellspacing="1"  >
					                <% if( ddhRs != null ) { 
					                	while( ddhRs.next() ) { %>
					                		
					                		<tr>
					                			<td style="width: 10%"><input type="text" value="<%= ddhRs.getString("SOHOADON") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 10%"><input type="text" value="<%= ddhRs.getString("NGAYXUATHD") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 30%"><input type="text" value="<%= ddhRs.getString("khTEN") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 25%"><input type="text" value="<%= ddhRs.getString("TENXUATHD") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 10%"><input type="text" value="<%= formater.format(ddhRs.getDouble("tongtienavat")) %>" disabled="disabled" style="width: 100%;" ></td>
                    	...
                    	<%-- <select name = "ddhIds" class="select2" style="width: 700px" multiple="multiple"  onchange="changePOform();" >
                    		<option value=""> </option>
                        	<%
                        		if(ddhRs != null)
                        		{
			                        		...
			                        		if(spRs != null)
			                        		{
			                        			...
			                        			<tr>
			                        				...
			                        				<% if(sanpham_soluong.get(spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") ) != null ) { %>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( spId[i] + "__" + spLoai[i] + "__" + spSCheme[i].trim() + "__" + spRs.getString("SOLO") ))) %>" onkeyup="Dinhdang(this);" readonly="readonly" >
			                        				<% } else { %>
			                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= tudeXUAT  %>" onkeyup="Dinhdang(this);" readonly="readonly" >
			                        				<% } %>
			                        				</td>
			                        				<td>
