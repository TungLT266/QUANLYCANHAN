...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho NPP > Đơn hàng bán
        </div>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" width="18%" >NPP</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center"><%= nhapkhoRs.getString("NGAYDONHANG") %></TD>
		                     <TD align="center"><%= nhapkhoRs.getString("maddh") %><%=nhapkhoRs.getString("iskm").equals("1")?" (KM)":" (Bán)" %>   </TD>
