				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu &gt; Dữ liệu nền kinh doanh &gt; Nhóm khách hàng &gt; Cập nhật</TD> 
			...
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							...
							<TD width="2" align="left" ><A href="../../NhomkhachhangNPPUpdateSvl?userId=<%=userId %>&excel=<%=nkhBean.getId()%>"" ><img src="../images/excel30.gif" alt="Xuất excel"  title="Xuất excel" border="1" longdesc="Xuất excel" style="border-style:outset"></A></TD>
							<TD >&nbsp; </TD>						
						</TR>
					</TABLE>
			</TD></TR>
