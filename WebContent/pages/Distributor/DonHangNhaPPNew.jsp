						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Xử lý đơn hàng > Đơn hàng bán>Bán cho Chi nhánh / Đối tác > Tạo mới </TD>								   
							...
							<TABLE border="0" width="100%" cellpadding = "0" cellspacing = "0" >
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%"  rows="1" readonly="readonly"  ><%= dhBean.getthongbao() %> </textarea>
									</FIELDSET>
							   </TD>
								</tr>
								<TR>
