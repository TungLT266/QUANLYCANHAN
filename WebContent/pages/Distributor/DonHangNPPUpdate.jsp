<%@page import="geso.traphaco.center.beans.nhaphanphoi.imp.Nhaphanphoi"%>
<%@page import="geso.traphaco.distributor.beans.donhangnhapp.imp.DonHangNPP"%>
<%@page import="geso.traphaco.distributor.beans.donhangnhapp.imp.SanPhamDhNpp"%>
<%@page import="geso.traphaco.center.beans.dieukienkhuyenmai.imp.Sanpham"%>
<%@page import="geso.traphaco.distributor.beans.donhangnhapp.ISanPhamDhNpp"%>
<%@page import="geso.traphaco.distributor.beans.donhangnhapp.IDonhangnpp"%>
...
{	 
	 ...
	 for(var k = 0; k < masp.length; k++)
	 {
		...
		if(nhappmua.value == "")
		{
			alert("vui lòng chọn Chi nhánh / Đối tác mua hàng...");
			return;
		}
						...
						<TD align="left" >
								...
								<TR>
									<TD align="left">
									   <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										   <TR height="22">
			 								   <TD align="left"  class="tbnavigation">&nbsp;Xử lý đơn hàng > Đơn hàng bán>Bán cho Chi nhánh / Đối tác > Cập nhật </TD>								   
							...
							<TABLE border="0" width="100%" cellpadding = "0" cellspacing = "0" >
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%"  rows="1" readonly="readonly" title="<%=  dhBean.getthongbao() %>" > </textarea>
									</FIELDSET>
							   </TD>
								</tr>
								<TR>
									<TD  align="left">						
										...
										<TABLE cellpadding = "6" cellspacing = "0" width = "100%" border = 0>
											...
											<TR >
												<TD width="22%" class="plainlabel">Chi nhánh / Đối tác bán hàng</TD>
												<TD colspan="3" class="plainlabel"><%= dhBean.getTenNPPBan() %> </TD>
												</TR>							
											
											<TR class="tblightrow">
												<TD  class="plainlabel">Chi nhánh / Đối tác mua hàng</TD>
