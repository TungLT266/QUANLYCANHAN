...
<%@ page  import = "geso.traphaco.distributor.beans.duyetdonhangcs.imp.*" %>
...
<% IErpDuyetdonhangcs lsxBean = (IErpDuyetdonhangcs)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpduyetdonhangcsUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng thầu > Bán hàng cho ETC > Duyệt đơn hàng ETC
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDuyetdonhangcsSvl?userId=<%= userId %>" >
...
<!-- 								</td> -->
								...
								<td> <input type="text" name="dongia" value="<%=formater2.format(Double.parseDouble((spGianhap[i]))) %>" style="width: 100%; text-align: right;" onkeyup="Dinhdang(this);" readonly="readonly" > </td>
