...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="frm" method="post"
		action="../../ErpReportDoanhThuChitiet">
		<input type="hidden" name="action" value='1'> <input
			type="hidden" name="userId" value='<%=userId%>'>
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Báo cáo quản trị &#62; Báo cáo khác &#62;  Doanh thu chi tết KH-SP</div>
					...
					<div style="width: 100%; float: none" align="left">
						<div style="width: 100%; float: none" align="left"
                         ...
                         <a href="" id="VungId" rel="subcontentvung">
	           	 		  ...
	           	 		  <DIV id="subcontentvung" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 400px; padding: 4px; max-height: 200px; overflow: auto; ">
                         ...
                         <a href="" id="khuvucId" rel="subcontentkhuvuc">
	           	 		 	&nbsp; <img alt="Chọn vùng" src="../images/vitriluu.png"> </a>
	           	 		  <DIV id="subcontentkhuvuc" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 400px; padding: 4px; max-height: 200px; overflow: auto; ">
				                    <table width="90%" align="center">
				                        <tr>
				                            <th width="70px">Mã </th>
				                            <th width="300px">Tên</th>
                         ...
                         <a href="" id="kbhId" rel="subcontentkbh">
	           	 		  ...
	           	 		  <DIV id="subcontentkbh" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 400px; padding: 4px; max-height: 200px; overflow: auto; ">
				                    <table width="90%" align="center">
				                        <tr>
				                            <th width="70px">Mã </th>
				                            <th width="300px">Tên</th>
                        ...
                        <%--  <a href="" id="khId" rel="subcontentKh">
	           	 		  ...
	           	 		  <DIV id="subcontentKh" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 560px; padding: 4px; max-height: 200px; overflow: auto; ">
				                    <table width="90%" align="center">
				                        <tr>
				                            <th width="70px">Mã khách hàng</th>
				                            <th width="300px">Tên khách hàng</th>
				                            <th width="20px" align="center">Chọn <input type="checkbox" onchange="sellectAll()" id="chkAll" ></th>
				                        </tr>
		                            	<%
			                        		if( RsKh!= null)
			                        		{
	  				 ...
	  				 <SELECT name="khIds" id="KhachHang" style="width: 230px;">
