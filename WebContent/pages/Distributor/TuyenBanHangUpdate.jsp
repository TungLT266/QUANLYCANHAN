 ...
 <script language="javascript" type="text/javascript">
	...
	{	
		...
		var tbh_khcdpt = document.getElementsByName("kh_tbh_cdptList");
				...
				var sott=tbh_khcdpt.item(tbh_khcdpt.length-1).value;
				...
				<TR>
					<TD align="left" class="tbnavigation">
					   <table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <TR height="22">
						  	<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền &gt; Dữ liệu nền kinh doanh &gt; Tuyến bán hàng > Cập nhật
