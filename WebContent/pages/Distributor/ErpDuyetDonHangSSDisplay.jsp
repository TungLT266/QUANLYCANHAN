...
<%@ page  import = "geso.traphaco.distributor.beans.duyetdonhangss.imp.*" %>
...
<% IErpDuyetdonhangss lsxBean = (IErpDuyetdonhangss)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpduyetdonhangssUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDuyetdonhangssSvl?userId=<%= userId %>" >
