...
<%@ page  import = "geso.traphaco.distributor.beans.donhang.ISanpham" %>
<%@ page  import = "geso.traphaco.distributor.beans.hoadontaichinhKM.imp.*" %>
			                            	...
			                            	<%
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			while(spRs.next())
				                        			{
				                        				...
				                        				String temID =tkmSp.getId() + "__" + spRs.getString("SOLO") + "__" + spRs.getString("NGAYHETHAN");
				                        			%>
				                        			
				                        			<tr>
				                        				<td>
				                        				<% if(sanpham_soluong.get( temID ) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%=tkmSp.getId() %>_spSOLUONG" value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( temID ))) %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } else { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%=tkmSp.getId() %>_spSOLUONG" value="<%= tudeXUAT  %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } %>
				                        				</td>
				                        				<td>
