...
<%@page import="geso.traphaco.distributor.beans.ctkmkhachhang.ICtkmkhachhang"%>
				  	...
				  	<tr>
						<TD align="left" colspan="4" class="legendtitle">
							<FIELDSET>
		    					...
		    					<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width: 100% ; color:#F00 ; font-weight:bold" readonly="readonly" rows="1" ><%=""%></textarea>
							</FIELDSET>
					   </TD>
					</tr>			
				  	<tr>
						   <TD align="left" colspan="4">
			                    ...
			                    <tr>
								  ...
								  <TR>
									  <TD width="20%" class="plainlabel" >Trình dược viên </TD>
								   ...
								   <TR>
									  <TD width="100%" colspan="2" >
							             	...
							             	<tr class="tblight">
							                	<th align="left" class="plainlabel">Tên Trình dược viên</th>
