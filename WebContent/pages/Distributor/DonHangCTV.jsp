            ...
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                    ...
                    <TR>
                        ...
                        <TD class="plainlabel" >
                            <input type="text" name="tenTDV" value="<%= obj.getTenTDV() %>"   />
                        </TD>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH style="width: 15%" align="center">Khách hàng</TH>
                 		...
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center"><%= nhapkhoRs.getString("ngaynhap") %></TD>
		                     <TD align="center"><%= nhapkhoRs.getString("tenkh") %></TD>
		                    	...
		                    	<%
		                    		...
		                    		if(tt.equals("0"))
		                    			trangthai = "TDV Chưa chốt";
		                    		else
		                    		{
		                    			if(tt.equals("1"))
		                    				trangthai = "TDV Đã chốt";
		                    			else
		                    				trangthai = "SS Đã duyệt";
		                    		}
		                    	%>
		                    	<%= trangthai %>
		                    </TD>   									                                    
                            ...
                            <% } %>
                                ...
                                <%if(quyen[Utility.XOA]!=0){ %>
                              		<A href = "../../DonhangctvSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>&loaidonhang=<%= obj.getLoaidonhang() %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn chốt báo cáo CTV này?')) return false;"></A>
                              	<% } %>
