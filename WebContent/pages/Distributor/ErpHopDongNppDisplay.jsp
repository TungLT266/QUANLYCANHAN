...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng thầu > Hợp đồng > Hiển thị
        </div>
			...
			<hr />
				<table cellpadding="0px" cellspacing="1px" width="100%">
					<!-- <tr class="tbheader">
						...
						<th align="center" width="13%" rowspan="2" >Tên sản phẩm</th>
						<th align="center" width="7%" rowspan="2" >Đơn vị</th>
						<th align="center" width="7%" rowspan="2" >Số lượng</th>
						<th align="center" width="7%" rowspan="2" >Đã giao</th>
					...
					<tr class="tbheader">
						...
						<th align="center" width="16%"  >Tên sản phẩm</th>
						<th align="center" width="7%" >Đơn vị</th>
						<th align="center" width="8%"  >Số lượng</th>
						<th align="center" width="7%" >Đã giao</th>
					...
					<%
						...
						if(spMa != null)
						{
							for(int i = 0; i < spMa.length; i++)
							{
								...
								if( soluong.contains("-") )
								{
									soluong = spSoluong[i].split("-")[0];
									dagiao = spSoluong[i].split("-")[1];
								}
							%>
							...
							<tr>
								...
								<td> 
									<input type="text" name="soluong" value="<%= soluong %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > 
								</td>
								<td> 
									<input type="text" name="soluong" value="<%= dagiao %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > 
								</td>
