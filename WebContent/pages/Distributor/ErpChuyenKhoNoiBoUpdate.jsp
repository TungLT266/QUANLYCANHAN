...
<% 
	IErpChuyenKhoNoiBo lsxBean = (IErpChuyenKhoNoiBo)session.getAttribute("lsxBean");  
...
<script type="text/javascript" src="../scripts/erp-SpListChuyenKhoNoiBo.js"></script>
...
<form name="hctmhForm" method="post" action="../../ErpChuyenKhoNoiBoUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý tồn kho > Kho TDV > Chuyển kho nội bộ > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpChuyenKhoNoiBoSvl?userId=<%= userId %>" >
   ...
   <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Chuyển kho nội bộ </legend>
        	<div style="float:none; width:100%" align="left">
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
               <TR>
                    <TD class="plainlabel" >Ngày chuyển </TD>
                    <TD  class="plainlabel" >
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="120px" style = "display: none">Kênh bán hàng</TD>
