...
<%@ page  import = "geso.traphaco.distributor.beans.dondathangotc.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<% IErpDuyetddhNppListOtc obj = (IErpDuyetddhNppListOtc)session.getAttribute("obj"); %>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpDuyetddhNppOtcSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng không thầu > Duyệt đơn hàng (NPP)
        </div>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
						...
						<TH align="center" style="width: 10%" >Tác vụ </TH> 
	               		<TH>  <A href = "../../ErpDuyetddhNppOtcSvl?userId=<%=userId%>&duyet=duyentoanbo"><IMG src="../images/Chot.png" alt="Duyệt toàn bộ đơn đặt hàng" title="Duyệt toàn bộ đơn đặt hàng" border=0>   </TH>
	                </TR>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center">   
                             		...
                             		<A href = "../../ErpduyetdonhangotcUpdateSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
