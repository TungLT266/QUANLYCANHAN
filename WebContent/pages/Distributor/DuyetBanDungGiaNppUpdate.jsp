				  ...
				  <TD height="100%" width="100%">
						...
						<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
						  ...
						  <TR style="display: none;" >
								...
								<TD class="plainlabel" width="90px" >Khu vực</TD>
								<TD class="plainlabel" >
						...
						<hr />
		                  ...
		                  <td align="center" width="10%">Mã khách hàng</td>
		                    	...
		                    	<td align="center" width="10%">CK Ủng hộ <input type="checkbox" name="checkAll3" id="checkAll3" onchange="SelectALL2();" > </td>
		                    	<%if(obj.getThang().equals("3") || obj.getThang().equals("6") || obj.getThang().equals("9") || obj.getThang().equals("12")){ %>
		                    	<td align="center" width="10%">Hưởng CK quý <input type="checkbox" name="checkAll2" id="checkAll2" onchange="SelectALL2();" > </td>
		                    	<%} %>
		                    </TR>
