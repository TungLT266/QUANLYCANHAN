...
<form name="hctmhForm" method="post" action="../../ErpXacnhannhanhangUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng > Biên bản nhận hàng > Cập nhật
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpXacnhannhanhangSvl?userId=<%= userId %>" >
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle"> Biên bản nhận hàng </legend>
        	<div style="float:none; width:100%" align="left">
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    <TD class="plainlabel" >Ngày xác nhận </TD>
                    <TD class="plainlabel" >
				...
				<TR>
                    <TD class="plainlabel" >Đại diện công ty</TD>
                    <TD class="plainlabel" colspan="3" >
                    	<table>
                    		<tr>
                    			<td>
                    				<select name = "nvIds" class="select2" style="width: 550px" multiple="multiple" >
			                    		<option value="" ></option>
			                    		<% if( nhanvienRs != null ) { 
			                    			while( nhanvienRs.next() ) {
			                    				if( lsxBean.getNhanvienIds().contains(nhanvienRs.getString("pk_seq")) ){ %>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="250px" colspan="3"  >
                    	<select name = "khId" class="select2" style="width: 550px" onchange="LocLaiPO();"   >
                    		<option value=""> </option>
                        	<%
                        		if(nppRs != null)
                        		{
                    ...
                    <TD class="plainlabel" style="display: none;" >Kho xuất </TD>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    		...
                    		<table style="width: 100%" cellpadding="1" cellspacing="1" >
                    			<TR class="tbheader">
				                    ...
				                    <TH align="center" style="width: 24%" >Khách hàng</TH>
					             ...
					             <table style="width: 98%" cellpadding="1" cellspacing="1"  >
					                <% if( ddhRs != null ) { 
					                	while( ddhRs.next() ) { %>
					                		...
					                		<tr>
					                			<td style="width: 10%" ><input type="text" value="<%= ddhRs.getString("MACHUNGTU") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 8%" ><input type="text" value="<%= ddhRs.getString("SOHOADON") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 8%" ><input type="text" value="<%= ddhRs.getString("NGAYXUATHD") %>" disabled="disabled" style="width: 100%;" ></td>
					                			<td style="width: 24%" ><input type="text" value="<%= ddhRs.getString("khTEN") %>" disabled="disabled" style="width: 100%;" ></td>
			...
			<table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="10%" >Đã nhận</th>
