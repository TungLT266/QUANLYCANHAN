...
<script language="javascript" type="text/javascript">
	...
	function TinhTien()
	 ...
	 function changeTDV()
	 { 
		 document.forms['hctmhForm'].action.value='changeTDV';
	     document.forms["hctmhForm"].submit();
	 }
	 ...
	 function XoaKhuyenMai( scheme )
	 {
		 document.forms['hctmhForm'].action.value='xoaSCHEME';
		 document.forms['hctmhForm'].schemeXOA.value=scheme;
	     document.forms["hctmhForm"].submit();
	 }
...
<input type="hidden" name="schemeXOA"  value=''>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
			Quản lý bán hàng > Bán hàng > Đơn hàng bán > Cập nhật
        </div>
    	...
    	<legend class="legendtitle">Đơn hàng bán</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">
                ...
                <TR>
                    ...
                    <TD class="plainlabel"    >
                    	<select name = "ddkdId"  class="select2" style="width: 315px" onchange="changeTDV();"  >
                    		<option value=""  > </option>
                        	<%
                        		if(ddkdRs != null)
                        		{
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr <%= style %>  >
								<td >
									<input type="text" name="spMa" value="<%= spMa[i].trim() %>" style="width: 100%"  onkeyup="ajax_showOptions(this,'nhapkho',event); " AUTOCOMPLETE="off"  onkeydown="keyCode(event, <%= i %>)"  > 
								...
								<% if(lsxBean.getLoaidonhang().equals("1")) { %>	
									...
									<td>
										...
										<input type="hidden" name="spChiavaodongia" value="<%= lsxBean.getSpChiavaodongia() %>"  > 
										
										<% if( spScheme[i].trim().length() > 0 && spThetich[i].equals("2") ) { %>
											<input type="text" name="scheme" value="<%= spScheme[i] %>" style="width: 80%; color: red; " readonly="readonly" > 
											<img  src="../images/Delete20.png" width="20" height="20" title="Xóa khuyến mại <%= spScheme[i] %>" border='0' onclick="XoaKhuyenMai('<%= spScheme[i] %>');" style="cursor: pointer;" >
										<% } else { %>
							...
							<% if(lsxBean.getLoaidonhang().equals("1")) { %>	
								...
								<td>
									...
									<td>
										...
										<input type="hidden" name="spChiavaodongia" value="1"  > 
									</td>
							<% } else if(lsxBean.getLoaidonhang().equals("2")) { %>
								<td> 
									<input type="text" name="scheme" value="" style="width: 100%; color: red; " readonly="readonly" > 
