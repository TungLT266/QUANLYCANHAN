...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
			Quản lý bán hàng > Bán hàng > Đơn hàng bán > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
  		<% if( lsxBean.getCapduyet().trim().length() <= 0 ) { %>
        ...
        <A href="../../ErpDonhangNppETCUpdateSvl?userId=<%=userId %>&id=<%= lsxBean.getId() %>&task=print&MTV=<%= lsxBean.getIsMTV() %>" >
    ...
    <fieldset>
    	<legend class="legendtitle">Đơn hàng bán</legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">
                	...
                	<TD class="plainlabel" >
                		...
                		<% if( !lsxBean.getLoaidonhang().equals("0") && lsxBean.getCapduyet().equals("CS") ) { %>
	                		<% if(lsxBean.getTratichluy().equals("1")) { %>
	                    		<input type="checkbox" name="tratichluy" value="1" checked="checked" onclick="return false;" > Trả tích lũy
	                   		<% } else { %>
	                   			<input type="checkbox" name="tratichluy" value="1" onclick="return false;" > Trả tích lũy
	                   		<% } %>
                   		<% } %>
                ...
                <tr>
                	<TD class="plainlabel" >Lý do không duyệt </TD>
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text"  name="lydokhongduyet" value="<%= lsxBean.getLydokhongduyet() %>" style="width: 700px;" />
                    </TD>
                </TR>
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr <%= style %>  >
								<td >
									<input type="text" name="spMa" value="<%= spMa[i].trim() %>" style="width: 100%"  onkeyup="ajax_showOptions(this,'nhapkho',event)" AUTOCOMPLETE="off"   > 
								...
								<td><input type="text" name="soluong" value="<%= spSoluong[i].trim() %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > </td>
								<td> 
