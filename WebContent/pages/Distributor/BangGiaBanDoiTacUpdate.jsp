...
<%@ page  import = "geso.traphaco.distributor.beans.banggiabandoitac.imp.*" %>
<%@ page  import = "geso.traphaco.distributor.beans.banggiabandoitac.*" %>
				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết lập dữ liệu nền > Dữ liệu nền sản phẩm > Bảng giá bán cho đối tác > Cập nhật</TD> 
