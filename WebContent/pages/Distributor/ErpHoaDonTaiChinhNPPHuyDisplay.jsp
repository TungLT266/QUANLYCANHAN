...
<% 
	...
	String[] tenxuatHD = lsxBean.getTenXuatHD();
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Nghiệp vụ khác > Hủy hóa đơn tài chính > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../HuyhoadontaichinhSvl?userId=<%= userId %>&loai=<%= lsxBean.getLoaidonhang() %>" >
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Hóa đơn tài chính </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                 ...
                 <TR>
                   ...
                   <TD class="plainlabel" style="display: none;">
                   			<input name = "loaiXHD"  style="width: 200px" value="<%= lsxBean.getLoaiXHD() %>" >
                   </TD>
                  ...
                  <%if(lsxBean.getLoaiXHD().equals("1")){ %>
                    ...
                    <TD class="plainlabel">
                    	<select name = "tenxhd" class="select2" style="width: 200px" >                    		
                        	<% for(int i=0;i < tenxuatHD.length; i++){ 
                        		 	if(tenxuatHD[i].equals(lsxBean.getTenxuathd())) {%>
                ...
                <TR>
                 ...
                 <TR>
                	<TD class="plainlabel" >Ghi chú 2 </TD>
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text"  name="ghichu2" value="<%= lsxBean.getGhichu2() %>" style="width: 500px" />
                    </TD>
                </TR>
                      <%-- <TR>
