										...
										<TR>
											<TD align="left">
												<TABLE width="100%" border="0" cellpadding="0"
													cellspacing="0">
													<TR height="22">
														<TD align="left" class="tbnavigation">Quản lý bán hàng > NPP bán hàng > Đơn hàng bán > Hiển thị
														</TD>
												...
												<TABLE width="100%" border="0" cellpadding="0"
													...
													<TR class="tbdarkrow">
														<TD width="30" align="left"><A
															href="../../DonhangSvl?userId=<%=userId %>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve"	style="border-style: outset">
														</A>
														</TD>
