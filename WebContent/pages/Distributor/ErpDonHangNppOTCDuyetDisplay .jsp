...
<%@ page  import = "geso.traphaco.distributor.beans.dondathangotc.imp.*" %>
...
<% IErpDonhangNppOTC lsxBean = (IErpDonhangNppOTC)session.getAttribute("lsxBean"); %>
...
<form name="hctmhForm" method="post" action="../../ErpduyetdonhangotcUpdateSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpDuyetddhNppOtcSvl?userId=<%= userId %>" >
