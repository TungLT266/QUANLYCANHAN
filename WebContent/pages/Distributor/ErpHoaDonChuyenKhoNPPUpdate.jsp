...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Nghiệp vụ kho > Hóa đơn khác > Cập nhật
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 20px;" class="days" readonly="readonly"  name="ngayxuat" value="<%= hdBean.getNgayxuatHD() %>"/>
                    </TD>
                    
                    <TD width="150px" class="plainlabel" valign="top">Ngày ghi nhận công nợ </TD>
                    <TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 20px;" class="days" readonly="readonly"  name="ngayghinhan" value="<%= hdBean.getNgayghinhanCN() %>"/>
                    </TD>
                </TR>
                ...
                <TR>
                	...
                	<TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 20px;" name="kyhieuhoadon" value="<%= hdBean.getKyhieuhoadon() %>"/>
                    </TD>
                    
                    <TD class="plainlabel">Số hóa đơn</TD>
                	<TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 20px;"  name="sohoadon" value="<%= hdBean.getSohoadon().trim() %>"/>
                    </TD>
                </TR>
                ...
                <tr>
                 ...
                 <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text"  name="ghichu" value="<%= hdBean.getGhichu() %>" style="border-radius:4px; height: 20px; width: 500px;"  />
                    </TD>
                </TR>
