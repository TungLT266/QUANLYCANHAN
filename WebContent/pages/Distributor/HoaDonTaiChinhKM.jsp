...
<%@ page  import = "geso.traphaco.distributor.beans.hoadontaichinhKM.*" %>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 18%" >Chi nhánh / Đối tác</TH>
					     ...
					     <%-- 	<TD align="center"><%= nhapkhoRs.getString("NGAYTAO") %></TD>	
		                    ...
		                    <% if(tt.equals("1")){ %>
		                    	...
		                    	<%if(quyen[Utility.SUA]!=0){ %>
		                    	 	<A href = "../../HoadontaichinhKMUpdateSvl?userId=<%=userId%>&update=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                                <%} %>
                                
                                <%if(quyen[Utility.CHOT]!=0){ %>
                                	<A href = "../../HoadontaichinhKMSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/Chot.png" alt="Duyệt xuất kho" title="Duyệt xuất kho" width="20" height="20" border=0 ></A>&nbsp;
                              	<%} %>
		                    ...
		                    <%} else{ %>
		                    	...
		                    	<A href = "../../HoadontaichinhKMUpdateSvl?userId=<%=userId%>&display=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
		                   		<%} %>
		                   		
		                   		<%  if( !tt.equals("3") && !tt.equals("5") ) { %>
		                   			
		                   			<%if(quyen[Utility.XEM]!=0){ %>
			                   		<A href = "../../HoadontaichinhKMPdfSvl?userId=<%=userId%>&pdf=<%= nhapkhoRs.getString("PK_SEQ") %>&nppId=<%= obj.getNppId()%>"><IMG src="../images/Printer30.png" alt="In" title="In" width="20" height="20" border=0 ></A>
			                   		<%} %>
