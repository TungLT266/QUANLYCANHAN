...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng không thầu > Sổ xuất hàng > Hiển thị
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
		...
		<A href="../../SoxuathangInSvl?userId=<%=userId%>&id=<%=lsxBean.getId() %>"  >
			<img src="../images/Printer30.png" alt="In" title="In chung tu" width="30" height="30" longdesc="In chung tu" border=1 style="border-style:outset"></A>
    	...
    	<legend class="legendtitle">Sổ xuất hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
				...
				<TR>
                    ...
                    <TD class="plainlabel" >
                    	<select name = "quanhuyenId" class="select2" style="width: 400px" onchange="submitform();">
                        	<option value=""> </option>
                        	<%
                        		if(quanhuyenRs != null)
                        		{
                ...
                <TR>
                    ...
                    <TD class="plainlabel" width="250px" >
                    	<select name = "nvbhId" class="select2" style="width: 200px" onchange="submitform();" >
                    		<option value=""> </option>
                        	<%
                        		if(nvbhRs != null)
                        		{
