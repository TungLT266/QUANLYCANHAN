...
<form name="hctmhForm" method="post" action="../../ErpLenhxuathangNppUpdateSvl">
...
<input type="hidden" name="phanloai" value='<%= lsxBean.getPhanloai() %>'>

<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng > Lệnh xuất hàng > Duyệt lệnh xuất hàng
        </div>
  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpLenhxuathangNppSvl?userId=<%= userId %>&loai=<%= lsxBean.getLoaidonhang() %>" >
  ...
  <%if(!lsxBean.getTrangthai().equals("4")){ %>     
   ...
   <%} %>
    ...
    <div align="left" style="width:100%; float:none; clear:left">
    <fieldset>
    	<legend class="legendtitle">Lệnh xuất hàng </legend>
                ...
                <TR>
                	<TD class="plainlabel" >
                   		<% if(lsxBean.getLoaidonhang().equals("0")) { %>
	                		Nhà phân phối 
	                	<% } else if( lsxBean.getLoaidonhang().equals("1") || lsxBean.getLoaidonhang().equals("2") ) { %>
	                		Khách hàng
	                	<% } else { %>
	                		Nhân viên
	                	<% } %>
				                        		...
				                        		if(spRs != null)
				                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<% if(sanpham_soluong.get( spMa[i] + "__" + spSCheme[i] + "__" + spRs.getString("SOLO") + "__" +  spRs.getString("NGAYHETHAN") ) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= temID %>_spSOLUONG" value="<%= formater2.format(Double.parseDouble( sanpham_soluong.get( spMa[i] + "__" + spSCheme[i] + "__" + spRs.getString("SOLO") + "__" +  spRs.getString("NGAYHETHAN") ).replaceAll(",", "") )) %>" onkeyup="CheckSoLuong_DeXuat(this);" >
				                        				<% } else { %>
