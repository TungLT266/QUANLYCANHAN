...
<%@ page  import = "geso.traphaco.distributor.beans.thongtinsanpham.IThongtinsanpham" %>
...
<form name="spForm" method="post" action="../../DThongtinsanphamDisplaySvl">
	...
	<TR>
		<TD colspan="4" align='left' valign='top' bgcolor="#FFFFFF">
			...
			<TR ><TD >
					<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
						<TR class = "tbdarkrow">
							<TD width="30" align="left"><A href="../../DThongtinsanphamSvl?userId=<%=userId %>" ><img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1" longdesc="Quay ve" style="border-style:outset"></A></TD>
							...
							<TR>
								<TD>
									...
									<TABLE border="0" width="100%" cellpadding="4" cellspacing="0">
										...
										<TR>
											<TD class="plainlabel" >Mã sản phẩm <FONT class="erroralert"> *</FONT></TD>
											<TD class="plainlabel"><INPUT type="text" name="masp" size="13" value = '<%=spBean.getMasp() %>'></TD>
										 	<TD class="plainlabel">Đơn vị đo lường <FONT class="erroralert"> *</FONT></TD>
						  	  				<TD class="plainlabel"><select name="dvdlId" id="dvdlId" ">
												<option value="" > </option>
													<%
														if(dvdl != null){
														try{
										...
										<TR>
											<TD class="plainlabel">Tên sản phẩm<FONT class="erroralert">*</FONT></TD>
										  	<TD class="plainlabel"><input name="tensp" type="text" size="40" value = '<%=spBean.getTen() %>'></TD>
										 ...
										 <TR>
											  ...
											  <%
											  String gia="";
											  if(spBean.getGiablc() != null && spBean.getGiablc().trim().length()!=0)
											  {
											  ...
											  <%-- <% if(spBean.getType().equals("1")) {%>
											  		<input name="type" type="checkbox" id="type" value="1" checked="checked" > is Bundle		
											  <%}else{ %>
											  		<input name="type" type="checkbox" id="type" value="0" > is Bundle	
											  <%} %>	 --%>
											  			  				
											  </TD>
											  <TD class="plainlabel">Ngành hàng</TD>
											  <TD class="plainlabel"><%= spBean.getnganhHang()%></TD>
										</TR>
										...
										<TR>
												<TD class="plainlabel" >Sản phẩm mới &nbsp; <%
													...
													<TD class="plainlabel" colspan="4">Sản phẩm chủ lực &nbsp; <%
