...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng > Xuất hóa đơn > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD class="plainlabel" valign="top">
                    	<input type="text" class="days" readonly="readonly"  name="ngayxuat" value="<%= hdBean.getNgayxuatHD() %>"/>
                    </TD>
                    
                    <TD width="150px" class="plainlabel" valign="top">Ngày ghi nhận công nợ </TD>
                    <TD class="plainlabel" valign="top">
                    	<input type="text" class="days" readonly="readonly"  name="ngayghinhan" value="<%= hdBean.getNgayghinhanCN() %>"/>
                    </TD>
                </TR>
                ...
                <TR>
                	...
                	<TD class="plainlabel" valign="top">
                    	<input type="text"   name="sohoadon" value="<%= hdBean.getSohoadon().trim() %>"/>
                    </TD>
                </TR>
                	...
                	<TR>
                      ...
                      <TD class="plainlabel">
                		...
                		<TD class="plainlabel">
	                    	...
	                    	<%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                    	In Người mua hàng
	                    	<%if(hdBean.getInNguoimua().equals("1")){%>                   	
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                    	<select name="hinhthuctt" id="hinhthuctt" style="width: 200px;" >
							    <% 
							   String[] mangchuoi=new String[]{"TM/CK","Chuyển khoản","Tiền mặt", "TM/CK/CTH"};
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text"  name="ghichu2" value="" style="width: 500px" />
                    </TD>
                </TR>
			...
			<hr />
			 ...
			 <table cellpadding="0px" cellspacing="1px" width="100%">
				<tr class="tbheader">
					...
					<th align="center" width="10%" >Chọn in</th>
				</tr>
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
       			                        		...
       			                        		if(spRs != null)
       			                        		{
				                        			...
				                        			<tr>
				                        				...
				                        				<% if(sanpham_soluong.get( temID ) != null ) { %>
				                        					<input type="text" style="width: 100%;text-align: right;" name="<%= spMa[i] + "_" + spSCheme[i] %>_spSOLUONG"  value="<%= formater.format(Double.parseDouble( sanpham_soluong.get( temID ))) %>" onkeyup="CheckSoLuong_DeXuat(this);" >				          
							...
							<td align="center">							 
           	 			 	 <% if(spChonin[i].equals("1")) { 	%>           	 			
           	 					<input type="checkbox" name = "<%= "spChonin" + i %>" id = "<%= "spChonin" + i %>" value="1" checked="checked" onchange="ReadOnly(<%= i %>);"  > 
           	 					
           	 				<%	} else {%>
           	 					<input type="checkbox" name = "<%= "spChonin" + i %>"  id = "<%= "spChonin" + i %>" value="1" onchange="ReadOnly(<%= i %>);" >
