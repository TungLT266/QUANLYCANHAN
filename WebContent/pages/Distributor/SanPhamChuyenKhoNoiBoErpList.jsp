...
<%
	...
	{	
		...
		String nhomkenhId = "100000"; //MTV luon lay kenh thau
		String command = " select a.ma, a.ten, b.donvi, isnull(a.hansudung, 0) as hansudung, isnull( a.thuexuat, c.thuexuat) as thuexuat, " + 
						 " ISNULL( ( select sum(available) from NHAPP_KHO where KHO_FK = '" + khoId + "' and sanpham_fk = a.pk_seq  and npp_fk = '" + nppId + "' and nhomkenh_FK in(  '" + nhomkenhId + "') ), 0 ) as avai " +
