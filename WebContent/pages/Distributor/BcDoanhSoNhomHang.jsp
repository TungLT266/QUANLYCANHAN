...
<%@page import="geso.traphaco.distributor.beans.reports.IBcDoanhSoNhomHangNpp"%>
									...
									<TD width="98%">
										<TABLE width="100%" border="0" cellpadding="6">
											<TR class="tbheader">
											    ...
											    <TH width="11%" rowspan="2">Chi nhánh / Đối tác</TH>
											    <TH width="7%" rowspan="2">Trình dược Viên</TH>
