...
<% IDuyetdonhang dhBean = (IDuyetdonhang)s.getAttribute("dhBean"); %>
...
<script language="javascript" type="text/javascript">
	...
	{	
		 document.getElementById("btnChot").innerHTML = "<a href='#'><img src='../images/waiting.gif'  title='cho thuc hien..' border='1' longdesc='cho thuc hien..' style='border-style:outset'> Processing...</a>";
	 	 ...
	 	 document.forms['dhForm'].action.value='duyetdonhang';
	     document.forms['dhForm'].submit();
	 }
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0" onload="EnterKhachHang();" >
	<form name="dhForm" method="post" action="../../DuyetdonhangUpdateSvl">
		...
		<input type="hidden" name="capduyet" id="capduyet" value='<%= dhBean.getCapduyet() %>'>
										...
										<TR>
											<TD align="left">
												<TABLE width="100%" border="0" cellpadding="0"
													cellspacing="0">
													<TR height="22">
														<TD align="left" class="tbnavigation">Quản lý bán hàng > Báo cáo đại lý > Duyệt đơn hàng <%= dhBean.getCapduyet() %> > Hiển thị
														</TD>
												...
												<TABLE width="100%" border="0" cellpadding="0"
													...
													<TR class="tbdarkrow">
														<TD width="30" align="left"><A
															href="../../DuyetdonhangSvl?userId=<%= userId %>&capduyet=<%= dhBean.getCapduyet() %>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve"	style="border-style: outset">
														</A>
														</TD>
														<TD width="30" align="left"><A
													...
													<TABLE cellpadding="3" cellspacing="0" width="100%"
														...
														<TR class="tblightrow">
															...
															<TD class="plainlabel" colspan="3" >
																...
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    											<span class="plainlabel" style="color: red;" >Chiết khấu </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										                    	...
										                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    											<span class="plainlabel" style="color: red;" >Tổng thanh toán </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
