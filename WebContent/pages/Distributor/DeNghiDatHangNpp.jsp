<%@page import="geso.traphaco.distributor.beans.denghidathangnpp.IDenghidathangnppList"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "geso.traphaco.distributor.beans.denghidathang.IDenghidathangList" %>
