	...
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	<% if(obj.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng cho NPP > Đơn trả hàng
			<% } else if(obj.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng thầu > Đơn trả hàng
			<% } else { %>
				Quản lý bán hàng > Bán hàng không thầu > Đơn trả hàng
			<% } %>
        </div>
                ...
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                     ...
                     <TD class="plainlabel" width="15%">Số chứng từ</TD>
                        ...
                        <TD class="plainlabel" valign="middle">
                           <select name="trangthai" style="width: 200px" class="select2"  onchange="submitform();"  >
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <%if(quyen[Utility.SUA]!=0){ %>
                                <A href = "../../DontrahangUpdateSvl?userId=<%=userId%>&update=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                              <% } %>
                                
                                <%if(quyen[Utility.CHOT]!=0){ %>
                                <A href = "../../DontrahangSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("PK_SEQ") %>&loaidonhang=<%= obj.getLoaidonhang() %>"><img src="../images/Chot.png" alt="Chốt" title="Chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn chốt Trả hàng này?')) return false;"></A>&nbsp;
                                 <% } %>
                                
                                <%if(quyen[Utility.XOA]!=0){ %>
                              	<A href = "../../DontrahangSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>&loaidonhang=<%= obj.getLoaidonhang() %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa Trả hàng này?')) return false;"></A>
                              	<% } %>
                              										
		                    <%} else{ %>
		                    
		                    <%if(quyen[Utility.XEM]!=0){ %>
		                    	<A href = "../../DontrahangUpdateSvl?userId=<%=userId%>&display=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
		                   <% } %>
		                   
		                     <%-- <% if(tt.equals("2") && (quyen[Utility.XOA]!=0)){ %> 
                              	<A href = "../../DontrahangSvl?userId=<%=userId%>&UnChot=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/unChot.png" alt="Mở Chốt" title="Mở Chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn mở Trả hàng về NCC này?')) return false;"></A>
                              	 <% } %> --%>
