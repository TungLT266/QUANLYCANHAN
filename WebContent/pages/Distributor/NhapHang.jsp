...
<%@ page  import = "geso.traphaco.distributor.beans.nhaphang.INhaphangList" %>
                                    ...
                                    while (nhaphanglist.next()){
                                        ...
                                        <%} else {%>
                                        	...
                                        	<%}%>
                                                ...
                                                <TD><div align="center"><%= formatter.format(Float.parseFloat(nhaphanglist.getString("sotienavat"))) %></div></TD>
                                	                    ...
                                	                    <TR><TD>
                                	                    	<% if (nhaphanglist.getString("trangthai").equals("0") ) {%>
                                	                    		...
                                	                    		<%if(quyen[Utility.SUA]!=0){ %>
	                                    	                    	<A href = "../../NhaphangUpdateSvl?userId=<%=userId%>&update=<%=nhaphanglist.getString("chungtu") %>"><img src="../images/Chot.png" alt="Nhận hàng" width="20" height="20" longdesc="Nhận hàng" border = 0 "></A>
																<%} %>
																
															<%}else{ %>
															
																<%if(quyen[Utility.XEM]!=0){ %>
                                	                    			<A href = "../../NhaphangUpdateSvl?userId=<%=userId%>&display=<%=nhaphanglist.getString("chungtu") %>"><img src="../images/Display20.png" alt="Hiển thị" width="20" height="20" longdesc="Hiển thị" border = 0 "></A>
																<%} %>
															<%} %>                                    	                   
                                        	            </TD>
