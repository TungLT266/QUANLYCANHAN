			...
			if(nppDNId == '106179') // Nếu Nhà Hải Phòng: các cột để 4 số lẻ
			{
				for(var i = 0; i < spMa.length; i++)
				{
					if(spMa.item(i).value != "" && dongia.item(i).value != "" && soluong.item(i).value != "" )
					{
						...
						var tt = Math.round(parseFloat(thanhtien.item(i).value.replace(/,/g,"")));
						...
						var tt_coCK = Math.round(parseFloat(thanhtien.item(i).value.replace(/,/g,""))) - parseFloat(ck_sp);
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Nghiệp vụ kho > Hóa đơn khác > Tạo mới
        </div>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                <TR>
                    ...
                    <TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 22px;" class="days" readonly="readonly"  name="ngayxuat" value="<%= hdBean.getNgayxuatHD() %>"/>
                    </TD>
                    
                    <TD width="150px" class="plainlabel" valign="top">Ngày ghi nhận công nợ </TD>
                    <TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 22px;" class="days" readonly="readonly"  name="ngayghinhan" value="<%= hdBean.getNgayghinhanCN() %>"/>
                    </TD>
                </TR>
                ...
                <TR>
                	...
                	<TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 22px;"  name="kyhieuhoadon" value="<%= hdBean.getKyhieuhoadon() %>"/>
                    </TD>
                    
                    <TD class="plainlabel">Số hóa đơn</TD>
                	<TD class="plainlabel" valign="top">
                    	<input type="text" style="border-radius:4px; height: 22px;"  name="sohoadon" value="<%= hdBean.getSohoadon().trim() %>"/>
                    </TD>
                </TR>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3">
                    	<select name="hinhthuctt" id="hinhthuctt" class="select2" style="width: 200px;" >
							    <% 
                 ...
                 <tr>
                    ...
                    <TD class="plainlabel" colspan="3">
					<select name = "doituong" id= "doituong" class="select2" style = "width:200px" onchange="loadcontent();">
							...
							<img  alt="Thông tin xuất hóa đơn " src="../images/vitriluu.png"></a>
						        <DIV id="sub" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 500px; padding: 4px;" >
						           ...
						           <tr>
						              ...
						              <td> 
						               	  <input type="text" id="nguoimuahang" name="nguoimuahang"  style="width: 100%; border-radius:4px; height: 22px;" value="<%= hdBean.getNguoimuahang() %>" > 
						              </td>
						           </tr>
		                           <tr>
		                              <td>Đơn vị: </td>
		                              <td> 
		                            	  <input type="text" id="donvinmh" name="donvinmh"  style="width: 100%; border-radius:4px; height: 22px;" value="<%= hdBean.getDonvimua() %>" > 
		                              </td>
		                           </tr>	
		                           <Tr>
		                               <td>Địa chỉ: </td>
		                               <td> 
		                           		 	<input type="text" id="diachi" name="diachi"  style="width: 100%; border-radius:4px; height: 22px;" value="<%= hdBean.getDiachi() %>" > 
		                               </td>
						           </tr>
		                           <Tr>
		                               <td>Mã số thuế: </td>
		                               <td> 
		                              		 <input type="text" id="masothue" name="masothue"  style="width: 100%; border-radius:4px; height: 22px;" value="<%= hdBean.getMasothue() %>" > 
		                               </td>
			                       </tr>
			                       </table>
				                    <div align="right">
              ...
              <%} %>
                 ...
                 <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text" style="border-radius:4px; height: 22px;width: 500px;" name="ghichu" value="<%= hdBean.getGhichu() %>" />
                    </TD>
                </TR>
                    ...
                    <TD class="plainlabel" colspan="2" valign="bottom" >
                		<table class="plainlabel" width="100%"  style="padding-top:0 ; margin-top:0">                 								                   								                   								
               				<tr>
               					<td>Tổng tiền </td>
               					<td>
               						<input type="text" style="text-align:right; border-radius:4px; height: 22px;" id="tongtien" name="tongtien" value="<%= hdBean.getTongtienBVAT() %>" >
               					</td>
               				</tr>
               				<tr>
               					<td>Tiền chiết khấu </td>
               					<td>
               						<input type="text" style="text-align:right; border-radius:4px; height: 22px;" id="tongchietkhau" name="tongchietkhau" value="<%= hdBean.getTongCK() %>">
               					</td>
               				</tr>                 				  
               				<tr>
               					<td>Phần trăm chiết khấu </td>
               					<td>
               						<input type="text" style="text-align:right; border-radius:4px; height: 22px;" id="ptchietkhau" name="tongchietkhau" value="<%= hdBean.getPtchietkhau() %>">
               					</td>
               				</tr>                   				  
               				...
               				<tr>
               					<td>Tiền vat </td>
               					<td>
               						<input type="text" style="text-align:right; border-radius:4px; height: 22px;" id="tienvat" name="tienvat" value="<%= hdBean.getTongVAT() %>">
               					</td>
               				</tr>
               				...
               				<tr>
               					<td>Tiền thực thu </td>
               					<td>
               						<input type="text" style="text-align:right; border-radius:4px; height: 22px;" id="tiensauvat" name="tiensauvat" value="<%= hdBean.getTongtienAVAT() %>">
               					</td>
               				</tr>
                  		</table>
                  	</TD>  
			 ...
			 <table cellpadding="0px" cellspacing="1px" width="100%">
				...
				<%
					...
					if(spMa != null)
					{
						...
						<tr>
							<td>
								<input type="hidden" name="ckId" value="<%= spCkId[i] %>" style="width: 100%"   > 	
								<input type="hidden" name="spId" value="<%= spId[i] %>" style="width: 100%"   > 								
								<input type="text" style="width: 100%; border-radius:4px; height: 22px;" name="spMa" value="<%= spMa[i] %>" readonly="readonly"  > 
							</td>
							<td> <input type="text" name="spTen" value="<%= spTen[i] %>" style="width: 100%; border-radius:4px; height: 22px;" > </td>
							<td>
								 <input type="text" name="donvi" value="<%= spDonvi[i] %>" style="width: 100%; border-radius:4px; height: 22px; text-align: right;" readonly="readonly">	 						
							</td>
							<td>
								<input type="text" name="soluong" value="<%= formatter.format(Double.parseDouble(spSoluong[i])) %>" style="width: 70%; text-align: right; border-radius:4px; height: 22px;" readonly="readonly" >															
									<a href="" id="scheme_<%= spMa[i] + "__" + spSCheme[i] + "__" + spCkId[i] %>" rel="subcontent_<%= spMa[i] + "__" + spSCheme[i] + "__" + spCkId[i] %>">
					                    ...
					                    <table width="95%" align="center">
					                    	<tr>
					                    		<td ><b>Tổng xuất</b></td>
					                    		<td colspan="3" > <input type="text" name="soluong2" value="<%= spSoluong[i] %>" style="width: 100px; text-align: right; height: 22px; border-radius:4px;" readonly="readonly" >	</td>
					                    	</tr>
					                        <tr>
			                            	...
			                            	<%
			                            		ResultSet spRs = hdBean.getSoloTheoSp(spId[i], spDonvi[i], spSoluong[i], spCkId[i]);  
       			                        		if(spRs != null)
       			                        		{
				                        			...
				                        			<tr>
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: right; height: 22px; border-radius:4px;" name="<%= spMa[i] + "_" + spSCheme[i] + "_" + spCkId[i] %>_spSOLUONG" value="<%= formater.format(spRs.getDouble("AVAILABLE")) %>" readonly="readonly">
				                        				</td>
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center; height: 22px; border-radius:4px;" name="<%= spMa[i] + "_" + spSCheme[i] + "_" + spCkId[i] %>_spSOLO" value="<%= spRs.getString("SOLO") %>" readonly="readonly">
				                        				</td>
				                        				<td>
				                        					<input type="text" style="width: 100%;text-align: center; height: 22px; border-radius:4px;" name="<%= spMa[i] + "_" + spSCheme[i] + "_" + spCkId[i] %>_spNGAYHETHAN" value="<%= spRs.getString("NGAYHETHAN") %>" readonly="readonly">
				                        				</td>				                        				
				                        			</tr>
							...
							<td>
								<input type="text" name="spDongia" value="<%= formatter2.format(Double.parseDouble(spDongia[i])) %>" style="width: 100%; text-align: right; height: 22px; border-radius:4px;" readonly="readonly" >
							...
							<td>
								<input type="text" name="spChietkhau" value="<%= formatter.format(Double.parseDouble(spChietkhau[i])) %>" style="width: 100%; text-align: right; height: 22px; border-radius:4px;" readonly="readonly">
							</td>
							<td>
								<input type="text" name="spTienthue" value="<%= formatter.format(Double.parseDouble(spTienThue[i])) %>" style="width: 100%; text-align: right; height: 22px; border-radius:4px;" readonly="readonly"  >
							</td>
							<td>
								
								<input type="text" name="thanhtien" value="<%= formatter2.format(Double.parseDouble(spThanhtien[i])) %>" style="width: 100%; text-align: right; height: 22px; border-radius:4px;" onkeypress="return keypress(event); " readonly="readonly" > 
							</td>
							<td >
								<input type="text" name="scheme" id = "<%= "scheme" + i %>"   value="<%= spSCheme[i] %>" style="width: 100%; text-align: right; height: 22px; border-radius:4px;" readonly="readonly"  >							
							</td>							
						</tr>	
