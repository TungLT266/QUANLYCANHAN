   ...
   <div id="main" style="width:99%; padding-left:2px">
	 <div align="left" id="header" style="width:100%; float:none">
    	  <div style="width:40%; padding:5px; float:left" class="tbnavigation">
        	Quản lý KM, trưng bày > Khuyến mại > Đăng ký khuyến mãi tích lũy > Hiển thị 
          </div>
    ...
    <fieldset>
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="1">
        	<Tr class="tbheader">
        		<td width="13%" >Mã khách hàng</td>
        		<td width="20%" >Tên khách hàng</td>
        		<td width="25%" >Địa chỉ</td>
        		<td width="12%" >Số hợp đồng</td>
        	...
        	<%
	        	...
	        	{ 
	        		...
	        		<tr>
        				...
        				<td>
        					<input type="text" name="khDoanhso" value="<%= khDoanhso[i] %>" style="width: 100%; text-align: right;" > 
        				</td>
	        		</tr>
