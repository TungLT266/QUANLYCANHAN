...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="khForm" method="post" action="../../TdvdoanhsoupdateSvl">
		<input type="hidden" name="userId" value='<%=userId%>'> <input
			type="hidden" name="nppId" value='<%=khBean.getNppId()%>'>
		<input type="hidden" name="action" value='1'> <input
			type="hidden" name="type" value='<%=khBean.gettype()%>'>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết
											lập dữ liệu nền> Dữ liệu nền kinh doanh > Cộng tác viên bổ sung doanh số > Tạo
											mới
								...
								<FIELDSET>
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
										...
										<TR>
											...
											<TD class="plainlabel" colspan="4"> <SELECT name="ddkdId"
												onChange="submitform();" >
													<option value=""></option>
													<%
								...
								<FIELDSET>
									...
									if (i % 2 != 0) {
										...
										<TR class=<%=darkrow%>>
											...
											%>
											<TD align="center"> <%=tbhRs.getString("ma") %>
												<input type="hidden" name="makh" value='<%=tbhRs.getString("pk_seq") %>'>
												</TD>
												
												
											<TD align="center"><div align="left"><%=tbhRs.getString("ten") %>
												</div>
											</TD>

											<TD align="center">
											<input name='doanhso' type="text" value="<%=khBean.getDoanhso()==""?"0":khBean.getDoanhso() %>" onkeypress="return keypress(event);" maxlength="10"  style="width: 100%">
											</TD>
										...
										<TR class=<%=darkrow%>>
											...
											%>
											<TD align="center"><%=kh_dsrs.getString("ma") %>
											...
											<TD align="center">
											<input name='doanhso' type="text" value="<%=khBean.getDoanhso()%>"onkeypress="return keypress(event);" maxlength="10"  style="width: 100%">
											</TD>
