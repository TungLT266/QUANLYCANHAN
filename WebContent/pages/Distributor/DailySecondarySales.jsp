	...
	<form name="frm" method="post" action="../../DailySecondarySalesTTSvl">
		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left" class="tbnavigation">Quản lý bán hàng &#62; Báo cáo &#62; Doanh số Sales Out</div>
			...
			<div align="left"
				...
				<fieldset>
                    ...
                    <TR>
									...
									<TD class="plainlabel" colspan="3"><select name="diabanid"
										class="select2" id="khoid" style="width: 250px"
										onchange="search();">
											<option value="" selected>All</option>
											<% if(rsdiaban != null)
