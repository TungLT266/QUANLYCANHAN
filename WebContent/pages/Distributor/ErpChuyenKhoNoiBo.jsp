...
<%@ page  import = "geso.traphaco.distributor.beans.chuyenkhonoibo.*" %>
<%@ page  import = "geso.traphaco.distributor.beans.chuyenkhonoibo.imp.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<% IErpChuyenKhonoiboList obj = (IErpChuyenKhonoiboList)session.getAttribute("obj"); %>
...
<% obj.setNextSplittings();
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("ErpChuyenKhoNoiBoSvl","",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpChuyenKhoNoiBoSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý tồn kho > Nghiệp vụ khác > Chuyển kho nội bộ
        </div>
        ...
        <fieldset style="margin-top:5px" >
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                     ...
                     <TR>
                     <TD class="plainlabel" width="15%">SCHEME
                     </TD>
                        <TD class="plainlabel">
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH style="width: 7%" align="center">Ngày xuất</TH>
	                     <TH style="width: 7%" align="center">SCHEME </TH>
	                    <TH style="width: 15%" align="center">Trình dược viên </TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="left"><%= nhapkhoRs.getString("tentdv") %></TD>  
		                    	 <TD align="center">
		                    	<%
		                    		String trangthai = "";
		                    ...
		                    <%if(quyen[Utility.SUA]!=0){ %>
                                <A href = "../../ErpChuyenKhoNoiBoUpdateSvl?userId=<%=userId%>&update=<%=nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Edit20.png" alt="Cập nhật" title="Cập nhật" border=0></A>&nbsp;
                              <% } %>
                                
                                <%if(quyen[Utility.CHOT]!=0){ %>
                                <A href = "../../ErpChuyenKhoNoiBoSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/Chot.png" alt="Chốt" title="Chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn chốt xuất chuyển hàng này?')) return false;"></A>&nbsp;
                                 <% } %>
                                
                                <%if(quyen[Utility.XOA]!=0){ %>
                              	<A href = "../../ErpChuyenKhoNoiBoSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa xuất chuyển hàng này?')) return false;"></A>
                              	<% } %>
                              										
		                    <%} else{ %>
		                    
		                    <%if(quyen[Utility.XEM]!=0){ %>
		                    	<A href = "../../ErpChuyenKhoNoiBoUpdateSvl?userId=<%=userId%>&display=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
		                   <% } %>
		                   
<%-- 		                    <% if(tt.equals("1") && (quyen[Utility.XOA]!=0)){ %> --%>
<%--                               	<A href = "../../ErpChuyenKhoNoiBoSvl?userId=<%=userId%>&UnChot=<%= nhapkhoRs.getString("PK_SEQ") %>"><img src="../images/unChot.png" alt="Mở Chốt" title="Mở Chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn mở xuất chuyển hàng này?')) return false;"></A> --%>
<%--                               	<% } %> --%>
