...
<%@ page import="geso.traphaco.distributor.beans.hoadonphelieu.IErpHoadonphelieuList"%>
...
<%	
	...
	int[] quyen = new  int[6];
	quyen = util.Getquyen("ErpHoadonphelieuSvl","",userId);
            ...
            <TR>
                <TD align="left" class="tbnavigation">
                    <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                        <TR height="22">
                            <TD align="left" colspan="2" class="tbnavigation"> Quản lý bán hàng > Nghiệp vụ khác > Xuất hóa đơn khác </TD>  
        ...
        <TABLE width="100%" cellpadding="0" cellspacing="1">
            <TR>
                ...
                <TR>
                    <TD width="100%">
                        <FIELDSET>
                            <LEGEND class="legendtitle">&nbsp;Xuất hóa đơn khác &nbsp;&nbsp;	
