										...
										<TR>
											<TD align="left">
												<TABLE width="100%" border="0" cellpadding="0"
													cellspacing="0">
													<TR height="22">
														<TD align="left" class="tbnavigation">Quản lý bán hàng > Báo cáo đại lý > Duyệt đơn hàng <%= dhBean.getCapduyet() %>
														</TD>
										...
										<tr>
											<TD align="left" colspan="4" class="legendtitle">
												<FIELDSET>
													...
													<textarea name="dataerror" style="width: 100%; font-weight: bold"
