...
<% IErpImportdonhangList obj = (IErpImportdonhangList)session.getAttribute("obj"); %>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpImportdonhangSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng > Import đơn hàng
        </div>
