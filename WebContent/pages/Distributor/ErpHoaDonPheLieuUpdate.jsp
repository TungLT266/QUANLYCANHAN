				...
				<TR>
					<TD align="left" class="tbnavigation">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
						  <tr height="22">
							 <TD align="left" colspan="2" class="tbnavigation">&nbsp;Quản lý bán hàng > Nghiệp vụ khác > Xuất hóa đơn khác > Cập nhật</TD> 
			                 ...
			                 <%if(obj.getKhoanmucDTId().equals("400002")||obj.getKhoanmucDTId().equals("400003")){ %>
	                          ...
	                          <TR>
				                    ...
				                    <TD  class="plainlabel" valign="middle" >Kênh bán hàng</TD>
			                  		<TD  class="plainlabel" valign="middle" >
			                  		<select id= "kbhId" name= "kbhId" style="width: 200px" class="select2" >			                  			
			                  			<!-- <option value = ""></option>  -->
			                  			<%try{ %>
			                  				<%if(kbhRs != null){ 
			                  				   while(kbhRs.next()) {%>
				                  			 ...
				                  			 while (m < 20) { %>
				                  				...
				                  				<tr>
				                  					...
				                  					<td>
				                  						...
				                  						<input type="hidden" name="dvt_fk" value="" style="width: 100%; "  >
				                  					</td>
				                  					<td>
