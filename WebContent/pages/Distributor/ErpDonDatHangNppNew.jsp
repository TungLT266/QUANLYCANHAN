...
<% ResultSet nhomkenhRs = lsxBean.getNhomkenhRs(); %>
    	...
    	<legend class="legendtitle">Đơn đặt hàng </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" valign="top">Nhóm kênh </TD>
                    <TD class="plainlabel" valign="top"   >
                    	...
                    	<select name = "nhomkenhId" class="select2" style="width: 200px" onchange="submitform();" >
                    		<option value=""  > </option>
                        	<%
                        		if(nhomkenhRs != null)
                        		{
                        			try
                        			{
                        			while(nhomkenhRs.next())
                        			{  
                        			if( nhomkenhRs.getString("pk_seq").equals(lsxBean.getNhomkenhId())){ %>
                        				<option value="<%= nhomkenhRs.getString("pk_seq") %>" selected="selected" ><%= nhomkenhRs.getString("ten") %></option>
                        			<%}else { %>
                        				<option value="<%= nhomkenhRs.getString("pk_seq") %>" ><%= nhomkenhRs.getString("ten") %></option>
                        		 <% } } nhomkenhRs.close();} catch(SQLException ex){}
                        		}
                        	%>
                    	</select>
                    </TD>         	
                ...
                <TR>
                	<TD class="plainlabel" valign="top">Đơn vị </TD>
                    <TD class="plainlabel" valign="top"  >
