...
<div id="main" style="width:99%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:50%; padding:5px; float:left" class="tbnavigation">
        	Quản lý KM, trưng bày > Trưng bày > Đăng ký trưng bày > Cập nhật
        </div>
  	...
  	<div align="left" style="width:100%; float: none"> 
    	<fieldset>
            ...
            <textarea name="dataerror"  style="width: 100% ; font-weight:bold" cols="71" rows="1"  style="width: 100% " readonly="readonly" ><%= dktbBean.getMessage() %></textarea>
            <% dktbBean.setMessage(""); %>
        </fieldset>
    </div>
    <div align="left" style="width:100%; float:none">
