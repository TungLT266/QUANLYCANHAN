		...
		<div id="main" style="width: 99%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Quản lý tồn kho &#62; Báo cáo &#62; Xuất nhập tồn TDV</div>
                           		...
                           		<TR>
                           			<td colspan="4">
                           			  <%if(obj.getChiTietXNT_Lo_Tong().trim().equals("1")){ %>
							  				<input onclick="capnhat_check()" name="layctnxsolo_tong" id="layctnxsolo_tong"  checked="checked" value="1"  type="checkbox" /> Nhập xuất  theo lô 			
							  		 <%}else{ %>
							  				<input onclick="capnhat_check()"  name="layctnxsolo_tong" id="layctnxsolo_tong"  value="1"  type="checkbox" /> Nhập xuất  theo lô
							  		  <%} %>
