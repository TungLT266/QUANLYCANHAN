  	...
  	<div align="left" id="button" style="width:100%; height:32px; padding:0px; float:none" class="tbdarkrow">
    	<A href= "../../ErpLenhxuathangNppSvl?userId=<%= userId %>&loai=<%= lsxBean.getLoaidonhang() %>" >
        	<img src="../images/Back30.png" alt="Quay ve"  title="Quay ve" border="1px" longdesc="Quay ve" style="border-style:outset"></A>
  			<A href="../../ErpDondathangDoitacInSvl?userId=<%=userId%>&id=<%=lsxBean.getId() %>&nppId=<%= lsxBean.getNppId() %>"  ><img src="../images/Printer30.png" alt="In" title="In chung tu" width="30" height="30" longdesc="In chung tu" border=1 style="border-style:outset"></A>
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<td> 
									...
									<a href="" id="scheme_<%= spMa[i] + "__" + spSCheme[i] %>" rel="subcontent_<%= spMa[i] + "__" + spSCheme[i] %>">
					                    ...
					                    <table width="95%" align="center">
			                            	...
			                            	<%
			                            		ResultSet spRs = lsxBean.getSoloTheoSp_HienThi(spMa[i], spSCheme[i], dvdl_fk, spSoluong[i]);  
				                        		if(spRs != null)
				                        		{
				                        			while(spRs.next())
				                        			{
								...
								<td> <input type="text" name="thanhtien" value="<%= spGianhap[i] %>" style="width: 100%; text-align: right;" readonly="readonly" > </td>
