            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0" border = "0">							
             ...
             <!--      		onChange="ChangeTienTe();" -->
                    ...
                    <TD class="plainlabel">Tìm đối tác</TD>
                  		<TD class="plainlabel" colspan="3">                        
                  		<select name="nppSearchId" style="width: 500px" onChange="ChangeSearch();" >
          <!--         		
                  		onChange="ChangeTienTe();" -->
                           <option value=""> </option>
                        	<%
             ...
             <%} %>
                ...
                <TR>
    	             ...
    	             <TD class="plainlabel" valign="top" colspan = 5>
						<input type="text"  id="sotienhd" name="sotienhd" value="<%= formatter.format(Double.parseDouble(tthdBean.getThuduoc().replaceAll(",",""))) %>"  style="text-align: right;"  onKeyPress = "return keypress(event);" />
					 </TD>
                </TR>
