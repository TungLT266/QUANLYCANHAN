	...
	function replaces()
	{
	 ...
	 function TinhTien()
	 {
	   ...
	   var ngayCL = document.getElementById("ngayCL").value;
		...
		if(parseFloat(ngayCL) < 0) // Từ ngày 2015-01-29 hiện theo kiểu mới
		{
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho NPP > Đơn bán hàng > Hiển thị
        </div>
				...
				<table cellpadding="0px" cellspacing="1px" width="100%">
					...
					<% for(int i = count; i < 0; i++) { %>
						...
						<tr>
							...
							<td> 
								<input type="text" name="dongia" value="" style="width: 100%; text-align: right;" readonly="readonly" > 
								<%if(lsxBean.getNgay_Chenhlech() < 0){ %>
								<input type="hidden" name="dongiagoc" value="" style="width: 100%; text-align: right;" readonly="readonly" > 
								<%} %>
							</td>
