...
<%@page import="geso.traphaco.distributor.beans.denghidathangnpp.IDanhsachsanpham"%>
<%@page import="geso.traphaco.distributor.beans.denghidathangnpp.IDenghidathangnpp"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "geso.traphaco.distributor.beans.denghidathang.IDenghidathang" %>
            ...
            <TABLE width = 100% cellpadding="0" cellspacing="0">
			  	<tr>
					<TD align="left" colspan="4" class="legendtitle">
	    				...
	    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%" readonly="readonly" rows="1"  ><%=dndhBean.getMessage()%></textarea>
						<% dndhBean.setMessage(""); %>
						</FIELDSET>
				   </TD>
				</tr>			
                                ...
                                <TD  align="left">
                                    ...
                                    <LEGEND class="legendtitle">&nbsp;Đề nghị đặt hàng &nbsp;</LEGEND>
                                                <TABLE cellpadding = 4 cellspacing = 0 width = "100%" border = 0>
                                                    <TR>
                                                        <TD width="20%" class="plainlabel">Chi nhánh / Đối tác  </TD>
