...
<%@ page  import = "geso.traphaco.distributor.beans.duyetdonhangcs.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<% IErpDuyetdonhangcsList obj = (IErpDuyetdonhangcsList)session.getAttribute("obj"); %>
...
<% obj.setNextSplittings();
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("ErpDuyetddhNppOtcSvl","",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpDuyetdonhangcsSvl">
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center">   
                             		...
                             		<A href = "../../ErpduyetdonhangcsUpdateSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
	                    			<A
									href="../../ErpDuyetdonhangcsSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG
