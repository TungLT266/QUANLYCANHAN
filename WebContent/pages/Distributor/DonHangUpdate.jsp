										...
										<TR>
											<TD align="left">
												<TABLE width="100%" border="0" cellpadding="0"
													cellspacing="0">
													<TR height="22">
														<TD align="left" class="tbnavigation">Quản lý bán hàng > NPP bán hàng > Đơn hàng bán > Cập nhật
														</TD>
												...
												<TABLE width="100%" border="0" cellpadding="0" cellspacing="0" >
													<TR class="tbdarkrow">
														<%-- <TD width="30" align="left">
															<A href="../../DonhangSvl?userId=<%=userId %>"><img src="../images/Back30.png" alt="Quay ve" title="Quay ve" border="1" longdesc="Quay ve"	style="border-style: outset"> </A>
														</TD>
														...
														<TD width="30" align="left">
															<A href="../../InBangKepdfSvl?userId=<%=userId%>&display=<%=dhBean.getId()%>"><img src="../images/Printer30.png" alt="In" title="In chung tu" longdesc="In chung tu" border=1 style="border-style: outset"> </A>
														</TD>
														<TD align="left">&nbsp;</TD>
													</TR>
												</TABLE></TD>
										               			...
										               			<a href="" id="popupTICHLUY" rel="subcontentTL">
												           	 	...
												           	 	<DIV id="subcontentTL" style="position:absolute; visibility: hidden; border: 9px solid #80CB9B;
													                    ...
													                    <table width="98%" align="center" cellpadding="2" cellspacing="1"  >
													                        <tr class="plainlabel" >
													                            <th width="30%" style="font-size: 12px; text-align: center;" rowspan="2" >DS ký hợp đồng</th>
													                            
													                            <th width="20%" style="font-size: 12px; text-align: center;" rowspan="2" >DS tích lũy</th>
													                            <th width="20%" style="font-size: 12px; text-align: center;" rowspan="2" >DS cần đạt</th>
