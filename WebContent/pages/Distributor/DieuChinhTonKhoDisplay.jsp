												...
												<FIELDSET>
													...
													<TABLE cellpadding="3" cellspacing="0" width="100%" border=0>
														...
														<TR class="tblightrow">
															...
															<TD class="plainlabel"><input name="ttien" id="ttien" type="text" value="<%= dctkBean.getGtdc() %>" style="background-color: #FFFFFF"> VND</TD>
												...
												<fieldset>
													<TABLE width=100% cellpadding="1" border="1" style="border-color: #80CB9B" cellspacing="0">
														<TR class="tbheader">
															...
															<TH width="15%" rowspan="2">Gía mua TB</TH>
