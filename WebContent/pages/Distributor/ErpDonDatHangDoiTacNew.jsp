...
<%@ page  import = "geso.traphaco.distributor.beans.dondathang.imp.*" %>
	...
	/* 	var ptchietkhau = document.getElementById("txtPTChietKhau").value;
		...
		for(var i = 0; i < spMa.length; i++)
		{
			if(spMa.item(i).value != "" && dongia.item(i).value != "" && soluong.item(i).value != "" )
			{
				...
				// 27/01 tongtienCK += parseFloat( _ck );
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho NPP > Đơn bán hàng > Tạo mới
        </div>
               ...
               <%//Bắt đầu từ 27/01: không hiện 2 ô này nữa  %>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" colspan="3" >
                    	<input type="text" name="ghichu" style="width: 600px;" value="<%= lsxBean.getGhichu() %>" >
					...
					<%
						...
						if(spMa != null)
						{
							...
							<tr>
								...
								<td> <input type="text" name="soluongton" value="0" style="width: 100%; text-align: right;" onkeypress="return keypress(event);"  > </td>
								...
								<td> 
									<input type="text" name="dongia" value="<%= spGianhap[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" readonly="readonly">
									<input type="hidden" name="dongiagoc" value="<%= spGiagoc[i] %>" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" >
								</td>
					...
					<% for(int i = count; i < 50; i++) { %>
						...
						<tr>
							...
							<td> <input type="text" name="soluongton" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" > </td>
							 <Td style="display:none;"><input type="hidden" name="soluongtongoc" value="0" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" onkeyup="Dinhdang(this);" ></td>
							<td> 
								<input type="text" name="dongia" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);" readonly="readonly"> 
								<input type="hidden" name="dongiagoc" value="" style="width: 100%; text-align: right;" onkeypress="return keypress(event);"> 
							</td>
							<td> <input type="text" name="chietkhau" value="" style="width: 100%; text-align: right;" readonly="readonly" > </td>
