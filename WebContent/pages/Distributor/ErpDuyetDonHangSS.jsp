...
<%@ page  import = "geso.traphaco.distributor.beans.duyetdonhangss.*" %>
<%@ page  import = "java.sql.ResultSet" %>
<%@ page  import = "geso.traphaco.center.util.*" %>
<% IErpDuyetdonhangssList obj = (IErpDuyetdonhangssList)session.getAttribute("obj"); %>
...
<% obj.setNextSplittings();
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("ErpDuyetdonhangssSvl","",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpDuyetdonhangssSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	&nbsp;Quản lý bán hàng > Bán hàng cho NPP > Duyệt đơn hàng
        </div>
            ...
            <legend class="legendtitle"> Tiêu chí tìm kiếm</legend>
                <TABLE width="100%" cellpadding="6px" cellspacing="0px" style="margin-top: 5px " >
                     ...
                     <TR>
                     	...
                     	<TD style=" display:none" class="plainlabel" width="100px">ETC / Đối tác</TD>
                    ...
                    <TR>
						...
						<TD  class="plainlabel" colspan="3"><INPUT name="sodh" type="text" size="30" value = '<%= obj.getSodh() == null ?"":obj.getSodh()  %>' onChange = "submitform();"></TD>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center">   
                             		...
                             		<A href = "../../ErpduyetdonhangssUpdateSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG src="../images/Display20.png" alt="Xem đơn đặt hàng" title="Xem đơn đặt hàng" border=0></A>
	                    			<A
									href="../../ErpDuyetdonhangssSvl?userId=<%=userId%>&duyet=<%= nhapkhoRs.getString("PK_SEQ") %>"><IMG
										src="../images/Chot.png" alt="Duyệt đơn đặt hàng"
										title="Duyệt đơn đặt hàng" border=0></A>
								</TD>
		                    <TD align="center">
											<% if(obj.getDonHangID().indexOf(nhapkhoRs.getString("PK_SEQ"))>=0){%>
 												<input name="chotdhid" onclick="Kiemtra(this)" id="gsbh" type="checkbox"
												value="<%= nhapkhoRs.getString("PK_SEQ")%>"
												checked></TD>
											<%}else{ %>
		
												<input name="chotdhid" onclick="Kiemtra(this)" id="gsbh" type="checkbox" value="<%= nhapkhoRs.getString("PK_SEQ")%>">
												</TD>
											<%} %>
		                </TR>
                     <% m++; } 
