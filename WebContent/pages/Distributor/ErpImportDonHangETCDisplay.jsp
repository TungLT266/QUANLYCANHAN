...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng > Gửi SMS TDV tỉnh > Hiển thị
        </div>
    	...
    	<legend class="legendtitle">Gửi SMS TDV tỉnh </legend>
            ...
            <TABLE width="100%" cellpadding="4" cellspacing="0">							
                ...
                <TR>
                    ...
                    <TD class="plainlabel" >
                    	<input type="text" name="maFastSEARCH" value="<%= lsxBean.getMaFast() %>"  />
                    </TD>   
                    <TD class="plainlabel" >Tên khách hàng </TD>
                    <TD class="plainlabel" >
                    	<input type="text" name="tenkhachhangSEARCH" value="<%= lsxBean.getTenkhachhang() %>"  />
                    </TD>         	
                </TR>
                ...
                <TR>
                    ...
                    <TD class="plainlabel" >
                    	<input type="text" name="machungtuSEARCH" value="<%= lsxBean.getMachungtu() %>"  />
                    </TD>   
                    <TD class="plainlabel" >Người tạo </TD>
                    <TD class="plainlabel" >
                    	<input type="text" name="nguoitaoSEARCH" value="<%= lsxBean.getNguoitaodon() %>"  />
                    </TD>         	
                </TR>
