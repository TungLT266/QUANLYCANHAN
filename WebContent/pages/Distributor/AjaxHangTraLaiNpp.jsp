...
<%
	...
	try
	{		
		String command = " select a.ma, a.ten, b.donvi, isnull(a.hansudung, 0) as hansudung, isnull(c.thuexuat, 0) as thuexuat, ISNULL( ( select sum(available) from NHAPP_KHO where KHO_FK = '"+khoId+"' and sanpham_fk = a.pk_seq  and npp_fk = '"+ nppId +"' and KBH_FK= '"+kbhId+"' ), 0 ) as avai " +
