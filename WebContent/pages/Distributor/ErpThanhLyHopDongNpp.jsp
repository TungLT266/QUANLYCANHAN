...
<% IErpThanhlyhopdongNppList obj = (IErpThanhlyhopdongNppList)session.getAttribute("obj"); %>
...
<% obj.setNextSplittings();
	...
	if(!util.check(userId, userTen, sum)){
		...
		int[] quyen = new  int[6];
		quyen = util.Getquyen("ErpThanhlyhopdongNppSvl","",userId);
%>
...
<body>
<form name="ckParkForm" method="post" action="../../ErpThanhlyhopdongNppSvl">
...
<div id="main" style="width:100%; padding-left:2px">
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:55%; padding:5px; float:left" class="tbnavigation">
        	Quản lý bán hàng > Bán hàng thầu > Thanh lý hợp đồng
  	...
  	<div id="cotent" style="width:100%; float:none">
        ...
        <div align="left" style="width:100%; float:none; clear:left; font-size:0.7em">
        	<fieldset>
            	<legend><span class="legendtitle">Thanh lý hợp đồng </span>&nbsp;&nbsp;
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 10%" >Loại thanh lý</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
                 			...
                 			{  		
                 				String chuoiFORMAT = "";
                 				String loaihd = nhapkhoRs.getString("loaitl");
             					String _loaihopdong = "";
             					if(loaihd.equals("0"))
             						_loaihopdong = "Theo từng tháng";
             					else if(loaihd.equals("1"))
             						_loaihopdong = "Toàn bộ";
		                    ...
		                    <TD align="center"> 
			                    	<%if(quyen[Utility.XEM]!=0){ %>
			                    		<A href = "../../ErpThanhlyhopdongNppUpdateSvl?userId=<%=userId%>&display=<%= nhapkhoRs.getString("id") %>"><IMG src="../images/Display20.png" alt="Hiển thị" title="Hiển thị" border=0></A>
			                    	<% } %>     
			                    	  <%if(quyen[Utility.XOA]!=0 &&  tt.equals("0")){ %>
                                	<A href = "../../ErpThanhlyhopdongNppSvl?userId=<%=userId%>&delete=<%= nhapkhoRs.getString("id") %>"><img src="../images/Delete20.png" alt="Xóa" title="Xóa" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn xóa thanh lý hợp đồng này?')) return false;"></A>
                              	<% } %>	  
			                    	  <%if(quyen[Utility.CHOT]!=0  && tt.equals("0")){ %>
    	                            <A href = "../../ErpThanhlyhopdongNppSvl?userId=<%=userId%>&chot=<%= nhapkhoRs.getString("id") %>&loaidonhang=<%= nhapkhoRs.getString("loaitl") %>"><img src="../images/Chot.png" alt="Chốt" title="Chốt" width="20" height="20" border=0 onclick="if(!confirm('Bạn có muốn chốt thanh lý hợp đồng này?')) return false;"></A>&nbsp;
	                            <% } %>       
		                    </TD>
		                </TR>
                     <% m++; } nhapkhoRs.close(); } %>
