...
<%@ page  import = "geso.traphaco.distributor.beans.phieugiaohangkm.*" %>
        	...
        	<fieldset>
            	...
            	<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
					<TR class="tbheader">
	                    ...
	                    <TH align="center" style="width: 9%" >Người tạo</TH>
					...
					<%
                 		if(nhapkhoRs != null)
                 		{
		                    ...
		                    <TD align="center">
		                    	<A href = "../../PhieugiaohangkmPdfSvl?userId=<%=userId%>&pdf=<%= nhapkhoRs.getString("PK_SEQ") %>&nppId=<%= obj.getNppId()%>"><IMG src="../images/pdf.jpg" title="In phiếu giao hàng khuyến mãi" width="20" height="20" border=0 ></A>		                    
		                    </TD>
		                </TR>
                     <% m++; }  }  else {%>
