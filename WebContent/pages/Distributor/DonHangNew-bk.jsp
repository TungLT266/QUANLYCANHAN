...
<%@page import="geso.traphaco.distributor.util.Utility"%><HTML>
<HEAD>
						...
						<TD align="left" >
							...
							<TABLE border="0" width="100%" cellpadding = "0" cellspacing = "0">
								...
								<TD align="left" colspan="4" class="legendtitle">
				    				...
				    				<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%" readonly="readonly" rows="1"><%= dhBean.getMessage() %></textarea>
										<% dhBean.setMessage(""); %>
									</FIELDSET>
							   </TD>
								</tr>
