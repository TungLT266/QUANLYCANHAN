...
<%@page import="geso.traphaco.distributor.beans.banggiasieuthi.imp.KhachHang_Bgst"%>
<%@page import="geso.traphaco.distributor.beans.banggiasieuthi.IKhachHang_Bgst"%>
<%@page import="geso.traphaco.distributor.beans.banggiasieuthi.IBanggiasieuthi"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ page  import = "geso.traphaco.center.beans.banggiamuanpp.IBanggiamuanpp_npp" %>
		...
		<TABLE width="100%" border="0" cellpadding="0"  cellspacing="1" >
		  	<tr>
				<TD align="left" colspan="4" class="legendtitle">
	    			...
	    			<textarea name="dataerror"  style="width: 100% ; font-weight:bold"  style="width:100%" rows="1"><%=bgsieuthikhBean.getMessage()%></textarea>
