...
<%@page import="geso.traphaco.distributor.beans.dangkykhuyenmaitichluy.IDangkykhuyenmaitichluyList"%>
...
<form id="dthForm" name="dthForm" method="post" action="../../TratichluySvl">
                    	...
                    	<TR>
                        	<TD align="left" class="tbnavigation">
                            	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                                	<tr height="22">
                                    	<TD align="left" colspan="2" class="tbnavigation">Quản lý KM, trưng bày > Khuyến mại > Duyệt trả khuyến mãi tích lũy</TD> 
	...
	<img style="top: -4px;" src="../images/button.png" alt="">Nhập lại</a>&nbsp;&nbsp;&nbsp;&nbsp;	
                      ...
                      <TABLE width="100%" cellspacing = 0 cellpadding=0>
                        <TR>
                            <TD >
                                <FIELDSET>
                                <LEGEND class="legendtitle">&nbsp;Duyệt khuyến mãi tích lũy &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              ...
                              <%
								...
								while (dstichluy.next()){							
									...
									<%}%>
									 ...
									 <td>
									 	<%if(dstichluy.getString("trangthai").equals("1") && dstichluy.getString("daduyet").equals("0") ){ %>
									 		Chờ duyệt
									 	<%}else if(dstichluy.getString("trangthai").equals("1") && dstichluy.getString("daduyet").equals("1")) { %>
									 		Đã duyệt
								     ...
								     <TD align="center">
								    	...
								    	<%if(quyen[Utility.CHOT]!=0 && dstichluy.getString("daduyet").equals("0") ){ %>
								    		<A href = "../../TratichluyUpdateSvl?userId=<%=userId%>&duyet=<%=dstichluy.getString("pk_seq")%>"><img src="../images/Chot.png" alt="Duyệt trả tích lũy" width="20" height="20" longdesc="Duyệt trả tích lũy" border = 0 "></A>
										<%} %>
										
								   		<%if(quyen[Utility.XEM]!=0){ %>
								    		<A href = "../../TratichluyUpdateSvl?userId=<%=userId%>&dislay=<%=dstichluy.getString("pk_seq")%>"><img src="../images/Display20.png" alt="Hien thi" width="20" height="20" longdesc="Hien thi" border = 0 "></A>
										<%} %>
