...
<input type="hidden" name="khachhangId" value='<%= lsxBean.getKhId() %>'>
	...
	<div align="left" id="header" style="width:100%; float:none">
    	<div style="width:60%; padding:5px; float:left" class="tbnavigation">
        	<% if(lsxBean.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng cho NPP > Đơn trả hàng > Tạo mới
			<% } else if(lsxBean.getLoaidonhang().equals("0")) { %>
				Quản lý bán hàng > Bán hàng thầu > Đơn trả hàng  > Tạo mới
			<% } else { %>
				Quản lý bán hàng > Bán hàng không thầu > Đơn trả hàng  > Tạo mới
			<% } 
			
			System.out.print("KBH:"+lsxBean.getKbhId());
               ...
               <TR>
                ...
                <tr>
                 ...
                 <TR>
                    ...
                    <TD class="plainlabel" >
                    	<input type="text"  value="<%= lsxBean.getTienCK() %>" id="txtPTChietKhau" style="text-align: right;" name="ptChietkhau" readonly="readonly" />
                    </TD>
                    <TD class="plainlabel" >Tổng thành tiền </TD>
                    <TD class="plainlabel" >
                    	<input type="text" readonly="readonly"  id="txtBVAT" name="BVAT" value="<%= lsxBean.getTienBvat() %>" style="text-align: right;"  />
                    </TD>
                </TR>
                ...
                <TR  >
                    ...
                    <TD class="plainlabel" >
                    	<input type="text" readonly="readonly"  value="<%= lsxBean.getTienAVat() %>" id="txtSauVAT" name="SauVAT" style="text-align: right;" />
                    </TD>
                </TR>
