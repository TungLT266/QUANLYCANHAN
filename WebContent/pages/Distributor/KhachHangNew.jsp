								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr height="22">
										<TD align="left" colspan="2" class="tbnavigation">&nbsp;Thiết
											lập dữ liệu nền> Dữ liệu nền kinh doanh > Khách hàng > Tạo mới
									...
									<TABLE border="0" width="100%" cellpadding="6" cellspacing="0">
								     ...
								     %>
										...
										<tr>
											...
											<TD class="plainlabel" colspan="6"><SELECT
										...
										<TR>
											...
											<TD class="plainlabel" >
												<INPUT type="checkbox" name="dungmau" value="<%=khBean.getDungmau() %>" size="15"> Dùng mẫu HO
											</TD>
										</TR>
									</TABLE>
								</FIELDSET></TD>
