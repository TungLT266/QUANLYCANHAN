...
<ul id="theMenu">
	...
	<%
		...
		System.out.println(":::: NPP DUOC CHON JSP: " + npp_duocchon_id );
	 	ResultSet rs = util.getMenuRs(userId, "1", session.getAttribute("congtyId").toString(), tdv_dangnhap_id, npp_duocchon_id, db);
	 	//ResultSet rs = util.getMenuRs(userId, "1", session.getAttribute("congtyId").toString(), "", "", db);
