...
<%@ page  import = "geso.traphaco.distributor.beans.mucchietkhau.*" %>
				...
				<tr>
							<TD align="left" colspan="4" class="legendtitle">
								<FIELDSET>
		                        	...
		                        	<textarea name="dataerror"  style="width: 100% ; font-weight:bold" style="width:100%" rows="1" ><%= mckBean.getMessage() %></textarea>
		                        	<% mckBean.setMessage(""); %>
                        		</FIELDSET>
						   </TD>
					</tr>
