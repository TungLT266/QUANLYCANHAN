...
<%@page import="geso.traphaco.distributor.beans.reports.IBcDoanhThuSanPham"%>
...
<%
	...
	IBcDoanhThuSanPham obj = (IBcDoanhThuSanPham) session.getAttribute("obj");
	...
	String url="";
	url = util.getUrl("BcDoanhThuSanPhamSvl","");
						...
						<div style="width: 100%; float: none" align="left"
						   ...
						   <TR>
								...
								<TR>
									...
									<TD class="plainlabel">
										<select name="ddkdId" id="ddkdId" style="width:250px"   onchange="submitform();" >
											<option value="" >All</option>
											<%if (ddkd != null)
													while (ddkd.next()) {
		...
		<div id="tabKM" class="tab_content">
											<TABLE width="100%" border="0" cellspacing="1px" cellpadding="3px">
												<TR class="plainlabel" valign="bottom">
													...
													<th  width="8%"  align="center"> TRÌNH DƯỢC VIÊN</th>
												...
												if(hdRs!=null){
													try{
														...
														<%}%>
														    ...
														    <Td align="left"><%=hdRs.getString("ddkdTen")==null?"":hdRs.getString("ddkdTen") %></Td>
