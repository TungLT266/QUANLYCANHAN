...
<body>
<form name="loginForm" method="post" action="/TraphacoHYERP/LoginSvl" >
<input type="hidden" name="login" value = "1"></input>
<input type="hidden" name="choncongty" value = "1"></input>
	    		...
	    		<td width="100%" >
			            <select style="width: 100%;  height: 35px; vertical-align:bottom; font-size: 0.9em;"
			            	...
			            	<% 
			            		...
			            		//String sql = "select PK_SEQ, TEN, CONGTY_FK " + 
		            				//	 " from NHAPHANPHOI where loaiNPP = '0' and TRANGTHAI = '1' and ( PK_SEQ = 1 or SiteCode = ( select CONVSITECODE from NHANVIEN where PK_SEQ = '" + session.getAttribute("userId") + "' ) ) ";
			            		...
			            		if(rsChucdanh != null)
			            		{
			            			...
			            			{
			            				%>			            				
			            				<option value="<%= rsChucdanh.getString("CONGTY_FK") %>" ><%= rsChucdanh.getString("TEN") %></option>
